...
if (!$locations_screen):
    ...
    $menu_management .=
        '<li>' .
        __(
            'If you haven&#8217;t yet created any menus, <strong>click the &#8217;create a new menu&#8217; link</strong> to get started'
        ) .
        '</li></ul>';
    $menu_management .=
        '<p>' .
  ...
  if ($menu_count < 1): ?>
       ...
       'Fill in the Menu Name and click the Create Menu button to create your first menu.'
		...
		<span class="add-edit-menu-action">
			<?php printf(
       __(
           'Edit your menu below, or <a href="%s">create a new menu</a>. Don&#8217;t forget to save your changes!'
       ),
       esc_url(
           add_query_arg(
               [
      ...
      ?>
       ...
       'Select'
			...
			<span class="add-new-menu-action">
				<?php printf(
        __(
            'or <a href="%s">create a new menu</a>. Don&#8217;t forget to save your changes!'
        ),
        esc_url(
            add_query_arg(
                [
						...
						<div class="major-publishing-actions wp-clearfix">
							<?php if ($menu_count > 0): ?>
								...
								<span class="cancel-action">
									<a class="submitcancel cancellation menu-cancel" href="<?php echo esc_url(
             admin_url('nav-menus.php')
         ); ?>"><?php _e('Cancel'); ?></a>
