...
switch ($action) {
        ...
        if (empty($errors)) {
            ...
            if ($referer) {
                if (
                    ...
                    url_to_postid($referer) === $attachment_id
                ) {
                    $location = $referer;
                }
            }
	...
	<a href="media-new.php" class="page-title-action"><?php echo esc_html_x(
     'Add New',
     'file'
 ); ?></a>
<?php } ?>
	...
	<input type="hidden" name="post_id" id="post_id" value="<?php echo isset(
     $post_id
 )
     ? esc_attr($post_id)
     : ''; ?>" />
