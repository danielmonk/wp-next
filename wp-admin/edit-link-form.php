...
if (!empty($link_id)) {
    ...
    /* translators: %s: URL to Links screen. */
    $heading = sprintf(
        __('<a href="%s">Links</a> / Add New Link'),
        'link-manager.php'
    );
...
<a href="link-add.php" class="page-title-action"><?php echo esc_html_x(
    'Add New',
    'link'
); ?></a>
...
<div class="inside">
	<input type="text" name="link_url" size="30" maxlength="255" class="code" value="<?php echo esc_attr(
     $link->link_url
 ); ?>" id="link_url" />
	<p><?php _e(
