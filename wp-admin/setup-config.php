...
<p class="step"><a href="<?php echo $step_1; ?>" class="button button-large"><?php _e(
    ...
    case 1:
        ...
        ?>
<h1 class="screen-reader-text"><?php _e(
...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		<tr>
			...
			<td id="dbname-desc"><?php _e(
       'The name of the database you want to use with WordPress.'
   ); ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="uname"><?php _e('Username'); ?></label></th>
			<td><input name="uname" id="uname" type="text" aria-describedby="uname-desc" size="25" value="<?php echo htmlspecialchars(
       ...
       ENT_QUOTES
		...
		<tr>
			...
			<td><input name="pwd" id="pwd" type="text" aria-describedby="pwd-desc" size="25" value="<?php echo htmlspecialchars(
   ...
   printf(
       __(
           'You should be able to get this info from your web host, if %s doesn&#8217;t work.'
       ),
       '<code>localhost</code>'
   ); ?>
			</td>
            ...
            switch ($constant) {
                ...
                case 'DB_CHARSET':
                    if (
                        ...
                        (!$wpdb->charset && $wpdb->has_cap('utf8mb4'))
                    ) {
                        $config_file[$line_num] =
                            "define( '" .
                            $constant .
