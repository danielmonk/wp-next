...
<div class="wrap">
	...
	<div class="card auth-app-card">
      ...
      'An application would like to connect to your account.'
        ...
        __(
            'Would you like to give the application identifying itself as %s access to your account? You should only do this if you trust the app in question.'
        ),
		...
		<?php else: ?>
			<p><?php _e(
       'Would you like to give this application access to your account? You should only do this if you trust the app in question.'
   ); ?></p>
		<?php endif; ?>
      ...
      if ($blogs_count > 1) { ?>
		...
		<?php if ($new_password): ?>
          ...
          '<strong>' . esc_html($app_name) . '</strong>'
					...
					<input id="new-application-password-value" type="text" class="code" readonly="readonly" value="<?php esc_attr(
