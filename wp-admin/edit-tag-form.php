...
?>
       ...
       'Description'
			...
			<td><textarea name="description" id="description" rows="5" cols="50" class="large-text"><?php echo $tag->description;
// textarea_escaped
?></textarea>
			<p class="description"><?php _e(
...
?>
if ('category' === $taxonomy) {
    /** This action is documented in wp-admin/edit-tags.php */ do_action_deprecated(
        'edit_category_form',
        [$tag],
        '3.0.0',
        '{$taxonomy}_add_form'
...
<div class="edit-tag-actions">
	...
	<?php if (current_user_can('delete_term', $tag->term_id)): ?>
		<span id="delete-link">
			<a class="delete" href="<?php echo admin_url(
       wp_nonce_url(
