  ...
  (function (l, g) {
    (g.editor = g.editor || {}),
      (window.switchEditors = new (function () {
          ...
          if (
            ...
            (g
              ...
              (d = (function (e, t) {
                ...
                t &&
                  !t.showAsPlainText &&
                  (n = t.urlAtStartOfContent ? t.endIndex : t.startIndex);
                e = E(e, r);
                e &&
                  !e.showAsPlainText &&
                  (r = e.urlAtEndOfContent ? e.startIndex : e.endIndex);
              ...
              (o.value = [
                o.value.slice(0, c),
                a.clone().addClass("mce_SELRES_start")[0].outerHTML,
                s,
                o.value.slice(p),
              ].join(""))),
              g
                ...
                g.getParam("wp_keep_scroll_position") &&
                  (m = (function (e) {
                    ...
                    if (t && !(t.rangeCount < 1)) {
                      ...
                      return (
                        n &&
                          (-1 !== a[0].indexOf("data-mce-object-selection") &&
                            (o -= a[1].length),
                          (a = n.index),
                          -1 !== n[0].indexOf("data-mce-object-selection") &&
                            (a -= n[1].length),
                          (i = a - o)),
                        { start: e, end: i }
                      );
        ...
        function S(e) {
          ...
          n.length &&
            (e.focus(),
            r.length
              ? ((t = e.getDoc().createRange()).setStartAfter(n[0]),
                t.setEndBefore(r[0]),
            ...
            e.getParam("wp_keep_scroll_position") &&
              (function (e, t) {
                var n,
                  ...
                  a = b(e),
                  o = l("#wp-content-editor-tools"),
                  c = 0,
                  t = 0;
                o.length && ((c = o.height()), (t = o.offset().top));
                (o =
                  window.innerHeight ||
                  ...
                  (a = o - (c + a));
                i < a ||
                  ((r = e.settings.wp_autoresize_on
                    ? ((n = l("html,body")), Math.max(i - a / 2, t - c))
                    : ((n = l(e.contentDocument).find("html,body")), r)),
                  n.animate({ scrollTop: parseInt(r, 10) }, 100));
              })(e, n),
            i(n),
            i(r),
            e.save();
        ...
        function a(e) {
          ...
          return (
            l && l("body").trigger("beforePreWpautop", [e]),
            (e.data = $(e.data)),
        ...
        function o(e) {
          e = { o: t, data: e, unfiltered: e };
          return (
            l && l("body").trigger("beforeWpautop", [e]),
            (e.data = r(e.data)),
        ...
        return (
          ...
          (g.editor.autop = o),
          (g.editor.removep = a),
          (t = { go: n, wpautop: o, pre_wpautop: a, _wp_Autop: r, _wp_Nop: $ })
        );
      })()),
      (g.editor.initialize = function (e, t) {
        ...
        l &&
          e &&
          g.editor.getDefaultSettings &&
          ((d = g.editor.getDefaultSettings()),
