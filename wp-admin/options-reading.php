...
<td id="front-static-pages"><fieldset><legend class="screen-reader-text"><span><?php _e(
...
<ul>
	...
	<div id="front-page-warning" class="notice notice-warning inline"><p><?php _e(
	...
	<div id="privacy-policy-page-warning" class="notice notice-warning inline"><p><?php _e(
...
<td><fieldset><legend class="screen-reader-text"><span><?php has_action(
