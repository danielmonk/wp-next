...
<div class="wrap">
    ...
    ?>
				<td>
					<fieldset>
					<legend class="screen-reader-text"><?php _e(
     ...
     'Allow site administrators to add new users to their site via the "Users &rarr; Add New" page'
 ); ?></label>
				</td>
			</tr>
        ...
        'Banned Names'
         ...
         implode(' ', (array) get_site_option('illegal_names'))
     ); ?>" size="45" />
