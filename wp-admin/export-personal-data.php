...
get_current_screen()->add_help_tab([
    ...
    'content' =>
        '<p>' .
        __(
            'This screen allows you to manage requests for an export of personal data.'
        ) .
        '</p>' .
        '<p>' .
        __(
        ...
        '<p>' .
        __(
            '<strong>Note: As this tool only gathers data from WordPress and participating plugins, you may need to do more to comply with export requests. You should also send the requestor any data collected by or stored with any 3rd party services used by your business or site.</strong>'
        ) .
        '</p>',
]);
...
get_current_screen()->add_help_tab([
    ...
    'content' =>
        '<p>' .
        __(
            'Personal data that is collected by WordPress and is displayed in the export files include:'
        ) .
        '</p>' .
        '<p>' .
        __(
        ...
        '<p>' .
        __(
            '<strong>Community Events Location</strong> &mdash; The IP Address of the user used for the Upcoming Community Events shown in the dashboard widget.'
        ) .
        '</p>' .
        '<p>' .
        __(
        ...
        '<p>' .
        __(
            '<strong>Comments</strong> &mdash; For any comments made by the user, Email Address, IP Address, User Agent (Browser/OS), Date/Time, Comment Content, and Content URL.'
        ) .
        '</p>' .
        '<p>' .
        __(
...
get_current_screen()->set_help_sidebar(
    '<p><strong>' .
        ...
        '<p>' .
        __(
            '<a href="https://wordpress.org/support/article/tools-export-personal-data-screen/">Documentation on Export Personal Data</a>'
        ) .
        '</p>' .
        '<p>' .
