...
<form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
	<table class="form-table" role="presentation">
       ...
       echo '<input name="user_name" type="hidden" value="admin" />';
        ...
        ?>
				<input name="user_name" type="text" id="user_login" size="25" value="<?php echo esc_attr(
		...
		<tr class="form-field form-required user-pass1-wrap">
         ...
         : wp_generate_password(18); ?>
					<input type="password" name="admin_password" id="pass1" class="regular-text" autocomplete="off" data-reveal="1" data-pw="<?php echo esc_attr(
         $initial_password
      ...
      ?>
       ...
       : _e('Search engine visibility'); ?></th>
			<td>
				<fieldset>
					<legend class="screen-reader-text"><span><?php has_action(
...
<p class="step"><a href="<?php echo esc_url(
    wp_login_url()
