...
get_current_screen()->set_help_sidebar(
    '<p><strong>' .
        ...
        '<p>' .
        __(
            '<a href="https://wordpress.org/support/article/keyboard-shortcuts/">Documentation on Keyboard Shortcuts</a>'
        ) .
        '</p>' .
        '<p>' .
...
if (
    ...
    if (
        ...
        echo '<div id="moderated" class="updated notice is-dismissible"><p>' .
            implode("<br/>\n", $messages) .
            '</p></div>';
    }
}
