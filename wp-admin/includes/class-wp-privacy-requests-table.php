...
abstract class WP_Privacy_Requests_Table extends WP_List_Table
{
    ...
    protected function get_request_counts()
    {
        ...
        $results = (array) $wpdb->get_results(
            $wpdb->prepare($query, $this->post_type, $this->request_type),
            ARRAY_A
        );
    ...
    protected function get_views()
    {
        ...
        $current_link_attributes = empty($current_status)
    ...
    {
        return sprintf(
            '<input type="checkbox" name="request_id[]" value="%1$s" /><span class="spinner"></span>',
            esc_attr($item->ID)
        );
    }
