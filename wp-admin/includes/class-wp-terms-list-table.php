...
class WP_Terms_List_Table extends WP_List_Table
{
    ...
    {
        $tags_per_page = $this->get_items_per_page(
    ...
    public function column_name($tag)
    {
        ...
        $out = sprintf('<strong>%s</strong><br />', $name);
   ...
   ?>
			...
			<div class="inline-edit-save submit">
				<button type="button" class="cancel button alignleft"><?php _e(
        'Cancel'
    ); ?></button>
				<button type="button" class="save button button-primary alignright"><?php echo $tax
        ->labels->update_item; ?></button>
