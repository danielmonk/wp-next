...
function populate_options(array $options = [])
{
    ...
    if (is_numeric($offset_or_tz)) {
        ...
        $offset_or_tz &&
        in_array($offset_or_tz, timezone_identifiers_list(), true)
    ) {
    ...
    if (is_multisite()) {
        ...
        $defaults['blogdescription'] = sprintf(
...
--The Team @ SITE_NAME'
    ...
    $upload_filetypes = array_unique(
        array_merge($misc_exts, $audio_exts, $video_exts)
    );
