...
function wp_nav_menu_item_link_meta_box()
{
	...
	<div class="customlinkdiv" id="customlinkdiv">
		...
		<p id="menu-item-url-wrap" class="wp-clearfix">
			...
			<input id="custom-menu-item-url" name="menu-item[<?php echo $_nav_menu_placeholder; ?>][menu-item-url]" type="text"<?php wp_nav_menu_disabled_check(
    $nav_menu_selected_id
       ...
       'Link Text'
			...
			<input id="custom-menu-item-name" name="menu-item[<?php echo $_nav_menu_placeholder; ?>][menu-item-title]" type="text"<?php wp_nav_menu_disabled_check(
    $nav_menu_selected_id
		...
		<p class="button-controls wp-clearfix">
			<span class="add-to-menu">
				<input type="submit"<?php wp_nav_menu_disabled_check(
        $nav_menu_selected_id
...
function wp_nav_menu_item_post_type_meta_box($object, $box)
{
    ...
    if ($nav_menu_selected_id) {
        ...
        $view_all_url = esc_url(
            add_query_arg($tab_name, 'all', remove_query_arg($removed_args))
        );
        $search_url = esc_url(
            add_query_arg($tab_name, 'search', remove_query_arg($removed_args))
        );
    }
    ?>
	<div id="posttype-<?php echo $post_type_name; ?>" class="posttypediv">
		<ul id="posttype-<?php echo $post_type_name; ?>-tabs" class="posttype-tabs add-menu-item-tabs">
			<li <?php echo 'most-recent' === $current_tab ? ' class="tabs"' : ''; ?>>
				<a class="nav-tab-link" data-type="tabs-panel-posttype-<?php echo esc_attr(
        $post_type_name
    ); ?>-most-recent" href="<?php echo $most_recent_url; ?>#tabs-panel-posttype-<?php echo $post_type_name; ?>-most-recent">
					<?php _e('Most Recent'); ?>
				</a>
			</li>
			<li <?php echo 'all' === $current_tab ? ' class="tabs"' : ''; ?>>
				<a class="nav-tab-link" data-type="<?php echo esc_attr(
        $post_type_name
    ); ?>-all" href="<?php echo $view_all_url; ?>#<?php echo $post_type_name; ?>-all">
					<?php _e('View All'); ?>
				</a>
			</li>
			<li <?php echo 'search' === $current_tab ? ' class="tabs"' : ''; ?>>
				<a class="nav-tab-link" data-type="tabs-panel-posttype-<?php echo esc_attr(
        $post_type_name
    ); ?>-search" href="<?php echo $search_url; ?>#tabs-panel-posttype-<?php echo $post_type_name; ?>-search">
					<?php _e('Search'); ?>
				</a>
			</li>
		</ul><!-- .posttype-tabs -->
    ...
    ?>
		...
		<div class="tabs-panel <?php echo 'search' === $current_tab
      ? 'tabs-panel-active'
      : 'tabs-panel-inactive'; ?>" id="tabs-panel-posttype-<?php echo $post_type_name; ?>-search" role="region" aria-label="<?php echo $post_type->labels->search_items; ?>" tabindex="0">
       ...
       $search_results = [];
			...
			<p class="quick-search-wrap">
				...
				<input type="search"<?php wp_nav_menu_disabled_check(
        $nav_menu_selected_id
    ); ?> class="quick-search" value="<?php echo $searched; ?>" name="quick-search-posttype-<?php echo $post_type_name; ?>" id="quick-search-posttype-<?php echo $post_type_name; ?>" />
				<span class="spinner"></span>
				<?php submit_button(
        __('Search'),
    ...
    ?>
		...
		<p class="button-controls wp-clearfix" data-items-type="posttype-<?php echo esc_attr(
      $post_type_name
  ); ?>">
        ...
        $tab_name
			...
			<span class="add-to-menu">
				<input type="submit"<?php wp_nav_menu_disabled_check(
        $nav_menu_selected_id
    ); ?> class="button submit-add-to-menu right" value="<?php esc_attr_e('Add to Menu'); ?>" name="add-post-type-menu-item" id="<?php echo esc_attr('submit-posttype-' . $post_type_name); ?>" />
				<span class="spinner"></span>
			</span>
		</p>
...
function wp_nav_menu_item_taxonomy_meta_box($object, $box)
{
	...
	<div id="taxonomy-<?php echo $taxonomy_name; ?>" class="taxonomydiv">
		<ul id="taxonomy-<?php echo $taxonomy_name; ?>-tabs" class="taxonomy-tabs add-menu-item-tabs">
			<li <?php echo 'most-used' === $current_tab ? ' class="tabs"' : ''; ?>>
				<a class="nav-tab-link" data-type="tabs-panel-<?php echo esc_attr(
        $taxonomy_name
    ); ?>-pop" href="<?php echo $most_used_url; ?>#tabs-panel-<?php echo $taxonomy_name; ?>-pop">
			...
			<li <?php echo 'all' === $current_tab ? ' class="tabs"' : ''; ?>>
				<a class="nav-tab-link" data-type="tabs-panel-<?php echo esc_attr(
        $taxonomy_name
    ); ?>-all" href="<?php echo $view_all_url; ?>#tabs-panel-<?php echo $taxonomy_name; ?>-all">
					<?php _e('View All'); ?>
				</a>
			</li>
			<li <?php echo 'search' === $current_tab ? ' class="tabs"' : ''; ?>>
				<a class="nav-tab-link" data-type="tabs-panel-search-taxonomy-<?php echo esc_attr(
        $taxonomy_name
    ...
    ?>
		...
		<div class="tabs-panel <?php echo 'search' === $current_tab
      ? 'tabs-panel-active'
      : 'tabs-panel-inactive'; ?>" id="tabs-panel-search-taxonomy-<?php echo $taxonomy_name; ?>" role="region" aria-label="<?php echo $taxonomy->labels->search_items; ?>" tabindex="0">
    ...
    ?>
		...
		<p class="button-controls wp-clearfix" data-items-type="taxonomy-<?php echo esc_attr(
      $taxonomy_name
  ); ?>">
			<span class="list-controls hide-if-no-js">
				<input type="checkbox"<?php wp_nav_menu_disabled_check(
        ...
        $tab_name
			...
			<span class="add-to-menu">
				<input type="submit"<?php wp_nav_menu_disabled_check(
        $nav_menu_selected_id
    ); ?> class="button submit-add-to-menu right" value="<?php esc_attr_e('Add to Menu'); ?>" name="add-taxonomy-menu-item" id="<?php echo esc_attr('submit-taxonomy-' . $taxonomy_name); ?>" />
				<span class="spinner"></span>
			</span>
		</p>
