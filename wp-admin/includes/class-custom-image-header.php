...
class Custom_Image_Header
{
    ...
    public function show_header_selector($type = 'default')
    {
        ...
        foreach ($headers as $header_key => $header) {
            ...
            echo '<img src="' .
                set_url_scheme($header_thumbnail) .
                '" alt="' .
...
<td>
	...
	<p><?php _e(
     'If you don&lsquo;t want to upload your own image, you can use one of these cool headers, or show a random one.'
 ); ?></p>
	<?php else: ?>
	<p><?php _e(
  ...
  ?>
    ...
    public function step_2()
    {
        ...
        if (
            !current_theme_supports('custom-header', 'flex-height') &&
            !current_theme_supports('custom-header', 'flex-width') &&
            get_theme_support('custom-header', 'width') == $width &&
            get_theme_support('custom-header', 'height') == $height
        ) {
            // Add the metadata.
            if (file_exists($file)) {
...
<form method="post" action="<?php echo esc_url(add_query_arg('step', 3)); ?>">
	...
	<div id="crop_image" style="position: relative">
      ...
      $url
  ); ?>" id="upload" width="<?php echo $width; ?>" height="<?php echo $height; ?>" alt="" />
	</div>
        ...
        if (
            ...
            wp_die(
                '<h1>' .
                    ...
                    '<p>' .
                    __(
                        'The current theme does not support a flexible sized header image.'
                    ) .
                    '</p>',
                403
            );
    ...
    {
        $parent_id = isset($object['post_parent'])
            ? $object['post_parent']
            : null;
