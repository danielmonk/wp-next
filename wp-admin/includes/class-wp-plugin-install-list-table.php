    ...
    public function no_items()
    {
        if (isset($this->error)) { ?>
			<div class="inline error"><p><?php echo $this->error->get_error_message(); ?></p>
				<p class="hide-if-no-js"><button class="button try-again"><?php _e(
        'Try Again'
    ); ?></button></p>
			</div>
		<?php } else { ?>
    ...
    protected function get_views()
    {
        ...
        foreach ((array) $tabs as $action => $text) {
            $current_link_attributes =
                $action === $tab ? ' class="current" aria-current="page"' : '';
            $href = self_admin_url('plugin-install.php?tab=' . $action);
            $display_tabs[
                'plugin-install-' . $action
            ] = "<a href='$href'$current_link_attributes>$text</a>";
        }
                    ...
                    case 'newer_installed':
                        if (is_plugin_active($status['file'])) {
                            ...
                            $action_links[] = sprintf(
                                ...
                                esc_attr(
                                    sprintf($button_label, $plugin['name'])
                                ),
                                $button_text
                            );
                        } else {
