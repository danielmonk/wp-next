...
class WP_Plugins_List_Table extends WP_List_Table
{
    ...
    public function search_box($text, $input_id)
    {
       ...
       $input_id
   ); ?>" class="wp-filter-search" name="s" value="<?php _admin_search_query(); ?>" placeholder="<?php esc_attr_e('Search installed plugins...'); ?>"/>
    ...
    public function single_row($item)
    {
                ...
                if ($is_active) {
                    if (current_user_can('manage_network_plugins')) {
                        $actions['deactivate'] = sprintf(
                            ...
                            wp_nonce_url(
                                'plugins.php?action=deactivate&amp;plugin=' .
                    ...
                    if (
                        ...
                        $actions['delete'] = sprintf(
                            ...
                            wp_nonce_url(
                                'plugins.php?action=delete-selected&amp;checked[]=' .
                                    urlencode($plugin_file) .
                                    '&amp;plugin_status=' .
                                    $context .
                                    '&amp;paged=' .
                ...
                if ($restrict_network_active) {
                    ...
                    if (
                        ...
                        $actions['resume'] = sprintf(
                            ...
                            wp_nonce_url(
                                'plugins.php?action=resume&amp;plugin=' .
                                    urlencode($plugin_file) .
                                    '&amp;plugin_status=' .
                                    $context .
                                    '&amp;paged=' .
        ...
        $requires_php = isset($plugin_data['requires_php'])
