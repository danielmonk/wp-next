...
class WP_Debug_Data
{
    ...
    static function debug_data()
    {
        ...
        $info['wp-media']['fields']['imagick_module_version'] = [
            ...
            'value' => is_array($imagick_version)
                ? $imagick_version['versionNumber']
                : $imagick_version,
        ];
        ...
        $info['wp-server']['fields']['php_sapi'] = [
            ...
            'value' =>
                'unknown' !== $php_sapi
                    ? $php_sapi
                    : __('Unable to determine PHP SAPI'),
            'debug' => $php_sapi,
        ];
        ...
        foreach ($mu_plugins as $plugin_path => $plugin) {
            ...
            $info['wp-mu-plugins']['fields'][
                sanitize_text_field($plugin['Name'])
            ] = [
                'label' => $plugin['Name'],
        ...
        foreach ($all_themes as $theme_slug => $theme) {
            ...
            $info['wp-themes-inactive']['fields'][
                sanitize_text_field($theme->name)
            ] = [
                'label' => sprintf(
                    /* translators: 1: Theme name. 2: Theme slug. */
                    __('%1$s (%2$s)'),
