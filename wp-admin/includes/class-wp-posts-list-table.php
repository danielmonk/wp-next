...
class WP_Posts_List_Table extends WP_List_Table
{
    ...
    public function prepare_items()
    {
        ...
        if ($this->hierarchical_display) {
            ...
            if (
                ...
                isset($_GET['author']) &&
                get_current_user_id() == $_GET['author']
            ) {
    ...
    protected function get_views()
    {
        ...
        foreach (
            ...
            $status_links[$status_name] = $this->get_edit_link(
                $status_args,
                $status_label,
                $class
            );
    ...
    protected function formats_dropdown($post_type)
    {
        ...
        $displayed_post_format = isset($_GET['post_format'])
            ...
            : '';
        ?>
		<label for="filter-by-format" class="screen-reader-text"><?php _e(
    ...
    public function get_columns()
    {
        ...
        if (
            ...
            $posts_columns['comments'] =
                '<span class="vers comment-grey-bubble" title="' .
                esc_attr__('Comments') .
  ...
  $this->comments_bubble($post->ID, $pending_comments);?>
    ...
    public function single_row($post, $level = 0)
    {
        ...
        $classes =
            'iedit author-' .
            (get_current_user_id() == $post->post_author ? 'self' : 'other');
  ...
  while ($bulk < 2):
       ...
       : 'inline-edit'; ?>" class="<?php echo $classes; ?>" style="display: none">
        ...
        : __('Quick Edit'); ?></legend>
				...
				<?php if (post_type_supports($screen->post_type, 'title')): ?>
					...
					<?php // $bulk // is_post_type_viewable()
         // $bulk
   ...
   ?>
			...
			<div class="submit inline-edit-save">
				<button type="button" class="button cancel alignleft"><?php _e(
        'Cancel'
    ); ?></button>
