...
function install_search_form($deprecated = true)
{
	...
	<form class="search-form search-plugins" method="get">
		...
		<label class="screen-reader-text" for="typeselector"><?php _e(
      'Search plugins by:'
  ); ?></label>
       ...
       $type
		...
		<label class="screen-reader-text" for="search-plugins"><?php _e(
      'Search Plugins'
  ); ?></label>
...
<div class="upload-plugin">
	...
	<form method="post" enctype="multipart/form-data" class="wp-upload-form" action="<?php echo self_admin_url(
     'update.php?action=upload-plugin'
 ); ?>">
		<?php wp_nonce_field('plugin-upload'); ?>
		<label class="screen-reader-text" for="pluginzip"><?php _e(
      'Plugin zip file'
  ); ?></label>
...
<div id="<?php echo $_tab; ?>-content" class='<?php echo $_with_banner; ?>'>
   ...
   if (!empty($api->slug) && empty($api->external)) { ?>
				<li><a target="_blank" href="<?php echo __('https://wordpress.org/plugins/') .
        $api->slug; ?>/"><?php _e(
         ...
         case 'install':
             if ($status['url']) {
                 if ($compatible_php && $compatible_wp) {
                     echo '<a data-slug="' .
                         esc_attr($api->slug) .
                         '" id="plugin_install_from_iframe" class="button button-primary right" href="' .
                         $status['url'] .
                         '" target="_parent">' .
                         __('Install Now') .
                         '</a>';
             ...
             if ($status['url']) {
                 if ($compatible_php) {
                     echo '<a data-slug="' .
                         ...
                         '" id="plugin_update_from_iframe" class="button button-primary right" href="' .
                         $status['url'] .
                         '" target="_parent">' .
