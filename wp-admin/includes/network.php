...
function network_step1($errors = false)
{
 ...
 if (isset($_POST['subdomain_install'])) {
     ...
     if ($got_mod_rewrite) {
         ...
         echo '<div class="error inline"><p><strong>' .
             __('Warning:') .
             '</strong> ';
         printf(
             /* translators: %s: mod_rewrite */
...
function network_step2($errors = false)
{
    ...
    $home_path =
        0 === strpos($abspath_fix, $document_root_fix)
	...
	<div class="error"><p><strong><?php _e('Warning:'); ?></strong> <?php _e(
    ...
    if ($_POST || !is_multisite()) { ?>
      ...
      'Complete the following steps to enable the features for creating a network of sites.'
		...
		<?php if (file_exists($home_path . '.htaccess')) {
  ...
  if (!empty($keys_salts)) {
      ...
      ?>
       ...
       printf(
		...
		<textarea class="code" readonly="readonly" cols="100" rows="<?php echo $num_keys_salts; ?>"><?php echo esc_textarea(
    $keys_salts_str
); ?></textarea>
			<?php
  }
...
';
     ...
     ?>
		<textarea class="code" readonly="readonly" cols="100" rows="20"><?php echo esc_textarea(
      $web_config_file
  ); ?></textarea>
		</li>
	</ol>
...
EOF;
     ...
     ?>
		<textarea class="code" readonly="readonly" cols="100" rows="<?php echo substr_count(
      $htaccess_file,
      "\n"
