...
<?php endif; ?>
	...
	<label for="replycontent" class="screen-reader-text"><?php _e(
     'Comment'
 ); ?></label>
	<?php
 $quicktags_settings = [
...
function touch_time($edit = 1, $for_post = 1, $tab_index = 0, $multi = 0)
{
    ...
    $day =
        ...
        '" size="2" maxlength="2"' .
        $tab_index_attribute .
        ' autocomplete="off" class="form-required" /></label>';
    $year =
        '<label><span class="screen-reader-text">' .
        __('Year') .
        '</span><input type="text" ' .
                    ...
                    if (
                        ...
                        if ($plugin) { ?>
							<div class="error inline">
								<p>
									<?php /* translators: %s: The name of the plugin that generated this meta box. */
         printf(
             __(
                 "This meta box, from the %s plugin, isn't compatible with the block editor."
             ),
...
function find_posts_div($found_action = '')
{
	...
	<div id="find-posts" class="find-box" style="display: none;">
		<div id="find-posts-head" class="find-box-head">
			...
			<button type="button" id="find-posts-close"><span class="screen-reader-text"><?php _e(
       'Close media attachment panel'
		...
		<div class="find-box-inside">
         ...
         $found_action
				...
				<label class="screen-reader-text" for="find-posts-input"><?php _e(
        'Search'
    ); ?></label>
...
var ajaxurl = '<?php echo esc_js(admin_url('admin-ajax.php', 'relative')); ?>',
  ...
  */
 $admin_body_id = isset($GLOBALS['body_id'])
     ? 'id="' . $GLOBALS['body_id'] . '" '
     : '';
...
function _local_storage_notice()
{
	...
	<p class="local-restore">
      ...
      'The backup of this post in your browser is different from the version below.'
		...
		<button type="button" class="button restore-backup"><?php _e(
      'Restore the backup'
  ); ?></button>
	</p>
	<p class="help">
