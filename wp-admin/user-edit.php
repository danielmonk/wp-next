...
switch ($action) {
	...
	<div class="notice notice-info"><p><strong><?php _e(
     'Important:'
 ); ?></strong> <?php _e('This user has super admin privileges.'); ?></p></div>
<?php } ?>
...
<div id="message" class="updated notice is-dismissible">
	...
	<?php endif; ?>
			<?php if (
       $wp_http_referer &&
       false === strpos($wp_http_referer, 'user-new.php') &&
       !IS_PROFILE_PAGE
   ): ?>
...
<table class="form-table" role="presentation">
	...
	<tr class="user-syntax-highlighting-wrap">
       ...
       'false',
       $profileuser->syntax_highlighting
   ); ?> />
   ...
   do_action('admin_color_scheme_picker', $user_id); ?>
	...
	<tr class="user-comment-shortcuts-wrap">
        ...
        'true',
        $profileuser->comment_shortcuts
    ); ?> />
				<?php _e('Enable keyboard shortcuts for comment moderation.'); ?>
			</label>
			<?php _e(
       '<a href="https://wordpress.org/support/article/keyboard-shortcuts/" target="_blank">More information</a>'
   ); ?>
		</td>
	</tr>
		<?php endif; ?>
	...
	<tr class="show-admin-bar user-admin-bar-front-wrap">
        ...
        _get_admin_bar_pref('front', $profileuser->ID)
    ); ?> />
...
<table class="form-table" role="presentation">
  ...
  ); ?>" disabled="disabled" class="regular-text" /> <span class="description"><?php _e(
...
<tr class="user-role-wrap"><th><label for="role"><?php _e(
    'Role'
); ?></label></th>
...
<tr class="user-display-name-wrap">
	<th><label for="display_name"><?php _e(
  ...
  ?>
	...
	<tr class="user-email-wrap">
     ...
     '(required)'
		...
		<td><input type="email" name="email" id="email" aria-describedby="email-description" value="<?php echo esc_attr(
      $profileuser->user_email
  ...
  if (
   ...
   printf(
       ...
       esc_url(
           wp_nonce_url(
               self_admin_url(
                   'profile.php?dismiss=' . $current_user->ID . '_new_email'
               ),
...
<th><label for="<?php echo $name; ?>">
   ...
   echo apply_filters("user_{$name}_label", $desc); ?>
	...
	<td><input type="text" name="<?php echo $name; ?>" id="<?php echo $name; ?>" value="<?php echo esc_attr(
    $profileuser->$name
); ?>" class="regular-text" /></td>
	</tr>
			<?php } ?>
...
<tr class="user-description-wrap">
	...
	<td><textarea name="description" id="description" rows="5" cols="30"><?php echo $profileuser->description;
        // textarea_escaped
        ?></textarea>
      ...
      'Set New Password'
		...
		<div class="wp-pwd hide-if-js">
			<span class="password-input-wrapper">
				<input type="password" name="pass1" id="pass1" class="regular-text" value="" autocomplete="off" data-pw="<?php echo esc_attr(
...
<tr class="pw-weak">
  ...
  if (!IS_PROFILE_PAGE): ?>
    ...
    printf(
        ...
        esc_html($profileuser->display_name)
    ); ?>
			</p>
		</td>
	</tr>
...
<?php elseif (!IS_PROFILE_PAGE && $sessions->get_all()): ?>
	<tr class="user-sessions-wrap hide-if-no-js">
       ...
       'Log Out Everywhere'
			...
			<p class="description">
				<?php printf(__('Log %s out of all locations.'), $profileuser->display_name); ?>
			</p>
		</td>
	</tr>
<?php endif; ?>
   ...
   if (!wp_is_site_protected_by_basic_auth('front')) { ?>
         ...
         'New Application Password Name'
					...
					<input type="text" size="30" id="new_application_password_name" name="new_application_password_name" placeholder="<?php esc_attr_e(
         'WordPress App on My Phone'
     ); ?>" class="input" aria-required="true" aria-describedby="new_application_password_name_desc" />
    ...
    do_action('wp_create_application_password_form', $profileuser); ?>
				...
				<?php submit_button(
        __('Add New Application Password'),
        'secondary',
