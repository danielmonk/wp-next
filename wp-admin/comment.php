...
switch ($action) {
    case 'editcomment':
        ...
        get_current_screen()->set_help_sidebar(
            '<p><strong>' .
                ...
                '<p>' .
                __(
                    '<a href="https://wordpress.org/support/article/comments-screen/">Documentation on Comments</a>'
                ) .
                '</p>' .
                '<p>' .
  ...
  if ('0' !== $comment->comment_approved) {
      ...
      if ($message) {
          echo '<div id="message" class="notice notice-info"><p>' .
              $message .
              '</p></div>';
      }
  }
  ?>
<div id="message" class="notice notice-warning"><p><strong><?php _e(
    'Caution:'
); ?></strong> <?php echo $caution_msg; ?></p></div>
...
<tr>
  ...
  ?>
	...
	<p class="edit-comment"><a href="<?php echo admin_url(
     "comment.php?action=editcomment&amp;c={$comment->comment_ID}"
 ); ?>"><?php esc_html_e('Edit'); ?></a></p>
	</td>
	</tr>
	</table>
    ...
    case 'unapprovecomment':
        ...
        if (
            wp_get_referer() &&
            !$noredir &&
            false === strpos(wp_get_referer(), 'comment.php')
        ) {
