var bootstrap_loaded = (typeof jQuery().emulateTransitionEnd == 'function');
var bootstrap_modal_loaded = (typeof jQuery().modal == 'function');

if (!bootstrap_loaded && !bootstrap_modal_loaded) {
    /*!
