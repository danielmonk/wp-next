...
if (!sbsw_js_exists) {
  ...
  jQuery(".sbsw-twitter-card").css(
    "color",
    jQuery(".sbsw-content-text").css("color")
  );
  ...
  !(function (a, b, c, d) {
    ...
    (function (a, b, c, d) {
      ...
      (e.Defaults = { autoHeight: !1, autoHeightClass: "sbi-owl-height" }),
        (e.prototype.update = function () {
      ...
      (e.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
        ...
        (e.prototype.thumbnail = function (b, c) {
          var d,
            ...
            l = function (a) {
              (e = '<div class="sbi-owl-video-play-icon"></div>'),
                (d = k.lazyLoad
          ...
          if (
            (b.wrap('<div class="sbi-owl-video-wrapper"' + g + "></div>"),
            this._core.settings.lazyLoad &&
              ((i = "data-src"), (j = "sbi-owl-lazy")),
            h.length)
          )
        ...
        (e.prototype.play = function (b) {
          ...
          this._playing ||
            ...
            a('<div class="sbi-owl-video-frame">' + c + "</div>").insertAfter(
              e.find(".sbi-owl-video")
            ),
            (this._playing = e.addClass("sbi-owl-video-playing")));
        }),
  ...
  function sbyAddImgLiquid() {
    ...
    (sbsw_imgLiquid.bgs_Available = !1),
      (sbsw_imgLiquid.bgs_CheckRunned = !1),
      (function (i) {
        function t() {
              ...
              this.each(function (t) {
                function e() {
                  -1 ===
                    ...
                    u.addClass("sbsw_imgLiquid_bgSize"),
                    u.addClass("sbsw_imgLiquid_ready"),
                    l();
                }

                function o() {
                  function e() {
                    c.data("sbsw_imgLiquid_error") ||
                      c.data("sbsw_imgLiquid_loaded") ||
                      c.data("sbsw_imgLiquid_oldProcessed") ||
                      (u.is(":visible") &&
                      c[0].complete &&
                      c[0].width > 0 &&
                      c[0].height > 0
                        ? (c.data("sbsw_imgLiquid_loaded", !0),
                  ...
                  if (c.data("oldSrc") && c.data("oldSrc") !== c.attr("src")) {
                    ...
                    return (
                      a.data(
                        "sbsw_imgLiquid_settings",
                        c.data("sbsw_imgLiquid_settings")
                      ),
                      c.parent().prepend(a),
                      c.remove(),
                      (c = a),
                  ...
                  return c.data("sbsw_imgLiquid_oldProcessed")
                    ? void r()
                    : (c.data("sbsw_imgLiquid_oldProcessed", !1),
                ...
                function d() {
                  (g.responsive || c.data("sbsw_imgLiquid_oldProcessed")) &&
                    c.data("sbsw_imgLiquid_settings") &&
                    ((g = c.data("sbsw_imgLiquid_settings")),
                    (u.actualSize =
                ...
                function n() {
                  c.data("sbsw_imgLiquid_error", !0),
                    u.addClass("sbsw_imgLiquid_error"),
                ...
                function r() {
                  ...
                  void 0 === c.data("owidth") && c.data("owidth", c[0].width),
                    ...
                    c.data("sbsw_imgLiquid_oldProcessed") ||
                      ...
                      c.data("sbsw_imgLiquid_oldProcessed", !0),
                      g.removeBoxBackground &&
                        u.css("background-image", "none"),
                      u.addClass("sbsw_imgLiquid_nobgSize"),
                      u.addClass("sbsw_imgLiquid_ready")),
                    g.onItemFinish && g.onItemFinish(t, u, c),
                    l();
                }
                ...
                return c.length
                  ? (c.data("sbsw_imgLiquid_settings")
                      ? (u
                          .removeClass("sbsw_imgLiquid_error")
                          .removeClass("sbsw_imgLiquid_ready"),
                        (g = i.extend(
                          {},
                          c.data("sbsw_imgLiquid_settings"),
                          a.options
                    ...
                    c.data("sbsw_imgLiquid_settings", g),
                    g.onItemStart && g.onItemStart(t, u, c),
                    void (sbsw_imgLiquid.bgs_Available && g.useBackgroundSize
                      ? e()
                      : o()))
                  : void n();
              })
  ...
  !(function (a, b, c, d) {
    ...
    (function (a, b, c, d) {
      ...
      (e.Defaults = { autoRefresh: !0, autoRefreshInterval: 500 }),
        ...
        (e.prototype.refresh = function () {
          this._core.$element.is(":visible") !== this._visible &&
            ((this._visible = !this._visible),
            this._core.$element.toggleClass("sbsw-owl-hidden", !this._visible),
            this._visible &&
              this._core.invalidate("width") &&
              this._core.refresh());
        }),
    ...
    (function (a, b, c, d) {
      ...
      (e.Defaults = { autoHeight: !1, autoHeightClass: "sbsw-owl-height" }),
        (e.prototype.update = function () {
          var b = this._core._current,
            c = b + this._core.settings.items,
            d = this._core.$stage.children().toArray().slice(b, c),
          ...
          (this._handlers = {
            ...
            "refreshed.owl.carousel": a.proxy(function (a) {
              a.namespace &&
                this._core.is("resizing") &&
                this._core.$stage
                  .find(".cloned .sbsw-owl-video-frame")
                  .remove();
            }, this),
            "changed.owl.carousel": a.proxy(function (a) {
              a.namespace &&
      ...
      (e.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
        ...
        (e.prototype.thumbnail = function (b, c) {
          var d,
            ...
            k = this._core.settings,
            l = function (a) {
              (e = '<div class="sbsw-owl-video-play-icon"></div>'),
                (d = k.lazyLoad
                  ? '<div class="sbsw-owl-video-tn ' +
                    j +
                    '" ' +
                    i +
                    '="' +
                    a +
                    '"></div>'
                  : '<div class="sbsw-owl-video-tn" style="opacity:1;background-image:url(' +
                    a +
                    ')"></div>'),
                b.after(d),
                b.after(e);
          ...
          if (
            (b.wrap('<div class="sbsw-owl-video-wrapper"' + g + "></div>"),
            this._core.settings.lazyLoad &&
              ((i = "data-src"), (j = "sbsw-owl-lazy")),
            h.length)
          )
            return l(h.attr(i)), h.remove(), !1;
          "youtube" === c.type
        ...
        (e.prototype.stop = function () {
          this._core.trigger("stop", null, "video"),
            this._playing.find(".sbsw-owl-video-frame").remove(),
            this._playing.removeClass("sbsw-owl-video-playing"),
            (this._playing = null),
            this._core.leave("playing"),
            this._core.trigger("stopped", null, "video");
        }),
            ...
            "youtube" === f.type
              ...
              : "vzaar" === f.type &&
                (c =
                  ...
                  f.id +
                  '/player?autoplay=true"></iframe>'),
            a('<div class="sbsw-owl-video-frame">' + c + "</div>").insertAfter(
              e.find(".sbsw-owl-video")
            ),
            (this._playing = e.addClass("sbsw-owl-video-playing")));
        }),
        (e.prototype.isInFullScreen = function () {
          var b =
            c.fullscreenElement ||
            ...
            this.core.current() !== this.previous &&
              (g &&
                ...
                d
                  .one(a.support.animation.end, c)
                  .css({ left: b + "px" })
                  .addClass("animated sbsw-owl-animated-out")
                  .addClass(g)),
              f &&
                e
                  .one(a.support.animation.end, c)
                  .addClass("animated sbsw-owl-animated-in")
                  .addClass(f));
          }
        }),
        (e.prototype.clear = function (b) {
          a(b.target)
            .css({ left: "" })
            .removeClass("animated sbsw-owl-animated-out sbsw-owl-animated-in")
            .removeClass(this.core.settings.animateIn)
            .removeClass(this.core.settings.animateOut),
            this.core.onTransitionEnd();
        }),
  ...
  (function ($) {
    ...
    Sbsw.prototype = {
      createPage: function (createFeeds, createFeedsArgs) {
        if (
          typeof window.sbswajaxurl === "undefined" ||
          window.sbswajaxurl.indexOf(window.location.hostname) === -1
        ) {
          window.sbswajaxurl =
            ...
            c = (function () {
              ...
              return (
                ...
                (b.prototype.build = function () {
                  var b = this;
                  if (
                    typeof a("#sbsw-lightbox").find(".sbsw-lb-container")
                      .hammer !== "function"
                  ) {
                    var Hammer = {
                      Manager: {
                  ...
                  a("" + lbBuilder.template()).appendTo(a("body")),
                    (this.$lightbox = a("#sbsw-lightbox")),
                    (this.$overlay = a("#sbsw-lightboxOverlay")),
                    ...
                    jQuery(document).on("click", function (event, b, c) {
                      ...
                      if (
                        !jQuery(event.target).closest(".sbsw-lb-outerContainer")
                          .length
                      ) {
                        if (
                          !jQuery(event.target).closest(
                            ".sbsw-lb-dataContainer"
                          ).length
                        ) {
                          //Fade out lightbox
                          ...
                          jQuery(
                            "#sbsw-lightboxOverlay, #sbsw-lightbox"
                          ).fadeOut();
                        }
                      }
                    }),
                    ...
                    jQuery("#sbsw-lightboxOverlay").on("click", function (c) {
                      ...
                      return (
                        "sbsw-lightbox" === a(c.target).attr("id") && b.end(),
                        !1
                      );
                    }),
                    this.$lightbox
                    ...
                    this.$lightbox
                      .find(".sbsw-lb-loader, .sbsw-lb-close")
                      .on("click", function () {
                        lbBuilder.pausePlayer();
                        lbBuilder.afterSlideChange();
                ...
                (b.prototype.start = function (b) {
                  ...
                  if (h) {
                    f = a(
                      b.prop("tagName") + '[data-sbsw-lightbox="' + h + '"]'
                    );
                ...
                (b.prototype.changeImage = function (b) {
                  ...
                  this.$overlay.fadeIn(this.options.fadeDuration),
                    a(".sbsw-lb-loader").fadeIn("slow"),
                    this.$lightbox
                      .find(
                        ".sbsw-lb-image, .sbsw-lb-nav, .sbsw-lb-prev, .sbsw-lb-next, .sbsw-lb-dataContainer, .sbsw-lb-numbers, .sbsw-lb-caption"
                      )
                      .hide(),
                ...
                (b.prototype.sizeContainer = function (a, b) {
                  function c() {
                    d.$lightbox.find(".sbsw-lb-dataContainer").width(g),
                      d.$lightbox.find(".sbsw-lb-prevLink").height(h),
                      d.$lightbox.find(".sbsw-lb-nextLink").height(h),
                      d.showImage();
                  }
                  var d = this,
                ...
                (b.prototype.showImage = function () {
                  this.$lightbox.find(".sbsw-lb-loader").hide(),
                    this.$lightbox.find(".sbsw-lb-image").fadeIn("slow"),
                    this.updateNav(),
                    this.updateDetails(),
                ...
                (b.prototype.updateNav = function () {
                  ...
                  this.$lightbox.find(".sbsw-lb-nav").show(),
                    this.album.length > 1 &&
                      (this.options.wrapAround
                        ? (a &&
                            this.$lightbox
                              .find(".sbsw-lb-prev, .sbsw-lb-next")
                              .css("opacity", "1"),
                          this.$lightbox
                            .find(".sbsw-lb-prev, .sbsw-lb-next")
                            .show())
                        : (this.currentImageIndex > 0 &&
                            (this.$lightbox.find(".sbsw-lb-prev").show(),
                            a &&
                              this.$lightbox
                                .find(".sbsw-lb-prev")
                                .css("opacity", "1")),
                          this.currentImageIndex < this.album.length - 1 &&
                            (this.$lightbox.find(".sbsw-lb-next").show(),
                            a &&
                              this.$lightbox
                                .find(".sbsw-lb-next")
                                .css("opacity", "1"))));
                ...
                (b.prototype.updateDetails = function () {
                  ...
                  if (jQuery("iframe.sbsw-lb-player-loaded").length) {
                    jQuery(".sbsw-lb-player-placeholder").replaceWith(
                      jQuery("iframe.sbsw-lb-player-loaded")
                    );
                    jQuery("iframe.sbsw-lb-player-loaded")
                      .removeClass("sbsw-lb-player-loaded")
                      .show();
                  }
                  ...
                  if (sbsw_supports_video()) {
                    if (
                      this.album[this.currentImageIndex].mediaType === "youtube"
                    ) {
                      ...
                      if (typeof window.sbswLightboxPlayer === "undefined") {
                        ...
                        window.sbswLightboxPlayer = new window.YT.Player(
                          playerID,
                          args
                        );
                      } else {
                      ...
                      this.album[this.currentImageIndex].mediaType === "video"
                    ) {
                      if (!$(".sbsw-lb-media").find("video").length) {
                        $(".sbsw-lb-media").append(
                          '<video class="sbsw-lb-video" src="' +
                            this.album[this.currentImageIndex].mediaURL +
                      ...
                      this.album[this.currentImageIndex].mediaType === "iframe"
                    ) {
                      if (
                        !$(".sbsw-lb-media").find("iframe.sbsw-lb-iframe")
                          .length
                      ) {
                        $(".sbsw-lb-media").append(
                          '<iframe class="sbsw-lb-iframe" title="Placeholder for videos in the lightbox" type="text/html" src="' +
                            this.album[this.currentImageIndex].mediaURL +
                ...
                (b.prototype.keyboardAction = function (a) {
                  ...
                  if (keycode === KEYCODE_ESC || key.match(/x|o|c/)) {
                    if (sbsw_supports_video())
                      $("#sbsw-lightbox video.sbsw_video")[0].pause();
                    ...
                    if (sbsw_supports_video())
                      $("#sbsw-lightbox video.sbsw-lb-video")[0].pause();
                    $("#sbsw-lightbox iframe").attr("src", "");
      ...
      createFeeds: function (args) {
        ...
        args.whenFeedsCreated(
          $(".sb-wall").each(function (index) {
            ...
            var $self = $(this),
              flags =
                typeof $self.attr("data-sbsw-flags") !== "undefined"
                  ? $self.attr("data-sbsw-flags").split(",")
                  : [],
              general =
            ...
            window.sbsw.feeds[
              index
            ].twitterCardHandler = new SbTwitterCardHandler("sbsw", $self);
            window.sbsw.feeds[index].init();

            window.sbsw.filterBars = {};
            window.sbsw.filterBars[index] = new SbFilterBar(
              window.sbsw.feeds[index]
            );
    ...
    SbswFeed.prototype = {
          ...
          $self.find(".sbsw-item").each(function () {
            $(this).attr(
              ...
              $(this)
                ...
                .replace(
                  "padding: " +
                    $self.find(".sb-wall-items-wrap").css("padding-top"),
                  "padding: " +
                    $self.find(".sb-wall-items-wrap").css("padding-top") +
                    " !important"
                )
          ...
          var itemsTabletSmall = cols,
            ...
            afterInit = function () {
              ...
              setTimeout(function () {
                $self
                  .find(
                    ".sb-wall-items-wrap.sbsw-carousel .sbsw-info, .sbsw-owl2row-item,.sb-wall-items-wrap.sbsw-carousel"
                  )
                  .fadeIn();
              }, 50);
              setTimeout(function () {
      ...
      setResizedImages: function () {
        if (
          $(this.el).find(".sbsw-resized-image-data").length &&
          typeof $(this.el)
            .find(".sbsw-resized-image-data")
          ...
          var rawResized = JSON.parse(
              $(this.el).find(".sbsw-resized-image-data").attr("data-resized")
            ),
            organizedResized = {
              facebook: {},
              instagram: {},
      ...
      afterLoadMoreClicked: function ($button) {
        $button
          .addClass("sbsw-loading")
          .append('<div class="sbsw-loader"></div>');
        $button
          .find(".sbsw-loader")
          .css("background-color", $button.css("color"));
        $button
          .closest(".sb-wall")
          .find(".sbsw-num-diff-hide")
          .addClass("sbsw-transition")
          .removeClass("sbsw-num-diff-hide");
      },
      ...
      revealNewImages: function () {
        ...
        if (typeof sbswCustomJS == "function")
          setTimeout(function () {
            sbswCustomJS();
          }, 100);
        ...
        $self.find(".sbsw-item.sbsw-new").each(function (index) {
          ...
          if ($(this).hasClass("sbsw-youtube-item")) {
            feed.itemsToCheck.youtube.push(
              $(this).attr("id").replace("sbsw-", "")
            );
          ...
          if ($self.find(".sbsw-content-text").length) {
            ...
            $self
              .find(".sbsw-content-text")
              .html(sbyLinkify($self.find(".sbsw-content-text").html()));
          }

          if ($self.find(".sbsw-quoted-tweet-text").length) {
            $self
              .find(".sbsw-quoted-tweet-text")
              .find(".emoji")
              .each(function () {
                $(this).replaceWith($(this).attr("alt"));
              });
            $self
              .find(".sbsw-quoted-tweet-text")
              .html(sbyLinkify($self.find(".sbsw-quoted-tweet-text").html()));
          }
          ...
          if (feed.settings.lightboxEnabled) {
            $self
              .find(".sbsw-lightbox-hover")
              .attr("data-sbsw-lightbox", feed.index);
            if ($self.hasClass("sbsw-youtube-item")) {
              $self
                .find(".sbsw-lightbox-hover")
                .attr("href", sbsw.options.lightboxPlaceholder);
            }
          }
      ...
      setItemsToCheck: function () {
        if (
          this.settings.ifResizingEnabled &&
          this.needsResizing.instagram.length > 0
        ) {
          this.itemsToCheck.instagram = this.needsResizing.instagram;
        }
        if (
          this.settings.fbResizingEnabled &&
          this.needsResizing.facebook.length > 0
        ) {
          this.itemsToCheck.facebook = this.needsResizing.facebook;
        }
        if (
          this.settings.twResizingEnabled &&
          this.needsResizing.twitter.length > 0
        ) {
      ...
      lazyLoadCheck: function ($item) {
        var feed = this;
        if (
          $item.find(".sbsw-item-media").length &&
          !$item.closest(".sb-wall").hasClass("sbsw-no-ll-check")
        ) {
      ...
      afterBackgroundProcessing: function (response) {
        ...
        $feedEl.find(".sbsw-twitter-item").each(function () {
          ...
          if (
            typeof response.twitter !== "undefined" &&
      ...
      loadMoreButtonInit: function () {
        var $self = $(this.el),
          feed = this;
        $self
          .find(".sb-wall-footer .sb-wall-load-btn")
          .off()
          .on("click", function () {
      ...
      appendNewPosts: function (newPostsHtml, plugin) {
        ...
        if ($self.find(".sbsw-items-wrap-" + plugin + " .sbsw-item").length) {
          $self
            .find(".sbsw-items-wrap-" + plugin + " .sbsw-item")
            .last()
            .after(newPostsHtml);
        } else {
      ...
      maybeRaiseSingleImageResolution: function ($item, index, forceChange) {
        var feed = this,
          ...
          currentRes =
            typeof $mediaItem.attr("data-current") === "undefined"
              ? 0
              : parseInt($mediaItem.attr("data-current")),
      ...
      maybeRaiseImageResolution: function (justNew) {
        ...
        $(feed.el)
          ...
          .each(function (index) {
            if (
              !$(this).hasClass("sbsw-num-diff-hide") &&
              $(this).find(".sbsw-item-media").length &&
              typeof $(this)
                .find(".sbsw-item-media")
      ...
      hideExtraItemsForWidth: function () {
        ...
        var $self = $(this.el),
          num =
            typeof $self.attr("data-num") !== "undefined" &&
            $self.attr("data-num") !== ""
              ? parseInt($self.attr("data-num"))
              : 1,
          nummobile =
            typeof $self.attr("data-nummobile") !== "undefined" &&
            $self.attr("data-nummobile") !== ""
              ? parseInt($self.attr("data-nummobile"))
              : num;
        ...
        if (!$self.hasClass(".sbsw_layout_carousel")) {
          if ($(window).width() < 480) {
            if (nummobile < $self.find(".sbsw-item").length) {
              $self
                .find(".sbsw-item")
                .slice(nummobile - $self.find(".sbsw-item").length)
                .addClass("sbsw_num_diff_hide");
            }
          } else {
            if (num < $self.find(".sbsw-item").length) {
              $self
                .find(".sbsw-item")
                .slice(num - $self.find(".sbsw-item").length)
                .addClass("sbsw_num_diff_hide");
            }
          }
        }
      ...
      setImageSizeClass: function () {
        ...
        var feedWidth = $self.innerWidth(),
          photoPadding =
            parseInt(
              $self.find(".sb-wall-items-wrap").outerWidth() -
                $self.find(".sb-wall-items-wrap").width()
            ) / 2,
      ...
      setMinImageWidth: function () {
        if (
          $(this.el).find(".sbsw-item .sbsw_video_thumbnail").first().length
        ) {
          this.minImageWidth = $(this.el)
            .find(".sbsw-item .sbsw_video_thumbnail")
            .first()
            .innerWidth();
        } else {
      ...
      getImageUrls: function ($item) {
        ...
        if ($item.hasClass("sbsw-facebook-item")) {
          if (
            typeof feed.resizedImages.facebook[id] !== "undefined" &&
            feed.resizedImages.facebook[id].id !== "pending" &&
            feed.resizedImages.facebook[id].id !== "error"
          ) {
            $.each(
              feed.resizedImages.facebook[id].sizes,
              function (index2, value2) {
                returnSrcSet[value2] =
                  sbswOptions.cffResizeUrl +
                  feed.resizedImages.facebook[id].id +
                  "-0-" +
                  value2 +
                  ".jpg";
              }
            ...
            if (
              typeof this.resizedImages.facebook[id] === "undefined" ||
              (typeof this.resizedImages.facebook[id] !== "undefined" &&
                typeof this.resizedImages.facebook[id]["id"] !== "undefined" &&
                this.resizedImages.facebook[id]["id"] !== "pending" &&
                this.resizedImages.facebook[id]["id"] !== "error")
            ) {
              ...
              if (typeof returnSrcSet[0] !== "string") {
                $.each(returnSrcSet[0], function (resolution) {
                  if (
                    parseInt(resolution) > 150 &&
                    parseInt(resolution) < 500
                  ) {
                    hasMediumSize = true;
                  }
                });
          ...
          if (
            typeof this.resizedImages.instagram[id] !== "undefined" &&
            ...
            if (
              typeof this.resizedImages.instagram[id]["sizes"] !== "undefined"
            ) {
              var foundSizes = [];
              if (
                typeof this.resizedImages.instagram[id]["sizes"]["full"] !==
                "undefined"
              ) {
                srcSet[640] =
                  sbswOptions.sbiResizeUrl +
                  this.resizedImages.instagram[id].id +
                  "full.jpg";
                foundSizes.push(640);
              }
              if (
                typeof this.resizedImages.instagram[id]["sizes"]["low"] !==
                "undefined"
              ) {
                srcSet[320] =
                  sbswOptions.sbiResizeUrl +
              ...
              if (
                typeof this.resizedImages.instagram[id]["sizes"]["thumb"] !==
                "undefined"
              ) {
                foundSizes.push(150);
                srcSet[150] =
            ...
            typeof this.resizedImages.instagram[id] === "undefined" ||
            (typeof this.resizedImages.instagram[id]["id"] !== "undefined" &&
              this.resizedImages.instagram[id]["id"] !== "pending" &&
              this.resizedImages.instagram[id]["id"] !== "error")
          ) {
            this.addToNeedsResizing($item, id);
          ...
          if (
            typeof feed.resizedImages.twitter[id] !== "undefined" &&
            feed.resizedImages.twitter[id].id !== "pending" &&
            feed.resizedImages.twitter[id].id !== "error"
          ) {
            $.each(
              feed.resizedImages.twitter[id].sizes,
              function (index2, value2) {
                returnSrcSet[value2] =
                  sbswOptions.ctfResizeUrl +
                  feed.resizedImages.twitter[id].id +
                  "-0-" +
                  value2 +
                  ".jpg";
              }
      ...
      applyImageLiquid: function () {
        ...
        sbyAddImgLiquid();
        if (
          typeof $self.find(".sbsw_player_item").sbsw_imgLiquid == "function"
        ) {
          if ($self.find(".sbsw_player_item").length) {
            $self
              .find(".sbsw_player_item .sbsw_player_video_thumbnail")
              .sbsw_imgLiquid({ fill: true });
          }
          $self
            .find(".sbsw-item .sbsw_item_video_thumbnail")
            .sbsw_imgLiquid({ fill: true });
        }
      },
      listenForVisibilityChange: function () {
        ...
        if (
          typeof $(this.el).filter(":hidden").sbyVisibilityChanged == "function"
        ) {
          //If the feed is initially hidden (in a tab for example) then check for when it becomes visible and set then set the height
          $(this.el)
            .filter(":hidden")
            .sbyVisibilityChanged({
      ...
      smashotopeInit: function () {
        var $self = $(this.el),
          $container = $self.find(".sbsw-items-wrap-current").length
            ? $self.find(".sbsw-items-wrap-current")
            : $self.find(".sb-wall-items-wrap"),
      ...
      setMasonry: function () {
        var $self = $(this.el),
          ...
          widthAdjustForPercentPadding =
            $self.find(".sb-wall-items-wrap").css("padding").indexOf(".") > -1
              ? 1
              : 0;
      ...
      appendSmashotope: function () {
        ...
        if ($self.find(".sbsw-items-wrap-current").data("smashotope")) {
          ...
          $self
            .find(".sbsw-items-wrap-current")
            .smashotope("appended", $(".sbsw-new"));
        }
      },
    };
    ...
    SbswLightboxBuilder.prototype = {
      getData: function (a) {
        var closestFeedIndex = parseInt(
            a.closest(".sb-wall").attr("data-sbsw-index") - 1
          ),
      ...
      template: function () {
        return (
          "<div id='sbsw-lightboxOverlay' class='sbsw-lightboxOverlay'></div>" +
      ...
      afterPlayerSetup: function ($lightbox, data, index, album) {
        ...
        if (
          typeof sbyLightboxCaption !== "undefined" &&
          sbyLightboxCaption !== ""
        ) {
          sbyLightboxCaption = sbyLightboxCaption.replace(/(>#)/g, "> #");
        }
        sbyLightboxCaption
          ? (sbyLightboxCaption = sbyLinkify(sbyLightboxCaption))
          : (sbyLightboxCaption = "");
        ...
        if (
          ...
          avatarImageHtml =
            data.avatar !== "undefined"
              ...
              : "";
          nameHtml =
            '<a class="sbsw-lightbox_username" href="' +
            data.accountURL +
            '" target="_blank" rel="noopener">' +
            avatarImageHtml +
            "<p>@" +
          ...
          $.each(window.sbsw.feeds, function () {
            if (
              typeof this.availableAvatarUrls !== "undefined" &&
              typeof this.availableAvatarUrls[data.name] !== "undefined" &&
              this.availableAvatarUrls[data.name] !== "undefined"
            ) {
              avatarImageHtml =
                '<img src="' + this.availableAvatarUrls[data.name] + '" />';
            }
          });
        }

        $lightbox
          .find(".sbsw-lb-caption")
          .html(
            nameHtml +
              '<span class="sbsw-caption-text">' +
              sbyLightboxCaption +
              "</span>"
          )
          .fadeIn("fast");
      ...
      afterResize: function () {
        ...
        if (playerHeight > 100) {
          var heightDif =
            $("#sbsw-lightbox .sbsw-lb-outerContainer").height() - playerHeight;
          if (heightDif > 10) {
      ...
      pausePlayer: function () {
        if (
          typeof YT.get("sbsw-lb-player") !== "undefined" &&
          typeof YT.get("sbsw-lb-player").pauseVideo === "function"
        ) {
          YT.get("sbsw-lb-player").pauseVideo();
        } else if (
          typeof window.sbswLightboxPlayer !== "undefined" &&
          typeof window.sbswLightboxPlayer.pauseVideo === "function"
        ) {
          window.sbswLightboxPlayer.pauseVideo();
        }
        if (
          sbsw_supports_video() &&
          $("#sbsw-lightbox video.sbsw-lb-video").length
        )
          $("#sbsw-lightbox video.sbsw-lb-video")[0].pause();
      },
      afterSlideChange: function () {
        ...
        $lightbox.removeClass(
          "sbsw-lightbox-type-image sbsw-lightbox-type-video sbsw-lightbox-type-iframe sbsw-lightbox-type-carousel sbsw-lightbox-type-youtube"
        );
    ...
    SbFilterBar.prototype = {
      ...
      beforeSwitch: function () {
        ...
        $self
          .find(".sb-wall-items-wrap")
          .removeClass("sbsw-items-wrap-current");
        $self
          .find(".sb-wall-items-wrap-outer-wrap")
          .css(
            "height",
            $self.find(".sbsw-items-wrap-visible").innerHeight() + "px"
          );
      },
      ...
      switchToFilteredSet: function (plugin) {
        ...
        if (!$self.find(".sbsw-items-wrap-" + plugin).length) {
          $self
            ...
            .last()
            .after(
              '<div class="sb-wall-items-wrap sbsw-items-wrap-' +
                plugin +
                ' sbsw-items-wrap-visible"></div>'
            );
          $self
            .find(".sbsw-items-wrap-" + plugin)
            .addClass("sbsw-items-wrap-current");
          ...
          setTimeout(function () {
            $self
              .find(".sbsw-items-wrap-" + plugin)
              .addClass("sbsw-items-wrap-visible");
      ...
      addRemoteFilteredPosts: function () {
        ...
        var itemOffset = $self.find(".sbsw-items-wrap-current .sbsw-item")
            .length,
          submitData = {
            action: "sbsw_load_more_clicked",
            filter_type: plugin,
        ...
        var onSuccess = function (data) {
          ...
          if (data.trim().indexOf("{") === 0) {
            ...
            $(".sbsw_no_js").removeClass("sbsw_no_js");
            var isOutOfPages =
              response.feedStatus.filterOutOfPages.indexOf(plugin) > -1;
            if (isOutOfPages) {
    ...
    window.sb_wall_init = function () {
      ...
      window.sbsw.createPage(window.sbsw.createFeeds, {
        whenFeedsCreated: window.sbsw.afterFeedsCreated,
      });
    };

    function sbswShareHTML($item) {
      var shareData = JSON.parse(
        $item.find(".sbsw-share-button").attr("data-share-data")
      );

      if ($item.find(".sbsw-lightbox-hover").length) {
        shareData.content = JSON.parse(
          $item.find(".sbsw-lightbox-hover").attr("data-lightbox-info")
        );
      } else {
        shareData.content = {
          media_url: $item.find(".sbsw-item-avatar img").length
            ? $item.find(".sbsw-item-avatar img").attr("src")
            : "",
      ...
      var facebook =
        ...
        pinterest =
          ...
          shareData.link +
          "&media=" +
          encodeURIComponent(shareData.content.media_url) +
          "&description=" +
          encodeURIComponent(shareData.content.title),
        linkedIn =
          ...
          encodeURIComponent(shareData.content.title),
        email =
          "mailto:?subject=Facebook&body=" +
          shareData.link +
          "%20-%20" +
          encodeURIComponent(shareData.content.title);

      var html =
        '<p class="sbsw-share-popup">' +
        '<a href="' +
        facebook +
        '" class="sbsw-share-facebook" target="_blank" rel="noopener">' +
        ...
        '<a href="' +
        twitter +
        '" class="sbsw-share-twitter" target="_blank" rel="noopener">' +
        ...
        '<a href="' +
        linkedIn +
        '" class="sbsw-share-linkedin" target="_blank" rel="noopener">' +
        ...
        '<a href="' +
        pinterest +
        '" class="sbsw-share-pinterest" target="_blank" rel="noopener">' +
        ...
        '<a href="' +
        email +
        '" class="sbsw-share-email" target="_blank" rel="noopener">' +
