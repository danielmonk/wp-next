...
class SW_Admin
{
    ...
    public function __construct(
        ...
        $this->display_your_feed_sections = [];
    ...
    public function verify_post($post)
    {
        return wp_verify_nonce(
            $post[$this->option_name . '_validate'],
            $this->option_name . '_validate'
        );
    }
    ...
    {
        wp_nonce_field(
            $this->get_option_name() . '_validate',
            $this->get_option_name() . '_validate',
            true,
            true
        ); ?>
        <input type="hidden" name="<?php echo $this->get_option_name() .
            '_tab_marker'; ?>" value="<?php echo esc_attr($tab); ?>"/>
		<?php
    }
    ...
    public function init()
    {
        ...
        add_action('admin_init', [$this, 'additional_settings_init']);
        add_action('admin_head', [$this, 'sbsw_hide_yt_menu']);
        add_action('admin_footer', [$this, 'sbsw_add_admin_js']);
    }
    ...
    public function settings_init()
    {
        ...
        $args = [
            ...
            'shortcode' => [
                ...
                'example' => 'list',
                'description' => __(
                    'How your posts are displayed visually.',
                    $text_domain
                ),
    ...
    public function additional_settings_init()
    {
        ...
        $args = [
            ...
            'additional' =>
                '<span class="sbsw_note">' .
                __('Number of posts to show initially.', $text_domain) .
                '</span>',
            'shortcode' => [
                'key' => 'num',
                'example' => 5,
        ...
        $args = [
            ...
            'shortcode' => [
                ...
                'description' =>
                    __(
                        'Light or dark color scheme for the feed.',
                        $text_domain
                    ) . ' light, dark',
                'display_section' => 'layout',
            ],
        ...
        $args = [
            ...
            'shortcode' => [
                ...
                'example' => '5px',
                'description' => __(
                    'The spacing/padding around the posts in the feed. Any number with a unit like "px" or "em".',
                    $text_domain
                ),
                'display_section' => 'layout',
            ],
        ...
        $args = [
            ...
            'shortcode' => [
                ...
                'example' => '#f00',
                'description' => __(
                    'Background color for the feed. Any hex color code.',
                    $text_domain
                ),
                'display_section' => 'layout',
            ],
        ...
        $args = [
            ...
            'shortcode' => [
                ...
                'example' => 300,
                'description' => __(
                    'Maximum length of the text in the post',
                    $text_domain
                ),
        ...
        $args = [
            ...
            'shortcode' => [
                ...
                'description' =>
                    __(
                        'Size of content/caption text, size of other text will be relative to this size.',
                        $text_domain
                    ) . ' 13px, 14px, inherit',
                'display_section' => 'text_date',
            ],
            'tooltip_info' => __(
                'Size of content/caption  text, size of other text in the info display will be relative to this size.',
                $text_domain
            ),
            'options' => $select_options,
        ];
        ...
        $args = [
            ...
            'shortcode' => [
                ...
                'example' => 'false',
                'description' => __(
                    'Include a "Load More" button at the bottom of the feed to load more posts.',
                    $text_domain
                ),
                'display_section' => 'text_date',
            ],
        ...
        $args = [
            ...
            'shortcode' => [
                ...
                'example' => '#filter',
                'description' => __(
                    'Show posts that have specific text in the content/caption.',
                    $text_domain
                ),
                'display_section' => 'customize',
            ],
            'additional' => __(
                '"includewords" separate multiple words with commas, include "#" for hashtags',
                $text_domain
            ),
        ];
        $this->add_settings_field($args);
        ...
        $args = [
            ...
            'class' => 'large-text',
            'title' => __(
                'Remove posts containing these words or hashtags',
                $text_domain
            ),
            'shortcode' => [
                'key' => 'excludewords',
                'example' => '#filter',
                'description' => __(
                    'Remove posts that have specific text in the title or description.',
                    $text_domain
                ),
                'display_section' => 'customize',
            ],
            'additional' => __(
                '"excludewords" separate multiple words with commas, include "#" for hashtags',
                $text_domain
            ),
        ];
        $this->add_settings_field($args);
        ...
        $args = [
            ...
            'note' => __(
                'Note: Custom JavaScript reruns every time more posts are loaded into the feed',
                $text_domain
            ),
        ];
        $this->add_settings_field($args);
        ...
        $args = [
            ...
            'default' => false,
            'tooltip_info' => __(
                'When navigating your site, if your theme uses Ajax to load content into your pages (meaning your page doesn\'t refresh) then check this setting. If you\'re not sure then it\'s best to leave this setting unchecked while checking with your theme author, otherwise checking it may cause a problem.',
                $text_domain
            ),
        ];
        $this->add_settings_field($args);
        ...
        $args = [
            ...
            'default' => false,
            'tooltip_info' => __(
                'Initial posts will be loaded using AJAX instead of added to the page directly. If you use page caching, this will allow the feed to update according to the "Check for new posts every" setting on the "Configure" tab.',
                $text_domain
            ),
        ];
        //$this->add_settings_field( $args );
        ...
        $args = [
            ...
            'default' => false,
            'tooltip_info' => __(
                'The default HTML for the feed can be replaced with custom templates added to your theme\'s folder. Enable this setting to use these templates. See <a href="https://smashballoon.com/social-wall-custom-templates/" target="_blank">this guide</a>',
                $text_domain
            ),
        ];
        $this->add_settings_field($args);
    ...
    public function add_settings_section($args)
    {
        ...
        add_settings_section($id, $title, $callback, $id);

        $save_after = isset($args['save_after']) ? $args['save_after'] : false;
        $this->settings_sections[$args['tab']][] = [
            'id' => $id,
    ...
    public function add_settings_field($args)
    {
        ...
        if (isset($args['shortcode'])) {
            $title_after = isset($args['shortcode']['after'])
                ? $args['shortcode']['after']
                : '';
            $shortcode = $args['shortcode'];
        }

        if ($shortcode) {
            $this->display_your_feed_sections[$shortcode['display_section']][
                'settings'
            ][] = $shortcode;
        }
        ...
        if (
            $args['callback'] === 'checkbox' ||
            (isset($args['falsefield']) && $args['falsefield'] === true)
        ) {
            $tab = 'none';
        ...
        if (
            $args['callback'] === 'layout' ||
            $args['callback'] === 'sub_option'
        ) {
            $tab = 'none';
            foreach ($this->settings_sections as $key => $settings_sections) {
                foreach ($settings_sections as $this_tab_sections) {
            ...
            $sub_options = isset($args['layouts'])
                ? $args['layouts']
                : $args['sub_options'];
                ...
                if (isset($sub_option['options'])) {
                    foreach ($sub_option['options'] as $sub_sub_option) {
                        if (!empty($sub_sub_option['shortcode'])) {
                            $key = !empty($sub_sub_option['shortcode']['key'])
                                ? $sub_sub_option['shortcode']['key']
                                : $sub_option['slug'] . $sub_sub_option['name'];
                            $example = !empty(
                                $sub_sub_option['shortcode']['example']
                            )
                                ? $sub_sub_option['shortcode']['example']
                                : '';
                            $description = !empty(
                                $sub_sub_option['shortcode']['description']
                            )
                                ? $sub_sub_option['shortcode']['description']
                                : '';
                            $display_section = !empty(
                                $sub_sub_option['shortcode']['display_section']
                            )
                                ? $sub_sub_option['shortcode'][
                                    'display_section'
                                ]
                                : str_replace('sbspf_', '', $args['section']);
                            $sub_shortcode = [
                                'key' => $key,
                                'example' => $example,
                            ...
                            if (
                                ...
                                $this->display_your_feed_sections[
                                    $display_section
                                ]['settings'][] = $sub_shortcode;
                            }
                        }
                        if ($sub_sub_option['callback'] === 'checkbox') {
                            $this->add_false_field(
                                $sub_option['slug'] . $sub_sub_option['name'],
                                $tab
                            );
                        }
    ...
    public function set_display_table_sections($headings)
    {
        foreach ($headings as $heading) {
            $this->display_your_feed_sections[$heading['slug']] = [
                'label' => $heading['label'],
                'settings' => [],
            ];
        }
    ...
    public function checkbox($args)
    {
        ...
        $selected = isset($this->settings[$args['name']])
            ? $this->settings[$args['name']]
            : $default;
        $label = isset($args['label']) ? $args['label'] : __('Yes');
        $tooltip_text = isset($args['tooltip_text'])
            ? $args['label']
            : $this->default_tooltip_text();
        $has_shortcode =
            isset($args['has_shortcode']) && $args['has_shortcode'] ? '1' : '';
        ?>
        <input name="<?php echo $this->option_name .
            '[' .
            esc_attr($args['name']) .
            ']'; ?>" id="<?php echo $this->option_name . '_' . $args['name']; ?>" class="sbspf_single_checkbox" type="checkbox"<?php if (
    $selected
) {
    echo ' checked';
} ?>/>
        <label for="<?php echo $this->option_name .
            '_' .
            $args['name'] .
            $has_shortcode; ?>"><?php echo esc_html($label); ?></label><?php if (
    $has_shortcode === '1'
): ?><code class="sbspf_shortcode"> <?php echo $args['name'] . "\n"; ?>
            Eg: <?php echo $args['name']; ?>=<?php echo $args[
    'shortcode_example'
]; ?></code><br><?php endif; ?>
		<?php if (isset($args['tooltip_info'])): ?>
            <a class="sbspf_tooltip_link" href="JavaScript:void(0);"><?php echo $tooltip_text; ?></a>
            <p class="sbspf_tooltip sbspf_more_info"><?php echo $args[
                'tooltip_info'
            ]; ?></p>
		<?php endif;
    }
    ...
    {
        $default = isset($args['default']) ? $args['default'] : false;
        $selection_array = isset($this->settings[$args['name']])
            ? (array) $this->settings[$args['name']]
            : (array) $default;
        $tooltip_text = isset($args['tooltip_text'])
            ? $args['label']
            : $this->default_tooltip_text();
      ...
      $pro_only =
          isset($select_option['pro']) && $select_option['pro']
              ? ' sbspf_pro_only'
              : '';
      $class = !empty($select_option['class'])
          ? ' ' . $select_option['class']
          : '';
      ?>
    ...
    $args['name'] .
    '_' .
    $index; ?>" value="<?php echo esc_attr(
    $select_option['value']
); ?>" type="checkbox"<?php if ($selected) {
    echo ' checked';
} ?>/>
                <label for="<?php echo $this->option_name .
                    '_' .
  ...
  endforeach; ?>
    ...
    public function text($args)
    {
        ...
        if (isset($args['min'])):
            ...
            $class = isset($args['class'])
                ? ' class="sbspf_number_field sbspf_size_' .
                    $args['size'] .
                    ' ' .
                    esc_attr($args['class']) .
                    '"'
            ...
            <input name="<?php echo $this->option_name .
                ...
                ']'; ?>" id="<?php echo $this->option_name .
    '_' .
    $args['name']; ?>"<?php echo $class; ?> type="number"<?php
 echo $size;
 echo $min;
 echo $max;
 echo $step;
 ?> value="<?php echo esc_attr($value); ?>" />
    ...
    $args[
        'name'
    ]; ?>" class="sbspf_colorpicker" type="text" value="#<?php echo esc_attr(
    str_replace('#', '', $value)
); ?>" />
		<?php else: ?>
            <input name="<?php echo $this->option_name .
    ...
    $args[
        'name'
    ]; ?>"<?php echo $class; ?> type="text" value="<?php echo esc_attr(
     stripslashes($value)
 ); ?>" />
		<?php endif;
        ?>
      ...
      $value = isset($this->settings[$args['select_name']])
          ? $this->settings[$args['select_name']]
          : $args['select_options'][0]['value']; ?>
    ...
    (string) $select_option['value'] === (string) $value
) {
    echo ' selected';
} ?>><?php echo esc_html($select_option['label']); ?></option>
				<?php endforeach; ?>
            </select>
		<?php
  endif; ?>
		...
		<?php if (isset($args['hidden'])): ?>
			...
			<?php if (is_callable([$this, $args['hidden']['callback']])) {
       echo $args['hidden']['before'];
       call_user_func_array(
           [$this, $args['hidden']['callback']],
           [$args['hidden']]
       );
  ...
  if (false /*$args['name'] === 'num'*/): ?>
    ...
    public function select($args)
    {
        ...
        <select name="<?php echo $this->option_name .
            '[' .
            $args['name'] .
            ']'; ?>" id="<?php echo $this->option_name . '_' . $args['name']; ?>">
    ...
    public function textarea($args)
    {
        $default = isset($args['default']) ? $args['default'] : '';
        $value = isset($this->settings[$args['name']])
            ? stripslashes($this->settings[$args['name']])
            : $default;
        ...
        <textarea name="<?php echo $this->option_name .
            '[' .
            $args['name'] .
            ']'; ?>" id="<?php echo $this->option_name . '_' . $args['name']; ?>"rows="7"><?php echo $value; ?></textarea>
    ...
    public function cache($args)
    {
        ...
        $caching_time = isset($this->settings['caching_time'])
            ? $this->settings['caching_time']
            : 1;
        $cache_time_unit_selected = isset($this->settings['cache_time_unit'])
            ? $this->settings['cache_time_unit']
            : 'hours';
        $cache_cron_interval_selected = isset(
            $this->settings['cache_cron_interval']
        )
            ? $this->settings['cache_cron_interval']
            : '';
        $cache_cron_time = isset($this->settings['cache_cron_time'])
        ...
        <div class="sbspf_cache_settings_wrap">
            ...
            <div class="sbspf_row sbspf-caching-cron-options" style="display: block;">
                ...
                <select name="<?php echo $this->option_name .
                    '[cache_cron_interval]'; ?>" id="sbspf_cache_cron_interval">
                    <option value="30mins"<?php if (
                        $cache_cron_interval_selected === '30mins'
                    ) {
                        echo ' selected';
                    } ?>><?php _e('Every 30 minutes', $this->vars->text_domain()); ?></option>
                    <option value="1hour"<?php if (
                        $cache_cron_interval_selected === '1hour'
                    ) {
                        echo ' selected';
                    } ?>><?php _e('Every hour', $this->vars->text_domain()); ?></option>
                    <option value="12hours"<?php if (
                        $cache_cron_interval_selected === '12hours'
                    ) {
                        echo ' selected';
                    } ?>><?php _e('Every 12 hours', $this->vars->text_domain()); ?></option>
                    <option value="24hours"<?php if (
                        $cache_cron_interval_selected === '24hours'
                    ) {
                        echo ' selected';
                    } ?>><?php _e('Every 24 hours', $this->vars->text_domain()); ?></option>
                </select>

                <div id="sbspf-caching-time-settings" style="">
					<?php _e('at', $this->vars->text_domain()); ?>
                    <select name="<?php echo $this->option_name .
                        '[cache_cron_time]'; ?>" style="width: 80px">
                        <option value="1"<?php if (
                            (int) $cache_cron_time === 1
                        ) {
                            echo ' selected';
                        } ?>>1:00</option>
                        <option value="2"<?php if (
                            (int) $cache_cron_time === 2
                        ) {
                            echo ' selected';
                        } ?>>2:00</option>
                        <option value="3"<?php if (
                            (int) $cache_cron_time === 3
                        ) {
                            echo ' selected';
                        } ?>>3:00</option>
                        <option value="4"<?php if (
                            (int) $cache_cron_time === 4
                        ) {
                            echo ' selected';
                        } ?>>4:00</option>
                        <option value="5"<?php if (
                            (int) $cache_cron_time === 5
                        ) {
                            echo ' selected';
                        } ?>>5:00</option>
                        <option value="6"<?php if (
                            (int) $cache_cron_time === 6
                        ) {
                            echo ' selected';
                        } ?>>6:00</option>
                        <option value="7"<?php if (
                            (int) $cache_cron_time === 7
                        ) {
                            echo ' selected';
                        } ?>>7:00</option>
                        <option value="8"<?php if (
                            (int) $cache_cron_time === 8
                        ) {
                            echo ' selected';
                        } ?>>8:00</option>
                        <option value="9"<?php if (
                            (int) $cache_cron_time === 9
                        ) {
                            echo ' selected';
                        } ?>>9:00</option>
                        <option value="10"<?php if (
                            (int) $cache_cron_time === 10
                        ) {
                            echo ' selected';
                        } ?>>10:00</option>
                        <option value="11"<?php if (
                            (int) $cache_cron_time === 11
                        ) {
                            echo ' selected';
                        } ?>>11:00</option>
                        <option value="0"<?php if (
                            (int) $cache_cron_time === 0
                        ) {
                            echo ' selected';
                        } ?>>12:00</option>
                    </select>
                    ...
                    <select name="<?php echo $this->option_name .
                        '[cache_cron_am_pm]'; ?>" style="width: 60px">
                        <option value="am"<?php if (
                            $cache_cron_am_pm === 'am'
                        ) {
                            echo ' selected';
                        } ?>><?php _e('AM', $this->vars->text_domain()); ?></option>
                        <option value="pm"<?php if (
                            $cache_cron_am_pm === 'pm'
                        ) {
                            echo ' selected';
                        } ?>><?php _e('PM', $this->vars->text_domain()); ?></option>
                    </select>
                </div>

				<?php if (wp_next_scheduled('sbsw_feed_update')) {
        ...
        if ($schedule == '30mins') {
            $schedule = __('every 30 minutes', $this->vars->text_domain());
        }
        if ($schedule == 'twicedaily') {
            $schedule = __('every 12 hours', $this->vars->text_domain());
        }
        $sbspf_next_cron_event = wp_next_scheduled('sbsw_feed_update');
        echo '<p class="sbspf-caching-sched-notice"><span><b>' .
            __('Next check', $this->vars->text_domain()) .
            ': ' .
            date($time_format, $sbspf_next_cron_event + sbsw_get_utc_offset()) .
            ' (' .
            str_replace('sw', '', $schedule) .
            ')</b> - ' .
            __(
                'Note: Saving the settings on this page will clear the cache and reset this schedule',
                $this->vars->text_domain()
            ) .
            '</span></p>';
    } else {
        echo '<p style="font-size: 11px; color: #666;">' .
            __('Nothing currently scheduled', $this->vars->text_domain()) .
            '</p>';
    } ?>
            </div>
        </div>
        ...
        <div class="sbspf_layouts">
			<?php foreach ($args['layouts'] as $layout): ?>
                <div class="sbspf_layout_cell">
                    <input class="sbspf_layout_type" id="sbspf_layout_type_<?php echo esc_attr(
                        $layout['slug']
    ...
    $layout['slug']
); ?>"<?php if ($layout['slug'] === $value) {
    echo ' checked';
} ?>><label for="sbspf_layout_type_<?php echo esc_attr(
    $layout['slug']
); ?>"><span class="sbspf_label"><?php echo $layout[
    'label'
]; ?></span><img src="<?php echo esc_url(
    $this->vars->plugin_url() . $layout['image']
); ?>"></label>
                </div>
			<?php endforeach; ?>
            ...
            <div class="sbspf_layout_options_wrap">
				<?php foreach ($args['layouts'] as $layout): ?>
                    <div class="sbspf_layout_settings sbspf_layout_type_<?php echo esc_attr(
                        $layout['slug']
                    ); ?>">

                        <div class="sbspf_layout_setting">
							<?php echo sbsw_admin_icon(
           'info-circle'
       ); ?>&nbsp;&nbsp;&nbsp;<span class="sbspf_note" style="margin-left: 0;"><?php echo $layout[
    'note'
]; ?></span>
                        </div>
           ...
           $option['name'] = $layout['slug'] . $option['name']; ?>
                                <div class="sbspf_layout_setting">
									<?php if ($option['callback'] !== 'checkbox'): ?>
                                        <label title="<?php echo __(
                                            'Click for shortcode option',
                                            $this->vars->text_domain()
                                        ); ?>"><?php echo $option[
    'label'
]; ?></label><code class="sbspf_shortcode"> <?php echo $option['name'] .
    "\n"; ?>
                                            Eg: <?php echo $option[
                                                'name'
                                            ]; ?>=<?php echo $option[
    'shortcode'
									...
									<?php else:$option['shortcode_example'] = $option['shortcode']['example'];
             $option['has_shortcode'] = true;endif; ?>
									<?php call_user_func_array([$this, $option['callback']], [$option]); ?>
    ...
    {
        $updated_options = get_option($this->option_name, []);
        ...
        if ($tab === 'configure') {
            do_action(
                $this->option_name . '_after_configure_save',
                $updated_options
            );
        } elseif ($tab === 'customize') {
            do_action(
                $this->option_name . '_after_customize_save',
                $updated_options
            );
        }
    ...
    public function create_menus()
    {
        ...
        $capability = current_user_can('manage_social_wall_options')
            ? 'manage_social_wall_options'
            : 'manage_options';

        //Change the menu links based on whether the plugin is installed or not
        $sbsw_sbi_menu_text =
            '<span class="sbsw_sbi_menu">Instagram Feed</span>';
        $sbsw_sbi_menu_link = 'sb-instagram-feed';
        if (!defined('SBIVER')) {
            $sbsw_sbi_menu_text =
                '<span class="sbsw_plugin_missing">Instagram Feed</span>';
            $sbsw_sbi_menu_link = 'https://smashballoon.com/instagram-feed/';
        }
        $sbsw_cff_menu_text =
            '<span class="sbsw_cff_menu">Facebook Feed</span>';
        $sbsw_cff_menu_link = 'cff-top';
        if (!defined('CFFVER')) {
            $sbsw_cff_menu_text =
                '<span class="sbsw_plugin_missing">Facebook Feed</span>';
            $sbsw_cff_menu_link =
        ...
        if (!defined('CTF_VERSION')) {
            $sbsw_ctf_menu_text =
                '<span class="sbsw_plugin_missing">Twitter Feed</span>';
            $sbsw_ctf_menu_link =
        ...
        if (!defined('SBYVER')) {
            $sbsw_yt_menu_text =
                '<span class="sbsw_plugin_missing">YouTube Feed</span>';
    ...
    public function next_step()
    {
        ...
        foreach ($this->tabs as $tab) {
            if (
                $this->active_tab === $tab['slug'] &&
                isset($tab['next_step_instructions'])
            ) {
                $next_tab_slug = isset($this->tabs[$i + 1]['slug'])
                    ? $this->tabs[$i + 1]['slug']
                    : $tab['slug'];
                $return = [
        ...
        <div class="sbspf_sub_options">
			<?php foreach ($cta_options as $sub_option): ?>
                <div class="sbspf_sub_option_cell">
                    <input class="sbspf_sub_option_type" id="sbspf_sub_option_type_<?php echo esc_attr(
                        $sub_option['slug']
                    ); ?>" name="<?php echo $this->option_name .
    '[' .
    $args['name'] .
    ']'; ?>" type="radio" value="<?php echo esc_attr(
    $sub_option['slug']
); ?>"<?php if ($sub_option['slug'] === $value) {
    echo ' checked';
} ?>><label for="sbspf_sub_option_type_<?php echo esc_attr(
    $sub_option['slug']
); ?>"><span class="sbspf_label"><?php echo $sub_option[
    'label'
]; ?></span></label>
                </div>
			<?php endforeach; ?>
            ...
            <div class="sbspf_box_setting">
				<?php if (isset($cta_options)):
        foreach ($cta_options as $sub_option): ?>
                    <div class="sbspf_sub_option_settings sbspf_sub_option_type_<?php echo esc_attr(
                        $sub_option['slug']
                    ); ?>">
           ...
           'info-circle',
           'sbspf_small_svg'
       ); ?>&nbsp;&nbsp;&nbsp;<span class="sbspf_note" style="margin-left: 0;"><?php echo $sub_option[
    'note'
]; ?></span>
                        </div>
  ...
  $this->select($args);
  $custom_value = isset($this->settings['customdate'])
      ? stripslashes($this->settings['customdate'])
      : '';
  ?>
        </div>
        <div class="sbspf_box_settings">
            <div class="sbspf_box_setting sbsw_relativetext_wrap">
                <?php foreach ($args['text_settings'] as $text_setting):
                    $value = isset($this->settings[$text_setting['key']])
                        ? stripslashes($this->settings[$text_setting['key']])
                        : $text_setting['default']; ?>
                <div class="sbsw-date-text-setting-wrap">
                    <label><?php echo $text_setting['label']; ?></label>
                    <input name="sbsw_settings[<?php echo $text_setting[
                        'key'
                    ]; ?>]" id="sbsw_settings_<?php echo $text_setting[
    'key'
]; ?>" type="text" placeholder="<?php echo $text_setting[
    'default'
]; ?>" value="<?php echo esc_attr($value); ?>">
                </div>
                <?php
            ...
            <div class="sbspf_box_setting sbsw_customdate_wrap">
                ...
                <input name="sbsw_settings[customdate]" id="sbsw_settings_customdate" type="text" placeholder="F j, Y g:i a" value="<?php echo esc_attr(
                    $custom_value
                ); ?>"><a href="https://smashballoon.com/social-wall/docs/date/" class="sbspf-external-link sbspf_note" target="_blank"><?php _e('Examples', SBSW_TEXT_DOMAIN); ?></a>
            </div>
        </div>
		<?php
    }
    ...
    public function default_tooltip_text()
    {
        return '<span class="screen-reader-text">' .
            __('What does this mean?', $this->vars->text_domain()) .
            '</span>' .
            sbsw_admin_icon('question-circle');
    }
}
