...
<p><?php _e(
    "Copy and paste the following shortcode directly into the page, post or widget where you'd like the feed to show up:",
    'custom-twitter-feeds'
); ?></p>
<input type="text" value="[custom-twitter-feeds]" size="20" readonly="readonly" style="text-align: center;" onclick="this.focus();this.select()" title="<?php _e(
    'To copy, click the field then press Ctrl + C (PC) or Cmd + C (Mac).',
    'custom-twitter-feeds'
); ?>" />

<h3 style="padding-top: 10px;"><?php _e(
    'Multiple Feeds',
    'custom-twitter-feeds'
); ?></h3>
<p><?php _e(
    "If you'd like to display multiple feeds then you can set different settings directly in the shortcode like so:",
    'custom-twitter-feeds'
); ?>
    </br><code>[custom-twitter-feeds screenname=gopro num=9]</code></p>
<p><?php _e(
    "You can display as many different feeds as you like, on either the same page or on different pages, by just using the shortcode options below. For example:",
    'custom-twitter-feeds'
); ?><br />
...
<!-- <p><span class="ctf_table_key"></span><?php _e(
    'Pro version only',
    'custom-twitter-feeds'
); ?></p> -->
...
<table class="ctf_shortcode_table">
    <tbody>
        ...
        <tr class="ctf_table_header"><td colspan=3><?php _e(
            "Configure Options",
            'custom-twitter-feeds'
        ); ?></td></tr>
        <tr>
            <td>screenname</td>
            <td><?php _e(
                'A user account name/Twitter handle. This will generate a user timeline feed. Separate multiple screennames using commas.',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>hashtag</td>
            <td><?php _e(
                'Any hashtag. This will generate a hashtag feed. Separate multiple hashtags using commas.',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr class="ctf_pro">
            <td>search</td>
            <td><?php _e(
                'Any search term or terms. Can use "OR" or "AND" for complex feeds.',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>home</td>
            <td><?php _e(
                'A home timeline will automatically use the account attached to your access token credentials',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr class="ctf_pro">
            <td>mentions</td>
            <td><?php _e(
                'A mentions timeline will automatically use the account attached to your access token credentials',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr class="ctf_pro">
            <td>lists</td>
            <td><?php _e(
                'Any list ID. Use the tool on the "configure" tab to get a list ID',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                '"In reply to" tweets will be included in your feed',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                'Retweets will be included in your feed',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>layout</td>
            <td><?php _e(
                "How posts are arranged visually in the feed.",
                'custom-twitter-feeds'
            ); ?> 'list', 'carousel', or 'masonry'</td>
            <td><code>[instagram-feed layout=carousel]</code></td>
        </tr>
        <tr>
            <td>class</td>
            <td><?php _e(
                "A custom CSS class added to the feed",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Disable the pop up lightbox for media in the feed",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>include</td>
            <td><?php _e(
                "Parts of the Tweet to include in the feed. <b>Available options:</b><br />retweeter, avatar, author, text, date, actions, twitterlink, linkbox, repliedto, media, twittercards",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>exclude</td>
            <td><?php _e(
                "Parts of the Tweet to exclude in the feed. <b>Available options:</b><br />retweeter, avatar, author, text, date, actions, twitterlink, linkbox, repliedto, media, twittercards",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>showheader</td>
            <td><?php _e(
                "Include a header for this feed",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>creditctf</td>
            <td><?php _e(
                "Include a credit link to the Custom Twitter Feeds homepage at the bottom of the feed",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>showbutton</td>
            <td><?php _e(
                "Show the button that loads more tweets",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>dateformat</td>
            <td><?php _e(
                "Number of one of the default date formats",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>datecustom</td>
            <td><?php _e(
                "Manually entered custom date format",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>mtime</td>
            <td><?php _e(
                "Translation for \"m\" time unit (English minute)",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>htime</td>
            <td><?php _e(
                "Translation for \"h\" time unit (English hour)",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>disablelinks</td>
            <td><?php _e(
                "Disable the links in the text of the tweet",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Link the tweet text to Twitter",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Custom text for the Twitter link",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>includewords</td>
            <td><?php _e(
                "Show only tweets that include these words or phrases",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>excludewords</td>
            <td><?php _e(
                "Show only Tweets that DON'T contain these words or phrases",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>includeanyall</td>
            <td><?php _e(
                "Whether or not any or all of the includewords need to be in the tweet",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>excludeanyall</td>
            <td><?php _e(
                "Whether or not any or all of the excludewords need to be in the tweet",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>filterandor</td>
            <td><?php _e(
                "Tweet needs to contain includewords AND/OR doesn't contain excludewords",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>multiplier</td>
            <td><?php _e(
                'A multiplying factor 1-3 to help with tweet filtering',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                'Search and hashtag feeds will cache the last 150 tweets persistently',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>autores</td>
            <td><?php _e(
                'Smallest image resolution available is used relative to actual size of the images on the page',
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>width</td>
            <td><?php _e(
                "The width of your feed. Any number with a unit like \"px\" or \"%\".",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>height</td>
            <td><?php _e(
                "The height of your feed. Any number with a unit like \"px\" or \"em\".",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>tweetbgcolor</td>
            <td><?php _e(
                "Background color for each tweet. Any hex color code",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Size of author info font in pixels",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Weight of author info font; inherit, bold, or normal",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>logosize</td>
            <td><?php _e(
                "Size of Twitter logo in pixels",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>logocolor</td>
            <td><?php _e(
                "Color of Twitter logo. Any color hex code.",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>datetextsize</td>
            <td><?php _e(
                "Size of date info font in pixels",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Weight of date info font; inherit, bold, or normal",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Size of quoted author info font in pixels",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Weight of quoted author info font; inherit, bold, or normal",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>textcolor</td>
            <td><?php _e(
                "Color of the text. Any color hex code",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>linktextcolor</td>
            <td><?php _e(
                "Color of the links inside the tweet text. Any color hex code",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>iconcolor</td>
            <td><?php _e(
                "Color of the icons. Any color hex code",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>buttoncolor</td>
            <td><?php _e(
                "Color of the background of the button. Any color hex code",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Color of the text of the button. Any color hex code",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>imagecols</td>
            <td><?php _e(
                "Images wil be displayed in this number of columns, masonry style",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>maxmedia</td>
            <td><?php _e(
                "The maximum number of media that can be displayed in the feed. All media still available in the lightbox",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>carouselcols</td>
            <td><?php _e(
                "Number of columns for the carousel feed for desktop",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Number of columns for the carousel feed for mobile screens",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "How to display the carousel navigation arrows; onhover, below, hide",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>carouselpag</td>
            <td><?php _e(
                "Whether to show the carousel pagination controls",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "How the height of the carousel is set; tallest, clickexpand, auto",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Whether the carousel should automatically start scrolling",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>carouseltime</td>
            <td><?php _e(
                "The time between slides when autoplaying",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>carouselloop</td>
            <td><?php _e(
                "How the carousel posts should loop. <b>Available options:</b> none, infinite, rewind",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>masonrycols</td>
            <td><?php _e(
                "Number of columns for the masonry feed for desktop",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Number of columns for the masonry feed for mobile screens",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            <td>autoscroll</td>
            <td><?php _e(
                "Load more Tweets as the visitor scrolls to the end of the feed",
                'custom-twitter-feeds'
            ); ?></td>
        ...
        <tr>
            ...
            <td><?php _e(
                "Distance in pixels from the bottom of the page to trigger the automatic loading of more tweets",
                'custom-twitter-feeds'
            ); ?></td>
...
<p><i class="fa fa-question-circle" aria-hidden="true"></i>&nbsp; <?php _e(
    'Need help? <a href="?page=custom-twitter-feeds&tab=support">Get Support</a>.'
); ?></p>
