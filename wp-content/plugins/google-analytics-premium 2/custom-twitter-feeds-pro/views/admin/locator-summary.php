...
<div class="ctf-feed-locator-summary-wrap">
    ...
    <p><?php esc_html_e(
        'The table below shows a record of all feeds found on your site. A feed may not show up here immediately after being created.',
        'custom-twitter-feeds'
    ); ?></p>
	<?php if (!empty($locator_summary)): ?>
      ...
      foreach ($locator_section['results'] as $result):
          ...
          if ($should_add) {
              ...
              if (strlen($comma_separated) > 31) {
                  $display =
                      '<span class="ctf-condensed-wrap">' .
                      substr($comma_separated, 0, 30) .
                      '<a class="ctf-locator-more" href="JavaScript:void(0);">...</a></span>';
                  $comma_separated =
                      '<span class="ctf-full-wrap">' .
                      esc_html($comma_separated) .
                      '</span>';
              } else {
                  $comma_separated = '';
              }
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="ctf-condensed-wrap"><a class="ctf-locator-more"
                                                                        href="JavaScript:void(0);"><?php esc_html_e(
                                                                            'Show',
                                                                            'custom-twitter-feeds'
                                                                        ); ?></a></span>
                                ...
                                <td><a href="<?php echo esc_url(
                                    get_the_permalink($result['post_id'])
                                ); ?>"
                                       target="_blank"
                                       rel="noopener"><?php echo esc_html(
  ...
  endforeach;else: ?>
        <p><?php esc_html_e(
            'Locations of your feeds are currently being detected. You\'ll see more information posted here soon!',
            'custom-twitter-feeds'
        ); ?></p>
	<?php endif; ?>
</div>