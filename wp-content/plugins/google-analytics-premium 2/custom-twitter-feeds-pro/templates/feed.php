...
<div id="ctf" class="<?php echo $ctf_feed_classes; ?>" style="<?php echo $ctf_styles; ?>" data-ctfshortcode="<?php echo $this->getShortCodeJSON(); ?>" <?php echo $ctf_main_atts; ?> data-ctfneeded="<?php echo esc_attr(
     $ctf_data_needed
 ); ?>" <?php echo $ctf_data_atts; ?>>
    <?php if ($feed_options['showheader']):
        include ctf_get_feed_template_part(
            CTF_Display_Elements_Pro::header_type($feed_options),
            $feed_options
        );
    endif; ?>
