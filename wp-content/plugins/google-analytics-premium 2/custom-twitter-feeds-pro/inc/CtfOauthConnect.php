...
class CtfOauthConnect
{
    ...
    private function buildBaseString($oauth)
    {
        ...
        return 'GET&' .
            ...
            '&' .
            rawurlencode(implode('&', $base_string));
    }
    ...
    private function curlRequest($url)
    {
        ...
        curl_setopt($br, CURLOPT_HTTPHEADER, [$this->header]); // must pass in array
    ...
    private function wpHttpRequest($url)
    {
        ...
        if (!is_wp_error($result)) {
            ...
            if ($response_code !== 200) {
                ...
                $errors['wp_http'] =
                    date('m-d H:i:s') . ':' . esc_html($result['body']);
                ...
                $error_return = [
                    'errors' => [
                        [
                            'code' => $response_code,
                            'message' => __(
                                'Could not connect to the Twitter API. Your host may be blocking the connection.',
