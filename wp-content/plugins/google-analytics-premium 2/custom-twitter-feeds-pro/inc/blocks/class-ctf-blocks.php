...
class CTF_Blocks
{
    ...
    public function register_block()
    {
        ...
        register_block_type('ctf/ctf-feed-block', [
    ...
    public function enqueue_block_editor_assets()
    {
        ...
        wp_localize_script('ctf-feed-block', 'ctf_block_editor', [
    ...
    public function get_feed_html($attr)
    {
        ...
        $return .= do_shortcode(
            '[custom-twitter-feeds ' . $shortcode_settings . ']'
        );
