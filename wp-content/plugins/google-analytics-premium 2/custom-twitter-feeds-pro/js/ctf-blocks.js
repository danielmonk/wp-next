...
(function () {
  var _wp = wp,
    ...
    ServerSideRender =
      _wp$serverSideRender === void 0
        ? wp.components.ServerSideRender
        : _wp$serverSideRender,
  ...
  registerBlockType("ctf/ctf-feed-block", {
    ...
    edit: function edit(props) {
      var _props = props,
        ...
        shortcodeSettings =
          _props$attributes$sho === void 0
            ? ctf_block_editor.shortcodeSettings
            : _props$attributes$sho,
        _props$attributes$cli = _props$attributes.noNewChanges,
        noNewChanges =
          _props$attributes$cli === void 0 ? true : _props$attributes$cli,
        _props$attributes$exe = _props$attributes.executed,
        executed =
          _props$attributes$exe === void 0 ? false : _props$attributes$exe;
      ...
      function afterRender() {
        ...
        if (!executed || typeof window.ctfGB === "undefined") {
          window.ctfGB = true;
          setTimeout(function () {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(TextareaControl, {
              ...
              help:
                ctf_block_editor.i18n.example +
                ': \'screenname="smashballoon" showbutton="true"\'',
