...
var CTFAdminNotifications =
  window.CTFAdminNotifications ||
  (function (document, window, $) {
    ...
    var el = {
      ...
      $adminBarCounter: $(
        "#wp-admin-bar-wpforms-menu .ctf-menu-notification-counter"
      ),
    ...
    var app = {
      ...
      dismiss: function (event) {
        ...
        // Remove notification.
        var $nextMessage =
            el.$nextMessage.length < 1 ? el.$prevMessage : el.$nextMessage,
