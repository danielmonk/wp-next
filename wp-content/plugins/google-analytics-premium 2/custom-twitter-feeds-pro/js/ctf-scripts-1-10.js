...
if (!ctf_js_exists) {
      ...
      return (
        (o._getOption = function (t) {
          return "fitWidth" == t
            ...
            : a.apply(this.smashotope, arguments);
        }),
        i
      );
    }),
  ...
  jQuery(".ctf-twitter-card").css(
    "color",
    jQuery(".ctf-content-text").css("color")
  );
  ...
  !(function (a, b) {
    ...
    (function (a, b) {
      "function" == typeof define && define.amd
        ...
        : b(a.Smashotope.LayoutMode, a.Packery);
    })(window, function (a, b) {
      ...
      return (
        (d._getOption = function (a) {
          return "horizontal" == a
            ...
            : j.apply(this.smashotope, arguments);
        }),
        c
      );
    });
  ...
  function ctfAddImgLiquid() {
    ...
    (ctf_imgLiquid.bgs_Available = !1),
      (ctf_imgLiquid.bgs_CheckRunned = !1),
      (function (i) {
        function t() {
              ...
              this.each(function (t) {
                function e() {
                  -1 ===
                    ...
                    u.addClass("ctf_imgLiquid_bgSize"),
                    u.addClass("ctf_imgLiquid_ready"),
                    l();
                }

                function o() {
                  function e() {
                    c.data("ctf_imgLiquid_error") ||
                      c.data("ctf_imgLiquid_loaded") ||
                      c.data("ctf_imgLiquid_oldProcessed") ||
                      (u.is(":visible") &&
                      c[0].complete &&
                      c[0].width > 0 &&
                      c[0].height > 0
                        ? (c.data("ctf_imgLiquid_loaded", !0),
                  ...
                  if (c.data("oldSrc") && c.data("oldSrc") !== c.attr("src")) {
                    ...
                    return (
                      a.data(
                        "ctf_imgLiquid_settings",
                        c.data("ctf_imgLiquid_settings")
                      ),
                      c.parent().prepend(a),
                      c.remove(),
                      (c = a),
                  ...
                  return c.data("ctf_imgLiquid_oldProcessed")
                    ? void r()
                    : (c.data("ctf_imgLiquid_oldProcessed", !1),
                ...
                function d() {
                  (g.responsive || c.data("ctf_imgLiquid_oldProcessed")) &&
                    c.data("ctf_imgLiquid_settings") &&
                    ((g = c.data("ctf_imgLiquid_settings")),
                    (u.actualSize =
                ...
                function n() {
                  c.data("ctf_imgLiquid_error", !0),
                    u.addClass("ctf_imgLiquid_error"),
                ...
                function r() {
                  ...
                  void 0 === c.data("owidth") && c.data("owidth", c[0].width),
                    ...
                    c.data("ctf_imgLiquid_oldProcessed") ||
                      ...
                      c.data("ctf_imgLiquid_oldProcessed", !0),
                      g.removeBoxBackground &&
                        u.css("background-image", "none"),
                      u.addClass("ctf_imgLiquid_nobgSize"),
                      u.addClass("ctf_imgLiquid_ready")),
                    g.onItemFinish && g.onItemFinish(t, u, c),
                    l();
                }
                ...
                return c.length
                  ? (c.data("ctf_imgLiquid_settings")
                      ? (u
                          .removeClass("ctf_imgLiquid_error")
                          .removeClass("ctf_imgLiquid_ready"),
                        (g = i.extend(
                          {},
                          c.data("ctf_imgLiquid_settings"),
                          a.options
                    ...
                    c.data("ctf_imgLiquid_settings", g),
                    g.onItemStart && g.onItemStart(t, u, c),
                    void (ctf_imgLiquid.bgs_Available && g.useBackgroundSize
                      ? e()
                      : o()))
                  : void n();
              })
  ...
  var ctfIconSVG = {
    "fa-clock":
      'class="svg-inline--fa fa-clock fa-w-16" aria-hidden="true" data-fa-processed="" data-prefix="far" data-icon="clock" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z"></path></svg>',
    "fa-play":
      'class="svg-inline--fa fa-play fa-w-14 sbi_playbtn" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="play" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M424.4 214.7L72.4 6.6C43.8-10.3 0 6.1 0 47.9V464c0 37.5 40.7 60.1 72.4 41.3l352-208c31.4-18.5 31.5-64.1 0-82.6z"></path></svg>',
    "fa-image":
      'class="svg-inline--fa fa-image fa-w-16" aria-hidden="true" data-fa-processed="" data-prefix="far" data-icon="image" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M464 64H48C21.49 64 0 85.49 0 112v288c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V112c0-26.51-21.49-48-48-48zm-6 336H54a6 6 0 0 1-6-6V118a6 6 0 0 1 6-6h404a6 6 0 0 1 6 6v276a6 6 0 0 1-6 6zM128 152c-22.091 0-40 17.909-40 40s17.909 40 40 40 40-17.909 40-40-17.909-40-40-40zM96 352h320v-80l-87.515-87.515c-4.686-4.686-12.284-4.686-16.971 0L192 304l-39.515-39.515c-4.686-4.686-12.284-4.686-16.971 0L96 304v48z"></path></svg>',
    "fa-user":
      'class="svg-inline--fa fa-user fa-w-16" style="margin-right: 3px;" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M96 160C96 71.634 167.635 0 256 0s160 71.634 160 160-71.635 160-160 160S96 248.366 96 160zm304 192h-28.556c-71.006 42.713-159.912 42.695-230.888 0H112C50.144 352 0 402.144 0 464v24c0 13.255 10.745 24 24 24h464c13.255 0 24-10.745 24-24v-24c0-61.856-50.144-112-112-112z"></path></svg>',
    "fa-comment":
      'class="svg-inline--fa fa-comment fa-w-18" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="comment" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M576 240c0 115-129 208-288 208-48.3 0-93.9-8.6-133.9-23.8-40.3 31.2-89.8 50.3-142.4 55.7-5.2.6-10.2-2.8-11.5-7.7-1.3-5 2.7-8.1 6.6-11.8 19.3-18.4 42.7-32.8 51.9-94.6C21.9 330.9 0 287.3 0 240 0 125.1 129 32 288 32s288 93.1 288 208z"></path></svg>',
    "fa-heart":
    ...
    "fa-check":
      'class="svg-inline--fa fa-check fa-w-16" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z"></path></svg>',
    "fa-exclamation-circle":
      'class="svg-inline--fa fa-exclamation-circle fa-w-16" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="exclamation-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M504 256c0 136.997-111.043 248-248 248S8 392.997 8 256C8 119.083 119.043 8 256 8s248 111.083 248 248zm-248 50c-25.405 0-46 20.595-46 46s20.595 46 46 46 46-20.595 46-46-20.595-46-46-46zm-43.673-165.346l7.418 136c.347 6.364 5.609 11.346 11.982 11.346h48.546c6.373 0 11.635-4.982 11.982-11.346l7.418-136c.375-6.874-5.098-12.654-11.982-12.654h-63.383c-6.884 0-12.356 5.78-11.981 12.654z"></path></svg>',
    "fa-map-marker":
    ...
    "fa-share":
      'class="svg-inline--fa fa-share fa-w-16" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="share" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M503.691 189.836L327.687 37.851C312.281 24.546 288 35.347 288 56.015v80.053C127.371 137.907 0 170.1 0 322.326c0 61.441 39.581 122.309 83.333 154.132 13.653 9.931 33.111-2.533 28.077-18.631C66.066 312.814 132.917 274.316 288 272.085V360c0 20.7 24.3 31.453 39.687 18.164l176.004-152c11.071-9.562 11.086-26.753 0-36.328z"></path></svg>',
    "fa-times":
      'class="svg-inline--fa fa-times fa-w-12" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="times" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M323.1 441l53.9-53.9c9.4-9.4 9.4-24.5 0-33.9L279.8 256l97.2-97.2c9.4-9.4 9.4-24.5 0-33.9L323.1 71c-9.4-9.4-24.5-9.4-33.9 0L192 168.2 94.8 71c-9.4-9.4-24.5-9.4-33.9 0L7 124.9c-9.4 9.4-9.4 24.5 0 33.9l97.2 97.2L7 353.2c-9.4 9.4-9.4 24.5 0 33.9L60.9 441c9.4 9.4 24.5 9.4 33.9 0l97.2-97.2 97.2 97.2c9.3 9.3 24.5 9.3 33.9 0z"></path></svg>',
    "fa-envelope":
      'class="svg-inline--fa fa-envelope fa-w-16" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="envelope" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z"></path></svg>',
    "fa-edit":
      'class="svg-inline--fa fa-edit fa-w-18" aria-hidden="true" data-fa-processed="" data-prefix="far" data-icon="edit" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M402.3 344.9l32-32c5-5 13.7-1.5 13.7 5.7V464c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V112c0-26.5 21.5-48 48-48h273.5c7.1 0 10.7 8.6 5.7 13.7l-32 32c-1.5 1.5-3.5 2.3-5.7 2.3H48v352h352V350.5c0-2.1.8-4.1 2.3-5.6zm156.6-201.8L296.3 405.7l-90.4 10c-26.2 2.9-48.5-19.2-45.6-45.6l10-90.4L432.9 17.1c22.9-22.9 59.9-22.9 82.7 0l43.2 43.2c22.9 22.9 22.9 60 .1 82.8zM460.1 174L402 115.9 216.2 301.8l-7.3 65.3 65.3-7.3L460.1 174zm64.8-79.7l-43.2-43.2c-4.1-4.1-10.8-4.1-14.8 0L436 82l58.1 58.1 30.9-30.9c4-4.2 4-10.8-.1-14.9z"></path></svg>',
    "fa-arrows-alt":
      'class="svg-inline--fa fa-arrows-alt fa-w-16" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="arrows-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M352.201 425.775l-79.196 79.196c-9.373 9.373-24.568 9.373-33.941 0l-79.196-79.196c-15.119-15.119-4.411-40.971 16.971-40.97h51.162L228 284H127.196v51.162c0 21.382-25.851 32.09-40.971 16.971L7.029 272.937c-9.373-9.373-9.373-24.569 0-33.941L86.225 159.8c15.119-15.119 40.971-4.411 40.971 16.971V228H228V127.196h-51.23c-21.382 0-32.09-25.851-16.971-40.971l79.196-79.196c9.373-9.373 24.568-9.373 33.941 0l79.196 79.196c15.119 15.119 4.411 40.971-16.971 40.971h-51.162V228h100.804v-51.162c0-21.382 25.851-32.09 40.97-16.971l79.196 79.196c9.373 9.373 9.373 24.569 0 33.941L425.773 352.2c-15.119 15.119-40.971 4.411-40.97-16.971V284H284v100.804h51.23c21.382 0 32.09 25.851 16.971 40.971z"></path></svg>',
    "fa-check-circle":
      'class="svg-inline--fa fa-check-circle fa-w-16" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="check-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z"></path></svg>',
    "fa-ban":
    ...
    "fa-facebook-square":
      'class="svg-inline--fa fa-facebook-square fa-w-14" aria-hidden="true" data-fa-processed="" data-prefix="fab" data-icon="facebook-square" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M448 80v352c0 26.5-21.5 48-48 48h-85.3V302.8h60.6l8.7-67.6h-69.3V192c0-19.6 5.4-32.9 33.5-32.9H384V98.7c-6.2-.8-27.4-2.7-52.2-2.7-51.6 0-87 31.5-87 89.4v49.9H184v67.6h60.9V480H48c-26.5 0-48-21.5-48-48V80c0-26.5 21.5-48 48-48h352c26.5 0 48 21.5 48 48z"></path></svg>',
    "fa-twitter":
    ...
    "fa-linkedin":
      'class="svg-inline--fa fa-linkedin fa-w-14" aria-hidden="true" data-fa-processed="" data-prefix="fab" data-icon="linkedin" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"></path></svg>',
    "fa-pinterest":
      'class="svg-inline--fa fa-pinterest fa-w-16" aria-hidden="true" data-fa-processed="" data-prefix="fab" data-icon="pinterest" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512"><path fill="currentColor" d="M496 256c0 137-111 248-248 248-25.6 0-50.2-3.9-73.4-11.1 10.1-16.5 25.2-43.5 30.8-65 3-11.6 15.4-59 15.4-59 8.1 15.4 31.7 28.5 56.8 28.5 74.8 0 128.7-68.8 128.7-154.3 0-81.9-66.9-143.2-152.9-143.2-107 0-163.9 71.8-163.9 150.1 0 36.4 19.4 81.7 50.3 96.1 4.7 2.2 7.2 1.2 8.3-3.3.8-3.4 5-20.3 6.9-28.1.6-2.5.3-4.7-1.7-7.1-10.1-12.5-18.3-35.3-18.3-56.6 0-54.7 41.4-107.6 112-107.6 60.9 0 103.6 41.5 103.6 100.9 0 67.1-33.9 113.6-78 113.6-24.3 0-42.6-20.1-36.7-44.8 7-29.5 20.5-61.3 20.5-82.6 0-19-10.2-34.9-31.4-34.9-24.9 0-44.9 25.7-44.9 60.2 0 22 7.4 36.8 7.4 36.8s-24.5 103.8-29 123.2c-5 21.4-3 51.6-.9 71.2C65.4 450.9 0 361.1 0 256 0 119 111 8 248 8s248 111 248 248z"></path></svg>',
    "fa-spinner":
      'class="svg-inline--fa fa-spinner fa-w-16 fa-pulse" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="spinner" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M304 48c0 26.51-21.49 48-48 48s-48-21.49-48-48 21.49-48 48-48 48 21.49 48 48zm-48 368c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zm208-208c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zM96 256c0-26.51-21.49-48-48-48S0 229.49 0 256s21.49 48 48 48 48-21.49 48-48zm12.922 99.078c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.491-48-48-48zm294.156 0c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.49-48-48-48zM108.922 60.922c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.491-48-48-48z"></path></svg>',
    "fa-spin":
      'class="svg-inline--fa fa-spin fa-w-16 fa-pulse" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="spinner" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M304 48c0 26.51-21.49 48-48 48s-48-21.49-48-48 21.49-48 48-48 48 21.49 48 48zm-48 368c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zm208-208c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zM96 256c0-26.51-21.49-48-48-48S0 229.49 0 256s21.49 48 48 48 48-21.49 48-48zm12.922 99.078c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.491-48-48-48zm294.156 0c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.49-48-48-48zM108.922 60.922c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.491-48-48-48z"></path></svg>',
    "fa-plus":
      'class="svg-inline--fa fa-plus fa-w-14" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M448 294.2v-76.4c0-13.3-10.7-24-24-24H286.2V56c0-13.3-10.7-24-24-24h-76.4c-13.3 0-24 10.7-24 24v137.8H24c-13.3 0-24 10.7-24 24v76.4c0 13.3 10.7 24 24 24h137.8V456c0 13.3 10.7 24 24 24h76.4c13.3 0 24-10.7 24-24V318.2H424c13.3 0 24-10.7 24-24z"></path></svg>',
    "fa-minus":
    ...
    if (ctf.font_method != "fontfile") {
      ...
      elem.each(function () {
        jQuery(this)
          .find("span.fa")
          .each(function () {
            var faClass = jQuery(this)
                .attr("class")
                .match(/fa-[a-z-]+/),
              styles = jQuery(this).attr("style");
            if (faClass && typeof ctfIconSVG[faClass[0]] !== "undefined") {
              var theStyle =
                typeof styles !== "undefined" ? 'style="' + styles + '" ' : "";
              jQuery(this).replaceWith(
                "<svg " + theStyle + ctfIconSVG[faClass[0]]
              );
            }
          });
      });
  ...
  !(function (a, b, c, d) {
      ...
      (e.Defaults = { autoRefresh: !0, autoRefreshInterval: 500 }),
        ...
        (e.prototype.refresh = function () {
          this._core.$element.is(":visible") !== this._visible &&
            ...
            this._core.$element.toggleClass("ctf-owl-hidden", !this._visible),
            this._visible &&
    ...
    (function (a, b, c, d) {
      ...
      (e.Defaults = { autoHeight: !1, autoHeightClass: "ctf-owl-height" }),
        (e.prototype.update = function () {
          ...
          (this._handlers = {
            ...
            "refreshed.owl.carousel": a.proxy(function (a) {
              a.namespace &&
                ...
                this._core.$stage.find(".cloned .ctf-owl-video-frame").remove();
            }, this),
            "changed.owl.carousel": a.proxy(function (a) {
              a.namespace &&
                "position" === a.property.name &&
      ...
      (e.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
        ...
        (e.prototype.thumbnail = function (b, c) {
          var d,
            ...
            l = function (a) {
              (e = '<div class="ctf-owl-video-play-icon"></div>'),
                (d = k.lazyLoad
                  ? '<div class="ctf-owl-video-tn ' +
                    j +
                    '" ' +
                    i +
                    '="' +
                    a +
                    '"></div>'
                  : '<div class="ctf-owl-video-tn" style="opacity:1;background-image:url(' +
                    a +
                    ')"></div>'),
                b.after(d),
                b.after(e);
          ...
          if (
            (b.wrap('<div class="ctf-owl-video-wrapper"' + g + "></div>"),
            this._core.settings.lazyLoad &&
              ((i = "data-src"), (j = "ctf-owl-lazy")),
            h.length)
          )
        ...
        (e.prototype.stop = function () {
          this._core.trigger("stop", null, "video"),
            this._playing.find(".ctf-owl-video-frame").remove(),
            this._playing.removeClass("ctf-owl-video-playing"),
            (this._playing = null),
        ...
        (e.prototype.play = function (b) {
          ...
          this._playing ||
            ...
            a('<div class="ctf-owl-video-frame">' + c + "</div>").insertAfter(
              e.find(".ctf-owl-video")
            ),
            (this._playing = e.addClass("ctf-owl-video-playing")));
        }),
    ...
    (function (a, b, c, d) {
      ...
      (e.Defaults = { animateOut: !1, animateIn: !1 }),
            ...
            this.core.current() !== this.previous &&
              (g &&
                ...
                d
                  ...
                  .css({ left: b + "px" })
                  .addClass("animated ctf-owl-animated-out")
                  .addClass(g)),
              f &&
                e
                  .one(a.support.animation.end, c)
                  .addClass("animated ctf-owl-animated-in")
                  .addClass(f));
          }
        }),
        (e.prototype.clear = function (b) {
          a(b.target)
            .css({ left: "" })
            .removeClass("animated ctf-owl-animated-out ctf-owl-animated-in")
  ...
  (function ($) {
    function ctfAddVisibilityListener() {
      ...
      !(function (i) {
        var n = {
            ...
            runOnLoad: !0,
            frequency: 100,
            ctfPreviousVisibility: null,
          },
          c = {};
        (c.ctfCheckVisibility = function (i, n) {
          if (jQuery.contains(document, i[0])) {
            var e = n.ctfPreviousVisibility,
              t = i.is(":visible");
            (n.ctfPreviousVisibility = t),
              null == e
                ? n.runOnLoad && n.callback(i, t)
                : e !== t && n.callback(i, t),
              setTimeout(function () {
    ...
    ctf.prototype = {
      createPage: function (createFeeds, createFeedsArgs) {
        if (
          typeof window.ctfajaxurl === "undefined" ||
          window.ctfajaxurl.indexOf(window.location.hostname) === -1
        ) {
          window.ctfajaxurl =
            window.location.hostname + "/wp-admin/admin-ajax.php";
        }
      ...
      maybeAddIntents: function () {
        $.each(window.ctf.feeds, function (index) {
          ...
          if (
            !window.ctfIntentsIncluded &&
            window.ctf.feeds[index].settings.consentGiven &&
            typeof $self.attr("data-ctfintents") !== "undefined"
          ) {
            ...
            c = (function () {
              ...
              return (
                ...
                (b.prototype.build = function () {
                  var b = this;
                  if (
                    typeof a("#ctf_lightbox").find(".ctf_lb-container")
                      .hammer !== "function"
                  ) {
                    var Hammer = {
                      Manager: {
                  ...
                  a("" + lbBuilder.template()).appendTo(a("body")),
                    (this.$lightbox = a("#ctf_lightbox")),
                    (this.$overlay = a("#ctf_lightboxOverlay")),
                    ...
                    jQuery(document).on("click", function (event, b, c) {
                      ...
                      if (
                        !jQuery(event.target).closest(".ctf_lb-outerContainer")
                          .length
                      ) {
                        if (
                          !jQuery(event.target).closest(".ctf_lb-dataContainer")
                            .length
                        ) {
                          //Fade out lightbox
                          ...
                          jQuery(
                            "#ctf_lightboxOverlay, #ctf_lightbox"
                          ).fadeOut();
                        }
                      }
                    }),
                    ...
                    jQuery("#ctf_lightboxOverlay").on("click", function (c) {
                      ...
                      return (
                        "ctf_lightbox" === a(c.target).attr("id") && b.end(), !1
                      );
                    }),
                    this.$lightbox
                      .find(".ctf_lb-prev")
                    ...
                    this.$lightbox
                      .find(".ctf_lb-loader, .ctf_lb-close")
                      .on("click", function () {
                        lbBuilder.afterSlideChange();
                ...
                (b.prototype.start = function (b) {
                  ...
                  if (h) {
                    f = a(
                      b.prop("tagName") + '[data-ctf-lightbox="' + h + '"]'
                    );
                ...
                (b.prototype.changeImage = function (b) {
                  ...
                  this.$overlay.fadeIn(this.options.fadeDuration),
                    a(".ctf_lb-loader").fadeIn("slow"),
                    this.$lightbox
                      .find(
                        ".ctf_lb-image, iframe, .ctf_video, .ctf_lb-nav, .ctf_lb-prev, .ctf_lb-next, .ctf_lb-dataContainer, .ctf_lb-numbers, .ctf_lb-caption"
                      )
                      .hide(),
                ...
                (b.prototype.sizeContainer = function (a, b) {
                  function c() {
                    d.$lightbox.find(".ctf_lb-dataContainer").width(g),
                      d.$lightbox.find(".ctf_lb-prevLink").height(h),
                      d.$lightbox.find(".ctf_lb-nextLink").height(h),
                      d.showImage();
                  }
                  var d = this,
                ...
                (b.prototype.showImage = function () {
                  this.$lightbox.find(".ctf_lb-loader").hide(),
                    this.$lightbox.find(".ctf_lb-image").fadeIn("slow"),
                    this.updateNav(),
                    this.updateDetails(),
                ...
                (b.prototype.updateNav = function () {
                  ...
                  this.$lightbox.find(".ctf_lb-nav").show(),
                    this.album.length > 1 &&
                      (this.options.wrapAround
                        ? (a &&
                            this.$lightbox
                              .find(".ctf_lb-prev, .ctf_lb-next")
                              .css("opacity", "1"),
                          this.$lightbox
                            .find(".ctf_lb-prev, .ctf_lb-next")
                            .show())
                        : (this.currentImageIndex > 0 &&
                            (this.$lightbox.find(".ctf_lb-prev").show(),
                            a &&
                              this.$lightbox
                                .find(".ctf_lb-prev")
                                .css("opacity", "1")),
                          this.currentImageIndex < this.album.length - 1 &&
                            (this.$lightbox.find(".ctf_lb-next").show(),
                            a &&
                              this.$lightbox
                                .find(".ctf_lb-next")
                                .css("opacity", "1"))));
                ...
                (b.prototype.updateDetails = function () {
                  ...
                  if (
                    ...
                    jQuery(".ctf_lb-container").prepend(
                      '<a href="https://twitter.com/' +
                        ...
                        '" target="_blank" rel="noopener noreferrer" class="ctf_gdpr_notice"><svg style="color: rgba(255,255,255,1)" class="svg-inline--fa fa-play fa-w-14 sbi_playbtn" aria-label="Play" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="play" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M424.4 214.7L72.4 6.6C43.8-10.3 0 6.1 0 47.9V464c0 37.5 40.7 60.1 72.4 41.3l352-208c31.4-18.5 31.5-64.1 0-82.6z"></path></svg></a>'
                    );
                  } else if (
                    this.album[this.currentImageIndex].video !== "link"
                  ) {
                  ...
                  if (
                    typeof this.album[this.currentImageIndex].amplify !==
                    "undefined"
                  )
                    $("#ctf_lightbox").addClass("ctf-amplify");
                  ...
                  if (this.album[this.currentImageIndex].iframe.length) {
                    ...
                    $("#ctf_lightbox")
                      .removeClass("ctf_video_lightbox")
                      .addClass("ctf-has-iframe");
                  ...
                  if (
                    parseInt(this.album[this.currentImageIndex].audioiframe) ===
                    1
                  ) {
                  ...
                  jQuery("#ctf_lightbox .ctf_instagram a").attr(
                    "href",
                    this.album[this.currentImageIndex].url
                  );
                  jQuery("#ctf_lightbox .ctf_lightbox_tooltip").hide();
                  jQuery("#ctf_lightbox #ctf_mod_box")
                    .find("#ctf_photo_id")
                    .text(this.album[this.currentImageIndex].id);
                  //Change social media sharing links on the fly
                  jQuery("#ctf_lightbox #ctf_facebook_icon").attr(
                    "href",
                    "https://www.facebook.com/sharer/sharer.php?u=" +
                      this.album[this.currentImageIndex].url +
                      "&t=Text"
                  );
                  jQuery("#ctf_lightbox #ctf_twitter_icon").attr(
                    "href",
                  ...
                  jQuery("#ctf_lightbox #ctf_linkedin_icon").attr(
                    "href",
                  ...
                  jQuery("#ctf_lightbox #ctf_pinterest_icon").attr(
                    "href",
                  ...
                  jQuery("#ctf_lightbox #ctf_email_icon").attr(
                    "href",
                  ...
                  var ctfLightboxCaption = this.album[this.currentImageIndex]
                      .title,
                    hashRegex = /(^|\s)#(\w[\u0041-\u005A\u0061-\u007A\u00AA\u00B5\u00BA\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u0527\u0531-\u0556\u0559\u0561-\u0587\u05D0-\u05EA\u05F0-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u08A0\u08A2-\u08AC\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0977\u0979-\u097F\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C33\u0C35-\u0C39\u0C3D\u0C58\u0C59\u0C60\u0C61\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D05-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D60\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E87\u0E88\u0E8A\u0E8D\u0E94-\u0E97\u0E99-\u0E9F\u0EA1-\u0EA3\u0EA5\u0EA7\u0EAA\u0EAB\u0EAD-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F4\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u1700-\u170C\u170E-\u1711\u1720-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1877\u1880-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191C\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19C1-\u19C7\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4B\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1CE9-\u1CEC\u1CEE-\u1CF1\u1CF5\u1CF6\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2183\u2184\u2C00-\u2C2E\u2C30-\u2C5E\u2C60-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005\u3006\u3031-\u3035\u303B\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312D\u3131-\u318E\u31A0-\u31BA\u31F0-\u31FF\u3400-\u4DB5\u4E00-\u9FCC\uA000-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA697\uA6A0-\uA6E5\uA717-\uA71F\uA722-\uA788\uA78B-\uA78E\uA790-\uA793\uA7A0-\uA7AA\uA7F8-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA80-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uABC0-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC+0-9]+\w)/gi,
                    tagRegex = /[@]+[A-Za-z0-9-_]+/g;

                  ctfLightboxCaption
                    ? (ctfLightboxCaption = ctfLinkify(ctfLightboxCaption))
                    : (ctfLightboxCaption = "");
                  ...
                  ctfLightboxCaption = ctfLightboxCaption.replace(
                    hashRegex,
                    ctfReplaceHashtags
                  );
                    ...
                    this.$lightbox
                      ...
                      .html(
                        '<div class="ctf-author-box' +
                          ...
                          '<a href="https://twitter.com/' +
                          this.album[this.currentImageIndex].user +
                          '" class="ctf-author-avatar" target="_blank" style="">' +
                          '<img src="' +
                          ...
                          '<a href="https://twitter.com/' +
                          this.album[this.currentImageIndex].user +
                          '" target="_blank" class="ctf-author-name">' +
                          this.album[this.currentImageIndex].name +
                          "</a>" +
                          '<a href="https://twitter.com/' +
                          this.album[this.currentImageIndex].user +
                          '" class="ctf-author-screenname" target="_blank">@' +
                          this.album[this.currentImageIndex].user +
                          "</a>" +
                          '<span class="ctf-screename-sep">·</span>' +
                          '<div class="ctf-tweet-meta">' +
                          '<a href="https://twitter.com/statuses/' +
                          this.album[this.currentImageIndex].id +
                          '" class="ctf-tweet-date" target="_blank">' +
                          this.album[this.currentImageIndex].date +
                          "</a>" +
                          "</div>" +
                          "</div> <!-- end .ctf-author-box-link -->" +
                          '</div><div class="ctf-caption-text' +
                          avatarClass +
                          '">' +
                          ctfLightboxCaption +
                          "</div>"
                ...
                (b.prototype.keyboardAction = function (a) {
                  ...
                  if (keycode === KEYCODE_ESC || key.match(/x|o|c/)) {
                    if (ctf_supports_video())
                      $("#ctf_lightbox video.ctf_video")[0].pause();
                    ...
                    if (ctf_supports_video())
                      $("#ctf_lightbox video.ctf_lb-video")[0].pause();
                    $("#ctf_lightbox iframe").attr("src", "");
      ...
      createFeeds: function (args) {
        ...
        args.whenFeedsCreated(
          $(".ctf").each(function (index) {
            ...
            var $self = $(this),
              flags =
                typeof $self.attr("data-ctf-flags") !== "undefined"
                  ? $self.attr("data-ctf-flags").split(",")
                  : [],
              general =
                typeof $self.attr("data-options") !== "undefined"
                  ? JSON.parse($self.attr("data-options"))
                  : {};
            if ($self.hasClass("ctf-masonry")) {
              general.masonry = true;
            } else if ($self.hasClass("ctf-carousel")) {
              var carouselAuto =
                typeof $self.attr("data-ctf-interval") !== "undefined"
                  ? $self.attr("data-ctf-interval")
                  : false;
              general.carousel = [
            ...
            var feedOptions = {
              cols:
                typeof $self.attr("data-ctf-cols") !== "undefined"
                  ? $self.attr("data-ctf-cols")
                  : 3,
              colsmobile:
                typeof $self.attr("data-ctf-mobilecols") !== "undefined"
                  ? $self.attr("data-ctf-mobilecols")
                  : 1,
              imageCols: $self.attr("data-ctfimagecols"),
              maxMedia: parseInt($self.attr("data-ctfmaxmedia")),
              feedID: $self.attr("data-feedid"),
              postID:
                typeof $self.attr("data-postid") !== "undefind"
                  ? $self.attr("data-postid")
                  : "unknown",
            ...
            window.ctf.feeds[
              index
            ].twitterCardHandler = new SbTwitterCardHandler("ctf", $self);
    ...
    function ctfFeed(el, index, settings) {
      ...
      this.resizedImages = {};
      (this.resizingDisabled = !$(this.el).find(".ctf-resized-image-data")
        .length),
    ...
    ctfFeed.prototype = {
      init: function () {
        ...
        $self
          .find(".ctf-header .ctf-header-link")
          .on("mouseenter mouseleave", function (e) {
            switch (e.type) {
              ...
              case "mouseleave":
                $self
                  .find(".ctf-header .ctf-header-img-hover")
                  .stop()
                  .fadeOut(600);
                break;
            }
        ...
        if (layout === "masonry") {
            ...
            if (typeof $(this).attr("style") !== "undefined") {
              $(this).attr(
                ...
                $(this)
                  ...
                  .replace(
                    "padding: " +
                      $self.find(".ctf-tweet-items").css("padding-top"),
                    "padding: " +
                      $self.find(".ctf-tweet-items").css("padding-top") +
                      " !important"
                  )
          ...
          var itemsTabletSmall = cols,
            ...
            onChange = function () {
              if (
                height === "clickexpand" &&
                !$self.find(".ctf-carousel-height-change").length
              ) {
            ...
            afterInit = function () {
              ...
              $self
                .find(".ctf-tweet-items.ctf-carousel")
                .fadeIn(400, function () {
              ...
              setTimeout(function () {
                $self
                  .find(
                    ".ctf-tweet-items.ctf-carousel .ctf-info, .ctf-owl2row-item,.ctf-tweet-items.ctf-carousel"
                  )
                  .fadeIn();
              }, 50);
              setTimeout(function () {
      ...
      setResizedImages: function () {
        var feed = this;
        if (
          $(this.el).find(".ctf-resized-image-data").length &&
          typeof $(this.el)
            .find(".ctf-resized-image-data")
            .attr("data-resized") !== "undefined" &&
          ($(this.el)
            .find(".ctf-resized-image-data")
            .attr("data-resized")
            .indexOf('{"') === 0 ||
          ...
          var rawResized = JSON.parse(
              $(this.el).find(".ctf-resized-image-data").attr("data-resized")
            ),
            organizedResized = {};
      ...
      afterLoadMoreClicked: function ($button) {
        $button
          .addClass("ctf-loading")
          .append('<div class="ctf-loader"></div>');
        $button
          .find(".ctf-loader")
          .css("background-color", $button.css("color"));
        $button
          .closest(".ctf")
          .find(".ctf-num-diff-hide")
          .addClass("ctf-transition")
          .removeClass("ctf-num-diff-hide");
      },
      ...
      beforeNewImagesRevealed: function () {
        ...
        if (
          ...
          (!$(feed.el).find(".ctf-hide-avatar").length ||
            $(feed.el).find(".ctf-hide-avatar.ctf-no-consent").length)
        ) {
          if (!feed.settings.overrideBlockCDN) {
            $(feed.el)
              .find(".ctf-item")
              .addClass("ctf-hide-avatar ctf-no-consent");
          } else {
            $(feed.el)
              .find(".ctf-item.ctf-no-consent")
              .removeClass("ctf-hide-avatar");
            $(feed.el)
              .find(".ctf-author-avatar")
              .each(function () {
                $(this)
                  .find("img")
                  .attr("src", $(this).find("img").attr("data-avatar"));
              });
          }
        }
        ctfSVGify($(this.el));
      ...
      initCarousel: function () {
        ...
        $self
          .find(".ctf-more")
          .attr("data-ctf-last", $self.find(".ctf-item").last().attr("id"));
        ...
        setTimeout(function () {
          var areaLeft =
            parseInt($self.find(".ctf-owl-stage-outer").eq(0).outerHeight()) -
            parseInt($self.find(".ctf-more span").eq(0).outerHeight());
          //$ctf.find('.ctf-more span').css('padding-top',areaLeft/2 + 'px').css('padding-bottom',areaLeft/2 + 'px');
          $self
            .find(".ctf-more")
            .css("padding-top", areaLeft / 2 + "px")
            .css("padding-bottom", areaLeft / 2 + "px");
          if ($self.is(":hover")) {
      ...
      sizeItems: function () {
        var $self = $(this.el),
          ...
          useTweetMediaMasonry =
            imageCols !== "auto" && !$self.hasClass("ctf-narrow")
              ? false
              : true,
            ...
            if (numMedia !== 2) {
              ...
              if (numMedia > 2) {
                ...
                if (
                  ...
                  typeof $this.find("img").first().attr("data-ctfsizes") !==
                    "undefined"
                ) {
                  sizes = $this
                    .find("img")
      ...
      revealNewImages: function () {
        ...
        if (typeof window.ctf_custom_js == "function")
          setTimeout(function () {
            window.ctf_custom_js();
          }, 100);
        ...
        $self.find(".ctf-item.ctf-new").each(function (index) {
          ...
          if ($ctfItem.find(".ctf-twitter-card-placeholder").length) {
            ...
            if ($ctfItem.find("iframe").length) {
              ...
              $ctfItem
                .find(".ctf-tweet-text")
                .html($ctfItem.find(".ctf-tweet-text").html().replace(url, ""));
            } else {
          ...
          $ctfText
            .find(".ctf_remaining")
            .html(" " + $ctfText.find(".ctf_remaining").html());
          ...
          if (
            ...
            !$ctf.find(".ctf-tweet-text-link").length
          ) {
            ...
            if (
              $ctfText.find(".ctf_remaining").length &&
              $ctfText.find(".ctf_remaining").html().indexOf(" ") === 0
            ) {
              $ctfText
                .find(".ctf_remaining")
                .html($ctfText.find(".ctf_remaining").html().replace(" ", ""));
            }
            ...
            $ctfItem
              .find(".ctf-twitter-card")
              .css("color", $ctfText.css("color"));
          } // End "ctfdata-disablelinks" check

          // shorten long urls in twee
          $ctfItem.find(".ctf-tweet-text a").each(function () {
            if (
              jQuery(this).text().indexOf("http") > -1 &&
              jQuery(this).text().length > 63
            ) {
          ...
          $ctfItem
            .find(
              ".ctf-tweet-content:not(.ctf-disable-lightbox) .ctf-tweet-media a"
            )
            .on({
              mouseenter: function () {
          ...
          if (feed.settings.lightboxEnabled) {
            $self
              .find(".ctf-lightbox-hover")
              .attr("data-ctf-lightbox", feed.index);
            if ($self.hasClass("ctf-youtube-item")) {
              $self
                .find(".ctf-lightbox-hover")
                .attr("href", ctf.options.lightboxPlaceholder);
            }
          }
      ...
      lazyLoadCheck: function ($item) {
        ...
        if (
          $item.find(".ctf-tweet-media img").length &&
          !$item.closest(".ctf").hasClass("ctf-no-ll-check")
        ) {
          $item.find(".ctf-tweet-media img").each(function (index) {
            var maxResImage =
              typeof $(this).attr("data-full-image") !== "undefined"
                ? $(this).attr("data-full-image")
                : $(this).closest("a").attr("href");

            if (
              maxResImage &&
              typeof $(this).attr("data-src") !== "undefined"
            ) {
            ...
            if (
              maxResImage &&
              typeof $(this).attr("data-orig-src") !== "undefined"
            ) {
              ...
              if (
                ...
                if (maxResImage) {
                  ...
                  if ($(this).closest(".ctf_imgLiquid_bgSize").length) {
                    $(this)
                      .closest(".ctf_imgLiquid_bgSize")
                      .css("background-image", "url(" + maxResImage + ")");
                  }
                }
              }
            });
        ...
        if (
          $item.find(".ctf-tc-image img").length &&
          !$item.closest(".ctf").hasClass("ctf-no-ll-check")
        ) {
          $item.find(".ctf-tc-image img").each(function () {
            ...
            if (
              maxResImage &&
              $(this).closest(".ctf_imgLiquid_bgSize").length
            ) {
              $(this)
                .closest(".ctf_imgLiquid_bgSize")
                .css("background-image", "url(" + maxResImage + ")");
      ...
      sendDataForBackgroundProcesses: function () {
        ...
        if (
          feed.itemsToCheck.cards.length > 0 ||
          feed.itemsToCheck.resize.length > 0
        ) {
          var feedID =
            typeof feed.settings.feedID !== "undefined"
          ...
          onSuccess = function (data) {
            if (lastIDData !== "") {
              ...
              if ($ctf.hasClass("ctf-carousel")) {
                ...
                if (
                  carouselLoopType === "none" ||
                  carouselLoopType === "rewind"
                ) {
                  carouselPos =
                    $ctf
                      .find(".ctf-owl-item")
                      .index($ctf.find(".ctf-owl-item.active").last()) -
                    carouselCols +
                    1;
                  ...
                  carouselPos =
                    ($ctf
                      .find(".ctf-owl-item")
                      .index($ctf.find(".ctf-owl-item.cloned").last()) -
                      carouselCols +
                      1) /
                    2;
              ...
              if ($ctf.find(".ctf-out-of-tweets").length) {
                ...
                $ctf
                  .find(".ctf-tweet-items")
                  .after($ctf.find(".ctf-out-of-tweets"));
      ...
      maybeRaiseSingleImageResolution: function ($item, index) {
        var feed = this,
          $mediaItem = $item.find(".ctf-tweet-media a").length
            ? $item.find(".ctf-tweet-media a")
            : $item.find(".ctf-quoted-media-wrap a"),
        ...
        if (!$mediaItem.length) {
          if ($item.find(".ctf-quoted-media-wrap img").length) {
            if ($item.find(".ctf-quoted-media-wrap .ctf-tc-image").length) {
              ...
              typeof $item
                .find(".ctf-quoted-media-wrap")
                .attr("data-available-images") !== "undefined"
            ) {
              $mediaItem = $item.find(".ctf-quoted-media-wrap");
            }
          } else if (
            typeof $item
              .find(".ctf-tweet-media")
              .attr("data-available-images") !== "undefined"
          ) {
        ...
        $mediaItem.each(function (i) {
          var $thisItem = $(this),
            $img = $(this).find("img"),
            baseUrl =
              typeof $img.attr("data-full-image") !== "undefined"
                ? $img.attr("data-full-image")
                : $img.closest("a").attr("href");
          (sizesArr =
            typeof $img.attr("data-ctfsizes") !== "undefined"
              ? $img.attr("data-ctfsizes").split(",")
              : "default"),
            (currentUrl = $img.attr("src")),
            (currentRes =
              typeof $img.attr("data-current") === "undefined"
                ? 0
                : parseInt($img.attr("data-current"))),
            (neededRes = feed.getNeededRes($thisItem, i, $mediaItem.length)),
            (forceChange =
              typeof forceChange !== "undefined" ? forceChange : false),
            (changeToRes = 0);

          if (
            typeof feed.resizedImages[id] === "undefined" &&
            !feed.settings.consentGiven &&
            !feed.settings.overrideBlockCDN
          ) {
          ...
          if (sizesArr[0] !== "full") {
            ...
            if (newUrl !== currentUrl) {
              if (feed.settings.debugEnabled) {
                var reason =
                  currentUrl === feed.placeholderURL
                    ? "was placeholder"
                    : "too small";
              ...
              if (newUrl !== currentUrl) {
                ...
                if (
                  currentRes < 700 &&
                  $img.closest(".ctf_imgLiquid_ready").length &&
                  !$img
                    .closest(".ctf_imgLiquid_ready")
                    .hasClass("ctf-secondary-check")
                ) {
                  $img
                    .closest(".ctf_imgLiquid_ready")
                    .addClass("ctf-secondary-check");
                  $img.on("load", function () {
                    if (!$(this).hasClass("ctf-secondary-checked")) {
                      ...
                      var imagEl = $img.get(0),
                        ...
                        aspectRatio =
                          imagEl.naturalWidth / imagEl.naturalHeight;
      ...
      maybeRaiseImageResolution: function (justNew) {
        var feed = this,
          itemsSelector =
            typeof justNew !== "undefined" && justNew === true
              ? ".ctf-item.ctf-new"
              : ".ctf-item";
        if (!feed.isInitialized) {
          return;
        ...
        $(feed.el)
          ...
          .each(function (index) {
            if (
              !$(this).hasClass("ctf-num-diff-hide") &&
              ($(this).find(".ctf-tweet-media").length ||
                $(this).find(".ctf-quoted-media-wrap").length)
            ) {
      ...
      getImageUrls: function ($item) {
        $mediaItem = $item.find(".ctf-tweet-media").length
          ? $item.find(".ctf-tweet-media")
          : $item.find(".ctf-quoted-media-wrap");
        ...
        var feed = this,
          apiSourceSet = JSON.parse(
            $mediaItem.attr("data-available-images").replace(/\\\//g, "/")
          ),
          srcSet =
            typeof apiSourceSet[0] !== "undefined"
              ? apiSourceSet
              : apiSourceSet,
          id = $item.attr("id").replace("ctf_", "");
        ...
        if (
          ...
          jQuery.each(srcSet, function (index, value) {
            ...
            jQuery.each(
              feed.resizedImages[id].sizes,
              function (index2, value2) {
                returnSrcSet[index][value2] =
                  window.ctfOptions.resized_url +
                  feed.resizedImages[id].id +
                  "-" +
                  index +
                  "-" +
                  value2 +
          ...
          typeof this.resizedImages[id] === "undefined" ||
          (typeof this.resizedImages[id]["id"] !== "undefined" &&
      ...
      addToNeedsResizing: function (id) {
        if (
          !this.resizingDisabled &&
          this.itemsToCheck.resize.indexOf(id) === -1
        ) {
      ...
      setImageSizeClass: function () {
        ...
        if (ctfItemWidth > 480)
          $self.removeClass("ctf-narrow ctf-super-narrow");
      ...
      listenForVisibilityChange: function () {
        ...
        if (
          typeof $(this.el).filter(":hidden").ctfVisibilityChanged == "function"
        ) {
          //If the feed is initially hidden (in a tab for example) then check for when it becomes visible and set then set the height
          $(this.el)
            .filter(":hidden")
            .ctfVisibilityChanged({
      ...
      smashotopeInit: function () {
        var $self = $(this.el),
          $container = $self.find(".ctf-items-wrap-current").length
            ? $self.find(".ctf-items-wrap-current")
            : $self.find(".ctf-tweet-items"),
          ...
          photoPadding =
            parseInt(
              $self.find(".ctf-tweet-items").outerWidth() -
                $self.find(".ctf-tweet-items").width()
            ) / 2,
          cols = this.getColumnCount(),
          feedWidthSansPadding = feedWidth - photoPadding * (cols + 2),
          colWidth = feedWidthSansPadding / cols,
          widthAdjustForPercentPadding =
            $self.find(".ctf-tweet-items").css("padding").indexOf(".") > -1
              ? 1
              : 0,
          margin = 10,
          scrollbarwidth = $self.hasClass("ctf-fixed-height")
            ? Math.floor(20 / cols)
            : 0;
      ...
      checkConsent: function () {
        ...
        if (typeof CLI_Cookie !== "undefined") {
          ...
          this.settings.consentGiven =
            ctfCmplzGetCookie("complianz_consent_status") === "allow";
      ...
      addFullFeatures: function () {
        ...
        $(feed.el)
          .find(".ctf-iframe-placeholder")
          .each(function () {
            $(this).replaceWith(
              '<iframe src="' +
                $(this).attr("data-ctf-url") +
                '" type="text/html" allowFullScreen frameBorder="0" title="Twitter Feed Media" webkitAllowFullScreen mozallowfullscreen></iframe>'
            );
          });
        $(feed.el)
          .find(".ctf-disable-lightbox .ctf-video-thumb")
          .each(function () {
            if (typeof $(this).attr("data-video-src") !== "undefined") {
              $(this).replaceWith(
                "<video " +
                  $(this).attr("data-video-atts") +
                  ' src="' +
                  $(this).attr("data-video-src") +
                  '" type="video/mp4" poster="' +
                  $(this).attr("data-video-poster") +
                  '">'
              );
            }
          });
        $(feed.el)
          .find(".ctf-video-thumb.ctf-thum-type-animated_gif")
          .each(function () {
            if (typeof $(this).attr("data-video-src") !== "undefined") {
              $(this).replaceWith(
                "<video " +
    ...
    ctfLightboxBuilder.prototype = {
      getData: function (a) {
        var closestFeedIndex = parseInt(
          a.closest(".ctf").attr("data-ctf-index") - 1
        );
    ...
    SbTwitterCardHandler.prototype = {
      ...
      handleImageError: function ($item) {
        ...
        $item.find("." + prefix + "-twitter-card").each(function () {
          $(this)
            ...
            .on("error", function () {
              $(this)
                .closest("." + prefix + "-twitter-card")
                .addClass(prefix + "-tc-no-image");
              $(this).remove();
            });
        });
      },
      ...
      afterCardAdded: function ($item, cardData) {
        $item
          .find(".ctf-tweet-text")
          .find('a[href^="' + cardData.url + '"]')
          .remove();
        $item
          .find(".ctf-tweet-text")
          .find('a[href^="' + cardData.shortUrl + '"]')
          .remove();
        $item
          .find(".ctf-tweet-text")
          .html($item.find(".ctf-tweet-text").html().replace(cardData.url, ""));
        $item
          .find(".ctf-tweet-text")
          .html(
            $item.find(".ctf-tweet-text").html().replace(cardData.shortUrl, "")
          );
      ...
      maybeRaiseSingleResolution: function ($item) {
        ...
        var imageUrls = JSON.parse(
            $img.attr("data-available-images").replace(/\\\//g, "/")
          ),
          currentUrl = $img.attr("src"),
          currentRes =
            typeof $img.attr("data-current") === "undefined"
    ...
    window.ctf_init = function () {
      window.ctf = new ctf();
      window.ctf.createPage(window.ctf.createFeeds, {
        whenFeedsCreated: window.ctf.afterFeedsCreated,
      });
    };
    ...
    function ctfUpdateSize($ctf, feed) {
      var isExpanded =
        typeof feed.settings.expanded !== "undefined" && feed.settings.expanded;
    ...
    function ctfInitClickExpand($self, feed) {
      ...
      if (typeof feed.settings.expanded !== "undefined") {
        ...
        $self
          .find(".ctf-carousel-height-change")
          .removeClass("ctf-carousel-more")
          .addClass("ctf-carousel-less")
          .find("span")
          .html(
      ...
      $self.find(".ctf-carousel-height-change").on("click", function (e) {
        ...
        if ($thisMoreButton.hasClass("ctf-carousel-more")) {
          ...
          ctfFeedHeightToggle(minHeight, $owlStageOuter);
          $thisMoreButton
            .removeClass("ctf-carousel-less")
            .addClass("ctf-carousel-more")
            .find("span")
            .html(
              '<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-plus fa-w-14 fa-2x"><path fill="currentColor" d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" class=""></path></svg>'
            );
