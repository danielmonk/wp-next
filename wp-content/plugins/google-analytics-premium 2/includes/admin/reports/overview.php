    ...
    public function prepare_report_data($data)
    {
        ...
        if (!empty($data['data']['countries'])) {
            ...
            foreach ($data['data']['countries'] as $key => $country) {
                $data['data']['countries'][$key]['name'] = isset(
                    $country_names[$country['iso']]
                )
                    ? $country_names[$country['iso']]
                    : $country['iso'];
            }
        ...
        if (!empty($data['data']['toppages'])) {
            foreach ($data['data']['toppages'] as $key => $page) {
                ...
                $url =
                    '(not set)' === $title
                        ? ''
                        : esc_url($data['data']['toppages'][$key]['hostname']);
        ...
        if (!empty($data['data'])) {
            $data['data']['galinks'] = [
                'countries' =>
                    'https://analytics.google.com/analytics/web/#report/visitors-geo/' .
