...
class MonsterInsights_Review
{
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_monsterinsights_review_dismiss', [
            $this,
            'review_dismiss',
        ]);
    }
    ...
    public function review()
    {
        ...
        $activated = get_option('monsterinsights_over_time', []);
        ...
        if (!empty($activated['connected_date'])) {
            ...
            if (
                $activated['connected_date'] + DAY_IN_SECONDS * $days >
                time()
            ) {
                return;
            }
        ...
        $feedback_url = add_query_arg(
            [
                ...
                'wpf192157_27' => monsterinsights_is_pro_version()
                    ? 'pro'
                    : 'lite',
        ...
        $feedback_url = monsterinsights_get_url(
            'review-notice',
            'feedback',
            $feedback_url
        );
        ...
        'google-analytics-for-wordpress'
				...
				<p>
					<a href="#" class="monsterinsights-review-switch-step" data-step="3"><?php esc_html_e(
         'Yes',
         'google-analytics-for-wordpress'
     ); ?></a><br />
					<a href="#" class="monsterinsights-review-switch-step" data-step="2"><?php esc_html_e(
         'Not Really',
         'google-analytics-for-wordpress'
     ); ?></a>
				</p>
			...
			<div class="monsterinsights-review-step monsterinsights-review-step-2" style="display: none">
				<p><?php esc_html_e(
        'We\'re sorry to hear you aren\'t enjoying MonsterInsights. We would love a chance to improve. Could you take a minute and let us know what we can do better?',
        'google-analytics-for-wordpress'
    ); ?></p>
				<p>
					<a href="<?php echo esc_url(
         $feedback_url
     ); ?>" class="monsterinsights-dismiss-review-notice monsterinsights-review-out"><?php esc_html_e(
    'Give Feedback',
    'google-analytics-for-wordpress'
); ?></a><br>
					<a href="#" class="monsterinsights-dismiss-review-notice" target="_blank" rel="noopener noreferrer"><?php esc_html_e(
         'No thanks',
         'google-analytics-for-wordpress'
     ); ?></a>
				</p>
        ...
        'google-analytics-for-wordpress'
				...
				<p><strong><?php echo wp_kses(
        __(
            '~ Syed Balkhi<br>Co-Founder of MonsterInsights',
            'google-analytics-for-wordpress'
        ),
        ['br' => []]
    ); ?></strong></p>
				<p>
					<a href="https://wordpress.org/support/plugin/google-analytics-for-wordpress/reviews/?filter=5#new-post" class="monsterinsights-dismiss-review-notice monsterinsights-review-out" target="_blank" rel="noopener noreferrer"><?php esc_html_e(
         'Ok, you deserve it',
         'google-analytics-for-wordpress'
     ); ?></a><br>
					<a href="#" class="monsterinsights-dismiss-review-notice" target="_blank" rel="noopener noreferrer"><?php esc_html_e(
