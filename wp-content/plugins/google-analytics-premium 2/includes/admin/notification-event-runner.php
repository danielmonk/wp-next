...
class MonsterInsights_Notification_Event_Runner
{
    ...
    {
        add_action(
            'wp_ajax_monsterinsights_vue_get_notifications',
            [$this, 'maybe_add_notifications'],
            9
        );
    }
    ...
    public function maybe_add_notifications()
    {
        ...
        foreach ($notifications as $notification) {
            ...
            if (empty($last_runs[$notification->notification_id])) {
                ...
                $time_since =
                    $last_runs[$notification->notification_id] +
                    $notification->notification_interval * DAY_IN_SECONDS;
                $time_now = time();
    ...
    public function register_notification($notification)
    {
        ...
        if (
            ...
            !isset(self::$notifications[$notification_id])
        ) {
