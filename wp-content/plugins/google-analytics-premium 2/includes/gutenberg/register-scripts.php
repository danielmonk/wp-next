    ...
    wp_localize_script(
        ...
        [
            ...
            'allowed_post_types' => apply_filters(
                'monsterinsights_headline_analyzer_post_types',
                ['post']
            ),
            ...
            'is_headline_analyzer_enabled' =>
                apply_filters(
                    'monsterinsights_headline_analyzer_enabled',
                    true
                ) &&
                'true' !==
                    monsterinsights_get_option('disable_headline_analyzer'),
            'reports_url' => add_query_arg(
                'page',
                'monsterinsights_reports',
                admin_url('admin.php')
            ),
            'vue_assets_path' => plugins_url(
...
add_action(
    ...
    'monsterinsights_gutenberg_editor_assets'
);
