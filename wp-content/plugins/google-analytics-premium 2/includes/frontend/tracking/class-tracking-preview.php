...
class MonsterInsights_Tracking_Preview extends MonsterInsights_Tracking_Abstract
{
    ...
    {
        $output =
            '<!-- This site uses the Google Analytics by MonsterInsights plugin v ' .
            MONSTERINSIGHTS_VERSION .
            ' - https://www.monsterinsights.com/ -->';
        $output .=
            '<!-- ' .
            esc_html__(
                "You are currently in a preview window. MonsterInsights doesn't track preview window traffic to avoid false visit reports.",
