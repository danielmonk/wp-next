 ...
 */
function _monsterinsights_apply_filters_deprecated(
    $tag,
    $args,
    $version,
    $message = null
 ...
 */
function _monsterinsights_do_action_deprecated(
    $tag,
    $args,
    $version,
    $message = null
...
function _monsterinsights_deprecated_hook($hook, $version, $message = null)
{
     ...
     */
    if (
        (WP_DEBUG && apply_filters('deprecated_hook_trigger_error', true)) ||
        ...
        trigger_error(
            sprintf(
                esc_html__(
                    '%1$s is %3$sdeprecated%4$s since MonsterInsights version %2$s!',
 ...
 * @return void
 */
function _monsterinsights_deprecated_function(
    $function,
    $version,
    $backtrace = null
) {
...
function _monsterinsights_deprecated($message)
{
     ...
     */
    $show_errors = apply_filters(
        'monsterinsights_deprecated_trigger_error',
        $show_errors
    );
