...
$generated_i18n_strings = [
    ...
    __(
        'This list shows the top referral traffic sources for your site currently.',
        'ga-premium'
    ),

    // Reference: src/modules/reports/components/reports/monsterinsights-ReportRealTime-Pro.vue:225
    __(
        'This list shows the top countries visitors on your site right now are browsing from.',
        'ga-premium'
    ),

    // Reference: src/modules/reports/components/reports/monsterinsights-ReportRealTime-Pro.vue:226
    __(
        'This list shows the top cities visitors on your site right now are browsing from.',
        'ga-premium'
    ),
    ...
    __(
        'The Real-Time Report automatically paused due to inactivity. Please refresh the page to resume the Real-Time Report.',
        'ga-premium'
    ),
    ...
    __(
        'Connect your Search Console to Unlock Additional Actionable Insights',
        'ga-premium'
    ),
    ...
    __(
        'Conversion rate optimization is the key to generating more revenue for your store. Implement these 24 Ecommerce Tips to Double Your Conversions in 2020',
        'ga-premium'
    ),

    // Reference: src/modules/reports/components/reports/monsterinsights-YearInReview-Pro.vue:358
    __(
        'Read - 24 Ecommerce Hacks That Will Double Your Conversions in 2020',
        'ga-premium'
    ),
    ...
    __(
        'Your <strong>%1$s</strong> visitors viewed a total of <strong>%2$s</strong> pages. <span class=\'average-page-per-user\' style=\'font-size: 20px;margin-top:25px;display:block;font-family:Lato\'>That\'s an average of %s pages for each visitor!</span>',
        'ga-premium'
    ),
    ...
    __(
        'This list shows the number of conversions, impressions and conversion rate for each form on your website with at least 1 impression during the selected time range.',
        'ga-premium'
    ),
    ...
    __(
        'This list shows the top 50 Google search queries for your website.',
        'ga-premium'
    ),
    ...
    __(
        'This list shows the interest groups your visitors belong to.',
        'ga-premium'
    ),
    ...
    __(
        'This graph shows what percent of your users are in a particular age group.',
        'ga-premium'
    ),

    // Reference: src/modules/reports/components/reports/monsterinsights-ReportPublishers-Pro.vue:156
    __(
        'This graph shows the gender breakdown of your website visitors.',
        'ga-premium'
    ),
 ...
 MonsterInsights, its employees/contractors, and other affiliated parties are not lawyers. Any advice given in our support, documentation, website, other mediums or through our services/products should not be considered legal advice and is for informational and/or educational purposes only and are not guaranteed to be correct, complete or up-to-date, and do not constitute creating/entering an Attorney-Client relationship.',
    ...
    __(
        'MonsterInsights have partnered with SEMRush, the powerful all-in-one marketing toolkit that helps you get competitive <br>intelligence on SEO, paid traffic, social media, and more.',
        'ga-premium'
    ),
    ...
    __(
        'Unlock the Page Speed Report and Improve the Performance of Your Site',
        'ga-premium'
    ),
    ...
    __(
        'Enable gtag tracking code to improve compatibility. Read more about what this change means in this %1$sarticle%2$s. Once you switch you won’t be able to go back.',
        'ga-premium'
    ),

    // Reference: src/modules/settings/components/input/tab-engagement/SettingsInputEUCompliance-Pro.vue:104
    __(
        'gtag() Compatibility Mode is automatically enabled by the EU Compliance addon',
        'ga-premium'
    ),
    ...
    __(
        'The EU Compliance Addon has automatically enabled the gtag() compatibility feature so plugins integrating for cookie consent can use GA to store consent as a GA event.',
        'ga-premium'
    ),
    ...
    __(
        'xThis enables MonsterInsights to work with plugins that use %1$s and don\'t support %2$s',
        'ga-premium'
    ),
    ...
    // Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabGeneral-Pro.vue:88
    __(
        'Upgrade to the gtag.js tracking code for the latest Google Analytics tracking features. This will be the default in a future release and analytics.js tracking will no longer be supported. Tracking on your site should not be affected, more details about this change can be read in %$1sthis article%$2s.',
        'ga-premium'
    ),

    // Reference: src/modules/settings/components/tabs/monsterinsights-SettingsTabGeneral-Pro.vue:84
    __(
        'Upgrade to the gtag.js tracking code for the latest Google Analytics tracking features. This will be the default tracking option in a future release and analytics.js tracking will no longer be supported.',
        'ga-premium'
    ),
    ...
    __(
        'Order Popular Posts by comments or shares with 3 basic theme choices',
        'ga-premium'
    ),
