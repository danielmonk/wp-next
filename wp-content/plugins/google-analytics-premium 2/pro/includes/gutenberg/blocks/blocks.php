...
class MonsterInsights_Blocks_Pro
{
    ...
    {
        register_block_type('monsterinsights/popular-posts-products', [
            'attributes' => [
                'slug' => [
                    'type' => 'string',
                ],
            ...
            'render_callback' => [$this, 'popular_posts_products_output'],
        ]);
        register_block_type('monsterinsights/popular-posts-inline', [
            'attributes' => [
                'slug' => [
                    'type' => 'string',
                ],
            ...
            'render_callback' => [$this, 'popular_posts_inline_output'],
        ]);
        register_block_type('monsterinsights/popular-posts-widget', [
            'attributes' => [
                'slug' => [
                    'type' => 'string',
                ],
            ...
            'render_callback' => [$this, 'popular_posts_widget_output'],
        ]);
    }
    ...
    public function popular_posts_products_output($atts)
    {
        ...
        $output = MonsterInsights_Popular_Posts_Products()->shortcode_output(
            $atts
        );
    ...
    {
        $output = MonsterInsights_Popular_Posts_Inline()->shortcode_output(
            $atts
        );
    ...
    {
        $atts = $this->add_default_values($atts);
        $output = MonsterInsights_Popular_Posts_Widget()->shortcode_output(
            $atts
        );
