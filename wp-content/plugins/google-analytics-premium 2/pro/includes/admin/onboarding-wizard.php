...
class MonsterInsights_Onboarding_Wizard_Pro
{
    ...
    public function __construct()
    {
        ...
        add_action('network_admin_menu', [$this, 'add_dashboard_page']);

        add_action('wp_ajax_monsterinsights_onboarding_wpforms_install', [
            $this,
            'install_and_activate_wpforms',
        ]);

        add_action('wp_ajax_monsterinsights_onboarding_get_errors', [
            $this,
            'get_install_errors',
        ]);
        ...
        add_filter('monsterinsights_auth_success_redirect_url', [
            $this,
            'change_success_url',
        ]);
        add_filter('monsterinsights_reauth_success_redirect_url', [
            $this,
            'change_success_url',
        ]);
    }
    ...
    public function maybe_load_onboarding_wizard()
    {
        ...
        if (
            !(
                isset($_GET['page']) ||
                'monsterinsights-onboarding' !== $_GET['page'] ||
                apply_filters(
    ...
    public function enqueue_scripts()
    {
        ...
        if (!defined('MONSTERINSIGHTS_LOCAL_WIZARD_JS_URL')) {
            ...
            wp_enqueue_style(
                ...
                plugins_url(
                    $version_path . '/assets/vue/css/wizard' . $rtl . '.css',
                    MONSTERINSIGHTS_PLUGIN_FILE
                ),
                [],
                monsterinsights_get_asset_version()
            ...
            wp_register_script(
                ...
                plugins_url(
                    $version_path . '/assets/vue/js/wizard.js',
                    MONSTERINSIGHTS_PLUGIN_FILE
                ),
                ['monsterinsights-vue-vendors', 'monsterinsights-vue-common'],
                monsterinsights_get_asset_version(),
                true
            );
        } else {
            ...
            wp_register_script(
                'monsterinsights-vue-script',
                MONSTERINSIGHTS_LOCAL_WIZARD_JS_URL,
                ['monsterinsights-vue-vendors', 'monsterinsights-vue-common'],
                monsterinsights_get_asset_version(),
                true
            );
        ...
        $settings_page = is_network_admin()
            ? add_query_arg(
                'page',
    ...
    public function onboarding_wizard_header()
    {
       ...
       'MonsterInsights &rsaquo; Onboarding Wizard',
       'ga-premium'
   ); ?></title>
    ...
    public function onboarding_wizard_content()
    {
        ...
        monsterinsights_settings_error_page(
            'monsterinsights-vue-onboarding-wizard',
            '<a href="' .
                $admin_url .
                '">' .
                esc_html__(
    ...
    public function should_include_eu_addon()
    {
        ...
        if (class_exists('WooCommerce') && class_exists('WC_Countries')) {
            ...
            $continent = $wc_countries->get_continent_code_for_country(
                $country
            );
        ...
        if (
            ...
            function_exists('edd_get_shop_country')
        ) {
    ...
    public function change_return_url($siteurl)
    {
        ...
        if (isset($url['query'])) {
            ...
            $parameters['return'] = rawurlencode(
                add_query_arg(
                    [
