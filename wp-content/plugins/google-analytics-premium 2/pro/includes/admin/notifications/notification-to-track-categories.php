 ...
 * @since 7.12.3
 */
final class MonsterInsights_Notification_To_Track_Categories extends
        ...
        if (is_array($custom_dimensions) && !empty($custom_dimensions)) {
            foreach ($custom_dimensions as $custom_dimension) {
                if (
                    ...
                    "category" === $custom_dimension['type']
                ) {
                    $is_category_tracking_enabled = true;
                }
                if (
                    isset($custom_dimension['type']) &&
                    "tags" === $custom_dimension['type']
                ) {
