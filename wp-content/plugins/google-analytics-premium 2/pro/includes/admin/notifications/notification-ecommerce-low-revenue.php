 ...
 * @since 7.12.3
 */
final class MonsterInsights_Notification_Ecommerce_Low_Revenue extends
    MonsterInsights_Notification_Event
{
    ...
    public function prepare_notification_data($notification)
    {
        ...
        if (true === $enhanced_commerce) {
            ...
            $data['revenue'] = isset(
                $report['data']['infobox']['revenue']['value']
            )
                ? $report['data']['infobox']['revenue']['value']
                : 0;
            $data['prev_revenue_difference'] = isset(
                $report['data']['infobox']['revenue']['prev']
            )
                ? $report['data']['infobox']['revenue']['prev']
                : 0;
            ...
            if (!empty($data) && $data['prev_revenue_difference'] < 0) {
                ...
                $notification['title'] = sprintf(
                    __(
                        'Your eCommerce revenue has dropped to $%s',
                        'ga-premium'
                    ),
                    $data['revenue']
                );
                ...
                $notification['btns'] = [
                    "view_ecommerce_report" => [
                        'url' => $this->get_view_url(
                            'monsterinsights-report-ecommerce-revenue',
