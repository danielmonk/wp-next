 ...
 * @since 7.12.3
 */
final class MonsterInsights_Notification_To_Enable_Ecommerce_Tracking extends
    ...
    public function prepare_notification_data($notification)
    {
        ...
        if (
            ...
            $notification['content'] = sprintf(
                __(
                    'The MonsterInsights eCommerce addon makes it effortless to add Google Analytics Enhanced eCommerce tracking to your WordPress store whether you are using WooCommerce, MemberPress, LifterLMS or Easy Digital Downloads.<br><br>Enhanced eCommerce tracking lets you collect more data and gives you detailed insight into eCommerce engagement. %sIn this article%s, we will show you how to enable Enhanced eCommerce in WordPress with MonsterInsights.',
                    'ga-premium'
                ),
                '<a href="' .
