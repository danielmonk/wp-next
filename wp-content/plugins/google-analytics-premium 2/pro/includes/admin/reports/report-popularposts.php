...
final class MonsterInsights_Report_PopularPosts extends MonsterInsights_Report
{
    ...
    public function requirements($error = false, $args = [], $name = '')
    {
        ...
        if (!class_exists('MonsterInsights_Dimensions')) {
            ...
            $text = __(
                'Please %s the MonsterInsights Dimensions addon to load popular posts.',
                'ga-premium'
            );
        ...
        if (empty($dimension_id) || 0 === $dimension_id) {
            ...
            return __(
                'Please enable the "Post type" custom dimension in order to load Popular Posts data correctly.',
                'ga-premium'
            );
        }
    ...
    public function add_dimensions_settings_link($data)
    {
        if (current_user_can('monsterinsights_save_settings')) {
            $data['data']['footer'] = sprintf(
                ...
                esc_html__('Update dimensions settings', 'ga-premium')
            );
        }
