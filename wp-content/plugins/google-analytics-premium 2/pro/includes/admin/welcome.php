...
class MonsterInsights_Welcome_Pro
{
    ...
    public function __construct()
    {
        ...
        add_action('admin_init', [$this, 'maybe_redirect'], 9999);
        ...
        add_action('admin_enqueue_scripts', [$this, 'welcome_scripts']);
    }
    ...
    public function maybe_redirect()
    {
        ...
        if (
            !get_transient('_monsterinsights_activation_redirect') ||
            isset($_GET['monsterinsights-redirect'])
        ) {
            return;
        }
        ...
        if (
            ...
            $path =
                'index.php?page=monsterinsights-getting-started&monsterinsights-redirect=1';
            $redirect = is_network_admin()
    ...
    public function welcome_scripts()
    {
        ...
        if (
            ...
            !in_array($current_screen->id, $screens, true)
        ) {
            return;
        }
        global $wp_version;
        ...
        if (!defined('MONSTERINSIGHTS_LOCAL_WIZARD_JS_URL')) {
            wp_enqueue_style(
                'monsterinsights-vue-welcome-style-vendors',
                plugins_url(
                    $version_path . '/assets/vue/css/chunk-vendors.css',
            ...
            wp_enqueue_style(
                'monsterinsights-vue-welcome-style-common',
                plugins_url(
                    $version_path . '/assets/vue/css/chunk-common.css',
                    MONSTERINSIGHTS_PLUGIN_FILE
                ),
                [],
                monsterinsights_get_asset_version()
            ...
            wp_enqueue_style(
                'monsterinsights-vue-welcome-style',
                plugins_url(
                    $version_path . '/assets/vue/css/wizard.css',
                    MONSTERINSIGHTS_PLUGIN_FILE
                ),
                [],
                monsterinsights_get_asset_version()
        ...
        wp_localize_script(
            ...
            [
                ...
                'first_name' => !empty($user_data->first_name)
