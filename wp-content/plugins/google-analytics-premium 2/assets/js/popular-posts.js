var MonsterInsights_Popular_Posts = {
  ...
  grab_widgets_with_ajax: function () {
    ...
    var widgets_jsons = document.querySelectorAll(
        ".monsterinsights-popular-posts-widget-json"
      ),
      i,
      widgets_length = widgets_jsons.length;

    var params =
      "action=monsterinsights_popular_posts_get_widget_output&post_id=" +
      monsterinsights_pp.post_id;
