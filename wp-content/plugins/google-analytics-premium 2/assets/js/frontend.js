...
var MonsterInsights = function () {
  ...
  function __gaTrackerLinkType(el) {
    ...
    if (link.match(/^javascript\:/i)) {
      ...
      protocol &&
      protocol.length > 0 &&
      (__gaTrackerStringTrim(protocol) == "tel" ||
        __gaTrackerStringTrim(protocol) == "tel:")
    ) {
      ...
      protocol &&
      protocol.length > 0 &&
      (__gaTrackerStringTrim(protocol) == "mailto" ||
        __gaTrackerStringTrim(protocol) == "mailto:")
    ) {
      /* If it's a email */
      type = "mailto";
  ...
  function __gaTrackerClickEvent(event) {
    ...
    if (el && el.href && !el.hasAttribute("xlink:href")) {
      ...
      var extension = __gaTrackerGetExtension(
        el.href
      ...
      var target = __gaTrackerLinkTarget(
        el,
        event
      ...
      valuesArray.title = __gaTrackerGetTitle(
        el
  ...
  if (__gaTrackerWindow.addEventListener) {
    __gaTrackerWindow.addEventListener(
      "load",
      function () {
        document.body.addEventListener("click", __gaTrackerClickEvent, false);
      },
      false
    );
    ...
    if (__gaTrackerWindow.attachEvent) {
      __gaTrackerWindow.attachEvent("onload", function () {
