...
_e('Compose Message', 'buddypress'); ?></h2>

<form action="<?php bp_messages_form_action(
    'compose'
 ...
 do_action('bp_before_messages_compose_content'); ?>
	...
	<label for="send-to-input"><?php _e(
	...
	<?php if (bp_current_user_can('bp_moderate')): ?>
		<p><label for="send-notice"><input type="checkbox" id="send-notice" name="send-notice" value="1" /> <?php _e(
