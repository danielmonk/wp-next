...
<form action="<?php echo bp_displayed_user_domain() .
    ...
    '/capabilities/'; ?>" name="account-capabilities-form" id="account-capabilities-form" class="standard-form" method="post">
 ...
 do_action('bp_members_capabilities_account_before_submit'); ?>
	...
	<label for="user-spammer">
		<input type="checkbox" name="user-spammer" id="user-spammer" value="1" <?php checked(
