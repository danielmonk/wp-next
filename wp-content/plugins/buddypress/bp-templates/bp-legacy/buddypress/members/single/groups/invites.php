...
<?php if (bp_has_groups('type=invites&user_id=' . bp_loggedin_user_id())): ?>
 ...
 _e('Group invitations', 'buddypress'); ?></h2>
			...
			<li>
				<?php if (!bp_disable_group_avatar_uploads()): ?>
					<div class="item-avatar">
						<a href="<?php bp_group_permalink(); ?>"><?php bp_group_avatar(
    'type=thumb&width=50&height=50'
); ?></a>
					</div>
				<?php endif; ?>
				...
				<h4>
					...
					<span class="small">
						&nbsp;-&nbsp;
						<?php /* translators: %s: group members count */
      printf(
          _nx(
              '%d member',
              '%d members',
    ...
    do_action('bp_group_invites_item'); ?>
				...
				<div class="action">
					<a class="button accept" href="<?php bp_group_accept_invite_link(); ?>"><?php _e(
    'Accept',
    'buddypress'
); ?></a> &nbsp;
					<a class="button reject confirm" href="<?php bp_group_reject_invite_link(); ?>"><?php _e(
    'Reject',
    'buddypress'
); ?></a>
