 ...
 do_action('bp_before_message_thread_content'); ?>
	...
	<?php if (bp_thread_has_messages()): ?>
        ...
        bp_get_thread_recipients_count()
					...
					<?php printf(
         __('Conversation between %s recipients.', 'buddypress'),
         number_format_i18n(bp_get_thread_recipients_count())
				...
				<?php else: ?>
					...
					<?php printf(
         __('Conversation between %s.', 'buddypress'),
         bp_get_thread_recipients_list()
			...
			<a class="button confirm" href="<?php bp_the_thread_delete_link(); ?>"><?php _e(
    'Delete',
    'buddypress'
); ?></a>
  ...
  do_action('bp_before_message_thread_reply'); ?>
		...
		<form id="send-reply" action="<?php bp_messages_form_action(); ?>" method="post" class="standard-form">
			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<?php /** This action is documented in bp-templates/bp-legacy/buddypress-functions.php */
     ...
     do_action('bp_before_message_reply_box'); ?>
					...
					<label for="message_content" class="bp-screen-reader-text"><?php /* translators: accessibility text */
     _e('Reply to Message', 'buddypress'); ?></label>
     ...
     do_action('bp_after_message_reply_box'); ?>
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php esc_attr_e(
          'Send Reply',
          'buddypress'
