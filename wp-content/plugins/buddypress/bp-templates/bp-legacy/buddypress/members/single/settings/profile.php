...
_e('Profile visibility settings', 'buddypress'); ?></h2>

<form action="<?php echo trailingslashit(
    bp_displayed_user_domain() . bp_get_settings_slug() . '/profile'
 ...
 do_action('bp_core_xprofile_settings_before_submit'); ?>
	...
	<div class="submit">
		<input id="submit" type="submit" name="xprofile-settings-submit" value="<?php esc_attr_e(
      'Save Settings',
      'buddypress'
  ); ?>" class="auto" />
	</div>
