  ...
  do_action('bp_activity_entry_content'); ?>
		...
		<div class="activity-meta">
			...
			<?php if (bp_get_activity_type() == 'activity_comment'): ?>
				...
				<a href="<?php bp_activity_thread_permalink(); ?>" class="button view bp-secondary-action"><?php _e(
    'View Conversation',
    'buddypress'
); ?></a>
			...
			<?php if (is_user_logged_in()): ?>
				...
				<?php if (bp_activity_can_comment()): ?>
					...
					<a href="<?php bp_activity_comment_link(); ?>" class="button acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>">
						<?php /* translators: %s: number of activity comments */
      printf(
          __('Comment %s', 'buddypress'),
          '<span>' . bp_activity_get_comment_count() . '</span>'
      ); ?>
					</a>
				...
				<?php if (bp_activity_can_favorite()): ?>
					...
					<?php if (!bp_get_activity_is_favorite()): ?>
						...
						<a href="<?php bp_activity_favorite_link(); ?>" class="button fav bp-secondary-action"><?php _e(
    'Favorite',
    'buddypress'
); ?></a>
					...
					<?php else: ?>
						...
						<a href="<?php bp_activity_unfavorite_link(); ?>" class="button unfav bp-secondary-action"><?php _e(
    'Remove Favorite',
    'buddypress'
); ?></a>
         ...
         'width=' . BP_AVATAR_THUMB_WIDTH . '&height=' . BP_AVATAR_THUMB_HEIGHT
					...
					<div class="ac-reply-content">
						<div class="ac-textarea">
							<label for="ac-input-<?php bp_activity_id(); ?>" class="bp-screen-reader-text"><?php /* translators: accessibility text */
_e('Comment', 'buddypress'); ?></label>
							<textarea id="ac-input-<?php bp_activity_id(); ?>" class="ac-input bp-suggestions" name="ac_input_<?php bp_activity_id(); ?>"></textarea>
						</div>
						<input type="submit" name="ac_form_submit" value="<?php esc_attr_e(
          'Post',
          'buddypress'
      ); ?>" /> &nbsp; <a href="#" class="ac-reply-cancel"><?php _e(
    'Cancel',
    'buddypress'
); ?></a>
