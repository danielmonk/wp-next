...
<div id="buddypress">
 ...
 do_action('bp_before_directory_activity_content'); ?>
  ...
  do_action('template_notices'); ?>
	...
	<div class="item-list-tabs activity-type-tabs" aria-label="<?php esc_attr_e(
     'Sitewide activities navigation',
     'buddypress'
 ); ?>" role="navigation">
		<ul>
			<?php /**
   ...
   do_action('bp_before_activity_type_tab_all'); ?>
			...
			<li class="selected" id="activity-all">
				<a href="<?php bp_activity_directory_permalink(); ?>">
					<?php /* translators: %s: number of members */
     printf(
    ...
    do_action('bp_before_activity_type_tab_friends'); ?>
           ...
           bp_get_friends_slug() .
           '/'; ?>">
								<?php /* translators: %s: number of friends */
        printf(
    ...
    do_action('bp_before_activity_type_tab_favorites'); ?>
          ...
          bp_get_activity_slug() .
          '/favorites/'; ?>">
							<?php /* translators: %s: number of favorites */
       printf(
           __('My Favorites %s', 'buddypress'),
           '<span>' .
     ...
     do_action('bp_before_activity_type_tab_mentions'); ?>
          ...
          '/mentions/'; ?>">
							...
							<?php if (bp_get_total_mention_count_for_user(bp_loggedin_user_id())): ?>
								...
								<strong>
									<span>
										<?php /* translators: %s: new mentions count */
          printf(
              _nx(
                  '%s new',
                  '%s new',
   ...
   do_action('bp_activity_type_tabs'); ?>
	...
	<div class="item-list-tabs no-ajax" id="subnav" aria-label="<?php esc_attr_e(
     'Activity secondary navigation',
     'buddypress'
 ); ?>" role="navigation">
		<ul>
			<li class="feed"><a href="<?php bp_sitewide_activity_feed_link(); ?>" class="bp-tooltip" data-bp-tooltip="<?php esc_attr_e(
    'RSS Feed',
    'buddypress'
); ?>" aria-label="<?php esc_attr_e('RSS Feed', 'buddypress'); ?>"><?php _e(
    'RSS',
    'buddypress'
); ?></a></li>
