...
<input type="text" name="group-name" id="group-name" value="<?php echo esc_attr(
    bp_get_group_name()
); ?>" aria-required="true" />
...
<p>
	<label for="group-notify-members">
		<input type="checkbox" name="group-notify-members" id="group-notify-members" value="1" /> <?php _e(
