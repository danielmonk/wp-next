       ...
       do_action('bp_group_manage_members_admin_item', 'admins-list'); ?>
						...
						<div class="action">
							<?php if (count(bp_group_admin_ids(false, 'array')) > 1): ?>
								<a class="button confirm admin-demote-to-member" href="<?php bp_group_member_demote_link(); ?>"><?php _e(
    'Demote to Member',
    'buddypress'
); ?></a>
							<?php endif; ?>
	...
	<div class="bp-widget group-members-list group-mods-list">
      ...
      bp_group_has_members([
       ...
       do_action('bp_group_manage_members_admin_item', 'admins-list'); ?>
						...
						<div class="action">
							<a href="<?php bp_group_member_promote_admin_link(); ?>" class="button confirm mod-promote-to-admin"><?php _e(
    'Promote to Admin',
    'buddypress'
); ?></a>
							<a class="button confirm mod-demote-to-member" href="<?php bp_group_member_demote_link(); ?>"><?php _e(
    'Demote to Member',
    'buddypress'
); ?></a>
       ...
       do_action('bp_group_manage_members_admin_item', 'admins-list'); ?>
						...
						<div class="action">
							<?php if (bp_get_group_member_is_banned()): ?>
								...
								<a href="<?php bp_group_member_unban_link(); ?>" class="button confirm member-unban"><?php _e(
    'Remove Ban',
    'buddypress'
); ?></a>
							...
							<?php else: ?>
								...
								<a href="<?php bp_group_member_ban_link(); ?>" class="button confirm member-ban"><?php _e(
    'Kick &amp; Ban',
    'buddypress'
); ?></a>
								<a href="<?php bp_group_member_promote_mod_link(); ?>" class="button confirm member-promote-to-mod"><?php _e(
    'Promote to Mod',
    'buddypress'
); ?></a>
								<a href="<?php bp_group_member_promote_admin_link(); ?>" class="button confirm member-promote-to-admin"><?php _e(
    'Promote to Admin',
    'buddypress'
); ?></a>
							...
							<a href="<?php bp_group_member_remove_link(); ?>" class="button confirm"><?php _e(
    'Remove from group',
    'buddypress'
); ?></a>
