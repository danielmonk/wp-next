...
?>
   ...
   do_action('template_notices'); ?>
      ...
      'Groups directory main navigation',
      'buddypress'
  ); ?>">
			<ul>
      ...
      printf(
          __('All Groups %s', 'buddypress'),
          '<span>' . bp_get_total_group_count() . '</span>'
      ); ?>
					</a>
				</li>
        ...
        bp_get_total_group_count_for_user(bp_loggedin_user_id())
          ...
          bp_get_groups_slug() .
          '/my-groups/'; ?>">
							<?php /* translators: %s: current user groups count */
       printf(
    ...
    do_action('bp_groups_directory_group_filter'); ?>
      ...
      'Groups directory secondary navigation',
      'buddypress'
  ); ?>" role="navigation">
			<ul>
				<?php /**
  ...
  _e('Groups directory', 'buddypress'); ?></h2>
