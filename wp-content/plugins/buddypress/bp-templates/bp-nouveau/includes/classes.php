...
class BP_Nouveau_Object_Nav_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        $widget_ops = [
            'description' => __(
                'Displays BuddyPress primary nav in the sidebar of your site. Make sure to use it as the first widget of the sidebar and only once.',
                'buddypress'
            ),
    ...
    public function widget($args, $instance)
    {
        ...
        $item_nav_args = bp_parse_args(
            $instance,
            apply_filters('bp_nouveau_object_nav_widget_args', [
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        $instance['bp_nouveau_widget_title'] =
            (bool) $new_instance['bp_nouveau_widget_title'];
    ...
    public function form($instance)
    {
       ...
       $bp_nouveau_widget_title,
       true
   ); ?> id="<?php echo $this->get_field_id('bp_nouveau_widget_title'); ?>" name="<?php echo $this->get_field_name('bp_nouveau_widget_title'); ?>" />
			<label for="<?php echo $this->get_field_id(
       'bp_nouveau_widget_title'
   ); ?>"><?php esc_html_e('Include navigation title', 'buddypress'); ?></label>
		</p>
