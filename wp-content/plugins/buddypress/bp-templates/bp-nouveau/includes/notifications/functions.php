 ...
 */
function bp_nouveau_notifications_register_scripts($scripts = [])
{
...
function bp_nouveau_notifications_init_filters()
{
    ...
    bp_nouveau()->notifications->filters = [];
 ...
 */
function bp_nouveau_notifications_register_filter($args = [])
{
 ...
 */
function bp_nouveau_notifications_sort($filters = [])
{
    $sorted = [];
 ...
 */
function bp_nouveau_notifications_dashiconified_link(
    $link = '',
    $bp_tooltip = '',
    $dashicon = ''
) {
