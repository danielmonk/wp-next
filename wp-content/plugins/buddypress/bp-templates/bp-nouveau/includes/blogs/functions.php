...
function bp_nouveau_get_blogs_directory_nav_items()
{
    ...
    if (is_user_logged_in()) {
        $my_blogs_count = bp_get_total_blog_count_for_user(
            bp_loggedin_user_id()
        );
        ...
        if (bp_blog_signup_enabled()) {
            $nav_items['create'] = [
                ...
                'li_class' => ['no-ajax', 'site-create', 'create-button'],
 ...
 */
function bp_nouveau_blogs_catch_button_args($button = [])
{
 ...
 */
function bp_nouveau_blogs_customizer_settings($settings = [])
{
    return array_merge($settings, [
        'bp_nouveau_appearance[blogs_layout]' => [
            'index' => 'blogs_layout',
 ...
 */
function bp_nouveau_blogs_customizer_controls($controls = [])
{
    return array_merge($controls, [
        ...
        'sites_dir_layout' => [
            'label' => __(
                'Use column navigation for the Sites directory.',
                'buddypress'
            ),
        ...
        'sites_dir_tabs' => [
            'label' => __(
                'Use tab styling for Sites directory navigation.',
                'buddypress'
            ),
            'section' => 'bp_nouveau_dir_layout',
