...
function bp_nouveau_customize_register(WP_Customize_Manager $wp_customize)
{
    ...
    require_once trailingslashit(bp_nouveau()->includes_dir) .
    ...
    $wp_customize->add_panel('bp_nouveau_panel', [
        'description' => __(
            'Customize the appearance of BuddyPress Nouveau Template pack.',
            'buddypress'
        ),
     ...
     */
    $sections = apply_filters('bp_nouveau_customizer_sections', [
        'bp_nouveau_general_settings' => [
            'title' => __('General BP Settings', 'buddypress'),
            'panel' => 'bp_nouveau_panel',
            'priority' => 10,
            'description' => __(
                'Configure general BuddyPress appearance options.',
                'buddypress'
            ),
        ],
        'bp_nouveau_user_front_page' => [
            'title' => __('Member front page', 'buddypress'),
            'panel' => 'bp_nouveau_panel',
            'priority' => 30,
            'description' => __(
                'Configure the default front page for members.',
                'buddypress'
            ),
        ],
        'bp_nouveau_user_primary_nav' => [
            'title' => __('Member navigation', 'buddypress'),
            'panel' => 'bp_nouveau_panel',
            'priority' => 50,
            'description' => __(
                'Customize the navigation menu for members. In the preview window, navigate to a user to preview your changes.',
                'buddypress'
            ),
        ],
        'bp_nouveau_loops_layout' => [
            ...
            'priority' => 70,
            'description' => __(
                'Set the number of columns to use for BuddyPress loops.',
                'buddypress'
            ),
        ],
        'bp_nouveau_dir_layout' => [
            'title' => __('Directory layouts', 'buddypress'),
            'panel' => 'bp_nouveau_panel',
            'priority' => 80,
            'description' => __(
                'Select the layout style for directory content &amp; navigation.',
                'buddypress'
            ),
        ],
    ]);
     ...
     */
    $settings = apply_filters('bp_nouveau_customizer_settings', [
        'bp_nouveau_appearance[avatar_style]' => [
            'index' => 'avatar_style',
        ...
        'bp_nouveau_appearance[user_front_page]' => [
        ...
        'bp_nouveau_appearance[user_front_bio]' => [
        ...
        'bp_nouveau_appearance[user_nav_tabs]' => [
            'index' => 'user_nav_tabs',
            'capability' => 'bp_moderate',
            'sanitize_callback' => 'absint',
            'transport' => 'refresh',
        ...
        'bp_nouveau_appearance[user_subnav_tabs]' => [
        ...
        'bp_nouveau_appearance[members_layout]' => [
        ...
        'bp_nouveau_appearance[members_group_layout]' => [
        ...
        'bp_nouveau_appearance[members_friends_layout]' => [
        ...
        'bp_nouveau_appearance[activity_dir_layout]' => [
        ...
        'bp_nouveau_appearance[activity_dir_tabs]' => [
        ...
        'bp_nouveau_appearance[members_dir_layout]' => [
        ...
        'bp_nouveau_appearance[members_dir_tabs]' => [
        ...
        'bp_nouveau_appearance[groups_dir_layout]' => [
        ...
        'bp_nouveau_appearance[sites_dir_layout]' => [
        ...
        'bp_nouveau_appearance[sites_dir_tabs]' => [
    ...
    foreach ($settings as $id_setting => $setting_args) {
        ...
        if (
            empty($setting_args['index']) ||
            !isset($bp_nouveau_options[$setting_args['index']])
        ) {
            continue;
        }

        $args = array_merge($setting_args, [
            'default' => $bp_nouveau_options[$setting_args['index']],
        ]);
    ...
    $controls = [
        'bp_site_avatars' => [
            'label' => __(
                'Use the round style for member and group avatars.',
                'buddypress'
            ),
        ...
        'user_nav_order' => [
            ...
            'label' => __(
                'Reorder the primary navigation for a user.',
                'buddypress'
            ),
            'section' => 'bp_nouveau_user_primary_nav',
    ...
    if (current_theme_supports('align-wide')) {
        $controls['global_alignment'] = [
            'label' => __(
                'Select the BuddyPress container width for your site.',
                'buddypress'
            ),
            'section' => 'bp_nouveau_general_settings',
            'settings' => 'bp_nouveau_appearance[global_alignment]',
