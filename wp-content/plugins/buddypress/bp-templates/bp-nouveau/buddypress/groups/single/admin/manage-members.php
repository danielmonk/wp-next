...
<p class="bp-help-text"><?php esc_html_e(
    'Manage your group members; promote to moderators, admins or demote or ban.',
    'buddypress'
); ?></p>
...
<?php if (bp_rest_api_is_available()):
	...
	<dt class="admin-section section-title"><?php esc_html_e(
     'Administrators',
     'buddypress'
 ); ?></dt>
	...
	<?php if (bp_has_members('&include=' . bp_group_admin_ids())): ?>
       ...
       ); ?>"><?php esc_html_e('Demote to Member', 'buddypress'); ?></a>
						</p>
	...
	<?php if (bp_group_has_moderators()): ?>
		...
		<dt class="moderator-section section-title"><?php esc_html_e(
      'Moderators',
      'buddypress'
  ); ?></dt>
      ...
      ]); ?>" class="button confirm mod-promote-to-admin"><?php esc_html_e(
    'Promote to Admin',
    'buddypress'
); ?></a>
	...
	<dt class="gen-members-section section-title"><?php esc_html_e(
     'Members',
     'buddypress'
 ); ?></dt>
	...
	<dd class="general-members-listing">
        ...
        bp_group_the_member(); ?>
						...
						<p class="list-title member-name">
							...
							<span class="banned warn">
								<?php if (bp_get_group_member_is_banned()): ?>
									<?php esc_html_e('(banned)', 'buddypress'); ?>
								<?php endif; ?>
							</span>
						</p>
          ...
          'container' => 'div',
          'container_classes' => ['members-manage-buttons', 'text-links-list'],
          'parent_element' => '  ',
      ]); ?>
	...
	<?php else:bp_nouveau_user_feedback('group-manage-members-none');endif;
endif;
