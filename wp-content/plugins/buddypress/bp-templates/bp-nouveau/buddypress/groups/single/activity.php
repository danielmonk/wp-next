...
<h2 class="bp-screen-title<?php echo !bp_is_group_home()
...
<div class="subnav-filters filters clearfix">
	...
	<ul>
		...
		<li class="feed"><a href="<?php bp_group_activity_feed_link(); ?>" class="bp-tooltip no-ajax" data-bp-tooltip="<?php esc_attr_e(
    'RSS Feed',
    'buddypress'
...
<div id="activity-stream" class="activity single-group" data-bp-list="activity">
		...
		<li id="bp-activity-ajax-loader"><?php bp_nouveau_user_feedback(
