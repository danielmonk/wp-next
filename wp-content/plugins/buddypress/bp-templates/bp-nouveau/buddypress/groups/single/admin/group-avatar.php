...
<?php if (!bp_is_group_create()): ?>
	<?php if (!bp_get_group_has_avatar()): ?>
      ...
      'Add an image to use as a profile photo for this group. The image will be shown on the main group page, and in search results.',
      'buddypress'
  ); ?></p>
	<?php else: ?>
		<p class="bp-help-text"><?php esc_html_e(
      'Edit or update your avatar image for this group.',
      'buddypress'
  ); ?></p>
	<?php endif; ?>
<?php endif; ?>
