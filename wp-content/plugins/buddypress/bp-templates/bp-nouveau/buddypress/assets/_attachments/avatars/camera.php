...
<script id="tmpl-bp-avatar-webcam" type="text/html">
	<# if ( ! data.user_media ) { #>
		<div id="bp-webcam-message">
			<p class="warning"><?php esc_html_e(
	...
	<# } else { #>
		...
		<div class="avatar-crop-management">
			...
			<div id="avatar-crop-actions">
				<button type="button" class="button avatar-webcam-capture"><?php echo esc_html_x(
        'Capture',
        'button',
        'buddypress'
    ); ?></button>
				<button type="button" class="button avatar-webcam-save"><?php echo esc_html_x(
        'Save',
        'button',
        'buddypress'
    ); ?></button>
