...
<div class="member-front-page">
	...
	<?php if (
     ...
     !is_active_sidebar('sidebar-buddypress-members')
 ): ?>

		<div class="bp-feedback custom-homepage-info info">
			<strong><?php esc_html_e(
       'Manage the members default front page',
       'buddypress'
   ); ?></strong>
    ...
    'Close this notice',
    'buddypress'
); ?>" data-bp-close="remove"><span class="dashicons dashicons-dismiss" aria-hidden="true"></span></button><br/>
			<?php printf(
       /* translators: 1: link to the customizer option. 2: link to the customizer widgets section. */
       esc_html__(
           'You can set the preferences of the %1$s or add %2$s to it.',
           'buddypress'
       ),
