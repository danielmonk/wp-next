...
<?php if (bp_current_user_can('bp_xprofile_change_field_visibility')): ?>
	...
	<p class="field-visibility-settings-toggle field-visibility-settings-header" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id(); ?>">
      ...
      '<span class="current-visibility-level">' .
		...
		<button class="visibility-toggle-link text-button" type="button"><?php echo esc_html_x(
      'Change',
      'button',
      'buddypress'
  ); ?></button>
	...
	<div class="field-visibility-settings" id="field-visibility-settings-<?php bp_the_profile_field_id(); ?>">
       ...
       'buddypress'
		...
		<button class="field-visibility-settings-close button" type="button"><?php echo esc_html_x(
      'Close',
      'button',
      'buddypress'
  ); ?></button>
