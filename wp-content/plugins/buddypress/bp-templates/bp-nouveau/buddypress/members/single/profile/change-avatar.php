...
<h2 class="screen-heading change-avatar-screen"><?php esc_html_e(
...
<?php if (!(int) bp_get_option('bp-disable-avatar-uploads')): ?>
	...
	<p class="bp-feedback info">
		...
		<span class="bp-help-text">
			<?php /* Translators: %s is used to output the link to the Gravatar site */
   printf(
       esc_html__(
       ...
       '<a href="' .
           esc_url(__('https://gravatar.com', 'buddypress')) .
           '">Gravatar</a>'
   ); ?>
		</span>
	</p>
       ...
       'buddypress'
        ...
        'buddypress'
			...
			<?php if (bp_get_user_has_avatar()): ?>
				<p class="bp-help-text"><?php esc_html_e(
        "If you'd like to delete your current profile photo, use the delete profile photo button.",
        'buddypress'
    ); ?></p>
				<p><a class="button edit" href="<?php bp_avatar_delete_link(); ?>"><?php esc_html_e(
    ...
    'buddypress'
		...
		<?php if ('crop-image' === bp_get_avatar_admin_step()): ?>
			...
			<p class="bp-help-text screen-header"><?php esc_html_e(
...
<?php bp_nouveau_member_hook('after', 'avatar_upload_content');
