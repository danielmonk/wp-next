...
<div id="group-invites-container">
	...
	<nav class="<?php bp_nouveau_single_item_subnav_classes(); ?>" id="subnav" role="navigation" aria-label="<?php esc_attr_e(
    'Group invitations menu',
    'buddypress'
); ?>"></nav>
...
<script type="text/html" id="tmpl-bp-invites-users">
	...
	<div class="action">
		<# if ( undefined === data.is_sent || ( false === data.is_sent && true === data.can_edit ) ) { #>
			<button type="button" class="button invite-button group-add-remove-invite-button bp-tooltip bp-icons<# if ( data.selected ) { #> selected<# } #>" data-bp-tooltip="<# if ( data.selected ) { #><?php esc_attr_e(
       'Cancel invitation',
       'buddypress'
   ); ?><# } else { #><?php echo esc_attr_x(
    'Invite',
    'button',
    'buddypress'
); ?><# } #>">
		...
		<# if ( undefined !== data.can_edit && true === data.can_edit ) { #>
			<button type="button" class="button invite-button group-remove-invite-button bp-tooltip bp-icons" data-bp-tooltip="<?php echo esc_attr_x(
       'Cancel invitation',
       'button',
       'buddypress'
   ); ?>">
				<span class=" icons" aria-hidden="true"></span>
				<span class="bp-screen-reader-text"><?php echo esc_attr_x(
        'Cancel invitation',
        'button',
        'buddypress'
    ); ?></span>
...
<script type="text/html" id="tmpl-bp-invites-form">
	...
	<label for="send-invites-control"><?php esc_html_e(
	...
	<div class="action">
		<button type="button" id="bp-invites-reset" class="button bp-secondary-action"><?php echo esc_html_x(
      'Cancel',
      'button',
      'buddypress'
  ); ?></button>
		<button type="button" id="bp-invites-send" class="button bp-primary-action"><?php echo esc_html_x(
      'Send',
      'button',
      'buddypress'
  ); ?></button>
	...
	<div class="group-invites-search subnav-search clearfix" role="search" >
		<div class="bp-search">
			<form action="" method="get" id="group_invites_search_form" class="bp-invites-search-form" data-bp-search="{{data.scope}}">
				<label for="group_invites_search" class="bp-screen-reader-text"><?php bp_nouveau_search_default_text(
        _x('Search Members', 'heading', 'buddypress'),
        false
    ); ?></label>
				<input type="search" id="group_invites_search" placeholder="<?php echo esc_attr_x(
        'Search',
        ...
        'buddypress'
				...
				<button type="submit" id="group_invites_search_submit" class="nouveau-search-submit">
					...
					<span id="button-text" class="bp-screen-reader-text"><?php echo esc_html_x(
         'Search',
         'button',
         'buddypress'
     ); ?></span>
...
<script type="text/html" id="tmpl-bp-invites-paginate">
	<# if ( 1 !== data.page ) { #>
		<a href="#previous-page" id="bp-invites-prev-page" class="button invite-button bp-tooltip" data-bp-tooltip="<?php echo esc_attr_x(
      'Previous page',
      'link',
      'buddypress'
  ); ?>">
	...
	<# if ( data.total_page !== data.page ) { #>
		<a href="#next-page" id="bp-invites-next-page" class="button invite-button bp-tooltip" data-bp-tooltip="<?php echo esc_attr_x(
      'Next page',
      'link',
      'buddypress'
  ); ?>">
