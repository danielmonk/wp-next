...
<script type="text/html" id="tmpl-bp-messages-form">
	...
	<label for="send-to-input"><?php esc_html_e(
     'Send @Username',
     'buddypress'
 ); ?></label>
	...
	<div class="submit">
		<input type="button" id="bp-messages-send" class="button bp-primary-action" value="<?php echo esc_attr_x(
      'Send',
      'button',
      'buddypress'
  ); ?>"/>
		<input type="button" id="bp-messages-reset" class="text-button small bp-secondary-action" value="<?php echo esc_attr_x(
      'Reset',
      'form reset button',
      'buddypress'
  ); ?>"/>
...
<script type="text/html" id="tmpl-bp-messages-paginate">
	<# if ( 1 !== data.page ) { #>
		<button id="bp-messages-prev-page"class="button messages-button">
			...
			<span class="bp-screen-reader-text"><?php echo esc_html_x(
       'Previous page',
       'link',
       'buddypress'
   ); ?></span>
...
<script type="text/html" id="tmpl-bp-bulk-actions">
	...
	<label for="user_messages_select_all"><?php esc_html_e(
     'All Messages',
     'buddypress'
 ); ?></label>
	<div class="bulk-actions-wrap bp-hide">
		...
		<button class="messages-button bulk-apply bp-tooltip" type="submit" data-bp-tooltip="<?php echo esc_attr_x(
      'Apply',
      'button',
      'buddypress'
  ); ?>">
...
<script type="text/html" id="tmpl-bp-messages-thread">
	<div class="thread-cb">
		...
		<label for="bp-message-thread-{{data.id}}" class="bp-screen-reader-text"><?php esc_html_e(
      'Select message:',
      'buddypress'
  ); ?> {{data.subject}}</label>
	</div>
...
<script type="text/html" id="tmpl-bp-messages-preview">
	<# if ( undefined !== data.content ) { #>
		...
		<h2 class="message-title preview-thread-title"><?php esc_html_e(
      'Active conversation:',
      'buddypress'
  ); ?><span class="messages-title">{{{data.subject}}}</span></h2>
		<div class="preview-content">
			<header class="preview-pane-header">
				...
				<div class="actions">
					...
					<button type="button" class="message-action-delete bp-tooltip bp-icons" data-bp-action="delete" data-bp-tooltip="<?php esc_attr_e(
         'Delete conversation.',
         'buddypress'
     ); ?>">
						<span class="bp-screen-reader-text"><?php esc_html_e(
          ...
          'buddypress'
					...
					<# if ( undefined !== data.star_link ) { #>
						...
						<# if ( false !== data.is_starred ) { #>
							<a role="button" class="message-action-unstar bp-tooltip bp-icons" href="{{data.star_link}}" data-bp-action="unstar" aria-pressed="true" data-bp-tooltip="<?php esc_attr_e(
           'Unstar Conversation',
           'buddypress'
       ); ?>">
								<span class="bp-screen-reader-text"><?php esc_html_e(
            ...
            'buddypress'
						...
						<# } else { #>
							<a role="button" class="message-action-star bp-tooltip bp-icons" href="{{data.star_link}}" data-bp-action="star" aria-pressed="false" data-bp-tooltip="<?php esc_attr_e(
           'Star Conversation',
           'buddypress'
       ); ?>">
								<span class="bp-screen-reader-text"><?php esc_html_e(
            ...
            'buddypress'
					...
					<a href="../view/{{data.id}}/" class="message-action-view bp-tooltip bp-icons" data-bp-action="view" data-bp-tooltip="<?php esc_attr_e(
	...
	<div class="message-metadata">
		...
		<div class="actions">
			<# if ( undefined !== data.star_link ) { #>
				...
				<button type="button" class="message-action-unstar bp-tooltip bp-icons <# if ( false === data.is_starred ) { #>bp-hide<# } #>" data-bp-star-link="{{data.star_link}}" data-bp-action="unstar" data-bp-tooltip="<?php esc_attr_e(
        'Unstar Message',
        'buddypress'
    ); ?>">
					<span class="bp-screen-reader-text"><?php esc_html_e(
         ...
         'buddypress'
				...
				<button type="button" class="message-action-star bp-tooltip bp-icons <# if ( false !== data.is_starred ) { #>bp-hide<# } #>" data-bp-star-link="{{data.star_link}}" data-bp-action="star" data-bp-tooltip="<?php esc_attr_e(
        'Star Message',
        'buddypress'
    ); ?>">
					<span class="bp-screen-reader-text"><?php esc_html_e(
	...
	<form id="send-reply" class="standard-form send-reply">
		<div class="message-box">
			...
			<div class="message-content">
				...
				<label for="message_content" class="bp-screen-reader-text"><?php _e(
        'Reply to Message',
        'buddypress'
    ); ?></label>
				<div id="bp-message-content"></div>
				...
				<div class="submit">
					<input type="submit" name="send" value="<?php echo esc_attr_x(
         'Send Reply',
         'button',
         'buddypress'
