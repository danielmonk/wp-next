 ...
 * @return bool
 */
function bp_core_activate_site_options($keys = [])
{
...
function bp_core_get_root_options()
{
    ...
    if (false === $root_blog_options_meta) {
        $blog_options_keys =
            "'" . join("', '", (array) $root_blog_option_keys) . "'";
        $blog_options_table = bp_is_multiblog_mode()
            ? $wpdb->options
            : $wpdb->get_blog_prefix(bp_get_root_blog_id()) . 'options';
        ...
        if (is_multisite()) {
            ...
            $sitemeta_options_keys =
                "'" . join("', '", (array) $network_option_keys) . "'";
            $sitemeta_options_query = $wpdb->prepare(
                "SELECT meta_key AS name, meta_value AS value FROM {$wpdb->sitemeta} WHERE meta_key IN ( {$sitemeta_options_keys} ) AND site_id = %d",
                $current_site->id
            );
...
function bp_disable_profile_sync($default = false)
{
    ...
    return (bool) apply_filters(
        ...
        (bool) bp_get_option('bp-disable-profile-sync', $default)
    );
}
...
function bp_hide_loggedout_adminbar($default = true)
{
    ...
    return (bool) apply_filters(
        ...
        (bool) bp_get_option('hide-loggedout-adminbar', $default)
    );
}
...
function bp_disable_avatar_uploads($default = true)
{
    ...
    return (bool) apply_filters(
        ...
        (bool) bp_get_option('bp-disable-avatar-uploads', $default)
    );
}
...
function bp_disable_cover_image_uploads($default = false)
{
    ...
    return (bool) apply_filters(
        ...
        (bool) bp_get_option('bp-disable-cover-image-uploads', $default)
    );
}
...
function bp_disable_group_cover_image_uploads($default = false)
{
    ...
    return (bool) apply_filters(
        ...
        (bool) bp_get_option('bp-disable-group-cover-image-uploads', $default)
    );
}
...
function bp_disable_account_deletion($default = false)
{
    ...
    return apply_filters(
        ...
        (bool) bp_get_option('bp-disable-account-deletion', $default)
    );
}
...
function bp_restrict_group_creation($default = true)
{
    ...
    return (bool) apply_filters(
        ...
        (bool) bp_get_option('bp_restrict_group_creation', $default)
    );
}
...
function bp_force_buddybar($default = true)
{
    ...
    return (bool) apply_filters(
        'bp_force_buddybar',
        (bool) bp_get_option('_bp_force_buddybar', $default)
    );
}
...
function bp_is_akismet_active($default = true)
{
    ...
    return (bool) apply_filters(
        ...
        (bool) bp_get_option('_bp_enable_akismet', $default)
    );
}
...
function bp_get_theme_package_id($default = 'legacy')
{
    ...
    return apply_filters(
        ...
        bp_get_option('_bp_theme_package_id', $default)
    );
}
