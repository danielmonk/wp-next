 ...
 */
function bp_core_delete_notifications_by_type(
    $user_id,
    $component_name,
    $component_action
) {
    ...
    return bp_notifications_delete_notifications_by_type(
        $user_id,
        $component_name,
        $component_action
    );
 ...
 * @return false|int True on success, false on failure.
 */
function bp_core_delete_notifications_by_item_id(
    $user_id,
    $item_id,
    $component_name,
    $component_action,
 ...
 */
function bp_core_delete_all_notifications_by_type(
    $item_id,
    $component_name,
 ...
 * @return false|int True on success, false on failure.
 */
function bp_core_delete_notifications_from_user(
    $user_id,
    $component_name,
    $component_action
) {
    ...
    return bp_notifications_delete_notifications_from_user(
        $user_id,
        $component_name,
        $component_action
    );
...
function bp_core_check_notification_access($user_id, $notification_id)
{
    ...
    return bp_notifications_check_notification_access(
        $user_id,
        $notification_id
    );
}
