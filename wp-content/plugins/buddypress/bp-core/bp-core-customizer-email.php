...
function bp_email_init_customizer(WP_Customize_Manager $wp_customize)
{
    ...
    $wp_customize->add_panel('bp_mailtpl', [
        'description' => __(
    ...
    foreach ($controls as $control_id => $args) {
        $wp_customize->add_control(
            new $args['class']($wp_customize, $control_id, $args)
        );
    }
...
function bp_email_customizer_hide_sections($active, $section)
{
    ...
    return in_array(
        $section->id,
        array_keys(bp_email_get_customizer_sections()),
        true
    );
}
...
function bp_email_get_customizer_sections()
{
     ...
     */
    return apply_filters('bp_email_get_customizer_sections', [
        'section_bp_mailtpl_header' => [
            'capability' => 'bp_moderate',
            'panel' => 'bp_mailtpl',
            'title' => _x('Header', 'email', 'buddypress'),
        ],
        'section_bp_mailtpl_body' => [
            'capability' => 'bp_moderate',
            'panel' => 'bp_mailtpl',
            'title' => _x('Body', 'email', 'buddypress'),
        ],
        'section_bp_mailtpl_footer' => [
            'capability' => 'bp_moderate',
            'panel' => 'bp_mailtpl',
...
function bp_email_get_customizer_settings()
{
    ...
    return apply_filters('bp_email_get_customizer_settings', [
        ...
        'bp_email_options[header_text_size]' => [
            'capability' => 'bp_moderate',
        ...
        'bp_email_options[header_text_color]' => [
            'capability' => 'bp_moderate',
...
function bp_email_get_customizer_controls()
{
     ...
     */
    return apply_filters('bp_email_get_customizer_controls', [
        'bp_mailtpl_email_bg' => [
        ...
        'bp_mailtpl_highlight_color' => [
            'class' => 'WP_Customize_Color_Control',
            'description' => __(
                'Applied to links and other decorative areas.',
                'buddypress'
            ),
