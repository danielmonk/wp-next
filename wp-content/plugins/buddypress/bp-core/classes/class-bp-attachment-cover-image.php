...
class BP_Attachment_Cover_Image extends BP_Attachment
{
    ...
    public function __construct()
    {
        ...
        parent::__construct([
            ...
            'upload_error_strings' => [
                ...
                11 => sprintf(
                    _x(
                        'That image is too big. Please upload one smaller than %s',
                ...
                12 => sprintf(
                    ...
                    self::get_cover_image_types($allowed_types)
                ),
            ],
        ]);
    }
     ...
     */
    public static function get_cover_image_types($allowed_types = [])
    {
    ...
    public function validate_upload($file = [])
    {
        ...
        if (
            ...
            !bp_attachments_check_filetype(
                $file['tmp_name'],
                $file['name'],
                bp_attachments_get_allowed_mimes('cover_image')
            )
        ) {
            $file['error'] = 12;
        }
     ...
     * @return mixed
     */
    public function fit($file = '', $dimensions = [])
    {
        ...
        if (
            isset($cover_data['meta']['orientation']) &&
            isset($angles[$cover_data['meta']['orientation']])
        ) {
        ...
        if (empty($edit_args)) {
            ...
            $edit_args = array_merge($edit_args, [
                'file' => $file,
                'save' => false,
            ]);
        }
    ...
    public function script_data()
    {
        ...
        if (bp_is_user()) {
            ...
            $script_data['bp_params'] = [
                'object' => 'user',
                'item_id' => $item_id,
                'has_cover_image' => bp_attachments_get_user_has_cover_image(
                    $item_id
                ),
                'nonces' => [
            ...
            $script_data['feedback_messages'] = [
                1 => __(
                    'Your new cover image was uploaded successfully.',
                    'buddypress'
                ),
                2 => __(
                ...
                3 => __(
                    'Your cover image was deleted successfully!',
                    'buddypress'
                ),
            ];
        } elseif (bp_is_group()) {
            ...
            $script_data['bp_params'] = [
                'object' => 'group',
                'item_id' => bp_get_current_group_id(),
                'has_cover_image' => bp_attachments_get_group_has_cover_image(
                    $item_id
                ),
                'nonces' => [
                    'remove' => wp_create_nonce('bp_delete_cover_image'),
            ...
            $script_data['feedback_messages'] = [
                1 => __(
                    'The group cover image was uploaded successfully.',
                    'buddypress'
                ),
                2 => __(
                ...
                3 => __(
                    'The group cover image was deleted successfully!',
                    'buddypress'
                ),
            ];
        } else {
        ...
        $script_data['extra_js'] = ['bp-cover-image'];
