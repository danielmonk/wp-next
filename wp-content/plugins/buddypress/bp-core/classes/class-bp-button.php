...
class BP_Button
{
    ...
    public function __construct($args = '')
    {
        ...
        if (!empty($r['parent_element'])) {
            ...
            if (
                false === strpos($r['parent_attr']['class'], 'generic-button')
            ) {
        ...
        $this->contents = apply_filters(
            'bp_button_' . $this->component . '_' . $this->id,
            $this->contents,
            $this,
            $before,
            $after,
     ...
     * @return array
     */
    protected function backward_compatibility_args($r = [])
    {
