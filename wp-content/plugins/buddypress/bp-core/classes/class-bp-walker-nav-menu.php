...
class BP_Walker_Nav_Menu extends Walker_Nav_Menu
{
     ...
     * @var array
     */
    var $db_fields = ['id' => 'css_id', 'parent' => 'parent'];
     ...
     */
    public function do_walk($elements, $max_depth, $args = [])
    {
        $output = '';
    ...
    public function start_el(&$output, $item, $depth = 0, $args = [], $id = 0)
    {
        ...
        $item_output .=
            $args->link_before .
            apply_filters('the_title', $item->name, 0) .
            $args->link_after;
        $item_output .= '</a>';
