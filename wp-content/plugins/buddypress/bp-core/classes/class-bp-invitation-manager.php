...
abstract class BP_Invitation_Manager
{
     ...
     *         on failure.
     */
    public function add_invitation($args = [])
    {
        $r = bp_parse_args(
            $args,
            [
     ...
     *         on failure.
     */
    public function add_request($args = [])
    {
        $r = bp_parse_args(
            $args,
            [
         ...
         */
        $invite_args = array_merge($base_args, ['invite_sent' => 'sent']);
     ...
     */
    public function get_invitations($args = [])
    {
     ...
     */
    public function invitation_exists($args = [])
    {
        $is_invited = false;
     ...
     */
    public function request_exists($args = [])
    {
        $has_request = false;
     ...
     */
    public function accept_request($args = [])
    {
        /*
         * Some basic info is required to accept an invitation,
     ...
     * @return int|bool Number of rows updated on success, false on failure.
     */
    public function update_invitation($update_args = [], $where_args = [])
    {
