...
class BP_Core_Nav
{
     ...
     * @return BP_Core_Nav_Item
     */
    public function edit_nav($args = [], $slug = '', $parent_slug = '')
    {
        if (empty($slug)) {
            return false;
        }
        ...
        if (empty($parent_slug)) {
            $nav_items = $this->get_primary(['slug' => $slug], false);
            ...
            $this->nav[$this->object_id][$slug] = new BP_Core_Nav_Item(
                wp_parse_args($args, (array) $nav_item)
            );
    ...
    public function delete_nav($slug = '', $parent_slug = '')
    {
        ...
        if (!empty($parent_slug)) {
            ...
            return [$sub_item->screen_function];
            ...
            $screen_functions = [$nav_item->screen_function];
     ...
     */
    public function get_primary($args = [], $sort = true)
    {
        $params = wp_parse_args($args, ['primary' => true]);
     ...
     */
    public function get_secondary($args = [], $sort = true)
    {
        $params = wp_parse_args($args, ['parent_slug' => '']);
    ...
    {
        $primary_nav_items = $this->get_primary([
