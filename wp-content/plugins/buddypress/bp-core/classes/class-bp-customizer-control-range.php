...
class BP_Customizer_Control_Range extends WP_Customize_Control
{
    ...
    public function render_content()
    {
        ...
        ?><li id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr(
    $class
); ?>">
			<?php if ($this->label): ?>
         ...
         $this->label
			...
			<input type="range" id="<?php echo esc_attr("{$id}-range"); ?>" <?php
$this->link();
$this->input_attrs();
?> value="<?php echo esc_attr($this->value()); ?>" />
			<output for="<?php echo esc_attr("{$id}-range"); ?>"><?php echo esc_html(
    $this->value()
); ?></output>

			<?php if ($this->description): ?>
				<p><span class="description customize-control-description"><?php echo esc_html(
        $this->description
    ); ?></span></p>
			<?php endif; ?>
		</li><?php
