 ...
 */
function bp_get_template_part($slug, $name = null, $args = [])
{
    /**
 ...
 * @return false|string
 */
function bp_get_asset_template_part($slug, $name = null, $args = [])
{
...
function bp_locate_template(
    ...
    foreach ((array) $template_names as $template_name) {
        ...
        foreach ((array) $template_locations as $template_location) {
            ...
            if (
                file_exists(
                    trailingslashit($template_location) . $template_name
                )
            ) {
...
function bp_locate_template_asset($filename)
{
    ...
    $find = [get_theme_root(), bp_get_theme_compat_dir()];

    $replace = [get_theme_root_uri(), bp_get_theme_compat_url()];
 ...
 */
function bp_buffer_template_part($slug, $name = null, $echo = true, $args = [])
{
    ob_start();
 ...
 */
function bp_get_query_template($type, $templates = [])
{
 ...
 */
function bp_get_template_locations($templates = [])
{
    $locations = ['buddypress', 'community', ''];
 ...
 */
function bp_add_template_stack_locations($stacks = [])
{
    $retval = [];
    ...
    foreach ((array) $stacks as $stack) {
        foreach ((array) $locations as $custom_location) {
            $retval[] = untrailingslashit(
                trailingslashit($stack) . $custom_location
            );
        }
    }
...
function bp_parse_query($posts_query)
{
     ...
     */
    do_action_ref_array('bp_parse_query', [&$posts_query]);
}
...
{
    return isset(buddypress()->theme_compat->found_template) &&
        buddypress()->theme_compat->found_template;
}
...
{
    return bp_get_query_template('buddypress', [
