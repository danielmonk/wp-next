  ...
  var bpTypesCustomizeForm = function () {
    ...
    if (document.querySelector("#bp_type_has_directory")) {
      if (true === document.querySelector("#bp_type_has_directory").checked) {
        document
          .querySelector(".term-bp_type_directory_slug-wrap")
          .classList.add("bp-set-directory-slug");
      }
        ...
        .addEventListener("change", function (event) {
          if (true === event.target.checked) {
            document
              ...
              .classList.add("bp-set-directory-slug");
            document
              .querySelector("#bp_type_directory_slug")
              .removeAttribute("disabled");
          } else {
            document
              .querySelector(".term-bp_type_directory_slug-wrap")
              .classList.remove("bp-set-directory-slug");
            document
              .querySelector("#bp_type_directory_slug")
