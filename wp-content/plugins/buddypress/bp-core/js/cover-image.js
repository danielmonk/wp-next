...
(function (exports, $) {
  ...
  bp.CoverImage = {
    start: function () {
      ...
      if (
        true ===
        BP_Uploader.settings.defaults.multipart_params.bp_params.has_cover_image
      ) {
        this.deleteView();
      }
    },
    ...
    uploadResult: function (model) {
      ...
      if (!_.isUndefined(model.get("url"))) {
        ...
        if (0 === model.get("feedback_code")) {
          ...
          message =
            BP_Uploader.strings.feedback_messages[model.get("feedback_code")];
          type = "success";
        }
