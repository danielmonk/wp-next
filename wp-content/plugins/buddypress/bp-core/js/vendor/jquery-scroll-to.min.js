            ...
            if (null !== o) {
              ...
              e.each(i.axis.split(""), function (e, t) {
                var o = "x" === t ? "Left" : "Top",
                  ...
                  y = n.max(f, t);
                if (a)
                  (l[h] = a[r] + (d ? 0 : p - u.offset()[r])),
                    i.margin &&
                      ((l[h] -= parseInt(c.css("margin" + o)) || 0),
                      (l[h] -= parseInt(c.css("border" + o + "Width")) || 0)),
                    (l[h] += m[r] || 0),
                    i.over[r] &&
                      (l[h] += c["x" === t ? "width" : "height"]() * i.over[r]);
                else {
                  var b = c[r];
                  l[h] =
                    b.slice && "%" === b.slice(-1)
                ...
                i.limit &&
                  /^\d+$/.test(l[h]) &&
                  (l[h] = l[h] <= 0 ? 0 : Math.min(l[h], y)),
                  !e &&
                    i.queue &&
                    (p !== l[h] && s(i.onAfterFirst), delete l[h]);
              }),
                s(i.onAfter);
            }
          })
