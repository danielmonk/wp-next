...
WP_CLI::add_hook('before_wp_load', function () {
    ...
    if (class_exists('Scaffold_Command')) {
        ...
        WP_CLI::add_command(
            ...
            [
                'before_invoke' =>
                    __NAMESPACE__ . '\\Command\\Scaffold::check_dependencies',
            ]
        );
    }
    ...
    WP_CLI::add_command('bp', __NAMESPACE__ . '\\Command\\BuddyPress', [
        'before_invoke' =>
            __NAMESPACE__ . '\\Command\\BuddyPress::check_dependencies',
    ]);

    WP_CLI::add_command('bp signup', __NAMESPACE__ . '\\Command\\Signup', [
        'before_invoke' =>
            __NAMESPACE__ . '\\Command\\Signup::check_dependencies',
    ]);

    WP_CLI::add_command('bp tool', __NAMESPACE__ . '\\Command\\Tool', [
        'before_invoke' =>
            __NAMESPACE__ . '\\Command\\Tool::check_dependencies',
    ]);
    ...
    WP_CLI::add_command(
        ...
        [
            'before_invoke' =>
                __NAMESPACE__ . '\\Command\\Notification::check_dependencies',
        ]
    );

    WP_CLI::add_command('bp email', __NAMESPACE__ . '\\Command\\Email', [
        'before_invoke' =>
            __NAMESPACE__ . '\\Command\\Email::check_dependencies',
    ]);

    WP_CLI::add_command('bp member', __NAMESPACE__ . '\\Command\\Member', [
        'before_invoke' =>
            __NAMESPACE__ . '\\Command\\Member::check_dependencies',
    ]);

    WP_CLI::add_command('bp message', __NAMESPACE__ . '\\Command\\Messages', [
        'before_invoke' =>
            __NAMESPACE__ . '\\Command\\Messages::check_dependencies',
    ]);
    ...
    WP_CLI::add_command(
        ...
        [
            'before_invoke' =>
                __NAMESPACE__ . '\\Command\\Components::check_dependencies',
        ]
    );

    WP_CLI::add_command('bp friend', __NAMESPACE__ . '\\Command\\Friends', [
        'before_invoke' =>
            __NAMESPACE__ . '\\Command\\Friends::check_dependencies',
    ]);

    WP_CLI::add_command('bp activity', __NAMESPACE__ . '\\Command\\Activity', [
        'before_invoke' =>
            __NAMESPACE__ . '\\Command\\Activity::check_dependencies',
    ]);
    ...
    WP_CLI::add_command('bp group', __NAMESPACE__ . '\\Command\\Group', [
        'before_invoke' =>
            __NAMESPACE__ . '\\Command\\Group::check_dependencies',
    ]);
    ...
    WP_CLI::add_command('bp xprofile', __NAMESPACE__ . '\\Command\\XProfile', [
        'before_invoke' =>
            __NAMESPACE__ . '\\Command\\XProfile::check_dependencies',
    ]);
