 ...
 * @param int $group_id Group ID.
 */
function bp_groups_clear_group_administrator_cache_on_member_delete(
    $user_id,
    $group_id
) {
 ...
 */
function bp_groups_clear_user_group_cache_on_invitation_save(
    BP_Invitation $invitation
) {
 ...
 * @return bool True on success, false on failure.
 */
function bp_groups_reset_cache_incrementor_on_group_term_change(
    $object_id,
    $terms,
    $tt_ids,
    $taxonomy
 ...
 * @return bool True on success, false on failure.
 */
function bp_groups_reset_cache_incrementor_on_group_term_remove(
    $object_id,
    $terms,
    $taxonomy
) {
