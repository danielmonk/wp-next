...
class BP_Groups_Invitation_Manager extends BP_Invitation_Manager
{
    ...
    {
        if (!$type || !in_array($type, ['request', 'invite'], true)) {
            return false;
        }
    ...
    public function allow_invitation($args)
    {
        ...
        if (
            !bp_user_can($args['inviter_id'], 'groups_send_invitation', [
        ...
        if (
            !bp_user_can($args['user_id'], 'groups_receive_invitation', [
                'group_id' => $args['item_id'],
            ])
        ) {
            return false;
    ...
    public function allow_request($args)
    {
        ...
        if (
            !bp_user_can($args['user_id'], 'groups_request_membership', [
                'group_id' => $args['item_id'],
            ])
        ) {
            return false;
