...
class BP_Groups_Theme_Compat
{
    ...
    {
        add_action('bp_setup_theme_compat', [$this, 'is_group']);
    }
    ...
    public function is_group()
    {
        ...
        if (bp_is_groups_directory()) {
            ...
            add_filter('bp_replace_the_content', [$this, 'create_content']);
            ...
            add_filter('bp_replace_the_content', [$this, 'single_content']);
        }
    }
    ...
    public function directory_template_hierarchy($templates)
    {
        ...
        if ('' !== bp_get_current_group_directory_type()) {
            $new_templates[] =
                'groups/index-directory-type-' .
                sanitize_file_name(bp_get_current_group_directory_type()) .
                '.php';
        }
    ...
    public function create_template_hierarchy($templates)
    {
         ...
         * @param array $value Array of default template files to use.
         */
        $new_templates = apply_filters('bp_template_hierarchy_groups_create', [
    ...
    public function single_template_hierarchy($templates)
    {
        ...
        $new_templates = apply_filters(
            ...
            [
                'groups/single/index-id-' .
                (int) bp_get_current_group_id() .
                '.php',
                'groups/single/index-slug-' .
                sanitize_file_name(bp_get_current_group_slug()) .
                '.php',
                'groups/single/index-action-' .
                sanitize_file_name(bp_current_action()) .
                '.php',
                'groups/single/index-status-' .
