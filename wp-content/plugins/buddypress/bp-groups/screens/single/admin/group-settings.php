...
function groups_screen_group_admin_settings()
{
    ...
    if (isset($_POST['save'])) {
        ...
        $invite_status =
            isset($_POST['group-invite-status']) &&
            in_array(
        ...
        $current_types = array_intersect(
            bp_groups_get_group_types(['show_in_create_screen' => false]),
            (array) $current_types
        );
        ...
        if (
            ...
            bp_core_add_message(
                __('Group settings were successfully updated.', 'buddypress')
            );
        }
