...
class BP_Notifications_Component extends BP_Component
{
    ...
    {
        $includes = ['adminbar', 'template', 'filters', 'functions', 'cache'];
    ...
    public function setup_admin_bar($wp_admin_nav = [])
    {
        ...
        if (is_user_logged_in()) {
            ...
            $notifications_link = trailingslashit(
            ...
            if (!empty($count)) {
                $title = sprintf(
                    ...
                    _x(
                        'Notifications %s',
                        'My Account Notification pending',
                        'buddypress'
                    ),
                    '<span class="count">' .
                ...
                $unread = _x(
                    'Unread',
                    'My Account Notification sub nav',
                    'buddypress'
                );
            }
    ...
    {
        // Global groups.
        wp_cache_add_global_groups(['bp_notifications', 'notification_meta']);
    ...
    {
        parent::rest_api_init(['BP_REST_Notifications_Endpoint']);
    }
}
