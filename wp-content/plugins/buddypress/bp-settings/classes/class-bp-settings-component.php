...
class BP_Settings_Component extends BP_Component
{
    ...
    {
        parent::includes(['template', 'filters', 'functions']);
    }
    ...
    public function late_includes()
    {
        ...
        $actions = ['notifications', 'capabilities', 'data', 'delete-account'];
        ...
        if (is_user_logged_in()) {
            if (!bp_current_action() || bp_is_current_action('general')) {
                ...
                bp_is_post_request() &&
                in_array(bp_current_action(), $actions, true)
            ) {
                require $this->path .
                    'bp-settings/actions/' .
                    bp_current_action() .
    ...
    public function setup_nav($main_nav = [], $sub_nav = [])
    {
        ...
        if (
            (!bp_disable_account_deletion() && bp_is_my_profile()) ||
            bp_current_user_can('delete_users')
        ) {
            $sub_nav[] = [
