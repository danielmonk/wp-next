...
function bp_settings_action_data()
{
    if (
        ...
        empty($_POST['bp-data-export-nonce'])
    ) {
        return;
    }
    ...
    if (
        !empty($_POST['bp-data-export-delete-request-nonce']) &&
        wp_verify_nonce(
            $_POST['bp-data-export-delete-request-nonce'],
    ...
    $request_id = wp_create_user_request(
        buddypress()->displayed_user->userdata->user_email,
