parcelRequire = (function (e, r, t, n) {
...
})(
  {
        ...
        var i = wp,
          ...
          E = function (t) {
            var i = t.attributes,
              ...
              k = i.caption,
              S = h.embedScriptURL,
              x = l("BuddyPress Activity URL", "buddypress"),
              P = s(E),
              L = (0, e.default)(P, 2),
              N = L[0],
              R = L[1],
            ...
            return U
              ? n(
                  ...
                  n(
                    ...
                    {
                      onSubmit: function (e) {
                        e && e.preventDefault(), A(!1), r({ url: N });
                      },
                    },
                    n("input", {
                      type: "url",
                      ...
                      "aria-label": x,
                      placeholder: l("Enter URL to embed here…", "buddypress"),
                      onChange: function (e) {
                  ...
                  n(
                    ...
                    n(
                      ...
                      l("Learn more about activity embeds", "buddypress")
                    )
                  )
                )
              : g
              ? n(
                  ...
                  n(m, null),
                  n("p", null, l("Embedding…", "buddypress"))
                )
              : f && f.x_buddypress && "activity" === f.x_buddypress
              ? n(
                  o,
                  null,
                  !U && C,
                  n(
                    ...
                    n(
                      ...
                      n(
                        u,
                        null,
                        n(c, { html: f && f.html ? f.html : "", scripts: [S] })
                      )
                    ),
                    (!_.isEmpty(k) || a) &&
                      n(_, {
                        tagName: "figcaption",
                        placeholder: l("Write caption…", "buddypress"),
                        value: k,
                        onChange: function (e) {
                          return r({ caption: e });
                        },
              ...
              : n(
                  ...
                  n(
                    d,
                    { icon: "buddicons-activity", label: x },
                    n(
                      "p",
          ...
          k = h([
            f(function (e, t) {
              var i = t.attributes.url,
                r = e("core/editor").getEditorSettings(),
                n = e("core"),
                o = n.getEmbedPreview,
                s = n.isRequestingEmbedPreview,
                l = !!i && o(i),
                a = !!i && s(i);
              return {
                bpSettings: r.bp.activity || {},
                preview: l,
                fetching: a,
              };
            }),
    ...
    zmBI: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, "__esModule", { value: !0 }),
          (exports.default = void 0);
        var e = wp,
          t = e.blockEditor.RichText,
          a = e.element.createElement,
          r = function (e) {
            var r = e.attributes,
              i = r.url,
              c = r.caption;
            return i
              ? a(
                  ...
                  !t.isEmpty(c) &&
                    a(t.Content, { tagName: "figcaption", value: c })
                )
              : null;
          },
          i = r;
    ...
    hBDw: [
      function (require, module, exports) {
        "use strict";
        var t = i(require("./embed-activity/edit")),
          e = i(require("./embed-activity/save"));
        function i(t) {
          return t && t.__esModule ? t : { default: t };
        }
        var s = wp,
          r = s.i18n.__,
          d = s.blocks.registerBlockType;
        d("bp/embed-activity", {
          title: r("Embed an activity", "buddypress"),
          description: r(
            "Add a block that displays the activity content pulled from this or other community sites.",
            "buddypress"
          ),
          icon: "buddicons-activity",
          category: "buddypress",
      ...
      { "./embed-activity/edit": "Sjre", "./embed-activity/save": "zmBI" },
    ],
  },
  {},
  ["hBDw"],
