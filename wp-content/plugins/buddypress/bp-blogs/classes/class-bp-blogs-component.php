...
class BP_Blogs_Component extends BP_Component
{
    ...
    public function setup_globals($args = [])
    {
        ...
        $global_tables = [
            ...
            'table_name_blogmeta' =>
                $bp->table_prefix . 'bp_user_blogs_blogmeta',
        ];
        ...
        if (
             ...
             */
            $post_types = apply_filters('bp_blogs_record_post_post_types', [
                'post',
            ]);
    ...
    {
        // Files to include.
        $includes = ['cache', 'template', 'filters', 'functions'];
    ...
    public function setup_admin_bar($wp_admin_nav = [])
    {
        ...
        if (is_user_logged_in()) {
            ...
            $blogs_link = trailingslashit(
                bp_loggedin_user_domain() . bp_get_blogs_slug()
            );
    ...
    {
        // Global groups.
        wp_cache_add_global_groups(['bp_blog_meta']);
    ...
    {
        if (is_multisite()) {
            $controllers = ['BP_REST_Blogs_Endpoint'];
