...
class BP_Members_Theme_Compat
{
    ...
    {
        add_action('bp_setup_theme_compat', [$this, 'is_members']);
    }
    ...
    public function directory_template_hierarchy($templates = [])
    {
        ...
        if ('' !== bp_get_current_member_type()) {
            $new_templates[] =
                'members/index-directory-type-' .
                sanitize_file_name(bp_get_current_member_type()) .
                '.php';
        }
    ...
    public function single_template_hierarchy($templates)
    {
        ...
        $new_templates = apply_filters(
            ...
            [
                'members/single/index-id-' .
                (int) bp_displayed_user_id() .
                '.php',
                'members/single/index-nicename-' .
                sanitize_file_name($user_nicename) .
                '.php',
                'members/single/index-action-' .
                sanitize_file_name(bp_current_action()) .
                '.php',
                'members/single/index-component-' .
                sanitize_file_name(bp_current_component()) .
                '.php',
