...
class BP_Registration_Theme_Compat
{
    ...
    {
        add_action('bp_setup_theme_compat', [$this, 'is_registration']);
    }
    ...
    public function is_registration()
    {
        ...
        // Setup actions.
        add_filter('bp_get_buddypress_template', [$this, 'template_hierarchy']);
        add_action('bp_template_include_reset_dummy_post_data', [
            $this,
            'dummy_post',
        ]);
        add_filter('bp_replace_the_content', [$this, 'dummy_content']);
    }
    ...
    public function template_hierarchy($templates)
    {
         ...
         */
        $new_templates = apply_filters("bp_template_hierarchy_{$component}", [
