...
class BP_Members_MS_List_Table extends WP_MS_Users_List_Table
{
    ...
    public function prepare_items()
    {
        ...
        $signups_per_page = $this->get_items_per_page(
    ...
    public function get_columns()
    {
         ...
         */
        return apply_filters('bp_members_ms_signup_columns', [
    ...
    {
        ?>
		<label class="screen-reader-text" for="signup_<?php echo intval(
      $signup_object->id
  ); ?>"><?php printf(
    ...
    $signup_object->user_login
		...
		<input type="checkbox" id="signup_<?php echo intval(
      $signup_object->id
  ); ?>" name="allsignups[]" value="<?php echo esc_attr($signup_object->id); ?>" />
		<?php
    }
    ...
    public function column_username($signup_object = null)
    {
        ...
        echo $avatar .
            sprintf(
                '<strong><a href="%1$s" class="edit">%2$s</a></strong><br/>',
    ...
    public function column_email($signup_object = null)
    {
        printf(
            ...
            esc_attr($signup_object->user_email),
            esc_html($signup_object->user_email)
        );
    }
