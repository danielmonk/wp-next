...
class BP_XProfile_Field_Type_Checkbox extends BP_XProfile_Field_Type
{
   ...
   do_action(bp_get_the_profile_field_errors_action()); ?>
    ...
    public function edit_field_options_html(array $args = [])
    {
        ...
        $option_values = maybe_unserialize(
        ...
        $option_values = $option_values ? (array) $option_values : [];
        ...
        if (
            ...
            $option_values !=
                maybe_serialize($_POST['field_' . $this->field_obj->id])
        ) {
        ...
        for ($k = 0, $count = count($options); $k < $count; ++$k) {
            ...
            for (
                $j = 0, $count_values = count($option_values);
                $j < $count_values;
                ++$j
            ) {
                ...
                if (
                    $option_values[$j] === $allowed_options ||
