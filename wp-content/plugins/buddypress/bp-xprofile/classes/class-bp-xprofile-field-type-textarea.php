...
class BP_XProfile_Field_Type_Textarea extends BP_XProfile_Field_Type
{
  ...
  if (!$richtext_enabled) {
      $r = wp_parse_args($raw_properties, [
          'cols' => 40,
          'rows' => 5,
      ]); ?>

			<textarea <?php echo $this->get_edit_field_html_elements(
       $r
   ); ?> aria-labelledby="<?php bp_the_profile_field_input_name(); ?>-1" aria-describedby="<?php bp_the_profile_field_input_name(); ?>-3"><?php bp_the_profile_field_edit_value(); ?></textarea>
