...
class BP_REST_XProfile_Field_Groups_Endpoint extends WP_REST_Controller
{
    ...
    public function create_item_permissions_check($request)
    {
        $retval = new WP_Error(
            ...
            __(
                'Sorry, you are not allowed to view this XProfile field group.',
                'buddypress'
            ),
            [
    ...
    public function prepare_item_for_response($group, $request)
    {
        ...
        if ($request['fetch_fields']) {
            ...
            foreach ($group->fields as $field) {
                $data[
                    'fields'
                ][] = $this->fields_endpoint->assemble_response_data(
                    $field,
                    $request
                );
            }
        ...
        $schema = [
            ...
            'properties' => [
                ...
                'name' => [
                    'context' => ['view', 'edit'],
                    'description' => __(
                        'The name of group of profile fields.',
                        'buddypress'
                    ),
                    'type' => 'string',
                    'arg_options' => [
                ...
                'description' => [
                    'context' => ['view', 'edit'],
                    'description' => __(
                        'The description of the group of profile fields.',
                        'buddypress'
                    ),
                    'type' => 'object',
                    'arg_options' => [
                ...
                'fields' => [
                    'context' => ['view', 'edit'],
                    'description' => __(
                        'The fields associated with this group of profile fields.',
                        'buddypress'
                    ),
                    'type' => 'array',
                    'readonly' => true,
    ...
    public function get_collection_params()
    {
        ...
        $params['profile_group_id'] = [
            'description' => __(
                'ID of the field group that have fields.',
                'buddypress'
            ),
            'default' => 0,
            'type' => 'integer',
        ...
        $params['fetch_fields'] = [
            'description' => __(
                'Whether to fetch the fields for each group.',
                'buddypress'
            ),
            'default' => false,
            'type' => 'boolean',
