...
class BP_XProfile_Component extends BP_Component
{
    ...
    public function setup_globals($args = [])
    {
        ...
        if (!defined('BP_XPROFILE_BASE_GROUP_NAME')) {
            define(
                ...
                stripslashes(bp_core_get_root_option('avatar_default'))
            );
        }
        ...
        if (!defined('BP_XPROFILE_FULLNAME_FIELD_NAME')) {
            define(
                ...
                stripslashes(
                    bp_core_get_root_option('bp-xprofile-fullname-field-name')
                )
            );
        }
         ...
         */
        $this->field_types = apply_filters(
        ...
        if (bp_is_active('friends')) {
            $this->visibility_levels['friends'] = [
                'id' => 'friends',
                'label' => _x(
                    'My Friends',
                    'Visibility level setting',
    ...
    public function setup_nav($main_nav = [], $sub_nav = [])
    {
        ...
        add_action('bp_settings_setup_nav', [$this, 'setup_settings_nav']);
    ...
    {
        add_filter(
            'bp_settings_admin_nav',
            [$this, 'setup_settings_admin_nav'],
            2
        );
    }
        ...
        if (bp_is_profile_component()) {
            ...
            if (bp_is_my_profile()) {
                ...
                $bp->bp_options_avatar = bp_core_fetch_avatar([
                    ...
                    'alt' => sprintf(
                        _x('Profile picture of %s', 'Avatar alt', 'buddypress'),
