...
function friends_clear_friend_object_cache($friendship_id)
{
    ...
    wp_cache_delete(
        'friends_friend_ids_' . $friendship->initiator_user_id,
        'bp'
    );
 ...
 * @return bool
 */
function bp_friends_clear_bp_friends_friendships_cache(
    $friendship_id,
    $initiator_user_id,
    $friend_user_id
) {
 ...
 */
function bp_friends_clear_bp_friends_friendships_cache_remove(
    $friendship_id,
    BP_Friends_Friendship $friendship
) {
    // Clear friendship ID cache for each user.
    wp_cache_delete(
 ...
 * @param int $friend_user_id    The user ID not initiating the friendship.
 */
function bp_friends_clear_request_cache_on_save(
    $friendship_id,
    $initiator_user_id,
    $friend_user_id
) {
 ...
 * @param BP_Friends_Friendship $friendship Friendship object.
 */
function bp_friends_clear_request_cache_on_remove(
    $friendship_id,
    BP_Friends_Friendship $friendship
) {
