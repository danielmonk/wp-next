...
function bp_core_ajax_widget_friends()
{
      ...
      bp_the_member(); ?>
			<li class="vcard">
				...
				<div class="item">
					...
					<?php if ('active' == $type): ?>
						<div class="item-meta"><span class="activity" data-livestamp="<?php bp_core_iso8601_date(
          bp_get_member_last_active(['relative' => false])
      ); ?>"><?php bp_member_last_active(); ?></span></div>
					<?php elseif ('newest' == $type): ?>
						<div class="item-meta"><span class="activity" data-livestamp="<?php bp_core_iso8601_date(
          bp_get_member_registered(['relative' => false])
      ); ?>"><?php bp_member_registered(); ?></span></div>
  ...
  endwhile; ?>
	...
	<?php else: ?>
		<?php echo "-1[[SPLIT]]<li>"; ?>
		<?php _e(
      'There were no members found, please try another filter.',
      'buddypress'
  ); ?>
		<?php echo "</li>"; ?>
	<?php endif;
