 ...
 */
function bp_friends_filter_user_query_populate_extras(
...
function bp_friends_register_personal_data_exporters($exporters)
{
    $exporters['buddypress-friends'] = [
        ...
        'exporter_bp_friendly_name' => _x(
            'Friends',
            'BuddyPress Friends data exporter friendly name',
            'buddypress'
        ),
    ];

    $exporters['buddypress-friends-pending-sent-requests'] = [
        ...
        'exporter_bp_friendly_name' => _x(
            ...
            'BuddyPress Friend Requests data exporter friendly name',
            'buddypress'
        ),
    ];

    $exporters['buddypress-friends-pending-received-requests'] = [
        'exporter_friendly_name' => __(
