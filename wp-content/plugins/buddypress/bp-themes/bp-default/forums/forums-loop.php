...
<?php if (bp_has_forum_topics(bp_ajax_querystring('forums'))): ?>
	...
	<table class="forum">
       ...
       bp_the_forum_topic(); ?>
			...
			<tr class="<?php bp_the_topic_css_class(); ?>">
				<td class="td-title">
					<a class="topic-title" href="<?php bp_the_topic_permalink(); ?>" title="<?php esc_attr_e(
    ...
    'buddypress'
					...
					<p class="topic-meta">
						<span class="topic-by"><?php /* translators: "started by [poster] in [forum]" */ printf(
          __('Started by %1$s', 'buddypress'),
          bp_get_the_topic_poster_avatar('height=20&width=20') .
        ...
        $topic_in =
            ...
            '">' .
            bp_get_the_topic_object_avatar('type=thumb&width=20&height=20') .
            '</a>' .
            '<a href="' .
            bp_get_the_topic_object_permalink() .
            '" title="' .
				...
				<td class="td-freshness">
					...
					<p class="topic-meta">
						<span class="freshness-author">
							<a href="<?php bp_the_topic_permalink(); ?>"><?php bp_the_topic_last_poster_avatar(
    'type=thumb&width=20&height=20'
); ?></a>
