      ...
      bp_message_thread(); ?>
			<tr id="notice-<?php bp_message_notice_id(); ?>" class="<?php bp_message_css_class(); ?>">
				...
				<td width="21%">
					...
					<span class="activity"><?php _e(
         'Sent:',
         'buddypress'
     ); ?> <?php bp_message_notice_post_date(); ?></span>
				</td>
				...
				<td width="10%">
					...
					<a class="button" href="<?php bp_message_notice_delete_link(); ?>" class="confirm" title="<?php esc_attr_e(
    "Delete Message",
    "buddypress"
); ?>">x</a>
				</td>
