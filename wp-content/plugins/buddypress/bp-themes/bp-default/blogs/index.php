...
get_header('buddypress'); ?>
   ...
   ): ?> &nbsp;<a class="button" href="<?php echo bp_get_root_domain() .
     '/' .
     bp_get_blogs_root_slug() .
     '/create/'; ?>"><?php _e('Create a Site', 'buddypress'); ?></a><?php endif;
   ?></h3>
			...
			<div class="item-list-tabs" role="navigation">
				<ul>
					<li class="selected" id="blogs-all"><a href="<?php bp_root_domain(); ?>/<?php bp_blogs_root_slug(); ?>"><?php printf(
    __('All Sites <span>%s</span>', 'buddypress'),
    bp_get_total_blog_count()
         ...
         bp_get_total_blog_count_for_user(bp_loggedin_user_id())
						...
						<li id="blogs-personal"><a href="<?php echo bp_loggedin_user_domain() .
          bp_get_blogs_slug(); ?>"><?php printf(
    __('My Sites <span>%s</span>', 'buddypress'),
    bp_get_total_blog_count_for_user(bp_loggedin_user_id())
); ?></a></li>
			...
			<div id="blogs-dir-list" class="blogs dir-list">
				...
				<?php locate_template(['blogs/blogs-loop.php'], true); ?>
