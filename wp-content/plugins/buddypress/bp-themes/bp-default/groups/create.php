...
get_header('buddypress'); ?>
	...
	<div id="content">
       ...
       'Create a Group',
       'buddypress'
   ); ?> &nbsp;<a class="button" href="<?php echo trailingslashit(
     bp_get_root_domain() . '/' . bp_get_groups_root_slug()
 ); ?>"><?php _e('Groups Directory', 'buddypress'); ?></a></h3>
...
?>
				<?php if (bp_is_group_creation_step('group-settings')): ?>
					...
					<div class="radio">
						<label><input type="radio" name="group-status" value="public"<?php if (
          ...
          !bp_get_new_group_status()
            ...
            'buddypress'
						...
						<label><input type="radio" name="group-status" value="private"<?php if (
          'private' == bp_get_new_group_status()
            ...
            'buddypress'
						...
						<label><input type="radio" name="group-status" value="hidden"<?php if (
           ...
           'admins'
					...
					<?php if (bp_is_active('forums')): ?>
						...
						<?php if (bp_forums_is_installed_correctly()): ?>
							...
							<div class="checkbox">
								<label><input type="checkbox" name="group-show-forum" id="group-show-forum" value="1"<?php checked(
            ...
            true
						...
						<?php elseif (is_super_admin()): ?>
							...
							<p><?php printf(
           __(
               '<strong>Attention Site Admin:</strong> Group forums require the <a href="%s">correct setup and configuration</a> of a bbPress installation.',
               'buddypress'
           ),
           bp_core_do_network_admin()
               ? network_admin_url('settings.php?page=bb-forums-setup')
               : admin_url('admin.php?page=bb-forums-setup')
       ); ?></p>
...
?>
           ...
           'buddypress'
            ...
            'buddypress'
							...
							<p><?php _e(
           'To skip the avatar upload process, hit the "Next Step" button.',
           'buddypress'
       ); ?></p>
						</div><!-- .main-column -->
