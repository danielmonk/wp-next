...
if (bp_is_group_forum_topic_edit()):
    locate_template(['groups/single/forum/edit.php'], true);
elseif (bp_is_group_forum_topic()):
    locate_template(['groups/single/forum/topic.php'], true);
else:
     ?>
	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul>
			...
			<?php if (is_user_logged_in()): ?>
				...
				<li>
					<a href="#post-new" class="show-hide-new"><?php _e(
         'New Topic',
         'buddypress'
     ); ?></a>
				</li>
			...
			<?php if (bp_forums_has_directory()): ?>
				...
				<li>
					<a href="<?php bp_forums_directory_permalink(); ?>"><?php _e(
    'Forum Directory',
    'buddypress'
); ?></a>
				</li>
...
<?php if (!bp_is_group_forum_topic_edit() && !bp_is_group_forum_topic()): ?>
	...
	<?php if (
     ...
     ((is_user_logged_in() && 'public' == bp_get_group_status()) ||
         bp_group_is_member())
 ): ?>
		...
		<form action="" method="post" id="forum-topic-form" class="standard-form">
			<div id="new-topic-post">
				...
				<?php if (bp_groups_auto_join() && !bp_group_is_member()): ?>
					<p><?php _e(
         'You will auto join this group when you start a new topic.',
         'buddypress'
     ); ?></p>
				<?php endif; ?>
