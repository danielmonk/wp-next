	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul>
			<?php if (is_user_logged_in()): ?>
				...
				<li>
					<a href="<?php bp_forum_topic_new_reply_link(); ?>" class="new-reply-link"><?php _e(
    'New Reply',
    'buddypress'
); ?></a>
				</li>
	...
	<?php if (bp_has_forum_topic_posts()): ?>
       ...
       bp_the_forum_topic_post(); ?>
          ...
          bp_get_the_topic_post_is_mine()
						...
						<a href="#post-<?php bp_the_topic_post_id(); ?>" title="<?php esc_attr_e(
     ...
     bp_group_is_member()
		...
		<?php if (bp_get_the_topic_is_last_page()): ?>
          ...
          'buddypress'
					...
					<div class="submit">
						<input type="submit" name="submit_reply" id="submit" value="<?php esc_attr_e(
          'Post Reply',
          'buddypress'
      ); ?>" />
					</div>
