 ...
 * @return array|string
 */
function bp_messages_enforce_current_user($args = [])
{
...
function bp_messages_filter_kses($content)
{
     ...
     */
    $messages_allowedtags = apply_filters(
        'bp_messages_allowed_tags',
        $messages_allowedtags
    );
...
function bp_messages_register_personal_data_exporter($exporters)
{
    $exporters['buddypress-messages'] = [
        ...
        'exporter_bp_friendly_name' => _x(
            'Private Messages',
            'BuddyPress Messages data exporter friendly name',
            'buddypress'
        ),
    ];
