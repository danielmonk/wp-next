...
function messages_add_autocomplete_js()
{
    ...
    if (bp_is_messages_component() && bp_is_current_action('compose')) {
        ...
        wp_enqueue_script(
            'bp-jquery-autocomplete',
            "{$url}autocomplete/jquery.autocomplete{$min}.js",
            ['jquery'],
            bp_get_version()
        );
        wp_enqueue_script(
            'bp-jquery-autocomplete-fb',
            "{$url}autocomplete/jquery.autocompletefb{$min}.js",
            ['jquery'],
            bp_get_version()
        );
        wp_enqueue_script(
            'bp-jquery-bgiframe',
            "{$url}autocomplete/jquery.bgiframe{$min}.js",
            ['jquery'],
            bp_get_version()
        );
        wp_enqueue_script(
            'bp-jquery-dimensions',
            "{$url}autocomplete/jquery.dimensions{$min}.js",
            ['jquery'],
            bp_get_version()
        );
    }
...
function messages_add_autocomplete_css()
{
    if (bp_is_messages_component() && bp_is_current_action('compose')) {
        ...
        wp_enqueue_style(
            'bp-messages-autocomplete',
            "{$url}autocomplete/jquery.autocompletefb{$min}.css",
            [],
            bp_get_version()
        );
