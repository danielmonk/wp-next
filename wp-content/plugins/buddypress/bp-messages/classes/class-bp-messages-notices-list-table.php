...
class BP_Messages_Notices_List_Table extends WP_List_Table
{
    ...
    {
        return apply_filters('bp_notices_list_table_get_columns', [
            'subject' => _x(
                'Subject',
                'Admin Notices column header',
                'buddypress'
            ),
            'message' => _x(
                'Content',
    ...
    public function column_subject($item)
    {
        ...
        echo '<strong>' .
            apply_filters('bp_get_message_notice_subject', $item->subject) .
            '</strong> ' .
    ...
    public function column_date_sent($item)
    {
        echo apply_filters(
            ...
            bp_format_time(strtotime($item->date_sent))
        );
    }
}
