...
class BP_Messages_Component extends BP_Component
{
    ...
    public function late_includes()
    {
        ...
        if (bp_is_messages_component()) {
            ...
            if (
                ...
                in_array(
                    bp_action_variable(0),
                    ['delete', 'read', 'unread', 'bulk-manage', 'bulk-delete'],
                    true
                )
            ) {
                require $this->path .
            ...
            if (is_user_logged_in() && bp_is_active($this->id, 'star')) {
                // Single action.
                if (in_array(bp_current_action(), ['star', 'unstar'], true)) {
                ...
                if (bp_is_action_variable('bulk-manage')) {
                    require $this->path .
                        'bp-messages/actions/bulk-manage-star.php';
                }
            }
            ...
            if (bp_is_user()) {
                ...
                // Nav item - Starred.
                if (
                    bp_is_active($this->id, 'star') &&
                    bp_is_current_action(bp_get_messages_starred_slug())
                ) {
    ...
    public function setup_globals($args = [])
    {
        ...
        $global_tables = [
            ...
            'table_name_recipients' =>
                $bp->table_prefix . 'bp_messages_recipients',
            ...
            if (bp_is_active($this->id, 'star')) {
                $wp_admin_nav[] = [
                    ...
                    'href' => trailingslashit(
                        $messages_link . bp_get_messages_starred_slug()
                    ),
                    'position' => 11,
                ];
            }
    ...
    {
        parent::rest_api_init(['BP_REST_Messages_Endpoint']);
    }
}
