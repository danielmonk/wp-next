...
function monsterinsights_performance_frontend_tracking_options_analytics_create(
    $create
) {
...
add_filter(
    ...
    'monsterinsights_performance_frontend_tracking_options_analytics_create',
    10,
    1
);
add_filter(
