...
class MonsterInsights_Performance
{
    ...
    public function requires_monsterinsights()
    {
		...
		<div class="error">
			<p><?php esc_html_e(
       'Please install MonsterInsights Pro to use the MonsterInsights Performance addon',
       'monsterinsights-performance'
   ); ?></p>
		</div>
		<?php
    ...
    public function requires_monsterinsights_version()
    {
		...
		<div class="error">
			<p><?php esc_html_e(
       'Please install or update MonsterInsights Pro with version 7.4 or newer to use the MonsterInsights Performance addon',
       'monsterinsights-performance'
   ); ?></p>
		</div>
		<?php
    ...
    public static function get_instance()
    {
        if (
            !isset(self::$instance) &&
            !(self::$instance instanceof MonsterInsights_Performance)
        ) {
