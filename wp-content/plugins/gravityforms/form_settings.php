...
class GFFormSettings
{
    ...
    public static function form_settings_ui()
    {
        ...
        if (rgpost('gform_meta')) {
            ...
            check_admin_referer(
                "gform_save_form_settings_{$form_id}",
                'gform_save_form_settings'
            );
            ...
            $updated_form['descriptionPlacement'] = rgpost(
                'form_description_placement'
            );
            $updated_form['subLabelPlacement'] = rgpost(
            ...
            $updated_form['button']['text'] =
                rgpost('form_button') == 'text'
                    ? rgpost('form_button_text_input')
                    : '';
            $updated_form['button']['imageUrl'] =
                rgpost('form_button') == 'image'
                    ? rgpost('form_button_image_url')
                    : '';

            // Save and Continue settings
            $updated_form['save']['enabled'] = rgpost('form_save_enabled');
            $updated_form['save']['button']['type'] = 'link';
            $updated_form['save']['button']['text'] = rgpost(
                'form_save_button_text'
            );

            // limit entries settings
            $updated_form['limitEntries'] = rgpost('form_limit_entries');
            $updated_form['limitEntriesCount'] = $updated_form['limitEntries']
                ? rgpost('form_limit_entries_count')
                : '';
            $updated_form['limitEntriesPeriod'] = $updated_form['limitEntries']
                ? rgpost('form_limit_entries_period')
                : '';
            $updated_form['limitEntriesMessage'] = $updated_form['limitEntries']
                ? rgpost('form_limit_entries_message')
                : '';

            // form scheduling settings
            $updated_form['scheduleForm'] = rgpost('form_schedule_form');
            $updated_form['scheduleStart'] = $updated_form['scheduleForm']
                ? rgpost('gform_schedule_start')
                : '';
            $updated_form['scheduleStartHour'] = $updated_form['scheduleForm']
                ? rgpost('form_schedule_start_hour')
                : '';
            $updated_form['scheduleStartMinute'] = $updated_form['scheduleForm']
                ? rgpost('form_schedule_start_minute')
                : '';
            $updated_form['scheduleStartAmpm'] = $updated_form['scheduleForm']
                ? rgpost('form_schedule_start_ampm')
                : '';
            $updated_form['scheduleEnd'] = $updated_form['scheduleForm']
                ? rgpost('form_schedule_end')
                : '';
            $updated_form['scheduleEndHour'] = $updated_form['scheduleForm']
                ? rgpost('form_schedule_end_hour')
                : '';
            $updated_form['scheduleEndMinute'] = $updated_form['scheduleForm']
                ? rgpost('form_schedule_end_minute')
                : '';
            $updated_form['scheduleEndAmpm'] = $updated_form['scheduleForm']
                ? rgpost('form_schedule_end_ampm')
                : '';
            $updated_form['schedulePendingMessage'] = $updated_form[
                'scheduleForm'
            ]
                ? rgpost('form_schedule_pending_message')
                : '';
            $updated_form['scheduleMessage'] = $updated_form['scheduleForm']
                ? rgpost('form_schedule_message')
                : '';

            // require login settings
            $updated_form['requireLogin'] = rgpost('form_require_login');
            $updated_form['requireLoginMessage'] = $updated_form['requireLogin']
                ? rgpost('form_require_login_message')
                : '';

            $updated_form = GFFormsModel::maybe_sanitize_form_settings(
                $updated_form
            );
             ...
             */
            $updated_form = apply_filters(
                'gform_pre_form_settings_save',
                $updated_form
            );

            $update_result = GFFormDetail::save_form_info(
                $form_id,
                addslashes(json_encode($updated_form))
            );
		...
		<?php
  switch (rgar($update_result, 'status')) { case 'invalid_json': ?>
          ...
          '</a>'
				...
				<div class="error below-h2" id="after_update_error_dialog">
					<p>
						<?php _e(
          'The form title you have entered has already been used. Please enter a unique form title.',
          'gravityforms'
      ); ?>
					</p>
				</div>
  ...
  $tr_form_title =
      ...
      '
		...
		<td>
			<input type="text" id="form_title_input" name="form_title_input" class="fieldwidth-3" value="' .
      esc_attr($form['title']) .
      '" />
            </td>
        </tr>';
  ...
  $tr_form_description =
      ...
      '
		...
		<td>
			<textarea id="form_description_input" name="form_description_input" class="fieldwidth-3 fieldheight-2">' .
      esc_html(rgar($form, 'description')) .
      '</textarea>
            </td>
        </tr>';
  ...
  foreach ($alignment_options as $value => $label) {
      $selected =
          $form['labelPlacement'] == $value ? 'selected="selected"' : '';
  ...
  foreach ($description_options as $value => $label) {
      $selected =
          rgar($form, 'descriptionPlacement') == $value
              ? 'selected="selected"'
              : '';
  ...
  $tr_form_description_placement =
      '
        <tr id="description_placement_setting" style="' .
      $style .
      '">
            <th>
                ' .
  ...
  $sub_label_placement_options = [
      'below' => __('Below inputs', 'gravityforms'),
      'above' => __('Above inputs', 'gravityforms'),
  ];
  foreach ($sub_label_placement_options as $value => $label) {
      $selected =
          rgar($form, 'subLabelPlacement') == $value
              ? 'selected="selected"'
              : '';
  ...
  $tr_css_class_name =
      ...
      '</label>
		...
		<td>
			<input type="text" id="form_css_class" name="form_css_class" class="fieldwidth-3" value="' .
      esc_attr(rgar($form, 'cssClass')) .
      '" />
            </td>
        </tr>';
  ...
  $tr_form_button =
      ...
      '
            ...
            <td>
                ...
                <input type="radio" id="form_button_text" name="form_button" value="text" onclick="ToggleButton();" onkeypress="ToggleButton();" ' .
      $text_button_checked .
      ' />
      ...
      '</label>
			...
			<input type="radio" id="form_button_image" name="form_button" value="image" onclick="ToggleButton();" onkeypress="ToggleButton();" ' .
      $image_button_checked .
      ' />
  ...
  $tr_form_button_text =
      ...
      '
		...
		<td>
			<input type="text" id="form_button_text_input" name="form_button_text_input" class="fieldwidth-3" value="' .
      esc_attr(rgars($form, 'button/text')) .
      '" />
            </td>
        </tr>';
  ...
  $tr_form_button_image_path =
      '
        <tr id="form_button_image_path_setting" class="child_setting_row" style="' .
      $image_style_display .
      '">
            <th>
                ' .
      ...
      '
		...
		<td>
			<input type="text" id="form_button_image_url" name="form_button_image_url" class="fieldwidth-3" value="' .
      esc_attr(rgars($form, 'button/imageUrl')) .
      '" />
            </td>
        </tr>' .
      $subsetting_close;
  ...
  $tr_form_button_conditional =
      '
        <tr>
            <th>
                ' .
      __('Button conditional logic', 'gravityforms') .
      ' ' .
      gform_tooltip('form_button_conditional_logic', '', true) .
      '
            </th>
            <td>
                <input type="checkbox" id="form_button_conditional_logic" onclick="SetButtonConditionalLogic(this.checked); ToggleConditionalLogic(false, \'form_button\');" onkeypress="SetButtonConditionalLogic(this.checked); ToggleConditionalLogic(false, \'form_button\');"' .
      $button_conditional_checked .
      ' />
                <label for="form_button_conditional_logic" class="inline">' .
      ' ' .
  ...
  $save_button_text = isset($form['save']['button']['text'])
      ? esc_attr(rgars($form, 'save/button/text'))
      : __('Save and Continue Later', 'gravityforms');
  ...
  $tr_enable_save =
      '
        <tr>
            <th>
                ' .
      __('Save and Continue', 'gravityforms') .
      ' ' .
      gform_tooltip('form_enable_save', '', true) .
      '
            </th>
            <td>
                <input type="checkbox" id="form_save_enabled" name="form_save_enabled" onclick="ToggleEnableSave();" onkeypress="ToggleEnableSave();" value="1" ' .
      $save_enabled_checked .
      ' />
                <label for="form_save_enabled">' .
  ...
  $tr_save_warning =
      '
        <tr id="form_save_warning" class="child_setting_row" ' .
      $save_enabled_style .
      '>
            ' .
      $subsetting_open .
      ...
      '</div>
                    ...
                    ' .
      __(
          'When this setting is activated two confirmations and one notification are automatically generated and can be modified in their respective editors. When this setting is deactivated the confirmations and the notification will be deleted automatically and any modifications will be lost.',
          'gravityforms'
      ) .
      '</div>
                </div>
  ...
  $tr_save_button_text =
      '
        <tr id="form_save_button_text_setting" class="child_setting_row" ' .
      $save_enabled_style .
      '>
            <th>
                ' .
      ...
      '
		...
		<td>
			<input type="text" id="form_save_button_text" name="form_save_button_text" class="fieldwidth-3" value="' .
      $save_button_text .
      '" />
            </td>
            ' .
  ...
  foreach ($limit_periods as $value => $label) {
      $selected =
          rgar($form, 'limitEntriesPeriod') == $value
              ? 'selected="selected"'
              : '';
      $limit_entries_dd .=
          '<option value="' .
  ...
  $tr_limit_entries =
      ...
      ' ' .
      gform_tooltip('form_limit_entries', '', true) .
      '
            </th>
            <td>
                <input type="checkbox" id="gform_limit_entries" name="form_limit_entries" onclick="ToggleLimitEntry();" onkeypress="ToggleLimitEntry();" value="1" ' .
      $limit_entry_checked .
      ' />
                <label for="gform_limit_entries">' .
  ...
  $tr_limit_entries_count =
      '
        <tr id="limit_entries_count_setting" class="child_setting_row" style="' .
      esc_attr($limit_entry_style) .
      '">
            ' .
      $subsetting_open .
      '
      ...
      '
		...
		<td>
			<input type="text" id="gform_limit_entries_count" name="form_limit_entries_count" style="width:70px;" value="' .
      esc_attr(rgar($form, 'limitEntriesCount')) .
      '" />
                &nbsp;
  ...
  $tr_limit_entries_message =
      '
        <tr id="limit_entries_message_setting" class="child_setting_row" style="' .
      $limit_entry_style .
      '">
            ' .
      $subsetting_open .
      ...
      '</label>
		...
		<td>
			<textarea id="form_limit_entries_message" name="form_limit_entries_message" class="fieldwidth-3">' .
      esc_html(rgar($form, 'limitEntriesMessage')) .
      '</textarea>
            </td>
            ' .
      $subsetting_close .
  ...
  for ($i = 1; $i <= 12; $i++) {
      $selected =
          rgar($form, 'scheduleStartHour') == $i ? 'selected="selected"' : '';
      $start_hour_dd .=
          '<option value="' . $i . '" ' . $selected . '>' . $i . '</option>';
  }
  // Create start minute dd options.
  foreach (['00', '15', '30', '45'] as $value) {
      $selected =
          rgar($form, 'scheduleStartMinute') == $value
              ? 'selected="selected"'
              : '';
      $start_minute_dd .=
          '<option value="' .
  ...
  for ($i = 1; $i <= 12; $i++) {
      $selected =
          rgar($form, 'scheduleEndHour') == $i ? 'selected="selected"' : '';
      $end_hour_dd .=
          '<option value="' . $i . ' "' . $selected . '>' . $i . '</option>';
  }
  ...
  foreach (['00', '15', '30', '45'] as $value) {
      $selected =
          rgar($form, 'scheduleEndMinute') == $value
              ? 'selected="selected"'
              : '';
      $end_minute_dd .=
          '<option value="' .
  ...
  $tr_schedule_form =
      ...
      ' ' .
      gform_tooltip('form_schedule_form', '', true) .
      '
            </th>
            <td>
                <input type="checkbox" id="gform_schedule_form" name="form_schedule_form" value="1" onclick="ToggleSchedule();" onkeypress="ToggleSchedule();"' .
      $schedule_form_checked .
      '/>
                <label for="gform_schedule_form">' .
      __('Schedule form', 'gravityforms') .
      '</label>
            </td>
        </tr>';
  ...
  $tr_schedule_start =
      '
        <tr id="schedule_start_setting" class="child_setting_row" style="' .
      $schedule_form_style .
      '">
            ' .
      $subsetting_open .
      '
            <th>
                <label for="gform_schedule_start">' .
      __('Schedule Start Date/Time', 'gravityforms') .
      '</label>
            </th>
            <td>
                <input type="text" id="gform_schedule_start" name="gform_schedule_start" class="datepicker" value="' .
      esc_attr(rgar($form, 'scheduleStart')) .
      '" />
                &nbsp;&nbsp;
  ...
  $tr_schedule_end =
      '
        <tr id="schedule_end_setting" class="child_setting_row" style="' .
      esc_attr($schedule_form_style) .
      '">
            ' .
      $subsetting_open .
      '
      ...
      '
            ...
            <td>
                <input type="text" id="gform_schedule_end" name="form_schedule_end" class="datepicker" value="' .
      esc_attr(rgar($form, 'scheduleEnd')) .
      '" />
                &nbsp;&nbsp;
  ...
  $tr_schedule_pending_message =
      '
        <tr id="schedule_pending_message_setting" class="child_setting_row" style="' .
      esc_attr($schedule_form_style) .
      '">
            ' .
      $subsetting_open .
      ...
      '
            ...
            <td>
                <textarea id="gform_schedule_pending_message" name="form_schedule_pending_message" class="fieldwidth-3">' .
      esc_html(rgar($form, 'schedulePendingMessage')) .
      '</textarea>
            </td>
            ' .
      $subsetting_close .
  ...
  $tr_schedule_message =
      '
        <tr id="schedule_message_setting" class="child_setting_row" style="' .
      esc_attr($schedule_form_style) .
      '">
            ' .
      $subsetting_open .
      ...
      '
            ...
            <td>
                <textarea id="gform_schedule_message" name="form_schedule_message" class="fieldwidth-3">' .
      esc_html(rgar($form, 'scheduleMessage')) .
      '</textarea>
            </td>
            ' .
      $subsetting_close .
  ...
  $tr_honey_pot =
      '
        <tr>
            <th>
                ' .
      __('Anti-spam honeypot', 'gravityforms') .
      ' ' .
      gform_tooltip('form_honeypot', '', true) .
      '
            </th>
            <td>
                <input type="checkbox" id="gform_enable_honeypot" name="form_enable_honeypot" value="1" ' .
      $honey_pot_checked .
      '/>
                <label for="gform_enable_honeypot">' .
  ...
  $tr_enable_animation =
      '
        <tr>
            <th>
                ' .
      __('Animated transitions', 'gravityforms') .
      ' ' .
      gform_tooltip('form_animation', '', true) .
      '
            </th>
            <td>
                <input type="checkbox" id="gform_enable_animation" name="form_enable_animation" value="1" ' .
      $enable_animation_checked .
      ' />
  ...
  $tr_requires_login =
      ...
      ' ' .
      gform_tooltip('form_require_login', '', true) .
      '
            </th>
            <td>
                <input type="checkbox" id="gform_require_login" name="form_require_login" value="1" onclick="ToggleRequireLogin();" onkeypress="ToggleRequireLogin();"' .
      $require_login_checked .
      ' />
                <label for="gform_require_login">' .
      __('Require user to be logged in', 'gravityforms') .
      '</label>
            </td>
        </tr>';
  ...
  $tr_requires_login_message =
      '
        <tr id="require_login_message_setting" class="child_setting_row" style="' .
      esc_attr($require_login_style) .
      '">
            ' .
      $subsetting_open .
      '
      ...
      ' ' .
      gform_tooltip('form_require_login_message', '', true) .
      '
            </th>
            <td>
                <textarea id="gform_require_login_message" name="form_require_login_message" class="fieldwidth-3">' .
      esc_html(rgar($form, 'requireLoginMessage')) .
      '</textarea>
            </td>
            ' .
      $subsetting_close .
  ...
  $form_basics = [
      'form_title' => $tr_form_title,
      'form_description' => $tr_form_description,
  ];
  $form_layout = [
      'form_label_placement' => $tr_form_label_placement,
      'form_description_placement' => $tr_form_description_placement,
      'form_sub_label_placement' => $tr_sub_label_placement,
      'css_class_name' => $tr_css_class_name,
  ];
  $form_button = [
      'form_button_type' => $tr_form_button,
      'form_button_text' => $tr_form_button_text,
      'form_button_image_path' => $tr_form_button_image_path,
      'form_button_conditional' => $tr_form_button_conditional,
  ];
  $save_button = [
      'save_enabled' => $tr_enable_save,
      'save_warning' => $tr_save_warning,
      'save_button_text' => $tr_save_button_text,
  ];
  $form_restrictions = [
      'limit_entries' => $tr_limit_entries,
      'number_of_entries' => $tr_limit_entries_count,
      'entry_limit_message' => $tr_limit_entries_message,
      'schedule_form' => $tr_schedule_form,
      'schedule_start' => $tr_schedule_start,
      'schedule_end' => $tr_schedule_end,
      'schedule_pending_message' => $tr_schedule_pending_message,
      'schedule_message' => $tr_schedule_message,
      'requires_login' => $tr_requires_login,
      'requires_login_message' => $tr_requires_login_message,
  ];
  $form_options = [
      'honey_pot' => $tr_honey_pot,
      'enable_animation' => $tr_enable_animation,
  ];
  ...
  ?>
		...
		<div class="gform_panel gform_panel_form_settings" id="form_settings">
			...
			<h3><span><i class="fa fa-cogs"></i> <?php esc_html_e(
       'Form Settings',
       'gravityforms'
   ); ?></span></h3>
			...
			<form action="" method="post" id="gform_form_settings">
				...
				<table class="gforms_form_settings" cellspacing="0" cellpadding="0">
					<?php // Write out array of table rows
     if (is_array($form_settings)) {
        ...
        'gform_save_form_settings'
				...
				<input type="button" id="gform_save_settings" name="gform_save_settings" value="<?php _e(
        'Update Form Settings',
        'gravityforms'
    ); ?>" class="button-primary gfbutton" onclick="SaveFormSettings();" onkeypress="SaveFormSettings();" />
    ...
    public static function confirmations_list_page($form_id)
    {
        ...
        $add_new_url = add_query_arg(['cid' => 0]);
        ?>

		<h3><span><i class="fa fa-envelope-o"></i> <?php _e(
      'Confirmations',
      'gravityforms'
  ); ?>
				<a id="add-new-confirmation" class="add-new-h2" href="<?php echo esc_url(
        $add_new_url
    ); ?>"><?php _e('Add New', 'gravityforms'); ?></a></span>
		</h3>
		...
		<script type="text/javascript">
			...
			function ToggleActive(img, confirmation_id) {
				...
				if (is_active) {
					...
					jQuery(img).attr('title', '<?php _e(
         'Inactive',
         'gravityforms'
     ); ?>').attr('alt', '<?php _e('Inactive', 'gravityforms'); ?>');
				}
				else {
         ...
         'Active',
         'gravityforms'
     ); ?>').attr('alt', '<?php _e('Active', 'gravityforms'); ?>');
				}
				...
				mysack.setVar("rg_update_confirmation_active", "<?php echo wp_create_nonce(
        'rg_update_confirmation_active'
         ...
         __('Ajax error while updating confirmation', 'gravityforms')
     ); ?>')
				};
				mysack.runAJAX();
  ...
  ?>
    ...
    public static function confirmations_edit_page($form_id, $confirmation_id)
    {
        ...
        $form = gf_apply_filters(
            ['gform_admin_pre_render', $form_id],
        ...
        $confirmation = self::handle_confirmation_edit_submission(
            rgar($form['confirmations'], $confirmation_id, []),
            $form
        );
        ...
        $confirmation_ui_settings = self::get_confirmation_ui_settings(
            $confirmation
        );
        ...
        if (
            ...
            self::confirmation_looks_unsafe($confirmation['message'])
        ) {
            $dismissible_message = esc_html__(
                'Your confirmation message appears to contain a merge tag as the value for an HTML attribute. Depending on the attribute and field type, this might be a security risk. %sFurther details%s',
                'gravityforms'
            );
       ...
       : 'new ConfirmationObj()'; ?>;
         ...
         sprintf(
             ...
             __(
                 'Ensure that the conditional logic for this confirmation is different from all the other confirmations for this form and then press save to create the new confirmation.',
                 'gravityforms'
             )
         )
     ); ?>,
			...
			function MaybeAddSaveMergeTags(mergeTags, elementId, hideAllFields, excludeFieldTypes, isPrepop, option) {
				...
				if ( event === 'form_saved' || event === 'form_save_email_sent' ) {
					mergeTags['other'].tags.push({ tag: '{save_link}', label: <?php echo json_encode(
         __('Save &amp; Continue Link', 'gravityforms')
     ); ?> });
					mergeTags['other'].tags.push({ tag: '{save_token}', label: <?php echo json_encode(
         __('Save &amp; Continue Token', 'gravityforms')
     ); ?> });
				}

				if ( event === 'form_saved' ) {
					mergeTags['other'].tags.push({ tag: '{save_email_input}', label: <?php echo json_encode(
         __('Save &amp; Continue Email Input', 'gravityforms')
     ); ?> });
				}
		...
		<div id="confirmation-editor">
			...
			<form id="confirmation_edit_form" method="post">
				...
				<table class="form-table gforms_form_settings">
					<?php array_map([__CLASS__, 'output'], $confirmation_ui_settings); ?>
				</table>
    ...
    ?>
				...
				<input type="hidden" id="confirmation_id" name="confirmation_id" value="<?php echo esc_attr(
        $confirmation_id
    ); ?>" />
				<input type="hidden" id="form_id" name="form_id" value="<?php echo esc_attr(
        $form_id
    ); ?>" />
				<input type="hidden" id="is_default" name="is_default" value="<?php echo rgget(
        'isDefault',
        $confirmation
    ); ?>" />
				<input type="hidden" id="conditional_logic" name="conditional_logic" value="<?php echo htmlentities(
        json_encode(rgget('conditionalLogic', $confirmation))
    ); ?>" />

				<p class="submit">
					<input type="submit" name="save" value="<?php _e(
         'Save Confirmation',
         'gravityforms'
     ); ?>" onclick="StashConditionalLogic(event);" onkeypress="StashConditionalLogic(event);" class="button-primary">
				</p>
    ...
    public static function get_confirmation_ui_settings($confirmation)
    {
        ...
        $ui_settings = [];
        $confirmation_type = rgar($confirmation, 'type')
            ? rgar($confirmation, 'type')
            : 'message';
      ...
      !rgar($confirmation, 'name')
          ? 'gfield_error'
          : ''; ?>
		<tr <?php echo $is_default
      ? 'style="display:none;"'
      : ''; ?> class="<?php echo $class; ?>">
			<th><?php _e('Confirmation Name', 'gravityforms'); ?></th>
			<td>
				<input type="text" id="form_confirmation_name" name="form_confirmation_name" value="<?php echo esc_attr(
        rgar($confirmation, 'name')
    ); ?>" />
			</td>
  ...
  ?>
		...
		<tr>
			...
			<td>
				<input type="radio" id="form_confirmation_show_message" name="form_confirmation" <?php checked(
        'message',
        $confirmation_type
				...
				&nbsp;&nbsp;
				<input type="radio" id="form_confirmation_show_page" name="form_confirmation" <?php checked(
        'page',
        $confirmation_type
				...
				&nbsp;&nbsp;
				<input type="radio" id="form_confirmation_redirect" name="form_confirmation" <?php checked(
        'redirect',
        $confirmation_type
  ...
  ?>
		...
		<tr id="form_confirmation_message_container" <?php echo $confirmation_type !=
  'message'
      ? 'style="display:none;"'
      : ''; ?> >
			...
			<td>
				...
				<?php wp_editor(rgar($confirmation, 'message'), 'form_confirmation_message', [
        'autop' => false,
        'editor_class' =>
            'merge-tag-support mt-wp_editor mt-manual_position mt-position-right',
    ]); ?>
				<div style="margin-top:5px;">
					<input type="checkbox" id="form_disable_autoformatting" name="form_disable_autoformatting" value="1" <?php echo empty(
         $confirmation['disableAutoformat']
     )
         ? ''
         : "checked='checked'"; ?> />
					<label for="form_disable_autoformatting"><?php _e(
         'Disable Auto-formatting',
         'gravityforms'
     ); ?> <?php gform_tooltip('form_confirmation_autoformat'); ?></label>
				</div>
			</td>
  ...
  ?>
      ...
      !$is_valid &&
      $confirmation_type == 'page' &&
      !rgar($confirmation, 'pageId')
          ? 'gfield_error'
          : ''; ?>
		<tr class="form_confirmation_page_container" <?php echo $confirmation_type !=
  'page'
      ? 'style="display:none;"'
      : ''; ?> class="<?php echo $class; ?>">
			<?php echo $subsetting_open; ?>
        ...
        'selected' => rgar($confirmation, 'pageId'),
        'show_option_none' => __('Select a page', 'gravityforms'),
    ]); ?>
			</td>
			<?php echo $subsetting_close; ?>
  ...
  'page'
      ...
      : ''; ?> class="<?php echo $class; ?>">
       ...
       'gravityforms'
   ); ?> <?php gform_tooltip('form_redirect_querystring'); ?></th>
			<td>
				<input type="checkbox" id="form_page_use_querystring" name="form_page_use_querystring" <?php echo empty(
        $confirmation['queryString']
    )
        ? ''
        : "checked='checked'"; ?> onclick="TogglePageQueryString()" onkeypress="TogglePageQueryString()" />
				<label for="form_page_use_querystring"><?php _e(
        'Pass Field Data Via Query String',
        'gravityforms'
    ); ?></label>

				<div id="form_page_querystring_container" <?php echo empty(
        $confirmation['queryString']
    )
        ? 'style="display:none;"'
        : ''; ?> >
					<?php $query_string = rgget('queryString', $confirmation); ?>
					<textarea name="form_page_querystring" id="form_page_querystring" class="merge-tag-support mt-position-right mt-hide_all_fields mt-option-url" style="width:98%; height:100px;"><?php echo esc_textarea(
         $query_string
     ); ?></textarea><br />

					<div class="instruction"><?php _e(
  ...
  ?>
      ...
      !rgar($confirmation, 'url')
		...
		<tr class="form_confirmation_redirect_container <?php echo $class; ?>" <?php echo $confirmation_type != 'redirect' ? 'style="display:none;"' : ''; ?> >
			...
			<td>
				<input type="text" id="form_confirmation_url" name="form_confirmation_url" value="<?php echo esc_attr(
        rgget('url', $confirmation)
    ); ?>" style="width:98%;" />
			</td>
			<?php echo $subsetting_close; ?>
		</tr> <!-- / confirmation url -->
  ...
  ?>
		...
		<tr class="form_confirmation_redirect_container" <?php echo $confirmation_type !=
  'redirect'
      ? 'style="display:none;"'
      : ''; ?> >
			<?php echo $subsetting_open; ?>
       ...
       'gravityforms'
			...
			<td>
				<input type="checkbox" id="form_redirect_use_querystring" name="form_redirect_use_querystring" <?php echo empty(
        $confirmation['queryString']
    )
        ? ''
        : "checked='checked'"; ?> onclick="ToggleQueryString()" onkeypress="ToggleQueryString()" />
				<label for="form_redirect_use_querystring"><?php _e(
        'Pass Field Data Via Query String',
        'gravityforms'
    ); ?></label>

				<div id="form_redirect_querystring_container" <?php echo empty(
        $confirmation['queryString']
    )
        ? 'style="display:none;"'
        : ''; ?> >
					...
					<textarea name="form_redirect_querystring" id="form_redirect_querystring" class="merge-tag-support mt-position-right mt-hide_all_fields mt-option-url" style="width:98%; height:100px;"><?php echo esc_textarea(
         $query_string
     ); ?></textarea><br />
  ...
  ?>
		...
		<tr <?php echo rgget('isDefault', $confirmation)
      ? 'style="display:none;"'
      : ''; ?> >
   ...
   * @param array $form         The Form Object.
   */
  $ui_settings = gf_apply_filters(
      ['gform_confirmation_ui_settings', $form_id],
      $ui_settings,
      $confirmation,
      $form
  );
  ...
  return $ui_settings;
    ...
    public static function page_header($title = '')
    {
        ...
        $query = ['subview' => $tab['name']];

        if (
            rgar($tab, 'capabilities') &&
            !GFCommon::current_user_can_any($tab['capabilities'])
        ) {
            continue;
        }
        ...
        ?>
					<li <?php echo $current_tab == $tab['name'] ? "class='active'" : ''; ?>>
						<a href="<?php echo esc_url($url); ?>"><?php echo esc_html(
    $tab['label']
); ?></a><span></span>
					</li>
				<?php
    ...
    public static function get_tabs($form_id)
    {
        $setting_tabs = [
            ...
            '20' => [
                ...
                'query' => ['cid' => null, 'duplicatedcid' => null],
                'capabilities' => ['gravityforms_edit_forms'],
            ],
            '30' => [
                'name' => 'notification',
     ...
     */
    public static function handle_confirmation_edit_submission(
        $confirmation,
        $form
    ) {
        if (
        ...
        if (!in_array($type, ['message', 'page', 'redirect'])) {
            $type = 'message';
        }
        $confirmation['type'] = $type;

        // Filter HTML for users without the unfiltered_html capability
        $confirmation_message = self::maybe_wp_kses(
            rgpost('form_confirmation_message')
        );

        $failed_validation = false;

        $confirmation['message'] = $confirmation_message;
        $confirmation['disableAutoformat'] = (bool) rgpost(
            'form_disable_autoformatting'
        );
        $confirmation['pageId'] = absint(rgpost('form_confirmation_page'));
        $confirmation['url'] = rgpost('form_confirmation_url');
        $query_string =
            '' != rgpost('form_redirect_querystring')
                ? rgpost('form_redirect_querystring')
                : rgpost('form_page_querystring');
        ...
        $confirmation['conditionalLogic'] = $confirmation['isDefault']
            ? []
            : json_decode(rgpost('conditional_logic'), ARRAY_A);

        $confirmation[
            'conditionalLogic'
        ] = GFFormsModel::sanitize_conditional_logic(
            $confirmation['conditionalLogic']
        );
        ...
        if (!$confirmation['name']) {
            ...
            GFCommon::add_error_message(
                __('You must specify a Confirmation Name.', 'gravityforms')
            );
        }
        ...
        switch ($type) {
            case 'page':
                if (empty($confirmation['pageId'])) {
                    ...
                    GFCommon::add_error_message(
                        __(
                            'You must select a Confirmation Page.',
                            'gravityforms'
                        )
                    );
                }
            ...
            case 'redirect':
                if (
                    (empty($confirmation['url']) ||
                        !GFCommon::is_valid_url($confirmation['url'])) &&
                    !GFCommon::has_merge_tag($confirmation['url'])
                ) {
                    $failed_validation = true;
                    GFCommon::add_error_message(
                        __(
                            'You must specify a valid Redirect URL.',
                            'gravityforms'
                        )
                    );
                }
        ...
        $confirmation = gf_apply_filters(
            ['gform_pre_confirmation_save', $form['id']],
            $confirmation,
            $form,
            $is_new_confirmation
        );
        ...
        // trim values
        $confirmation = GFFormsModel::trim_conditional_logic_values_from_element(
            $confirmation,
            $form
        );
        ...
        $result = GFFormsModel::save_form_confirmations(
            $form['id'],
            $form['confirmations']
        );

        if ($result !== false) {
            $url = remove_query_arg(['cid', 'duplicatedcid']);
            GFCommon::add_message(
                sprintf(
                    __(
                        'Confirmation saved successfully. %sBack to confirmations.%s',
                        'gravityforms'
                    ),
                    '<a href="' . esc_url($url) . '">',
                    '</a>'
    ...
    public static function maybe_process_confirmation_list_action()
    {
        ...
        switch ($action) {
            case 'delete':
                $confirmation_deleted = self::delete_confirmation(
                    $object_id,
                    rgget('id')
                );
                if ($confirmation_deleted) {
                    GFCommon::add_message(
                        __('Confirmation deleted.', 'gravityforms')
                    );
                } else {
                    GFCommon::add_error_message(
                        __(
    ...
    public static function delete_confirmation($confirmation_id, $form_id)
    {
        ...
        return RGFormsModel::save_form_confirmations(
            $form['id'],
            $form['confirmations']
        );
    }
    ...
    public static function activate_save($form)
    {
        ...
        if (!$has_save_notification) {
            ...
            $form['notifications'][$notification_id] = [
                ...
                'message' => __(
                    'Thank you for saving {form_title}. Please use the unique link below to return to the form from any computer. <br /><br /> {save_link} <br /><br /> Remember that the link will expire after 30 days so please return via the provided link to complete your form submission.',
                    'gravityforms'
                ),
            ];
            GFFormsModel::save_form_notifications(
                $form_id,
                $form['notifications']
            );
        }
        ...
        if (!$has_save_confirmation) {
            $confirmation_1 = GFFormsModel::get_default_confirmation(
                'form_saved'
            );
            $confirmation_2 = GFFormsModel::get_default_confirmation(
            ...
            GFFormsModel::save_form_confirmations(
                $form_id,
                $form['confirmations']
            );
        }
    ...
    public static function deactivate_save($form)
    {
        ...
        foreach ($form['notifications'] as $notification_id => $notification) {
            if (
                rgar($notification, 'isDefault') &&
                rgar($notification, 'event') == 'form_save_email_requested'
            ) {
        ...
        foreach ($form['confirmations'] as $confirmation_id => $confirmation) {
            ...
            if (
                rgar($confirmation, 'isDefault') &&
                ($event == 'form_saved' || $event == 'form_save_email_sent')
            ) {
                unset($form['confirmations'][$confirmation_id]);
                $changed = true;
            }
    ...
    public static function save_form_title()
    {
        ...
        if (empty($form_title)) {
            ...
            $result['isValid'] = false;
            $result['message'] = __(
                'Please enter a unique form title.',
                'gravityforms'
            );
        } else {
...
class GFConfirmationTable extends WP_List_Table
{
    ...
    function prepare_items()
    {
        ...
        switch (rgget('orderby')) {
            case 'name':
                ...
                usort($this->items, [$this, 'sort_confirmations']);
     ...
     * @return int
     */
    function sort_confirmations($a = [], $b = [])
    {
    ...
    {
        $edit_url = add_query_arg(['cid' => $item['id']]);
        $duplicate_url = add_query_arg([
            'cid' => 0,
            'duplicatedcid' => $item['id'],
        ]);
        $actions = apply_filters('gform_confirmation_actions', [
            'edit' =>
                '<a href="' .
                esc_url($edit_url) .
                '">' .
                __('Edit', 'gravityforms') .
                '</a>',
            'duplicate' =>
                '<a href="' .
                esc_url($duplicate_url) .
                '">' .
                __('Duplicate', 'gravityforms') .
                '</a>',
            'delete' =>
                '<a class="submitdelete" onclick="javascript: if(confirm(\'' .
                __(
                    'WARNING: You are about to delete this confirmation.',
                    'gravityforms'
                ) .
                __("\'Cancel\' to stop, \'OK\' to delete.", 'gravityforms') .
                '\')){ DeleteConfirmation(\'' .
                esc_js($item['id']) .
                '\'); }" onkeypress="javascript: if(confirm(\'' .
                __(
                    'WARNING: You are about to delete this confirmation.',
                    'gravityforms'
                ) .
      ...
      $edit_url
  ); ?>"><strong><?php echo esc_html(rgar($item, 'name')); ?></strong></a>
		<div class="row-actions">

			<?php if (is_array($actions) && !empty($actions)) {
    ...
    public static function get_column_content($item)
    {
        switch (rgar($item, 'type')) {
            ...
            case 'redirect':
                ...
                $url = rgar($item, 'queryString')
                    ? "{$item['url']}{$url_connector}{$item['queryString']}"
                    : $item['url'];
                $url = esc_url($url);
