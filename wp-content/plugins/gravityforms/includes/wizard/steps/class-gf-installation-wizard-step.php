...
abstract class GF_Installation_Wizard_Step extends stdClass
{
    ...
    protected $_field_validation_results = [];
    ...
    function get_values()
    {
        $set_values = $this->_step_values ? $this->_step_values : [];
    ...
    function update($posted_values = [])
    {
        ...
        update_option(
            'gform_installation_wizard_' . $this->get_name(),
            $new_values
        );
