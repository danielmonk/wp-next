...
class GF_Update
{
    ...
    public static function updates()
    {
		...
		<table class="wp-list-table widefat plugins">
			...
			<tr>
				...
				<th scope="col" id="name" class="manage-column column-name column-primary"><?php esc_html_e(
        'Plugin',
        'gravityforms'
    ); ?></th>
				<th scope="col" id="description" class="manage-column column-description"><?php esc_html_e(
        'Description',
        'gravityforms'
    ); ?></th>
			</tr>
   ...
   foreach ($updates as $update) {
       ...
       $settings_link =
           $update['slug'] == 'gravityforms'
               ? admin_url('admin.php?page=gf_settings')
               : admin_url(
                   'admin.php?page=gf_settings&subview=' . $update['slug']
               );
       ...
       ?>
				<tr class="inactive<?php echo $update_class; ?>" data-slug="admin-bar-form-search" data-plugin="gw-admin-bar-form-manager.php">
					...
					<td class="plugin-title column-primary"><strong><?php echo $update[
         'name'
     ]; ?></strong>
						<div class="row-actions visible">
							<span class="deactivate"><a href="<?php echo $settings_link; ?>"><?php esc_html_e(
    'Settings',
    'gravityforms'
); ?></a></span>
						</div>
					...
					<td class="column-description desc">
						...
						<div class="active second plugin-version-author-uri">
							...
							<a href="<?php echo $plugin['PluginURI']; ?>"><?php esc_html_e(
    'Visit plugin page',
    'gravityforms'
); ?></a>
						</div>
  ...
  GF_System_Status::page_footer();
    ...
    public static function available_updates()
    {
        ...
        if (
            ...
            $version_message = esc_html__(
                'Your version of Gravity Forms is up to date.',
                'gravityforms'
            );
        } else {
            if (rgar($version_info, 'is_valid_key')) {
                ...
                $version_message = sprintf(
                    ...
                    esc_html__(
                        'You can update to the latest version automatically or download the update and install it manually.',
                        'gravityforms'
                    )
                );
            } else {
