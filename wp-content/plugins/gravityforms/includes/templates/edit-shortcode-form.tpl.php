<script type="text/html" id="tmpl-gf-shortcode-default-edit-form">
	...
	<form class="gf-edit-shortcode-form">
		...
		<h2 class="gf-edit-shortcode-form-title"><?php _e(
      'Insert A Form',
      'gravityforms'
  ); ?></h2>
		<br />
		...
		<br />
		<div>
			<a href="javascript:void(0);" onclick="jQuery('#gf-edit-shortcode-form-advanced-attrs').toggle();" onkeypress="jQuery('#gf-edit-shortcode-form-advanced-attrs').toggle();" ><?php _e(
       'Advanced Options',
       'gravityforms'
   ); ?></a>
		</div>
		...
		<input id="gform-update-shortcode" type="button" class="button-primary" value="<?php _e(
      'Update Form',
      'gravityforms'
  ); ?>" />
		<input id="gform-insert-shortcode" type="button" class="button-primary" value="<?php _e(
      'Insert Form',
      'gravityforms'
  ); ?>" />&nbsp;&nbsp;&nbsp;
		<a id="gform-cancel-shortcode" class="button" style="color:#bbb;" href="#"><?php _e(
      'Cancel',
      'gravityforms'
  ); ?></a>
