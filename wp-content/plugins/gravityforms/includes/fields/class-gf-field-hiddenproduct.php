    ...
    public function get_field_input($form, $value = '', $entry = null)
    {
        ...
        $quantity_field = $has_quantity_field
            ...
            : "<input type='hidden' name='input_{$id}.3' value='" .
                esc_attr($quantity) .
                "' id='ginput_quantity_{$form_id}_{$this->id}' class='gform_hidden' />";
        ...
        return $quantity_field .
            $product_name_field .
            "<input name='input_{$id}.2' id='ginput_base_price_{$form_id}_{$this->id}' type='{$field_type}' value='{$price}' class='gform_hidden ginput_amount' {$disabled_text}/>";
    }
