...
class GF_Field_Calculation extends GF_Field
{
    ...
    public function get_field_input($form, $value = '', $entry = null)
    {
        ...
        if ($is_entry_detail || $is_form_editor) {
            ...
            $quantity_field .=
                ...
                "</span> <input type='{$qty_input_type}' name='input_{$id}.3' value='{$quantity}' id='ginput_quantity_{$form_id}_{$this->id}' class='ginput_quantity' size='10' {$tabindex} {$disabled_text}/>";
        } else {
    ...
    public function get_value_save_entry(
        ...
        if ($input_id == 2) {
            ...
            $value = $currency->to_money(
                GFCommon::calculate($this, $form, $lead)
            );
        }
        return $value;
    }
