...
class GF_Field_Hidden extends GF_Field
{
    ...
    public function get_field_input($form, $value = '', $entry = null)
    {
        ...
        $class_attribute =
            $is_entry_detail || $is_form_editor ? '' : "class='gform_hidden'";
        ...
        return sprintf(
            "<input name='input_%d' id='%s' type='$field_type' {$class_attribute} {$required_attribute} {$invalid_attribute} value='%s' %s/>",
            $id,
            $field_id,
            esc_attr($value),
            $disabled_text
