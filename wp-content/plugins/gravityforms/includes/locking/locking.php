...
class GFFormLocking extends GFLocking
{
    public function __construct()
    {
        ...
        $edit_url = admin_url(
            sprintf('admin.php?page=gf_edit_forms&id=%d', $form_id)
        );
    ...
    public function get_strings()
    {
        $strings = [
            'currently_locked' => __(
                'This form is currently locked. Click on the "Request Control" button to let %s know you\'d like to take over.',
                'gravityforms'
            ),
            'accept' => __('Accept', 'gravityforms'),
            'currently_editing' => __(
                '%s is currently editing this form',
                'gravityforms'
            ),
            'taken_over' => __(
                '%s has taken over and is currently editing this form.',
                'gravityforms'
            ),
            'lock_requested' => __(
                '%s has requested permission to take over control of this form.',
                'gravityforms'
            ),
        ];
...
class GFEntryLocking extends GFLocking
{
    public function __construct()
    {
        $capabilities = ['gravityforms_edit_entries'];
...
class GFFormSettingsLocking extends GFLocking
{
    public function __construct()
    {
        ...
        $edit_url = admin_url(
            sprintf(
                'admin.php?page=gf_edit_forms&view=settings&subview=%s&id=%d',
                esc_attr($subview),
                $form_id
            )
        );
    ...
    public function get_strings()
    {
        $strings = [
            'currently_locked' => __(
                'These form settings are currently locked. Click on the "Request Control" button to let %s know you\'d like to take over.',
                'gravityforms'
            ),
            'currently_editing' => '%s is currently editing these settings',
            'taken_over' =>
                '%s has taken over and is currently editing these settings.',
            'lock_requested' => __(
                '%s has requested permission to take over control of these settings.',
                'gravityforms'
            ),
        ];
...
class GFPluginSettingsLocking extends GFLocking
{
    ...
    public function get_strings()
    {
        $strings = [
            'currently_locked' => __(
                'These settings are currently locked. Click on the "Request Control" button to let %s know you\'d like to take over.',
                'gravityforms'
            ),
            'currently_editing' => '%s is currently editing these settings',
            'taken_over' =>
