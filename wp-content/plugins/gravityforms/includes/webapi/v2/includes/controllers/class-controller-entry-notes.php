...
class GF_REST_Entry_Notes_Controller extends GF_REST_Controller
{
    ...
    public function get_items($request)
    {
        ...
        if (!GFAPI::entry_exists($entry_id)) {
            return new WP_Error(
                'gf_entry_invalid_id',
                __('Invalid entry id.', 'gravityforms'),
                ['status' => 404]
            );
        }
        ...
        $allowed_criteria = ['user_id', 'note_type', 'sub_type', 'user_name'];
    ...
    public function get_items_permissions_check($request)
    {
        ...
        $capability = apply_filters(
            'gform_rest_api_capability_get_notes',
    ...
    public function update_item_permissions_check($request)
    {
         ...
         */
        $capability = apply_filters(
            'gform_rest_api_capability_put_notes',
    ...
    public function delete_item_permissions_check($request)
    {
         ...
         */
        $capability = apply_filters(
            'gform_rest_api_capability_delete_notes',
            'gravityforms_edit_entry_notes',
            $request
        );
