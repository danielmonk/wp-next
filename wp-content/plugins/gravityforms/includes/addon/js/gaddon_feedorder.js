var GFFeedOrder = function (args) {
  ...
  self.init = function () {
    ...
    var sortHandleMarkup =
      '<td class="sort-column"><i class="fa fa-bars feed-sort-handle"></i></td>';

    // Add sorting handle to table.
    $(".wp-list-table thead tr, .wp-list-table tfoot tr").append(
  ...
  self.initSorting = function () {
    $(".wp-list-table tbody").sortable({
      ...
      tolerance: "pointer",
      create: function () {
        $(".wp-list-table").addClass("feed-list-sortable");
      },
