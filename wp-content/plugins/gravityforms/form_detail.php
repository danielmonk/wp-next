...
class GFFormDetail
{
    public static function forms_page($form_id)
    {
        ...
        if (rgpost('operation') == 'trash') {
			...
			<?php exit();
        } elseif (!rgempty('gform_meta')) {
            check_admin_referer(
                "gforms_update_form_{$form_id}",
                'gforms_update_form'
            );

            $update_result = self::save_form_info(
                $form_id,
                rgpost('gform_meta', false)
            );
        }
		...
		<script type="text/javascript">
			...
			function has_entry(fieldNumber) {
				var submitted_fields = [<?php echo RGFormsModel::get_submitted_fields(
        $form_id
    ); ?>];
		...
		<?php
  $form = !rgempty('meta', $update_result)
      ? rgar($update_result, 'meta')
  ...
  if (isset($form['id'])) {
      echo "<script type=\"text/javascript\">var form = " .
          json_encode($form) .
          ';</script>';
  } else {
  ...
  ?>
		...
		<?php switch (rgar($update_result, 'status')) { case 'invalid_json': ?>
				<div class="error_base gform_editor_status" id="after_update_error_dialog">
					<?php esc_html_e(
         'There was an error while saving your form.',
         'gravityforms'
     ); ?>
					<?php printf(
         __('Please %scontact our support team%s.', 'gravityforms'),
         '<a href="https://www.gravityforms.com/support/">',
         '</a>'
     ); ?>
				</div>
				<?php break;case 'duplicate_title': ?>
				<div class="error_base gform_editor_status" id="after_update_error_dialog">
					<?php esc_html_e(
         'The form title you have entered is already taken. Please enter a unique form title.',
         'gravityforms'
     ); ?>
				</div>
				<?php break;default:
		...
		<?php $has_pages = GFCommon::has_pages($form); ?>
		<div id="gform_pagination" class="selectable gform_settings_container" style="display:<?php echo $has_pages
      ? 'block'
      : 'none'; ?>;">
			<div class="settings_control_container">
				<div class="gfield_admin_header_title"><?php esc_html_e(
        'Paging: Options',
        'gravityforms'
    ); ?></div>
				<a href="javascript:void(0);" class="form_edit_icon edit_icon_collapsed" title="<?php esc_attr_e(
        'click to edit page options',
        'gravityforms'
			...
			<div class="gf-pagebreak-first gf-pagebreak-container">
				<div class="gf-pagebreak-text-before"><?php esc_html_e(
        'begin form',
        'gravityforms'
    ); ?></div>
				<div class="gf-pagebreak-text-main"><span><?php esc_html_e(
        'START PAGING',
        'gravityforms'
    ); ?></span></div>
				<div class="gf-pagebreak-text-after"><?php esc_html_e(
			...
			<div id="pagination_settings" style="display: none;">
				<ul>
					<li style="width:100px; padding:0px;">
						<a href="#gform_pagination_settings_tab_1"><?php esc_html_e(
          'General',
          'gravityforms'
      ); ?></a></li>
					<li style="width:100px; padding:0px;">
						<a href="#gform_pagination_settings_tab_2"><?php esc_html_e(
          'Appearance',
          'gravityforms'
      ); ?></a></li>
				</ul>
						...
						<li id="percentage_style_setting">
							...
							<div class="percentage_style_setting" style="float:left; z-index: 99;">
								...
								<select id="percentage_style" onchange="TogglePercentageStyle();">
									...
									<option value="orange">  <?php esc_html_e(
             'Orange',
             'gravityforms'
         ); ?>  </option>
									<option value="red">  <?php esc_html_e('Red', 'gravityforms'); ?>  </option>
									<option value="custom">  <?php esc_html_e(
             'Custom',
             'gravityforms'
         ); ?>  </option>
								</select>
             ...
             'Completion Text',
             'gravityforms'
         ); ?> <?php gform_tooltip('percentage_confirmation_page_name'); ?>
								</label>
		...
		<ul id="gform_fields" class="<?php echo GFCommon::get_ul_classes(
      $form
  ); ?>" style="position: relative;">

			<?php $no_fields_style = !empty($form['fields'])
       ? ' style="display:none;"'
       : null; ?>
        ...
        ?>
				...
				<li id="no-fields"<?php echo $no_fields_style; ?>>
					...
					<div class="newform_notice"><?php esc_html_e(
         "This form doesn't have any fields yet. Follow the steps below to get started.",
         'gravityforms'
     ); ?>
						<span></span></div>
        ...
        ?>
					...
					<h4 class="gf_nofield_header gf_nofield_1">1. <?php esc_html_e(
         'Select A Field Type',
         'gravityforms'
     ); ?></h4>
         ...
         'gravityforms'
					...
					<div id="gf_nofield_1_instructions">
						<span class="gf_nofield_1_instructions_heading gf_tips"><?php esc_html_e(
          'Start Over There',
          'gravityforms'
      ); ?></span>
						<span class="gf_nofield_1_instructions_copy gf_tips"><?php esc_html_e(
          'Pick a field.. any field. Don\'t be shy.',
          'gravityforms'
      ); ?></span>
					</div>
        ...
        ?>
					...
					<h4 class="gf_nofield_header gf_nofield_2">2. <?php esc_html_e(
         ...
         'gravityforms'
					...
					<div id="gf_nofield_2_instructions">
						<span class="gf_nofield_2_instructions_copy gf_tips"><?php esc_html_e(
          'Now your new field magically appears over here.',
          'gravityforms'
      ); ?></span>
					</div>
        ...
        ?>
					...
					<h4 class="gf_nofield_header gf_nofield_3">3. <?php esc_html_e(
         'Edit Field Options',
         'gravityforms'
     ); ?></h4>
         ...
         'gravityforms'
					...
					<div id="gf_nofield_3_instructions">
						<span class="gf_nofield_3_instructions_copy_top gf_tips"><?php esc_html_e(
          'Preview your changes up here.',
          'gravityforms'
      ); ?></span>
						<span class="gf_nofield_3_instructions_copy_mid gf_tips"><?php esc_html_e(
          'Edit the field options. Go ahead.. go crazy.',
          'gravityforms'
      ); ?></span>
						<span class="gf_nofield_3_instructions_copy_bottom gf_tips"><?php esc_html_e(
          'If you get stuck, mouseover the tool tips for a little help.',
          'gravityforms'
      ); ?></span>
					</div>
        ...
        ?>
					...
					<h4 class="gf_nofield_header gf_nofield_4">4. <?php esc_html_e(
         'Drag to Arrange Fields',
         'gravityforms'
     ); ?></h4>
         ...
         'gravityforms'
					...
					<div id="gf_nofield_4_instructions">
						<span class="gf_nofield_4_instructions_copy_top gf_tips"><?php esc_html_e(
          'Grab here with your cursor.',
          'gravityforms'
      ); ?></span>
						<span class="gf_nofield_4_instructions_copy_bottom gf_tips"><?php esc_html_e(
          'Drag up or down to arrange your fields.',
          'gravityforms'
      ); ?></span>
					</div>
        ...
        ?>
					...
					<h4 class="gf_nofield_header gf_nofield_5">5. <?php esc_html_e(
         'Save Your Form',
         'gravityforms'
     ); ?></h4>
         ...
         'gravityforms'
					...
					<div id="gf_nofield_5_instructions">
						<span class="gf_nofield_5_instructions_heading gf_tips"><?php esc_html_e(
          'Save Your New Form',
          'gravityforms'
      ); ?></span>
						<span class="gf_nofield_5_instructions_copy gf_tips"><?php esc_html_e(
          ...
          'gravityforms'
			...
			<?php if (is_array(rgar($form, 'fields'))) {
       ...
       foreach ($form['fields'] as $field) {
		...
		<div id="gform_last_page_settings" class="selectable gform_settings_container" style="display:<?php echo $has_pages
      ? 'block'
      : 'none'; ?>;">
			<div class="settings_control_container">
				<div class="gfield_admin_header_title"><?php esc_html_e(
        ...
        'gravityforms'
			...
			<div id="last_page_settings" style="display:none;">
				<ul>
					<li style="width:100px; padding:0px;">
						<a href="#gform_last_page_settings_tab_1"><?php esc_html_e(
          'General',
          'gravityforms'
      ); ?></a></li>
				</ul>
		...
		<div>
			...
			<div id="after_insert_dialog" style="display:none;">
				<h3><?php esc_html_e(
        'You have successfully saved your form!',
        'gravityforms'
    ); ?></h3>
				...
				<div class="new-form-option">
					<a id="preview_form_link" href="<?php echo esc_url_raw(
         trailingslashit(site_url())
     ); ?>?gf_page=preview&id={formid}" target="_blank"><?php esc_html_e('Preview this Form', 'gravityforms'); ?></a>
				</div>

				<?php if (GFCommon::current_user_can_any('gravityforms_edit_forms')) { ?>
					<div class="new-form-option">
						<a id="notification_form_link" href="#"><?php esc_html_e(
          'Setup Email Notifications for this Form',
          'gravityforms'
      ); ?></a>
					</div>
				<?php } ?>
				...
				<div class="new-form-option">
					<a id="edit_form_link" href="#"><?php esc_html_e(
         ...
         'gravityforms'
				...
				<div class="new-form-option">
					<a href="?page=gf_edit_forms"><?php esc_html_e(
         'Return to Form List',
         'gravityforms'
     ); ?></a>
				</div>
		...
		<ul>
            ...
            <li style="width:100px; padding:0px; ">
                <a href="#gform_tab_3"><?php esc_html_e(
                    'Appearance',
                    'gravityforms'
                ); ?></a>
            </li>
			<li style="width:100px; padding:0px; ">
                <a href="#gform_tab_2"><?php esc_html_e(
                    'Advanced',
                    'gravityforms'
                ); ?></a>
			</li>
  ...
  do_action('gform_field_standard_settings', 0, $form_id); ?>
        ...
        <?php do_action('gform_field_standard_settings', 5, $form_id); ?>
        ...
        <?php do_action('gform_field_standard_settings', 10, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 20, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 25, $form_id); ?>
		<li class="product_field_type_setting field_setting">
			...
			<select id="product_field_type" onchange="if(jQuery(this).val() == '') return; jQuery('#field_settings').slideUp(function(){StartChangeProductType(jQuery('#product_field_type').val());});">
				<option value="singleproduct"><?php esc_html_e(
        'Single Product',
        'gravityforms'
    ); ?></option>
				<option value="select"><?php esc_html_e(
        'Drop Down',
        'gravityforms'
    ); ?></option>
				<option value="radio"><?php esc_html_e(
        'Radio Buttons',
        'gravityforms'
    ); ?></option>
				<option value="price"><?php esc_html_e(
        'User Defined Price',
        'gravityforms'
    ); ?></option>
				<option value="hiddenproduct"><?php esc_html_e(
        'Hidden',
        'gravityforms'
    ); ?></option>
				<option value="calculation"><?php esc_html_e(
        'Calculation',
        'gravityforms'
    ); ?></option>
			</select>
		</li>
		<?php do_action('gform_field_standard_settings', 37, $form_id); ?>
		<li class="shipping_field_type_setting field_setting">
			...
			<select id="shipping_field_type" onchange="if(jQuery(this).val() == '') return; jQuery('#field_settings').slideUp(function(){StartChangeShippingType(jQuery('#shipping_field_type').val());});">
				<option value="singleshipping"><?php esc_html_e(
        'Single Method',
        'gravityforms'
    ); ?></option>
				<option value="select"><?php esc_html_e(
		...
		<?php do_action('gform_field_standard_settings', 50, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 75, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 100, $form_id); ?>
        ...
        'gravityforms'
				...
				<option value="checkbox"><?php esc_html_e(
        'Checkboxes',
        'gravityforms'
    ); ?></option>
				<option value="radio"><?php esc_html_e(
		...
		<?php do_action('gform_field_standard_settings', 125, $form_id); ?>
        ...
        'gravityforms'
				...
				<option value="donation"><?php esc_html_e(
        'User Defined Price',
        'gravityforms'
    ); ?></option>
				<option value="radio"><?php esc_html_e(
		...
		<?php do_action('gform_field_standard_settings', 150, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 200, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 225, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 237, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 250, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 300, $form_id); ?>
		<li class="post_custom_field_type_setting field_setting">
			...
			<select id="post_custom_field_type" onchange="if(jQuery(this).val() == '') return; jQuery('#field_settings').slideUp(function(){StartChangePostCustomFieldType(jQuery('#post_custom_field_type').val());});">
				<optgroup class="option_header" label="<?php esc_attr_e(
        'Standard Fields',
        'gravityforms'
    ); ?>">
					<option value="text"><?php esc_html_e(
         'Single Line Text',
         'gravityforms'
     ); ?></option>
					<option value="textarea"><?php esc_html_e(
         'Paragraph Text',
         'gravityforms'
     ); ?></option>
					<option value="select"><?php esc_html_e(
         ...
         'gravityforms'
					...
					<option value="multiselect"><?php esc_html_e(
         'Multi Select',
         'gravityforms'
     ); ?></option>
					<option value="number"><?php esc_html_e('Number', 'gravityforms'); ?></option>
         ...
         'gravityforms'
				...
				<optgroup class="option_header" label="<?php esc_html_e(
        'Advanced Fields',
        'gravityforms'
    ); ?>">
					...
					<option value="fileupload"><?php esc_html_e(
         'File Upload',
         'gravityforms'
     ); ?></option>
		...
		<?php do_action('gform_field_standard_settings', 350, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 400, $form_id); ?>
		<?php
  if (class_exists('ReallySimpleCaptcha')) {<?php
      ...
      ?>
			<li class="captcha_type_setting field_setting">
				...
				<select id="field_captcha_type" onchange="StartChangeCaptchaType(jQuery(this).val())">
					<option value="simple_captcha"><?php esc_html_e(
         'Really Simple CAPTCHA',
         'gravityforms'
     ); ?></option>
					<option value="math"><?php esc_html_e(
         'Math Challenge',
         'gravityforms'
     ); ?></option>
				</select>
			</li>
			<?php do_action('gform_field_standard_settings', 450, $form_id); ?>
			...
			<?php do_action('gform_field_standard_settings', 500, $form_id); ?>
			...
			<?php do_action('gform_field_standard_settings', 550, $form_id); ?>
  ...
  $recaptcha_image_base =
      $recaptcha_type == 'invisible'
          ? '/images/captcha_invisible_'
          : '/images/captcha_';
  ?>
		<li class="captcha_theme_setting field_setting">
			...
			<select id="field_captcha_theme" onchange="SetCaptchaTheme(this.value, '<?php echo GFCommon::get_base_url() .
       $recaptcha_image_base; ?>' + this.value + '.jpg')">
      ...
      do_action('gform_field_standard_settings', 625, $form_id); ?>
			<li class="captcha_badge_setting field_setting">
				...
				<select id="field_captcha_badge" onchange="SetFieldProperty('captchaBadge', jQuery(this).val());">
					<option value="bottomright"><?php esc_html_e(
         'Bottom Right',
         'gravityforms'
     ); ?></option>
					<option value="bottomleft"><?php esc_html_e(
         'Bottom Left',
         'gravityforms'
     ); ?></option>
  ...
  ?>
     ...
     foreach ($custom_field_names as $name) { ?>
						<option value="<?php echo esc_attr($name); ?>"><?php echo esc_html(
    $name
); ?></option>
					<?php }
     ?>
		...
		<?php do_action('gform_field_standard_settings', 700, $form_id); ?>
		<li class="post_status_setting field_setting">
			...
			<select id="field_post_status" name="field_post_status">
				<?php
    $post_stati = apply_filters('gform_post_status_options', [
    ...
    ?>
		...
		<?php do_action('gform_field_standard_settings', 750, $form_id); ?>
		<li class="post_author_setting field_setting">
			...
			<?php
   $args = ['name' => 'field_post_author'];
   $args = gf_apply_filters(
       ['gform_author_dropdown_args', rgar($form, 'id')],
       $args
   );
   ...
   ?>
			<div>
				...
				<label for="gfield_current_user_as_author" class="inline"><?php esc_html_e(
        'Use logged in user as author',
        'gravityforms'
    ); ?> <?php gform_tooltip('form_field_current_user_as_author'); ?></label>
			</div>
		</li>

		<?php do_action('gform_field_standard_settings', 775, $form_id); ?>
    ...
    foreach ($post_formats[0] as $post_format) {
        ...
        $post_formats_dropdown .=
            "<option value='$post_format_val'>" .
            ucfirst($post_format_text) .
            '</option>';
    }

    echo '<select name="field_post_format" id="field_post_format">' .
        $post_formats_dropdown .
        '</select>';
    ?>
		...
		<?php do_action('gform_field_standard_settings', 800, $form_id); ?>
       ...
       'hide_empty' => 0,
       'id' => 'field_post_category',
       'name' => 'field_post_category',
       'orderby' => 'name',
       'selected' => 'field_post_category',
       'hierarchical' => true,
   ]); ?>
		</li>

		<?php do_action('gform_field_standard_settings', 825, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 850, $form_id); ?>
     ...
     ?>
		...
		<?php do_action('gform_field_standard_settings', 875, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 900, $form_id); ?>
		<li class="post_content_template_setting field_setting">
			<label class="section_label"><?php esc_html_e(
       'Content Template',
       'gravityforms'
   ); ?></label>
			...
			<div id="gfield_post_content_container">
				<div>
					<?php GFCommon::insert_post_content_variables(
         $form['fields'],
         'field_post_content_template',
         '',
         25
     ); ?>
				</div>
		...
		<?php do_action('gform_field_standard_settings', 950, $form_id); ?>
       ...
       'gravityforms'
		...
		<?php do_action('gform_field_standard_settings', 975, $form_id); ?>
		<li class="customfield_content_template_setting field_setting">
			...
			<div id="gfield_customfield_content_container">
				<div>
					<?php GFCommon::insert_post_content_variables(
         $form['fields'],
         'field_customfield_content_template',
		...
		<?php do_action('gform_field_standard_settings', 1000, $form_id); ?>
		<li class="post_image_setting field_setting">
			<label class="section_label"><?php esc_html_e(
       'Image Metadata',
       'gravityforms'
   ); ?> <?php gform_tooltip('form_field_image_meta'); ?></label>
		...
		<?php do_action('gform_field_standard_settings', 1025, $form_id); ?>
       ...
       'gravityforms'
			...
			<label for="gfield_featured_image" class="inline"><?php esc_html_e(
       'Set as Featured Image',
       'gravityforms'
   ); ?> <?php gform_tooltip('form_field_featured_image'); ?></label>
		</li>

		<?php do_action('gform_field_standard_settings', 1050, $form_id); ?>
		<li class="address_setting field_setting">
			<?php $addressTypes = $gf_address_field->get_address_types(
       rgar($form, 'id')
   ); ?>
    ...
    $addressType['label']
			...
			<?php foreach ($addressTypes as $key => $addressType) {
       $state_label = isset($addressType['state_label'])
           ? esc_attr($addressType['state_label'])
           : __('State', 'gravityforms'); ?>
				<div id="address_type_container_<?php echo esc_attr(
        $key
    ); ?>" class="gfield_sub_setting gfield_address_type_container">
					<input type="hidden" id="field_address_country_<?php echo esc_attr(
         $key
     ); ?>" value="<?php echo isset($addressType['country'])
    ? esc_attr($addressType['country'])
    : ''; ?>" />
					<input type="hidden" id="field_address_zip_label_<?php echo esc_attr(
         $key
     ); ?>" value="<?php echo isset($addressType['zip_label'])
    ? esc_attr($addressType['zip_label'])
    : __('Postal Code', 'gravityforms'); ?>" />
					<input type="hidden" id="field_address_state_label_<?php echo esc_attr(
         $key
     ); ?>" value="<?php echo $state_label; ?>" />
					<input type="hidden" id="field_address_has_states_<?php echo esc_attr(
         $key
     ); ?>" value="<?php echo is_array(rgget('states', $addressType))
    ? '1'
    : ''; ?>" />

					<?php if (
         isset($addressType['states']) &&
         is_array($addressType['states'])
						...
						<select id="field_address_default_state_<?php echo esc_attr(
          $key
					...
					<?php if (!isset($addressType['country'])) { ?>
		...
		<?php do_action('gform_field_standard_settings', 1100, $form_id); ?>
		<li class="name_format_setting field_setting">
			...
			<select id="field_name_format" onchange="StartChangeNameFormat(jQuery(this).val());">
				<option value="extended"><?php esc_html_e(
        'Extended',
        'gravityforms'
    ); ?></option>
				<option value="advanced"><?php esc_html_e(
        'Advanced',
        'gravityforms'
    ); ?></option>
			</select>
		</li>
		<?php do_action('gform_field_standard_settings', 1125, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1150, $form_id); ?>
		<li class="date_input_type_setting field_setting">
			...
			<select id="field_date_input_type" onchange="SetDateInputType(jQuery(this).val());">
				<option value="datefield"><?php esc_html_e(
        'Date Field',
        'gravityforms'
    ); ?></option>
				<option value="datepicker"><?php esc_html_e(
        'Date Picker',
        'gravityforms'
    ); ?></option>
				<option value="datedropdown"><?php esc_html_e(
        'Date Drop Down',
        'gravityforms'
    ); ?></option>
			</select>
			...
			<div id="date_picker_container">
				...
				<div id="gfield_icon_url_container">
					...
					<div class="instruction"><?php esc_html_e(
         'Preview this form to see your custom icon.',
         'gravityforms'
     ); ?></div>
				</div>
			</div>
		</li>
		<?php do_action('gform_field_standard_settings', 1200, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1225, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1250, $form_id); ?>
        ...
        'Separated with commas (i.e. jpg, gif, png, pdf)',
        'gravityforms'
    ); ?></small>
			</div>
		</li>
		<?php do_action('gform_field_standard_settings', 1260, $form_id); ?>
       ...
       'gravityforms'
		...
		<?php do_action('gform_field_standard_settings', 1267, $form_id); ?>
   ...
   ?>MB" />
			...
			<div id="gform_server_max_file_size_notice">
				<small><?php printf(
        esc_html__('Maximum allowed on this server: %sMB', 'gravityforms'),
        $max_upload_size
    ); ?></small>
			</div>
		</li>

		<?php do_action('gform_field_standard_settings', 1275, $form_id); ?>
   ...
   ?></label>
		...
		<?php do_action('gform_field_standard_settings', 1287, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1300, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1325, $form_id); ?>
    ...
    ?>
		...
		<?php do_action('gform_field_standard_settings', 1350, $form_id); ?>
		<li class="choices_setting field_setting">
			...
			<div style="float:right;">
				...
				<label for="field_choice_values_enabled" class="inline gfield_value_label"><?php esc_html_e(
        'show values',
        'gravityforms'
    ); ?></label>
			</div>

			<label for="choices" class="section_label"><?php echo apply_filters(
       'gform_choices_setting_title',
       __('Choices', 'gravityforms')
   ); ?>
			<?php gform_tooltip('form_field_choices'); ?></label>

			<div id="gfield_settings_choices_container">
				<label class="gfield_choice_header_label"><?php esc_html_e(
        'Label',
        'gravityforms'
    ); ?></label><label class="gfield_choice_header_value"><?php esc_html_e('Value', 'gravityforms'); ?></label><label class="gfield_choice_header_price"><?php esc_html_e('Price', 'gravityforms'); ?></label>
       ...
       $window_title
   ); ?>' onclick="tb_show('<?php echo esc_js($window_title); ?>', '#TB_inline?height=400&amp;width=600&amp;inlineId=gfield_bulk_add', '');" onkeypress="tb_show('<?php echo esc_js($window_title); ?>', '#TB_inline?height=400&amp;width=600&amp;inlineId=gfield_bulk_add', '');" class="button" />
     ...
     $predefined_choices = [
         ...
         __(
             'U.S. States',
             'gravityforms'
         ) => $gf_address_field->get_us_states(),
         __(
             'Canadian Province/Territory',
             'gravityforms'
         ) => $gf_address_field->get_canadian_provinces(),
         __('Continents', 'gravityforms') => [
             __('Africa', 'gravityforms'),
             __('Antarctica', 'gravityforms'),
             __('Asia', 'gravityforms'),
             __('Australia', 'gravityforms'),
             __('Europe', 'gravityforms'),
             __('North America', 'gravityforms'),
             __('South America', 'gravityforms'),
         ],
         __('Gender', 'gravityforms') => [
             __('Male', 'gravityforms'),
             __('Female', 'gravityforms'),
             __('Prefer Not to Answer', 'gravityforms'),
         ],
         __('Age', 'gravityforms') => [
             __('Under 18', 'gravityforms'),
             __('18-24', 'gravityforms'),
             __('25-34', 'gravityforms'),
             __('35-44', 'gravityforms'),
             __('45-54', 'gravityforms'),
             __('55-64', 'gravityforms'),
             __('65 or Above', 'gravityforms'),
             __('Prefer Not to Answer', 'gravityforms'),
         ],
         __('Marital Status', 'gravityforms') => [
             __('Single', 'gravityforms'),
             __('Married', 'gravityforms'),
             __('Divorced', 'gravityforms'),
             __('Widowed', 'gravityforms'),
         ],
         __('Employment', 'gravityforms') => [
             __('Employed Full-Time', 'gravityforms'),
             __('Employed Part-Time', 'gravityforms'),
             __('Self-employed', 'gravityforms'),
             __('Not employed but looking for work', 'gravityforms'),
             __('Not employed and not looking for work', 'gravityforms'),
             __('Homemaker', 'gravityforms'),
             __('Retired', 'gravityforms'),
             __('Student', 'gravityforms'),
             __('Prefer Not to Answer', 'gravityforms'),
         ],
         __('Job Type', 'gravityforms') => [
             __('Full-Time', 'gravityforms'),
             __('Part-Time', 'gravityforms'),
             __('Per Diem', 'gravityforms'),
             __('Employee', 'gravityforms'),
             __('Temporary', 'gravityforms'),
             __('Contract', 'gravityforms'),
             __('Intern', 'gravityforms'),
             __('Seasonal', 'gravityforms'),
         ],
         __('Industry', 'gravityforms') => [
             __('Accounting/Finance', 'gravityforms'),
             __('Advertising/Public Relations', 'gravityforms'),
             __('Aerospace/Aviation', 'gravityforms'),
             __('Arts/Entertainment/Publishing', 'gravityforms'),
             __('Automotive', 'gravityforms'),
             __('Banking/Mortgage', 'gravityforms'),
             __('Business Development', 'gravityforms'),
             __('Business Opportunity', 'gravityforms'),
             __('Clerical/Administrative', 'gravityforms'),
             __('Construction/Facilities', 'gravityforms'),
             __('Consumer Goods', 'gravityforms'),
             __('Customer Service', 'gravityforms'),
             __('Education/Training', 'gravityforms'),
             __('Energy/Utilities', 'gravityforms'),
             __('Engineering', 'gravityforms'),
             __('Government/Military', 'gravityforms'),
             __('Green', 'gravityforms'),
             __('Healthcare', 'gravityforms'),
             __('Hospitality/Travel', 'gravityforms'),
             __('Human Resources', 'gravityforms'),
             __('Installation/Maintenance', 'gravityforms'),
             __('Insurance', 'gravityforms'),
             __('Internet', 'gravityforms'),
             __('Job Search Aids', 'gravityforms'),
             __('Law Enforcement/Security', 'gravityforms'),
             __('Legal', 'gravityforms'),
             __('Management/Executive', 'gravityforms'),
             __('Manufacturing/Operations', 'gravityforms'),
             __('Marketing', 'gravityforms'),
             __('Non-Profit/Volunteer', 'gravityforms'),
             __('Pharmaceutical/Biotech', 'gravityforms'),
             __('Professional Services', 'gravityforms'),
             __('QA/Quality Control', 'gravityforms'),
             __('Real Estate', 'gravityforms'),
             __('Restaurant/Food Service', 'gravityforms'),
             __('Retail', 'gravityforms'),
             __('Sales', 'gravityforms'),
             __('Science/Research', 'gravityforms'),
             __('Skilled Labor', 'gravityforms'),
             __('Technology', 'gravityforms'),
             __('Telecommunications', 'gravityforms'),
             __('Transportation/Logistics', 'gravityforms'),
             __('Other', 'gravityforms'),
         ],
         __('Education', 'gravityforms') => [
             __('High School', 'gravityforms'),
             __('Associate Degree', 'gravityforms'),
             __("Bachelor's Degree", 'gravityforms'),
             __('Graduate or Professional Degree', 'gravityforms'),
             __('Some College', 'gravityforms'),
             __('Other', 'gravityforms'),
             __('Prefer Not to Answer', 'gravityforms'),
         ],
         __('Days of the Week', 'gravityforms') => [
             __('Sunday', 'gravityforms'),
             __('Monday', 'gravityforms'),
             __('Tuesday', 'gravityforms'),
             __('Wednesday', 'gravityforms'),
             __('Thursday', 'gravityforms'),
             __('Friday', 'gravityforms'),
             __('Saturday', 'gravityforms'),
         ],
         __('Months of the Year', 'gravityforms') => [
             __('January', 'gravityforms'),
             __('February', 'gravityforms'),
             __('March', 'gravityforms'),
             __('April', 'gravityforms'),
             __('May', 'gravityforms'),
             __('June', 'gravityforms'),
             __('July', 'gravityforms'),
             __('August', 'gravityforms'),
             __('September', 'gravityforms'),
             __('October', 'gravityforms'),
             __('November', 'gravityforms'),
             __('December', 'gravityforms'),
         ],
         __('How Often', 'gravityforms') => [
             __('Every day', 'gravityforms'),
             __('Once a week', 'gravityforms'),
             __('2 to 3 times a week', 'gravityforms'),
             __('Once a month', 'gravityforms'),
             __('2 to 3 times a month', 'gravityforms'),
             __('Less than once a month', 'gravityforms'),
         ],
         __('How Long', 'gravityforms') => [
             __('Less than a month', 'gravityforms'),
             __('1-6 months', 'gravityforms'),
             __('1-3 years', 'gravityforms'),
             __('Over 3 years', 'gravityforms'),
             __('Never used', 'gravityforms'),
         ],
         __('Satisfaction', 'gravityforms') => [
             __('Very Satisfied', 'gravityforms'),
             __('Satisfied', 'gravityforms'),
             __('Neutral', 'gravityforms'),
             __('Unsatisfied', 'gravityforms'),
             __('Very Unsatisfied', 'gravityforms'),
         ],
         __('Importance', 'gravityforms') => [
             __('Very Important', 'gravityforms'),
             __('Important', 'gravityforms'),
             __('Somewhat Important', 'gravityforms'),
             __('Not Important', 'gravityforms'),
         ],
         __('Agreement', 'gravityforms') => [
             __('Strongly Agree', 'gravityforms'),
             __('Agree', 'gravityforms'),
             __('Disagree', 'gravityforms'),
             __('Strongly Disagree', 'gravityforms'),
         ],
         __('Comparison', 'gravityforms') => [
             __('Much Better', 'gravityforms'),
             __('Somewhat Better', 'gravityforms'),
             __('About the Same', 'gravityforms'),
             __('Somewhat Worse', 'gravityforms'),
             __('Much Worse', 'gravityforms'),
         ],
         __('Would You', 'gravityforms') => [
             __('Definitely', 'gravityforms'),
             __('Probably', 'gravityforms'),
             __('Not Sure', 'gravityforms'),
             __('Probably Not', 'gravityforms'),
             __('Definitely Not', 'gravityforms'),
         ],
         __('Size', 'gravityforms') => [
             __('Extra Small', 'gravityforms'),
             __('Small', 'gravityforms'),
             __('Medium', 'gravityforms'),
             __('Large', 'gravityforms'),
             __('Extra Large', 'gravityforms'),
         ],
     ];
     $predefined_choices = gf_apply_filters(
         ['gform_predefined_choices', rgar($form, 'id')],
         $predefined_choices
     );
     ...
     ?>
					...
					<div class="panel-instructions"><?php esc_html_e(
         'Select a category and customize the predefined choices or paste your own list to bulk add choices.',
         'gravityforms'
     ); ?></div>

					<div class="bulk-left-panel">
						<ul id="bulk_items">
							<?php foreach (array_keys($predefined_choices) as $name) {
          ...
          'gravityforms'
					...
					<div class="panel-custom" style="">
						<a href="javascript:void(0);" onclick="LoadCustomChoicesPanel(true, 'slow');" onkeypress="LoadCustomChoicesPanel(true, 'slow');" id="bulk_save_as"><?php esc_html_e(
          'Save as new custom choice',
          'gravityforms'
      ); ?></a>

						<div id="bulk_custom_edit" style="display:none;">
							<?php esc_html_e('Save as', 'gravityforms'); ?>
							<input type="text" id="custom_choice_name" value="<?php esc_attr_e(
           'Enter name',
           'gravityforms'
       ); ?>" onfocus="if(this.value == '<?php echo esc_js(__('enter name', 'gravityforms')); ?>') this.value='';">&nbsp;&nbsp;
							<a href="javascript:void(0);" onclick="SaveCustomChoices();" onkeypress="SaveCustomChoices();" class="button" id="bulk_save_button"><?php esc_html_e(
           'Save',
           'gravityforms'
       ); ?></a>&nbsp;
							<a href="javascript:void(0);" onclick="CloseCustomChoicesPanel('slow');" onkeypress="CloseCustomChoicesPanel('slow');" id="bulk_cancel_link"><?php esc_html_e(
           'Cancel',
           'gravityforms'
       ); ?></a>
							<a href="javascript:void(0);" onclick="DeleteCustomChoice();" onkeypress="DeleteCustomChoice();" id="bulk_delete_link"><?php esc_html_e(
           'Delete',
           'gravityforms'
       ); ?></a>
						</div>
					...
					<script type="text/javascript">
						...
						var gform_custom_choices = <?php echo GFCommon::json_encode(
          $custom_choices
      ); ?>;
						var gform_predefined_choices = <?php echo GFCommon::json_encode(
          $predefined_choices
      ); ?>;
					</script>
		...
		<?php do_action('gform_field_standard_settings', 1360, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1362, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1368, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1375, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1387, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1400, $form_id); ?>
		...
		<li class="number_format_setting field_setting">
			...
			<select id="field_number_format" onchange="SetFieldProperty('numberFormat', this.value);jQuery('.field_calculation_rounding').toggle(this.value != 'currency');">
				...
				<option value="currency"><?php esc_html_e(
        'Currency',
        'gravityforms'
    ); ?></option>
			</select>
    ...
    foreach ($cards as $card) { ?>
					...
					<li>
						<input type="checkbox" id="field_credit_card_<?php echo esc_attr(
          $card['slug']
      ); ?>" value="<?php echo esc_attr(
    $card['slug']
); ?>" onclick="SetCardType(this, this.value);" onkeypress="SetCardType(this, this.value);" />
						<label for="field_credit_card_<?php echo esc_attr(
          $card['slug']
    ...
    ?>
		...
		<?php do_action('gform_field_standard_settings', 1435, $form_id); ?>
		...
		<li class="input_mask_setting field_setting">
			...
			<div id="gform_input_mask">
				...
				<p class="mask_text_description" style="margin:5px 0 0;">
					...
					<a href="javascript:void(0);" onclick="tb_show('<?php echo esc_js(
         __('Custom Mask Instructions', 'gravityforms')
     ); ?>', '#TB_inline?width=350&amp;inlineId=custom_mask_instructions', '');" onkeypress="tb_show('<?php echo esc_js(__('Custom Mask Instructions', 'gravityforms')); ?>', '#TB_inline?width=350&amp;inlineId=custom_mask_instructions', '');"><?php esc_html_e('Help', 'gravityforms'); ?></a>
				</p>
           ...
           'gravityforms'
						...
						<ul class="examples-list">
							<li>
								...
								<span class="label"><?php esc_html_e(
            'Mask',
            'gravityforms'
     ...
     foreach ($masks as $mask_name => $mask_value) { ?>
						<option value="<?php echo esc_attr($mask_value); ?>"><?php echo esc_html(
    $mask_name
); ?></option>
					<?php }
     ?>
		...
		<?php do_action('gform_field_standard_settings', 1500, $form_id); ?>
		...
		<?php do_action('gform_field_standard_settings', 1550, $form_id); ?>
		...
		<li class="calculation_setting field_setting">
			...
			<div id="calculation_options" style="display:none;margin-top:10px;">
				...
				<div>
					<?php GFCommon::insert_calculation_variables(
         $form['fields'],
         'field_calculation_formula',
         '',
         'FormulaContentCallback',
         40
     ); ?>
					<div class="gf_calculation_buttons">
						<?php foreach (['+', '-', '/', '*', '(', ')', '.'] as $button) { ?>
							<input type="button" value="<?php echo in_array($button, ['.'])
           ? $button
           : " $button "; ?>" onclick="InsertVariable('field_calculation_formula', 'FormulaContentCallback', this.value);" onkeypress="InsertVariable('field_calculation_formula', 'FormulaContentCallback', this.value);" />
						<?php } ?>
					</div>
				</div>
				<textarea id="field_calculation_formula" class="fieldwidth-3 fieldheight-2"></textarea>
				<br />
				<a href="javascript:void(0)" onclick="var field = GetSelectedField(); alert(IsValidFormula(field.calculationFormula) ? '<?php echo esc_js(
        __('The formula appears to be valid.', 'gravityforms')
    ); ?>' : '<?php echo esc_js(__('There appears to be a problem with the formula.', 'gravityforms')); ?>');" onkeypress="var field = GetSelectedField(); alert(IsValidFormula(field.calculationFormula) ? '<?php echo esc_js(__('The formula appears to be valid.', 'gravityforms')); ?>' : '<?php echo esc_js(__('There appears to be a problem with the formula.', 'gravityforms')); ?>');"><?php esc_html_e('Validate Formula', 'gravityforms'); ?></a>
				...
				<div class="field_calculation_rounding">
					...
					<select id="field_calculation_rounding" onchange="SetFieldProperty('calculationRounding', this.value);">
						...
						<option value="norounding"><?php esc_html_e(
          'Do not round',
          'gravityforms'
      ); ?></option>
					</select>
		...
		<?php do_action('gform_field_standard_settings', 1600, $form_id); ?>

		<li class="rules_setting field_setting">
			<label for="rules" class="section_label"><?php esc_html_e(
       'Rules',
       'gravityforms'
   ); ?></label>
		...
		<?php do_action('gform_field_standard_settings', -1, $form_id); ?>
		</ul>
		</div>
		<div id="gform_tab_3">
            <ul>
    ...
    do_action('gform_field_appearance_settings', 0, $form_id); ?>
                <li class="placeholder_setting field_setting">
					...
					<span id="placeholder_warning" style="display:none"><?php _e(
         'Placeholder text is not supported when using the Rich Text Editor.',
         'gravityforms'
     ); ?></span>
                </li>
				<?php do_action('gform_field_appearance_settings', 20, $form_id); ?>
         ...
         'gravityforms'
				...
				<?php do_action('gform_field_appearance_settings', 50, $form_id); ?>
    ...
    switch ($label_placement_form_setting) {
        case 'left_label':
            $label_placement_form_setting_label = __(
                'Left aligned',
                'gravityforms'
            );
            break;
    ...
    $description_placement_form_setting_label =
        $description_placement_form_setting == 'above'
            ? ($description_placement_form_setting_label = __(
                'Above inputs',
                'gravityforms'
            ))
            : ($description_placement_form_setting_label = __(
    ...
    ?>
          ...
          __('Visible (%s)', 'gravityforms'),
          esc_html($label_placement_form_setting_label)
      ); ?></option>
						<option value="hidden_label"><?php esc_html_e(
          'Hidden',
          'gravityforms'
      ); ?></option>
					</select>
					<div id="field_description_placement_container" style="display:none; padding-top:10px;">
						...
						<select id="field_description_placement"
							...
							<option
								value=""><?php printf(
            __('Use Form Setting (%s)', 'gravityforms'),
            esc_html($description_placement_form_setting_label)
        ); ?></option>
							<option value="below"><?php esc_html_e(
           'Below inputs',
           'gravityforms'
       ); ?></option>
							<option value="above"><?php esc_html_e(
           'Above inputs',
           'gravityforms'
       ); ?></option>
						</select>
    ...
    $sub_label_placement_form_setting_label =
        $sub_label_placement_form_setting == 'above'
            ? ($sub_label_placement_form_setting_label = __(
                'Above inputs',
                'gravityforms'
            ))
            : ($sub_label_placement_form_setting_label = __(
    ...
    ?>
				<li class="sub_label_placement_setting field_setting">
					...
					<select id="field_sub_label_placement"
						...
						<option
							value=""><?php printf(
           __('Use Form Setting (%s)', 'gravityforms'),
           esc_html($sub_label_placement_form_setting_label)
       ); ?></option>
						<option value="below"><?php esc_html_e(
          'Below inputs',
          'gravityforms'
          ...
          'gravityforms'
				...
				<?php do_action('gform_field_appearance_settings', 250, $form_id); ?>
    ...
    ?>
				...
				<li class="size_setting field_setting">
					...
					<select id="field_size" onchange="SetFieldSize(jQuery(this).val());"><?php foreach (
         $size_choices
         as $size_choice
     ) {
         ...
         printf(
             ...
             esc_attr($size_choice['value']),
             esc_html($size_choice['text'])
         );
     } ?></select>
				</li>
  ...
  do_action('gform_field_advanced_settings', 0, $form_id); ?>
		...
		<?php do_action('gform_field_advanced_settings', 150, $form_id); ?>
		...
		<?php do_action('gform_field_advanced_settings', 155, $form_id); ?>
       ...
       'Label',
       'gravityforms'
   ); ?></label><label class="gfield_choice_header_value"><?php esc_html_e('Value', 'gravityforms'); ?></label>
			<ul id="field_prefix_choices" class="field_input_choices">
				<!-- content dynamically created from js.php -->
			</ul>
		</div>
		</li>
		<?php do_action('gform_field_advanced_settings', 175, $form_id); ?>
		...
		<?php do_action('gform_field_advanced_settings', 185, $form_id); ?>
        ...
        'gravityforms'
			...
			<div id="field_copy_values_disabled" style="display:none;padding-top: 10px;">
	            <span class="instruction" style="margin-left:0">
	                <?php esc_html_e(
                     'To activate this option, please add a field to be used as the source.',
                     'gravityforms'
                 ); ?>
  ...
  ?>
		<li class="captcha_language_setting field_setting">
			...
			<select id="field_captcha_language" onchange="SetFieldProperty('captchaLanguage', this.value);">
				...
				<option value="zh-HK"><?php esc_html_e(
        'Chinese (Hong Kong)',
        'gravityforms'
    ); ?></option>
				<option value="zh-CN"><?php esc_html_e(
        'Chinese (Simplified)',
        'gravityforms'
    ); ?></option>
				<option value="zh-TW"><?php esc_html_e(
        'Chinese (Traditional)',
        'gravityforms'
    ); ?></option>
				...
				<option value="en-GB"><?php esc_html_e(
        'English (UK)',
        'gravityforms'
    ); ?></option>
				...
				<option value="fr-CA"><?php esc_html_e(
        'French (Canadian)',
        'gravityforms'
    ); ?></option>
				...
				<option value="de-AT"><?php esc_html_e(
        'German (Austria)',
        'gravityforms'
    ); ?></option>
				<option value="de-CH"><?php esc_html_e(
        'German (Switzerland)',
        'gravityforms'
    ); ?></option>
				...
				<option value="pt-BR"><?php esc_html_e(
        'Portuguese (Brazil)',
        'gravityforms'
    ); ?></option>
				<option value="pt-PT"><?php esc_html_e(
        'Portuguese (Portugal)',
        'gravityforms'
    ); ?></option>
				...
				<option value="es-419"><?php esc_html_e(
  ...
  ?>
		...
		<?php do_action('gform_field_advanced_settings', 337, $form_id); ?>
		...
		<?php do_action('gform_field_advanced_settings', 350, $form_id); ?>
   ...
   ?></label>
		...
		<?php do_action('gform_field_advanced_settings', 375, $form_id); ?>
   ...
   ?></label>
		...
		<?php do_action('gform_field_advanced_settings', 400, $form_id); ?>
		<li class="visibility_setting field_setting">
			<label for="visibility" class="section_label"><?php esc_html_e(
       'Visibility',
       'gravityforms'
   ); ?> <?php gform_tooltip('form_field_visibility'); ?></label>
			<div>
				<?php foreach (GFCommon::get_visibility_options() as $visibility_option):
        $slug = sanitize_title_with_dashes($visibility_option['value']); ?>

					<input type="radio" name="field_visibility" id="field_visibility_<?php echo $slug; ?>" size="10" value="<?php echo $visibility_option[
    'value'
]; ?>" onclick="return SetFieldVisibility( this.value );" onkeypress="return SetFieldVisibility( this.value );" />
    ...
    endforeach; ?>
		...
		<?php do_action('gform_field_advanced_settings', 425, $form_id); ?>
		<li class="rich_text_editor_setting field_setting">
			...
			<label for="field_rich_text_editor" class="inline"><?php _e(
       'Use the Rich Text Editor',
       'gravityforms'
   ); ?> <?php gform_tooltip('form_field_rich_text_editor'); ?></label>
		</li>

		<?php do_action('gform_field_advanced_settings', 450, $form_id); ?>
		<li class="prepopulate_field_setting field_setting">
			...
			<label for="field_prepopulate" class="inline"><?php esc_html_e(
       'Allow field to be populated dynamically',
       'gravityforms'
   ); ?> <?php gform_tooltip('form_field_prepopulate'); ?></label>
			<br />
		...
		<?php do_action('gform_field_advanced_settings', 500, $form_id); ?>
		<li class="conditional_logic_field_setting field_setting">
			...
			<label for="field_conditional_logic" class="inline"><?php esc_html_e(
       'Enable Conditional Logic',
       'gravityforms'
   ); ?> <?php gform_tooltip('form_field_conditional_logic'); ?></label>
			<br />
		...
		<?php do_action('gform_field_advanced_settings', 525, $form_id); ?>
		<li class="conditional_logic_page_setting field_setting">
			...
			<label for="page_conditional_logic" class="inline"><?php esc_html_e(
       'Enable Page Conditional Logic',
       'gravityforms'
   ); ?> <?php gform_tooltip('form_page_conditional_logic'); ?></label>
			<br />
		...
		<?php do_action('gform_field_advanced_settings', 550, $form_id); ?>
		<li class="conditional_logic_nextbutton_setting field_setting">
			...
			<label for="next_button_conditional_logic" class="inline"><?php esc_html_e(
       'Enable Next Button Conditional Logic',
       'gravityforms'
   ); ?> <?php gform_tooltip('form_nextbutton_conditional_logic'); ?></label>
			<br />
		...
		<?php do_action('gform_field_advanced_settings', -1, $form_id); ?>
		</ul>
		</div>
      ...
      foreach ($field_groups as $group) {
          $tooltip_class = empty($group['tooltip_class'])
              ? 'tooltip_left'
              : $group['tooltip_class']; ?>
							<li id="add_<?php echo esc_attr(
           $group['name']
       ); ?>" class="add_field_button_container">
								<div class="button-title-link <?php echo $group['name'] == 'standard_fields'
            ? 'gf_button_title_active'
            : ''; ?>">
									<div class="add-buttons-title"><?php echo esc_html(
             $group['label']
         ); ?> <?php gform_tooltip(
     "form_{$group['name']}",
     $tooltip_class
     ...
     $save_button =
         '<input type="button" class="button button-large button-primary update-form" value="' .
         $save_button_text .
         '" onclick="SaveForm();" onkeypress="SaveForm();" />';
     ...
     $cancel_button =
         ...
         '" class="button button-large cancel-update-form">' .
     ...
     if (GFCommon::current_user_can_any('gravityforms_delete_forms')) {
         $trash_link =
             '<a class="submitdelete" onclick="gf_vars.isFormTrash = true; jQuery(\'#form_trash\')[0].submit();" onkeypress="gf_vars.isFormTrash = true; jQuery(\'#form_trash\')[0].submit();">' .
             __('Move to Trash', 'gravityforms') .
             '</a>';
     ...
     ?>
           ...
           trailingslashit(site_url())
       ); ?>?gf_page=preview&id=<?php echo absint(rgar($form, 'id')); ?>" target="_blank"><?php esc_html_e('Preview', 'gravityforms'); ?></a></strong>
					</div>
  ...
  require_once GFCommon::get_base_path() . '/js.php';
    ...
    public static function get_field_groups()
    {
            ...
            'standard_fields' => [
                ...
                'fields' => [
                    [
                        'class' => 'button',
                        'data-type' => 'text',
                        'value' => GFCommon::get_field_type_title('text'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'textarea',
                        'value' => GFCommon::get_field_type_title('textarea'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'select',
                        'value' => GFCommon::get_field_type_title('select'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'multiselect',
                        'value' => GFCommon::get_field_type_title(
                            'multiselect'
                        ),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'number',
                        'value' => GFCommon::get_field_type_title('number'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'checkbox',
                        'value' => GFCommon::get_field_type_title('checkbox'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'radio',
                        'value' => GFCommon::get_field_type_title('radio'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'hidden',
                        'value' => GFCommon::get_field_type_title('hidden'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'html',
                        'value' => GFCommon::get_field_type_title('html'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'section',
                        'value' => GFCommon::get_field_type_title('section'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'page',
                        'value' => GFCommon::get_field_type_title('page'),
                    ],
                ],
            ],
            'advanced_fields' => [
                ...
                'fields' => [
                    [
                        'class' => 'button',
                        'data-type' => 'name',
                        'value' => GFCommon::get_field_type_title('name'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'date',
                        'value' => GFCommon::get_field_type_title('date'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'time',
                        'value' => GFCommon::get_field_type_title('time'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'phone',
                        'value' => GFCommon::get_field_type_title('phone'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'address',
                        'value' => GFCommon::get_field_type_title('address'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'website',
                        'value' => GFCommon::get_field_type_title('website'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'email',
                        'value' => GFCommon::get_field_type_title('email'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'fileupload',
                        'value' => GFCommon::get_field_type_title('fileupload'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'captcha',
                        'value' => GFCommon::get_field_type_title('captcha'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'list',
                        'value' => GFCommon::get_field_type_title('list'),
                    ],
                ],
            ],
            'post_fields' => [
                ...
                'fields' => [
                    [
                        ...
                        'value' => GFCommon::get_field_type_title('post_title'),
                    ],
                    [
                        'class' => 'button',
                    ...
                    [
                        'class' => 'button',
                        'data-type' => 'post_tags',
                        'value' => GFCommon::get_field_type_title('post_tags'),
                    ],
                    [
                        'class' => 'button',
                    ...
                    [
                        ...
                        'value' => GFCommon::get_field_type_title('post_image'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'post_custom_field',
                        'value' => GFCommon::get_field_type_title(
                            'post_custom_field'
                        ),
                    ],
            ...
            'pricing_fields' => [
                ...
                'fields' => [
                    [
                        'class' => 'button',
                        'data-type' => 'product',
                        'value' => GFCommon::get_field_type_title('product'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'quantity',
                        'value' => GFCommon::get_field_type_title('quantity'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'option',
                        'value' => GFCommon::get_field_type_title('option'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'shipping',
                        'value' => GFCommon::get_field_type_title('shipping'),
                    ],
                    [
                        'class' => 'button',
                        'data-type' => 'total',
                        'value' => GFCommon::get_field_type_title('total'),
                    ],
                ],
            ],
        ];
        ...
        if (apply_filters('gform_enable_password_field', false)) {
            ...
            array_splice($field_groups['advanced_fields']['fields'], 7, 0, [
                $password,
            ]);
        }
        ...
        if (apply_filters('gform_enable_credit_card_field', false)) {
            $field_groups['pricing_fields']['fields'][] = [
                'class' => 'button',
    ...
    public static function color_picker($field_name, $callback)
    {
		...
		<table cellpadding="0" cellspacing="0">
			<tr>
				<td>
					<input type='text' class="iColorPicker" size="7" name='<?php echo esc_attr(
         $field_name
     ); ?>' onchange='SetColorPickerColor(this.name, this.value, "<?php echo $callback; ?>");' id='<?php echo esc_attr($field_name); ?>' />
				</td>
				<td style="padding-right:5px; padding-left:5px;">
					<img style="top:3px; cursor:pointer; border:1px solid #dfdfdf;" id="chip_<?php echo esc_attr(
         $field_name
     ); ?>" valign="bottom" height="22" width="22" src="<?php echo GFCommon::get_base_url(); ?>/images/blankspace.png" />
				</td>
				<td>
					<img style="cursor:pointer;" valign="bottom" id="chooser_<?php echo esc_attr(
         $field_name
		...
		<script type="text/javascript">
			jQuery("#chooser_<?php echo esc_js($field_name); ?>").click(function (e) {
				iColorShow(e.pageX, e.pageY, '<?php echo esc_js(
        $field_name
    ); ?>', "<?php echo esc_js($callback); ?>");
			});
    ...
    private static function _cat_rows(
        $categories,
        &$count,
        &$output,
        $parent = 0,
    ...
    private static function _cat_row(
        $category,
        $level,
        &$output,
        $name_override = false
        ...
        <tr class='author-self status-inherit' valign='top'>
            <th scope='row' class='check-column'><input type='checkbox' class='gfield_category_checkbox' value='" .
            esc_attr($cat->term_id) .
            "' name='" .
            esc_attr($cat->name) .
            "' onclick='SetSelectedCategories();' onkeypress='SetSelectedCategories();' /></th>
	...
	<select id="<?php echo esc_attr(
     $element_id
 ); ?>_variable_select" onchange="InsertVariable('<?php echo esc_js(
    $element_id
); ?>', '<?php echo esc_js($callback); ?>'); ">
		<option value=''><?php esc_html_e(
      'Insert Merge Tag',
      'gravityforms'
		...
		<option value='{ip}'><?php esc_html_e(
      'User IP Address',
      'gravityforms'
  ); ?></option>
		<option value='{date_mdy}'><?php esc_html_e(
      'Date',
      'gravityforms'
  ); ?> (mm/dd/yyyy)</option>
		<option value='{date_dmy}'><?php esc_html_e(
      'Date',
      'gravityforms'
  ); ?> (dd/mm/yyyy)</option>
		<option value='{embed_post:ID}'><?php esc_html_e(
      'Embed Post/Page Id',
      'gravityforms'
  ); ?></option>
		<option value='{embed_post:post_title}'><?php esc_html_e(
      'Embed Post/Page Title',
      'gravityforms'
  ); ?></option>
		<option value='{embed_url}'><?php esc_html_e(
      'Embed URL',
      'gravityforms'
  ); ?></option>
		<option value='{user_agent}'><?php esc_html_e(
      'HTTP User Agent',
      'gravityforms'
  ); ?></option>
		<option value='{referer}'><?php esc_html_e(
      'HTTP Referer URL',
      'gravityforms'
  ); ?></option>
		<option value='{user:display_name}'><?php esc_html_e(
      'User Display Name',
      'gravityforms'
  ); ?></option>
		<option value='{user:user_email}'><?php esc_html_e(
      'User Email',
      'gravityforms'
  ); ?></option>
		<option value='{user:user_login}'><?php esc_html_e(
      'User Login',
      'gravityforms'
  ); ?></option>
	<?php
    ...
    public static function change_input_type()
    {
        ...
        require_once GFCommon::get_base_path() . '/form_display.php';
        $field_content = GFFormDisplay::get_field_content(
            $field,
            '',
            true,
            $form_id,
    ...
    public static function save_custom_choice()
    {
        ...
        RGFormsModel::save_custom_choice(
            rgpost('previous_name'),
            rgpost('new_name'),
            GFCommon::json_decode(rgpost('choices'))
        );
        exit();
    }
    ...
    public static function save_form_info($id, $form_json)
    {
        ...
        GFCommon::log_debug(
            'GFFormDetail::save_form_info(): Form meta json: ' . $form_json
        );
        ...
        GFCommon::log_debug(
            'GFFormDetail::save_form_info(): Form meta => ' .
                print_r($form_meta, true)
        );

        // If form meta is not found, exit.
        if (!$form_meta) {
            return ['status' => 'invalid_json', 'meta' => null];
        }
        ...
        foreach ($forms as $form) {
            ...
            if (
                strtolower($form->title) == strtolower($form_meta['title']) &&
                rgar($form_meta, 'id') != $form->id
            ) {
                return ['status' => 'duplicate_title', 'meta' => $form_meta];
            }
        }
        ...
        if ($id > 0) {
            ...
            if (!empty($deleted_fields)) {
                ...
                foreach ($deleted_fields as $deleted_field) {
                    // Delete field.
                    $form_meta = GFFormsModel::delete_field(
                        $form_meta,
                        $deleted_field,
                        false
                    );
            ...
            if (!empty($deleted_fields)) {
                ...
                foreach ($deleted_fields as $deleted_field) {
                    $form_meta = GFFormsModel::delete_field_from_confirmations(
                        $form_meta,
                        $deleted_field
                    );
                    $form_meta = GFFormsModel::delete_field_from_notifications(
                        $form_meta,
                        $deleted_field
                    );
                }
            ...
            return ['status' => $id, 'meta' => $form_meta];
        } else {
            //inserting form
            ...
            if (apply_filters('gform_default_notification', true)) {
                $default_notification = [
                    ...
                    'toType' => 'email',
                    'subject' =>
                        __('New submission from', 'gravityforms') .
                        ' {form_title}',
                    'message' => '{all_fields}',
                ];

                $notifications = [
                    $default_notification['id'] => $default_notification,
                ];
            ...
            return ['status' => $id * -1, 'meta' => $form_meta];
        }
    }
    ...
    public static function get_post_category_values()
    {
        ...
        $id = !$has_input_name
            ? rgpost('objectType') . '_rule_value_' . rgpost('ruleIndex')
            : rgpost('inputName');
        $selected = rgempty('selectedValue') ? 0 : rgpost('selectedValue');

        $dropdown = wp_dropdown_categories([
            'class' =>
                'gfield_rule_select gfield_rule_value_dropdown gfield_category_dropdown',
            'orderby' => 'name',
            'id' => $id,
            'name' => $id,
            'selected' => $selected,
    ...
    public static function inline_scripts($echo = true)
    {
        ...
        $script_str .=
            sprintf('fieldSettings = %s;', json_encode($field_settings)) .
            PHP_EOL;

        $script_str .=
            sprintf(
                'function GetConditionalLogicFields(){return %s;}',
                json_encode($conditional_logic_fields)
            ) . PHP_EOL;
