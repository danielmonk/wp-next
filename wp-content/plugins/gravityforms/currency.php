    ...
    class RGCurrency
    {
        ...
        public function to_number($text)
        {
            ...
            foreach ($array as $char) {
                if (
                    ($char >= '0' && $char <= '9') ||
                    $char == $this->currency['decimal_separator']
                ) {
                    $clean_number .= $char;
                } elseif ($char == '-') {
                    $is_negative = true;
            ...
            $decimal_separator =
                $this->currency && $this->currency['decimal_separator']
        ...
        public function to_money($number, $do_encode = false)
        {
            ...
            $symbol_left = !empty($this->currency['symbol_left'])
                ? $this->currency['symbol_left'] .
                    $this->currency['symbol_padding']
                : '';
            $symbol_right = !empty($this->currency['symbol_right'])
                ? $this->currency['symbol_padding'] .
