...
$__gf_tooltips = [
    'notification_send_to_email' =>
        '<h6>' .
        __('Send To Email Address', 'gravityforms') .
        '</h6>' .
        __(
            'Enter the email address you would like the notification email sent to.',
            'gravityforms'
        ),
    'notification_autoformat' =>
        '<h6>' .
    ...
    'notification_send_to_routing' =>
        '<h6>' .
        __('Routing', 'gravityforms') .
        '</h6>' .
        __(
            'Allows notification to be sent to different email addresses depending on values selected in the form.',
            'gravityforms'
        ),
    ...
    'notification_from_name' =>
        ...
        '</h6>' .
        __(
            'Enter the name you would like the notification email sent from, or select the name from available name fields.',
            'gravityforms'
        ),
    'notification_reply_to' =>
        ...
        '</h6>' .
        __(
            'Enter the email address you would like to be used as the reply to address for the notification email.',
            'gravityforms'
        ),
    'notification_cc' =>
        '<h6>' .
        ...
        '</h6>' .
        __(
            'Enter a comma separated list of email addresses you would like to receive a CC of the notification email.',
            'gravityforms'
        ),
    'notification_bcc' =>
        '<h6>' .
        ...
        '</h6>' .
        __(
            'Enter a comma separated list of email addresses you would like to receive a BCC of the notification email.',
            'gravityforms'
        ),
    'notification_attachments' =>
        '<h6>' .
        __('Attachments', 'gravityforms') .
        '</h6>' .
        __(
            'When enabled, any files uploaded to File Upload fields will be attached to the notification email.',
            'gravityforms'
        ),
    'form_activity' =>
        '<h6>' .
        ...
        '</h6>' .
        __(
            'Limit the number of entries a form can generate and/or schedule a time period the form is active.',
            'gravityforms'
        ),
    'form_limit_entries' =>
        '<h6>' .
        ...
        '</h6>' .
        __(
            'Enter a number in the input box below to limit the number of entries allowed for this form. The form will become inactive when that number is reached.',
            'gravityforms'
        ),
    'form_schedule_form' =>
        '<h6>' .
        ...
        '</h6>' .
        __('Schedule a time period the form is active.', 'gravityforms'),
    'form_honeypot' =>
        '<h6>' .
        __('Enable Anti-spam honeypot', 'gravityforms') .
        '</h6>' .
        __(
            'Enables the honeypot spam protection technique, which is an alternative to the reCAPTCHA field.',
            'gravityforms'
        ),
    'form_animation' =>
        '<h6>' .
        ...
        '</h6>' .
        __(
            'Check this option to enable a sliding animation when displaying/hiding conditional logic fields.',
            'gravityforms'
        ),
    'form_title' =>
        '<h6>' .
        ...
        '</h6>' .
        __('Enter the title of your form.', 'gravityforms'),
    'form_description' =>
        '<h6>' .
    ...
    'form_description_placement' =>
        ...
        '</h6>' .
        __(
            'Select the default description placement.  Descriptions can be placed above the field inputs or below the field inputs. This setting can be overridden in the appearance settings for each field.',
            'gravityforms'
        ),
    ...
    'form_button_text' =>
        ...
        '</h6>' .
        __(
            'Enter the text you would like to appear on the form submit button.',
            'gravityforms'
        ),
    'form_button_image' =>
        '<h6>' .
    ...
    'form_field_add_icon_url' =>
        '<h6>' .
        __('Add Icon URL', 'gravityforms') .
        '</h6>' .
        __(
            "Enter the URL of a custom image to replace the default 'add item' icon. A maximum size of 16px by 16px is recommended",
            'gravityforms'
        ),
    'form_field_delete_icon_url' =>
        '<h6>' .
        __('Delete Icon URL', 'gravityforms') .
        '</h6>' .
        __(
            "Enter the URL of a custom image to replace the default 'delete item' icon. A maximum size of 16px by 16px is recommended",
            'gravityforms'
        ),
    ...
    'form_redirect_querystring' =>
        '<h6>' .
        __('Pass Data Via Query String', 'gravityforms') .
        '</h6>' .
        sprintf(
            __(
                "To pass field data to the confirmation page, build a Query String using the 'Insert Merge Tag' drop down. %s..more info on querystrings &raquo;%s",
                'gravityforms'
            ),
            "<a href='https://en.wikipedia.org/wiki/Query_string' target='_blank'>",
            '</a>'
        ),
    'form_field_label' =>
        '<h6>' .
    ...
    'form_field_recaptcha_theme' =>
        '<h6>' .
        __('reCAPTCHA Theme', 'gravityforms') .
        '</h6>' .
        __(
            'Select the visual theme for the reCAPTCHA field from the available options to better match your site design.',
            'gravityforms'
        ),
    'form_field_captcha_type' =>
        '<h6>' .
        __('CAPTCHA Type', 'gravityforms') .
        '</h6>' .
        __('Select the type of CAPTCHA you would like to use.', 'gravityforms'),
    'form_field_recaptcha_badge' =>
        '<h6>' .
        __('CAPTCHA Badge Position', 'gravityforms') .
        '</h6>' .
        __(
            "Select the position of the badge containing the links to Google's privacy policy and terms.",
            'gravityforms'
        ),
    'form_field_custom_field_name' =>
        '<h6>' .
    ...
    'form_field_address_type' =>
        '<h6>' .
        __('Address Type', 'gravityforms') .
        '</h6>' .
        __('Select the type of address you would like to use.', 'gravityforms'),
    'form_field_address_default_state_us' =>
        '<h6>' .
        __('Default State', 'gravityforms') .
        '</h6>' .
        __(
            'Select the state you would like to be selected by default when the form gets displayed.',
            'gravityforms'
        ),
    'form_field_address_default_state_canadian' =>
        '<h6>' .
        __('Default Province', 'gravityforms') .
        '</h6>' .
        __(
            'Select the province you would like to be selected by default when the form gets displayed.',
            'gravityforms'
        ),
    'form_field_address_default_country' =>
        '<h6>' .
        __('Default Country', 'gravityforms') .
        '</h6>' .
        __(
            'Select the country you would like to be selected by default when the form gets displayed.',
            'gravityforms'
        ),
    'form_field_address_hide_country' =>
        '<h6>' .
        __('Hide Country', 'gravityforms') .
        '</h6>' .
        __(
            'For addresses that only apply to one country, you can choose to not display the country drop down. Entries will still be recorded with the selected country.',
            'gravityforms'
        ),
    'form_field_address_hide_address2' =>
        '<h6>' .
        __('Hide Address Line 2', 'gravityforms') .
        '</h6>' .
        __(
            'Check this box to prevent the extra address input (Address Line 2) from being displayed in the form.',
            'gravityforms'
        ),
    'form_field_address_hide_state_us' =>
        '<h6>' .
    ...
    'form_field_address_hide_state_canadian' =>
        '<h6>' .
    ...
    'form_field_address_hide_state_international' =>
        '<h6>' .
        __('Hide State/Province/Region', 'gravityforms') .
        '</h6>' .
        __(
            'Check this box to prevent the State/Province/Region from being displayed in the form.',
            'gravityforms'
        ),
    'form_field_name_format' =>
        '<h6>' .
        __('Field Name Format', 'gravityforms') .
        '</h6>' .
        __(
            'Select the format you would like to use for the Name field.  There are 3 options, Normal which includes First and Last Name, Extended which adds Prefix and Suffix, or Simple which is a single input field.',
            'gravityforms'
        ),
    'form_field_number_format' =>
        '<h6>' .
    ...
    'form_field_force_ssl' =>
        '<h6>' .
        __('Force SSL', 'gravityforms') .
        '</h6>' .
        __(
            'Check this box to prevent this field from being displayed in a non-secure page (i.e. not https://). It will redirect the page to the same URL, but starting with https:// instead. This option requires a properly configured SSL certificate.',
            'gravityforms'
        ),
    'form_field_card_style' =>
        '<h6>' .
        __('Credit Card Icon Style', 'gravityforms') .
        '</h6>' .
        __(
            'Select the style you would like to use for the credit card icons.',
            'gravityforms'
        ),
    'form_field_date_format' =>
        '<h6>' .
        __('Field Date Format', 'gravityforms') .
        '</h6>' .
        __(
            'Select the format you would like to use for the date input.',
            'gravityforms'
        ),
    'form_field_time_format' =>
        '<h6>' .
    ...
    'form_field_fileupload_allowed_extensions' =>
        '<h6>' .
        __('Allowed File Extensions', 'gravityforms') .
        '</h6>' .
        __(
            'Enter the allowed file extensions for file uploads.  This will limit the type of files a user may upload.',
            'gravityforms'
        ),
    'form_field_multiple_files' =>
        '<h6>' .
    ...
    'form_field_max_files' =>
        '<h6>' .
        __('Maximum Number of Files', 'gravityforms') .
        '</h6>' .
        __(
            "Specify the maximum number of files that can be uploaded using this field. Leave blank for unlimited. Note that the actual number of files permitted may be limited by this server's specifications and configuration.",
            'gravityforms'
        ),
    'form_field_max_file_size' =>
        '<h6>' .
    ...
    'form_field_required' =>
        ...
        '</h6>' .
        __(
            'Select this option to make the form field required.  A required field will prevent the form from being submitted if it is not filled out or selected.',
            'gravityforms'
        ),
    'form_field_no_duplicate' =>
        '<h6>' .
        __('No Duplicates', 'gravityforms') .
        '</h6>' .
        __(
            'Select this option to limit user input to unique values only.  This will require that a value entered in a field does not currently exist in the entry database for that field.',
            'gravityforms'
        ),
    'form_field_hide_label' =>
        '<h6>' .
        __('Hide Field Label', 'gravityforms') .
        '</h6>' .
        __(
            'Select this option to hide the field label in the form.',
            'gravityforms'
        ),
    'form_field_number_range' =>
        '<h6>' .
    ...
    'form_field_calculation_formula' =>
        '<h6>' .
        __('Formula', 'gravityforms') .
        '</h6>' .
        __(
            'Specify a mathematical formula. The result of this formula will be dynamically populated as the value for this field.',
            'gravityforms'
        ),
    'form_field_calculation_rounding' =>
        '<h6>' .
        __('Rounding', 'gravityforms') .
        '</h6>' .
        __(
            'Specify how many decimal places the number should be rounded to.',
            'gravityforms'
        ),
    'form_field_admin_label' =>
        '<h6>' .
    ...
    'form_field_description_placement' =>
        '<h6>' .
        __('Description Placement', 'gravityforms') .
        '</h6>' .
        __(
            'Select the description placement.  Descriptions can be placed above the field inputs or below the field inputs.',
            'gravityforms'
        ),
    'form_field_sub_label_placement' =>
        '<h6>' .
        __('Sub-Label Placement', 'gravityforms') .
        '</h6>' .
        __(
            'Select the sub-label placement.  Sub-labels can be placed above the field inputs or below the field inputs.',
            'gravityforms'
        ),
    'form_field_size' =>
        '<h6>' .
        ...
        '</h6>' .
        __(
            'Select a form field size from the available options. This will set the width of the field. Please note: if using a paragraph field, the size applies only to the height of the field.',
            'gravityforms'
        ),
    'form_field_name_fields' =>
        '<h6>' .
        __('Name Fields', 'gravityforms') .
        '</h6>' .
        __(
            "Select the fields you'd like to use in this Name field and customize the Sub-Labels by entering new ones.",
            'gravityforms'
        ),
    'form_field_name_prefix_choices' =>
        '<h6>' .
        __('Name Prefix Choices', 'gravityforms') .
        '</h6>' .
        __(
            'Add Choices to this field. You can mark a choice as selected by default by using the radio buttons on the left.',
            'gravityforms'
        ),
    'form_field_address_fields' =>
        '<h6>' .
        __('Address Fields', 'gravityforms') .
        '</h6>' .
        __(
            "Select the fields you'd like to use in this Address Field and customize the Sub-Labels by entering new ones.",
            'gravityforms'
        ),
    ...
    'form_field_default_input_values' =>
        '<h6>' .
    ...
    'form_field_placeholder' =>
        ...
        '</h6>' .
        __(
            'The Placeholder will not be submitted along with the form. Use the Placeholder to give a hint at the expected value or format.',
            'gravityforms'
        ),
    'form_field_input_placeholders' =>
        '<h6>' .
        __('Placeholders', 'gravityforms') .
        '</h6>' .
        __(
            'Placeholders will not be submitted along with the form. Use Placeholders to give a hint at the expected value or format.',
            'gravityforms'
        ),
    'form_field_enable_copy_values_option' =>
        '<h6>' .
        __('Use Values Submitted in a Different Field', 'gravityforms') .
        '</h6>' .
        __(
            'Activate this option to allow users to skip this field and submit the values entered in the associated field. For example, this is useful for shipping and billing address fields.',
            'gravityforms'
        ),
    'form_field_copy_values_option_label' =>
        '<h6>' .
        __('Option Label', 'gravityforms') .
        '</h6>' .
        __(
            'Enter the label to be displayed next to the check box. For example, &quot;same as shipping address&quot;.',
            'gravityforms'
        ),
    'form_field_copy_values_option_field' =>
        '<h6>' .
    ...
    'form_field_copy_values_option_default' =>
        '<h6>' .
        __('Activated by Default', 'gravityforms') .
        '</h6>' .
        __(
            'Select this setting to display the option as activated by default when the form first loads.',
            'gravityforms'
        ),
    ...
    'form_field_recaptcha_language' =>
        '<h6>' .
        __('reCAPTCHA Language', 'gravityforms') .
        '</h6>' .
        __(
            'Select the language you would like to use for the reCAPTCHA display from the available options.',
            'gravityforms'
        ),
    ...
    'form_field_enable_enhanced_ui' =>
        '<h6>' .
        __('Enable Enhanced UI', 'gravityforms') .
        '</h6>' .
        sprintf(
            __(
                "By selecting this option, the %s jQuery script will be applied to this field, enabling search capabilities to Drop Down fields and a more user-friendly interface for Multi Select fields.",
                'gravityforms'
            ),
            "<a href='https://harvesthq.github.com/chosen/' target='_blank'>Chosen</a>"
        ),
    'form_field_checkbox_label' =>
        '<h6>' .
        __('Checkbox Text', 'gravityforms') .
        '</h6>' .
        __('Text of the consent checkbox.', 'gravityforms'),
    'form_field_select_all_choices' =>
        '<h6>' .
        __('"Select All" Choice', 'gravityforms') .
        '</h6>' .
        __(
            'Check this option to add a "Select All" checkbox before the checkbox choices to allow users to check all the checkboxes with one click.',
            'gravityforms'
        ),
    'form_field_other_choice' =>
        '<h6>' .
    ...
    'form_require_login' =>
        ...
        '</h6>' .
        __(
            'Check this option to require a user to be logged in to view this form.',
            'gravityforms'
        ),
    'form_require_login_message' =>
        '<h6>' .
        __('Require Login Message', 'gravityforms') .
        '</h6>' .
        __(
            'Enter a message to be displayed to users who are not logged in (shortcodes and HTML are supported).',
            'gravityforms'
        ),
    'form_page_conditional_logic' =>
        '<h6>' .
        __('Page Conditional Logic', 'gravityforms') .
        '</h6>' .
        __(
            'Create rules to dynamically display or hide this page based on values from another field.',
            'gravityforms'
        ),
    'form_progress_indicator' =>
        ...
        '</h6>' .
        __(
            'Select which type of visual progress indicator you would like to display.  Progress Bar, Steps or None.',
            'gravityforms'
        ),
    'form_percentage_style' =>
        '<h6>' .
    ...
    'form_nextbutton_conditional_logic' =>
        '<h6>' .
        __('Next Button Conditional Logic', 'gravityforms') .
        '</h6>' .
        __(
            "Create rules to dynamically display or hide the page's Next Button based on values from another field.",
            'gravityforms'
        ),
    'form_button_conditional_logic' =>
        ...
        '</h6>' .
        __(
            'Create rules to dynamically display or hide the submit button based on values from another field.',
            'gravityforms'
        ),
    'form_field_post_category_selection' =>
        '<h6>' .
    ...
    'form_field_post_status' =>
        '<h6>' .
        __('Post Status', 'gravityforms') .
        '</h6>' .
        __(
            'Select the post status that will be used for the post that is created by the form entry.',
            'gravityforms'
        ),
    'form_field_post_author' =>
        '<h6>' .
    ...
    'form_field_post_content_template_enable' =>
        '<h6>' .
    ...
    'form_field_post_title_template_enable' =>
        '<h6>' .
    ...
    'form_field_current_user_as_author' =>
        '<h6>' .
    ...
    'form_field_base_price' =>
        '<h6>' .
        __('Base Price', 'gravityforms') .
        '</h6>' .
        __('Enter the base price for this product.', 'gravityforms'),
    'form_field_disable_quantity' =>
        '<h6>' .
    ...
    'form_field_product' =>
        ...
        '</h6>' .
        __('Select which Product this field is tied to.', 'gravityforms'),
    'form_field_mask' =>
        '<h6>' .
    ...
    'form_standard_fields' =>
        ...
        '</h6>' .
        __('Standard Fields provide basic form functionality.', 'gravityforms'),
    'form_advanced_fields' =>
        '<h6>' .
    ...
    'export_select_forms' =>
        ...
        '</h6>' .
        __('Select the forms you would like to export.', 'gravityforms'),
    'export_conditional_logic' =>
        '<h6>' .
        __('Conditional Logic', 'gravityforms') .
        '</h6>' .
        __('Filter the entries by adding conditions.', 'gravityforms'),
    ...
    'import_select_file' =>
        ...
        '</h6>' .
        __(
            'Click the file selection button to upload a Gravity Forms export file from your computer.',
            'gravityforms'
        ),
    ...
    'settings_recaptcha_type' =>
        '<h6>' .
        __('reCAPTCHA Type', 'gravityforms') .
        '</h6>' .
        __(
    ...
    'form_percentage_confirmation_display' =>
        '<h6>' .
    ...
    'percentage_confirmation_page_name' =>
        '<h6>' .
    ...
    'personal_data_enable' =>
        '<h6>' .
        __('Enable Personal Data Tools', 'gravityforms') .
        '</h6>' .
        __(
    ...
    'personal_data_identification' =>
        '<h6>' .
        __('Identification', 'gravityforms') .
        '</h6>' .
        __(
            'Select the field which will be used to identify the owner of the personal data.',
            'gravityforms'
        ),
    'personal_data_field_settings' =>
        '<h6>' .
        __('Field Settings', 'gravityforms') .
        '</h6>' .
        __(
    ...
    'personal_data_retention_policy' =>
        '<h6>' .
        __('Retention Policy', 'gravityforms') .
        '</h6>' .
        __(
    ...
    'form_field_password_visibility_enable' =>
        '<h6>' .
        __('Password Visibility Toggle', 'gravityforms') .
        '</h6>' .
        __(
...
function gform_tooltip($name, $css_class = '', $return = false)
{
    ...
    $tooltip =
        "<a href='#' onclick='return false;' onkeypress='return false;' class='gf_tooltip " .
        esc_attr($css_class) .
        " {$tooltip_class}' title='" .
