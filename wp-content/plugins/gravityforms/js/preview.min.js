jQuery(document).ready(function () {
  function r(e) {
    for (var i = document.cookie.split("; "), r = 0; r < i.length; r++) {
      var o = i[r].split("=");
      if (e == o[0]) return unescape(o[1]);
    }
    return null;
  }
  jQuery(".toggle_helpers input[type=checkbox]").prop("checked", !1),
    ...
    r("dismissed-notifications") && jQuery(r("dismissed-notifications")).hide(),
    jQuery(".hidenotice").click(function () {
      var e = jQuery(this).closest(".preview_notice").attr("id"),
        i = r("dismissed-notifications") + ",#" + e;
      jQuery(this).closest(".preview_notice").slideToggle("slow"),
        (function (e, i) {
          document.cookie = e + "=" + escape(i);
          var r = new Date();
          r.setMonth(r.getMonth() + 1),
            (document.cookie += "; expires=" + r.toUTCString());
        })("dismissed-notifications", i.replace("null,", ""));
    }),
