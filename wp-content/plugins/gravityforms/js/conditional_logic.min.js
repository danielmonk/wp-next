...
function gf_apply_rules(e, t, i) {
  ...
  for (var a = 0; a < t.length; a++)
    gf_apply_field_rule(e, t[a], i, function () {
      ++r == t.length &&
...
function gf_check_field_rule(e, t, i, r) {
  var a = gf_get_field_logic(e, t);
  if (!a) return "show";
  var n = gf_get_field_action(e, a.section);
  return "hide" != n && (n = gf_get_field_action(e, a.field)), n;
}
function gf_get_field_logic(e, t) {
  var i = rgars(window, "gf_form_conditional_logic/" + e);
  if (!i) return !1;
  var r = rgars(i, "logic/" + t);
  if (r) return r;
  var a = rgar(i, "dependents");
  if (!a) return !1;
  for (var n in a) if (-1 !== a[n].indexOf(t)) return rgars(i, "logic/" + n);
  return !1;
}
function gf_apply_field_rule(e, t, i, r) {
  var a = gf_check_field_rule(e, t, i, r);
  gf_do_field_action(e, a, t, i, r);
  var n = window.gf_form_conditional_logic[e].logic[t];
  n.nextButton &&
    gf_do_next_button_action(
      e,
      (a = gf_get_field_action(e, n.nextButton)),
      t,
      i
    );
}
function gf_get_field_action(e, t) {
  if (!t) return "show";
  for (var i = 0, r = 0; r < t.rules.length; r++) {
    gf_is_match(
      e,
      gform.applyFilters(
        "gform_rule_pre_evaluation",
        jQuery.extend({}, t.rules[r]),
        e,
        t
      )
    ) && i++;
...
function gf_is_match(e, t) {
  ...
  var _ =
    -1 !== r.inArray(i.attr("type"), ["checkbox", "radio"])
      ? gf_is_match_checkable(i, t, e, n)
      : gf_is_match_default(i.eq(0), t, e, n);
  return gform.applyFilters("gform_is_value_match", _, e, t);
}
function gf_is_match_checkable(e, a, n, o) {
  var _ = !1;
  return (
    e.each(function () {
      var e = jQuery(this),
        t = gf_get_value(e.val()),
        i = -1 !== jQuery.inArray(a.operator, ["<", ">"]),
        r =
          -1 !==
          jQuery.inArray(a.operator, ["contains", "starts_with", "ends_with"]);
      if (t == a.value || i || r)
        return (
          e.is(":checked")
            ? "gf_other_choice" == t &&
            ...
            : (t = ""),
          gf_matches_operation(t, a.value, a.operator) ? !(_ = !0) : void 0
        );
    }),
    _
  );
}
function gf_is_match_default(e, t, i, r) {
  for (
    var a = e.val(),
      n = a instanceof Array ? a : [a],
      o = 0,
    ...
    var d = !n[l] || 0 <= n[l].indexOf("|"),
      f = gf_get_value(n[l]),
      c = gf_get_field_number_format(t.fieldId, i, "value");
    c && !d && (f = gf_format_number(f, c)),
      gf_matches_operation(f, t.value, t.operator) && o++;
  }
...
function gf_do_field_action(e, t, i, r, a) {
  for (
    ...
    var l = 0 == i ? "#gform_submit_button_" + e : "#field_" + e + "_" + o[_],
      d = n.defaults[o[_]];
    (do_callback = _ + 1 == o.length ? a : null),
      gf_do_action(t, l, n.animation, d, r, do_callback, e),
      gform.doAction(
...
function gf_do_next_button_action(e, t, i, r) {
  gf_do_action(
    t,
...
function gf_do_action(e, t, i, r, a, n, o) {
  var _ = jQuery(t);
  if (
    ...
    if (
      ...
      0 < _.length
        ? (_.find(":input:hidden:not(.gf-default-disabled)").prop(
            "disabled",
            !1
          ),
          _.slideDown(n))
      ...
      ("" != l && "none" != l) || (l = "list-item"),
        _.find(":input:hidden:not(.gf-default-disabled)").prop("disabled", !1),
        _.css("display", l),
        n && n();
    }
  else {
...
function gf_reset_to_default(e, a) {
  var t = jQuery(e).find(
    ...
    i.each(function () {
      ...
      if (!t.is('[type="hidden"]') || gf_is_hidden_pricing_input(t)) {
        if ("gf_other_choice" == t.prev("input").attr("value"))
          e = t.attr("value");
        else if (jQuery.isArray(a) && !t.is("select[multiple]")) e = a[n];
        else if (jQuery.isPlainObject(a)) {
          if (!(e = a[t.attr("name")]) && t.attr("id")) {
        ...
        if (
          ...
          if (
            ...
            var r = gf_get_ids_by_html_id(t.parents(".gfield").attr("id"));
            jQuery("#input_" + r[0] + "_" + r[1]).text(
      ...
      jQuery(e)
        ...
        .each(function () {
          var e = !!jQuery(this).is(":checked"),
            t = !!a && -1 < jQuery.inArray(jQuery(this).attr("id"), a);
          e != t &&
...
function gf_is_hidden_pricing_input(e) {
  return (
    ...
    (!(!e.attr("id") || 0 !== e.attr("id").indexOf("ginput_base_price")) ||
      e.parents(".gfield_shipping").length)
  );
}
gform.addAction(
  "gform_input_change",
