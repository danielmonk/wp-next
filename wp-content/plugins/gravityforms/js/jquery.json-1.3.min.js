!(function ($) {
  ...
  ($.quoteString = function (e) {
    ...
    ($.toJSON = function (e, t) {
      ...
      if ("object" == r && "function" == typeof e.toJSON) return e.toJSON(t);
      if ("function" != r && "number" == typeof e.length) {
        for (var n = [], o = 0; o < e.length; o++) n.push($.toJSON(e[o], t));
      ...
      for (var i in e) {
        ...
        var u = $.toJSON(e[i], t);
        "string" == typeof u &&
          (t ? n.push(f + ":" + u) : n.push(f + ": " + u));
      }
      return "{" + n.join(", ") + "}";
    }),
    ($.compactJSON = function (e) {
      return $.toJSON(e, !0);
    }),
