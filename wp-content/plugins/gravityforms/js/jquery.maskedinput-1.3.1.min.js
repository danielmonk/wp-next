              ...
              if (!w.prop("readonly")) {
                ...
                (m = w.val()),
                  8 === r || 46 === r || (a && 127 === r)
                    ...
                    ? x.call(this, e)
                    : 27 === r &&
                      (w.val(E), w.caret(0, T()), e.preventDefault());
              }
            }
            function R(t) {
              if (!w.prop("readonly")) {
                ...
                if (
                  ...
                  if (
                    (l.end - l.begin !== 0 &&
                      (S(l.begin, l.end), b(l.begin, l.end - 1)),
                    (n = p(l.begin - 1)),
                    g > n && ((a = String.fromCharCode(o)), u[n].test(a)))
                  ) {
            ...
            function T(e) {
              ...
              return (
                e
                  ? A()
                  : f > r + 1
                  ? o.autoclear || C.join("") === D
                    ? (w.val() && w.val(""), S(0, g))
                    : A()
                  : (A(), w.val(w.val().substring(0, r + 1))),
                f ? t : s
              );
            }
            var w = e(this),
