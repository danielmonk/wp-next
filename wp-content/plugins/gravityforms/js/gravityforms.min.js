...
function gformToggleRepeaterButtons(e) {
  var r = e.closest(".gfield_repeater_wrapper").data("max_items"),
    t = e.children(".gfield_repeater_items").children(".gfield_repeater_item")
      .length,
    i = e
      .children(".gfield_repeater_items")
      .children(".gfield_repeater_item")
...
var GFMergeTag = function () {
  (GFMergeTag.getMergeTagValue = function (e, r, t) {
    ...
    if (
      ...
      return "";
    o.find(".ginput_container_email").hasClass("ginput_complex") &&
      (l = l.first());
      ...
      (d = t.settings.multipart_params.form_id),
        ...
        t.bind("FilesAdded", function (o, e) {
          ...
          if (0 < l && l <= f)
            ...
            y.each(e, function (e, r) {
              if (((a = r.name.split(".").pop()), -1 < y.inArray(a, s)))
                return (
                  c(
              ...
              if (r.status == plupload.FAILED || (0 < l && l <= f))
                ...
                (n = gform
                  ...
                  y("#" + o.settings.filelist).prepend(n),
                  f++;
              }
            }),
              o.refresh();
            ...
            0 == t.length && (t = y(r)),
              ...
              0 < l &&
                l <= f &&
                (h.toggleDisabled(o.settings, !0),
                c(o.settings.gf_vars.message_id, v.max_reached)),
