    ...
    public static function help_page()
    {
		...
		<div class="wrap <?php echo GFCommon::get_browser_class(); ?>">
			...
			<div style="margin-top:10px;">
				...
				<div class="gf_admin_notice"><?php printf(
        esc_html__(
            '%sIMPORTANT NOTICE:%s We do not provide support via telephone or e-mail. Please %sopen a support ticket%s.',
            'gravityforms'
        ),
        '<strong>',
        '</strong>',
        ...
        '</a>'
				...
				<div class="gf_help_content"><p><?php printf(
        esc_html__(
        ...
        '</a>',
        '<a href="https://docs.gravityforms.com/category/knowledge-base/" target="_blank">',
        '</a>',
        '<a href="https://www.gravityforms.com/support/" target="_blank">',
        '</a>',
        '<strong>',
        '</strong>',
        '<a href="https://www.gravityforms.com/pricing/" target="_blank">',
        '</a>'
    ); ?></p></div>
                    ...
                    <ul class="resource_list">
                        <li>
                            <i class="fa fa-book"></i> <a target="_blank" href="https://docs.gravityforms.com/getting-started-gravity-forms-api-gfapi/">
                                <?php esc_html_e(
                                    'Getting Started with the Gravity Forms API',
                                    'gravityforms'
                                ); ?>
                            </a>
                        </li>
