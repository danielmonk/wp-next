!(function (t) {
  var e = acf.Field.extend({
    ...
    render: function () {
      ...
      var e = this.$control(),
        a = this.$button();
      0 == this.val() ? e.addClass("-empty") : e.removeClass("-empty"),
        this.allowAdd()
          ? (e.removeClass("-max"), a.removeClass("disabled"))
          : (e.addClass("-max"), a.addClass("disabled"));
    },
    ...
    duplicateRow: function (t) {
      ...
      return (
        this.$input().trigger("change"), this.render(), acf.focusAttention(a), a
      );
    },
  ...
  (function (t) {
    var e = acf.Field.extend({
      ...
      renderLayout: function (e) {
        var a,
          i = e.children("input").attr("name").replace("[acf_fc_layout]", ""),
          n = {
    ...
    var e = acf.Field.extend({
      ...
      renderAttachment: function (t) {
        ...
        if ("image" == t.type) e.find(".filename").remove();
          ...
          null !== a && (t.url = a), e.find(".filename").text(t.filename);
        }
