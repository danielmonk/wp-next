...
function _iterableToArrayLimit(t, e) {
  if ("undefined" != typeof Symbol && Symbol.iterator in Object(t)) {
    ...
    try {
      for (
        var a = t[Symbol.iterator](), c;
        !(n = (c = a.next()).done) && (r.push(c.value), !e || r.length !== e);
        n = !0
      );
    } catch (t) {
      (o = !0), (i = t);
...
!(function (t, e) {
  ...
  function a(t) {
    ...
    var i = {
      ...
      a = q,
      c = y;
    t.supports.align_text && ((i = w(i)), (a = R(a, t))),
  ...
  function u(t) {
    for (var e = c("core/block-editor").getBlocks(), r = 0; r < e.length; )
      (e = e.concat(e[r].innerBlocks)), r++;
    for (var n in t)
  ...
  function y() {
    return React.createElement(S.Content, null);
  }
  function m() {
  ...
  function k(t, r) {
    ...
    return o === e
      ? (console.warn(
          'The "'.concat(n, '" alignment component was not found.')
        ),
        t)
              ...
              value: function e() {
                ...
                return React.createElement(
                  ...
                  React.createElement(
                    O,
                    null,
                    React.createElement(G, { value: r(c), onChange: n })
                  ),
                  React.createElement(t, this.props)
                );
              },
  ...
  var C = wp.blockEditor,
    O = C.BlockControls,
    E = C.InspectorControls,
    S = C.InnerBlocks,
    j = wp.components,
    A = j.Toolbar,
    P = j.IconButton,
  ...
  var $ = N(function (t) {
    return (function (n) {
      function a(t) {
        ...
        if (o(t)) {
          for (var f in ((l.id = acf.uniqid("block_")), p.attributes))
            l[f] === e && p[f] !== e && (l[f] = p[f]);
          return _possibleConstructorReturn(n);
        }
        return i(t)
          ? ((l.id = acf.uniqid("block_")), _possibleConstructorReturn(n))
          : n;
      }
      _inherits(a, n);
  ...
  var q = (function (t) {
                ...
                React.createElement(
                  ...
                  "preview" === c &&
                    React.createElement(
                      ...
                      React.createElement(Q, this.props)
                    )
                ),
            ...
            value: function t() {
              ...
              return React.createElement(
                ...
                "auto" === o && n
                  ...
                  : "auto" !== o || n
                  ? "preview" === o
                    ? React.createElement(X, this.props)
                    : React.createElement(Q, this.props)
                  : React.createElement(X, this.props)
              );
            },
    ...
    J = M(function (t, e) {
      return { index: t("core/block-editor").getBlockIndex(e.clientId) };
    })(U),
    W = (function (t) {
      function e() {
        return _classCallCheck(this, e), r.apply(this, arguments);
    ...
    K = (function (r) {
      function n(t) {
        ...
        return (
          ...
          ((e = o.call(this, t)).setRef = e.setRef.bind(
            _assertThisInitialized(e)
          )),
          (e.id = ""),
          (e.el = !1),
          (e.subscribed = !0),
          (e.renderMethod = "jQuery"),
          e.setup(t),
          e.loadState(),
          e
        );
      ...
      return (
        _createClass(n, [
          ...
          },
          {
            key: "setState",
            value: function t(e) {
              (F[this.id] = _objectSpread(_objectSpread({}, this.state), e)),
                this.subscribed &&
                  _get(_getPrototypeOf(n.prototype), "setState", this).call(
                    this,
                    e
                  );
            },
          },
          {
            ...
            value: function e(r) {
              if ((r = r ? r.trim() : "") !== this.state.html) {
                var n = { html: r };
                "jsx" === this.renderMethod
                  ? ((n.jsx = acf.parseJSX(r)), (n.$el = t(this.el)))
                  : (n.$el = t(r)),
                  this.setState(n);
              }
            },
            ...
            value: function t() {
              return this.state.jsx
                ...
                : React.createElement(
                    "div",
                    { ref: this.setRef },
                    React.createElement(T, null, React.createElement(x, null))
                  );
            },
          },
          {
            ...
            value: function t(e, r) {
              return (
                e.index !== this.props.index && this.componentWillMove(),
                r.html !== this.state.html
              );
            },
          },
          {
        ...
        _createClass(n, [
          {
            ...
            value: function t(e) {
              ...
              (this.id = "BlockPreview-".concat(e.attributes.id)),
                r(e.name).supports.jsx && (this.renderMethod = "jsx");
            },
          },
          {
            key: "fetch",
            value: function t(r) {
              var n = this,
                ...
                s = void 0 === c ? 0 : c;
              if (
                (this.setState({ prevAttributes: a }), this.state.html === e)
              ) {
                var u = acf.get("preloadedBlocks");
                if (u && u[a.id]) return void this.setHtml(u[a.id]);
              }
              l({ attributes: a, query: { preview: !0 }, delay: s }).done(
                function (t) {
          ...
          },
          {
            ...
            value: function t() {
              ...
              acf.doAction("render_block_preview", r, e),
                acf.doAction("render_block_preview/type=".concat(o), r, e);
            },
          },
          {
            key: "shouldComponentUpdate",
            value: function t(e, r) {
              ...
              if (!p(o, i)) {
                var a = 0;
                o.className !== i.className && (a = 300),
                  o.anchor !== i.anchor && (a = 300),
                  this.fetch({ attributes: o, delay: a });
              }
              return _get(
                _getPrototypeOf(n.prototype),
          ...
          },
          {
            ...
            value: function t() {
              _get(
                ...
                p(this.state.prevAttributes, this.props.attributes) ||
                  this.fetch();
            },
          },
        ]),
