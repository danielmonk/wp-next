...
if (!class_exists('acf_field_repeater')):
    class acf_field_repeater extends acf_field
    {
        ...
        function input_admin_enqueue_scripts()
        {
            // localize
            acf_localize_text([
                'Minimum rows reached ({min} rows)' => __(
                    'Minimum rows reached ({min} rows)',
                    'acf'
                ),
                'Maximum rows reached ({max} rows)' => __(
                    'Maximum rows reached ({max} rows)',
                    'acf'
                ),
            ]);
        }
        ...
        function render_field($field)
        {
            ...
            if ($field['min']) {
                $value = array_pad($value, $field['min'], []);
            }
...
<div <?php acf_esc_attr_e($div); ?>>
	<?php acf_hidden_input(['name' => $field['name'], 'value' => '']); ?>
       ...
       echo ' acf-clone';
				...
				<?php if ($show_order): ?>
					<td class="acf-row-handle order" title="<?php _e('Drag to reorder', 'acf'); ?>">
						...
						<a class="acf-icon -collapse small" href="#" data-event="collapse-row" title="<?php _e(
          'Click to toggle',
          'acf'
      ); ?>"></a>
						<?php endif; ?>
    ...
    endforeach; ?>
				...
				<?php if ($show_remove): ?>
					<td class="acf-row-handle remove">
						<a class="acf-icon -plus small acf-js-tooltip hide-on-shift" href="#" data-event="add-row" title="<?php _e(
          'Add row',
          'acf'
      ); ?>"></a>
						<a class="acf-icon -duplicate small acf-js-tooltip show-on-shift" href="#" data-event="duplicate-row" title="<?php _e(
          'Duplicate row',
          'acf'
      ); ?>"></a>
						<a class="acf-icon -minus small acf-js-tooltip" href="#" data-event="remove-row" title="<?php _e(
          'Remove row',
          'acf'
      ); ?>"></a>
					</td>
...
<?php if ($show_add): ?>
	...
	<div class="acf-actions">
		<a class="acf-button button button-primary" href="#" data-event="add-row"><?php echo $field[
      'button_label'
  ]; ?></a>
	</div>
  ...
  acf_render_field_setting($field, [
      ...
      'placeholder' => __('Add Row', 'acf'),
        ...
        function prepare_field_for_export($field)
        {
            ...
            if (!empty($field['sub_fields'])) {
                $field['sub_fields'] = acf_prepare_fields_for_export(
                    $field['sub_fields']
                );
            }
            return $field;
