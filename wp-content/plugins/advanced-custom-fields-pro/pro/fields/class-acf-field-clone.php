    ...
    class acf_field_clone extends acf_field
    {
        ...
        function acf_clone_field($field, $clone_field)
        {
            ...
            if ($clone_field['display'] == 'seamless') {
                ...
                $field['prefix'] =
                    $clone_field['prefix'] . '[' . $clone_field['key'] . ']';
            ...
            if ($clone_field['prefix_name']) {
                ...
                if ($clone_field['display'] == 'seamless') {
                    $field['_name'] =
                        $clone_field['_name'] . '_' . $field['_name'];
                }
            }
...
<?php
        ...
        function render_field_settings($field)
        {
            ...
            acf_render_field_setting($field, [
                'label' => __('Fields', 'acf'),
                'instructions' => __(
                    'Select one or more fields you wish to clone',
                    'acf'
                ),
                'type' => 'select',
                'name' => 'clone',
            ...
            acf_render_field_setting($field, [
                ...
                'instructions' => __(
                    'Specify the style used to render the clone field',
                    'acf'
                ),
                'type' => 'select',
                'name' => 'display',
                ...
                'choices' => [
                    ...
                    'seamless' => __(
                        'Seamless (replaces this field with selected fields)',
                        'acf'
                    ),
                ],
            ]);
            ...
            $instructions = sprintf(
                $instructions,
                '<code class="prefix-label-code-1"></code>'
            );
            acf_render_field_setting($field, [
            ...
            $instructions = sprintf(
                $instructions,
                '<code class="prefix-name-code-1"></code>'
            );
            acf_render_field_setting($field, [
        ...
        function get_clone_setting_choice($selector = '')
        {
            ...
            if (isset($_POST['fields'][$selector])) {
                return $this->get_clone_setting_field_choice(
                    $_POST['fields'][$selector]
                );
            }
            ...
            // group
            if (acf_is_field_group_key($selector)) {
                return $this->get_clone_setting_group_choice(
                    acf_get_field_group($selector)
                );
            }
        ...
        function get_clone_setting_field_choice($field)
        {
            ...
            $ancestors = isset($field['ancestors'])
                ? $field['ancestors']
                : count(acf_get_field_ancestors($field));
        ...
        function get_clone_setting_group_choice($field_group)
        {
            ...
            // return
            return sprintf(
                __('All fields from %s field group', 'acf'),
                $field_group['title']
            );
        }
