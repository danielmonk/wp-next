...
if (!class_exists('acf_field_gallery')):
    class acf_field_gallery extends acf_field
    {
        ...
        function initialize()
        {
            ...
            // actions
            add_action('wp_ajax_acf/fields/gallery/get_attachment', [
                $this,
                'ajax_get_attachment',
            ]);
            add_action('wp_ajax_nopriv_acf/fields/gallery/get_attachment', [
                $this,
                'ajax_get_attachment',
            ]);

            add_action('wp_ajax_acf/fields/gallery/update_attachment', [
                $this,
                'ajax_update_attachment',
            ]);
            add_action('wp_ajax_nopriv_acf/fields/gallery/update_attachment', [
                $this,
                'ajax_update_attachment',
            ]);

            add_action('wp_ajax_acf/fields/gallery/get_sort_order', [
                $this,
                'ajax_get_sort_order',
            ]);
            add_action('wp_ajax_nopriv_acf/fields/gallery/get_sort_order', [
                $this,
                'ajax_get_sort_order',
            ]);
        }
        ...
        function render_attachment($id, $field)
        {
            ...
            if ($attachment['type'] === 'audio') {
                $dimensions =
                    __('Length', 'acf') . ': ' . $attachment['fileLength'];
       ...
       $thumb
			...
			<p class="filename"><strong><?php echo esc_html(
       $attachment['filename']
   ); ?></strong></p>
			<p class="uploaded"><?php echo esc_html($attachment['dateFormatted']); ?></p>
			<p class="dimensions"><?php echo esc_html($dimensions); ?></p>
			<p class="actions">
				<a href="#" class="acf-gallery-edit" data-id="<?php echo esc_attr(
        $id
    ); ?>"><?php _e('Edit', 'acf'); ?></a>
				<a href="#" class="acf-gallery-remove" data-id="<?php echo esc_attr(
        $id
    ); ?>"><?php _e('Remove', 'acf'); ?></a>
			</p>
		</div>
...
<div <?php acf_esc_attr_e($attrs); ?>>
	...
	<div class="acf-gallery-main">
        ...
        ?>
					<div class="<?php echo esc_attr($a_class); ?>" data-id="<?php echo esc_attr(
    $a_id
); ?>">
						<input type="hidden" name="<?php echo esc_attr(
          $field['name']
      ); ?>[]" value="<?php echo esc_attr($a_id); ?>" />
						<div class="margin">
							<div class="thumbnail">
						...
						<div class="actions">
							<a class="acf-icon -cancel dark acf-gallery-remove" href="#" data-id="<?php echo esc_attr(
           $a_id
    ...
    endforeach; ?>
		...
		<div class="acf-gallery-toolbar">
			<ul class="acf-hl">
				<li>
					<a href="#" class="acf-button button button-primary acf-gallery-add"><?php _e(
         'Add to gallery',
         'acf'
     ); ?></a>
				</li>
	...
	<div class="acf-gallery-side">
		<div class="acf-gallery-side-inner">
			...
			<div class="acf-gallery-toolbar">
				<ul class="acf-hl">
					<li>
						<a href="#" class="acf-button button acf-gallery-close"><?php _e(
          'Close',
          'acf'
      ); ?></a>
					</li>
					<li class="acf-fr">
						<a class="acf-button button button-primary acf-gallery-update" href="#"><?php _e(
          'Update',
          'acf'
      ); ?></a>
					</li>
        ...
        function render_field_settings($field)
        {
            ...
            acf_render_field_setting($field, [
                'label' => __('Insert', 'acf'),
                'instructions' => __(
                    'Specify where new attachments are added',
                    'acf'
                ),
                'type' => 'select',
                'name' => 'insert',
