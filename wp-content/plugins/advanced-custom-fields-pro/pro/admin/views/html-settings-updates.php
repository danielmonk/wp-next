...
$button = $active
    ? __('Deactivate License', 'acf')
    : __('Activate License', 'acf');
$readonly = $active ? 1 : 0;
?>
<div class="wrap acf-settings-wrap">
			...
			<form action="" method="post">
				...
				<table class="form-table">
					<tbody>
						<tr>
							<th>
								<label for="acf-field-acf_pro_licence"><?php _e(
            'License Key',
            'acf'
        ); ?></label>
							</th>
	...
	<div class="acf-box" id="acf-update-information">
		...
		<div class="inner">
					...
					<tr>
						...
						<td>
							<?php if ($update_available): ?>
								...
								<?php if ($active): ?>
									<a class="button button-primary" href="<?php echo esc_attr(
             admin_url('plugins.php?s=Advanced+Custom+Fields+Pro')
         ); ?>"><?php _e('Update Plugin', 'acf'); ?></a>
								<?php else: ?>
									<a class="button" disabled="disabled" href="#"><?php _e(
             'Please enter your license key above to unlock updates',
             'acf'
         ); ?></a>
								<?php endif; ?>
            ...
            add_query_arg('force-check', 1)
        ); ?>"><?php _e('Check Again', 'acf'); ?></a>
							<?php endif; ?>
						</td>
					</tr>
					<?php if ($changelog): ?>
