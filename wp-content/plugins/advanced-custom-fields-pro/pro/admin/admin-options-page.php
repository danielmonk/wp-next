...
if (!class_exists('acf_admin_options_page')):
    class acf_admin_options_page
    {
        ...
        function admin_load()
        {
            ...
            $this->page['post_id'] = acf_get_valid_post_id(
                $this->page['post_id']
            );
		...
		<div id="major-publishing-actions">
			...
			<div id="publishing-action">
				...
				<input type="submit" accesskey="p" value="<?php echo $this->page[
        'update_button'
   ...
   do_action('acf/options_page/submitbox_major_actions', $this->page); ?>
        ...
        function postbox_acf($post, $args)
        {
            ...
            acf_render_fields(
                ...
                $this->page['post_id'],
                'div',
                $field_group['instruction_placement']
            );
            ?>
...
<?php
        ...
        function html()
        {
            // load view
            acf_get_view(
                dirname(__FILE__) . '/views/html-options-page.php',
                $this->page
            );
        }
    }
