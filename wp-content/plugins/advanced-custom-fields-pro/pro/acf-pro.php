...
if (!class_exists('acf_pro')):
    class acf_pro
    {
        ...
        function register_assets()
        {
            ...
            wp_register_script(
                'acf-pro-input',
                acf_get_url("pro/assets/js/acf-pro-input{$min}.js"),
                ['acf-input'],
                $version
            );
            wp_register_script(
                'acf-pro-field-group',
                acf_get_url("pro/assets/js/acf-pro-field-group{$min}.js"),
                ['acf-field-group'],
                $version
            );
            ...
            wp_register_style(
                'acf-pro-input',
                acf_get_url('pro/assets/css/acf-pro-input.css'),
                ['acf-input'],
                $version
            );
            wp_register_style(
                'acf-pro-field-group',
                acf_get_url('pro/assets/css/acf-pro-field-group.css'),
                ['acf-input'],
                $version
            );
        }
