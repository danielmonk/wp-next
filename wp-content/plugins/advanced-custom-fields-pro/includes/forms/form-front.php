    ...
    class acf_form_front
    {
        ...
        function validate_form($args)
        {
            ...
            $args = wp_parse_args($args, [
                ...
                'html_updated_message' =>
                    '<div id="message" class="updated"><p>%s</p></div>', // 5.5.10
                'html_submit_button' =>
                    '<input type="submit" class="acf-button button button-primary button-large" value="%s" />', // 5.5.10
                'html_submit_spinner' => '<span class="acf-spinner"></span>', // 5.5.10
                'kses' => true, // 5.6.5
            ]);

            $args['form_attributes'] = wp_parse_args($args['form_attributes'], [
                'id' => $args['id'],
                'class' => 'acf-form',
                'action' => '',
                'method' => 'post',
            ...
            if ($args['post_id'] === 'new_post') {
                $args['new_post'] = wp_parse_args($args['new_post'], [
                    'post_type' => 'post',
                    'post_status' => 'draft',
                ]);
            }
        ...
        function pre_save_post($post_id, $form)
        {
            ...
            if (isset($_POST['acf']['_post_title'])) {
                $save['post_title'] = acf_extract_var(
                    $_POST['acf'],
                    '_post_title'
                );
            }
            ...
            if (isset($_POST['acf']['_post_content'])) {
                $save['post_content'] = acf_extract_var(
                    $_POST['acf'],
                    '_post_content'
                );
            }
		...
		<?php endif;
            ...
            acf_form_data([
                ...
                'form' => $is_registered
                    ? $args['id']
                    : acf_encrypt(json_encode($args)),
            ]);
            ?>
			<div class="acf-fields acf-form-fields -<?php echo esc_attr(
