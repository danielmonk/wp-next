    ...
    class ACF_Form_Post
    {
        ...
        function __construct()
        {
            ...
            add_filter(
                ...
                [$this, 'wp_insert_post_empty_content'],
                10,
                2
            );
            ...
            if ($field_groups) {
                foreach ($field_groups as $field_group) {
                    ...
                    $postboxes[] = [
                        ...
                        'edit' => acf_get_field_group_edit_link(
                            $field_group['ID']
                        ),
                    ];
        ...
        function edit_form_after_title()
        {
            ...
            echo '<style type="text/css" id="acf-style">' .
                $this->style .
                '</style>';
        }
        ...
        function allow_save_post($post)
        {
            ...
            if ($post->post_type == 'revision') {
                ...
                if (
                    acf_maybe_get_POST('wp-preview') == 'dopreview' &&
                    $form_post_id === $post->post_parent
                ) {
                    $allow = true;
                }
            }
