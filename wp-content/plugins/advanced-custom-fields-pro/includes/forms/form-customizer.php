    ...
    class acf_form_customizer
    {
        ...
        function save_widget($instance, $new_instance, $old_instance, $widget)
        {
            ...
            if (
                ...
                !isset($new_instance['acf']) ||
                !acf_verify_nonce('widget')
            ) {
                return $instance;
            }
        ...
        function settings($customizer)
        {
            ...
            foreach ($settings as $setting) {
                ...
                if (
                    substr($id, 0, 6) == 'widget' ||
                    substr($id, 0, 7) == 'nav_menu'
                ) {
                    // allow
                } else {
                    continue;
        ...
        function customize_save($customizer)
        {
            ...
            foreach ($settings as $setting) {
                ...
                add_filter(
                    'pre_update_option_' . $id_data['base'],
                    [$this, 'pre_update_option'],
                    10,
                    3
                );
            }
