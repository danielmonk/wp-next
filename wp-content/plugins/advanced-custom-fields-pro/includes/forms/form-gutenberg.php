...
if (!class_exists('ACF_Form_Gutenberg')):
    class ACF_Form_Gutenberg
    {
        ...
        function enqueue_block_editor_assets()
        {
            ...
            add_action('block_editor_meta_box_hidden_fields', [
                $this,
                'block_editor_meta_box_hidden_fields',
            ]);

            // Cusotmize editor metaboxes.
            add_filter('filter_block_editor_meta_boxes', [
                $this,
        ...
        function add_meta_boxes()
        {
            ...
            remove_action('edit_form_after_title', [
                acf_get_instance('ACF_Form_Post'),
        ...
        function filter_block_editor_meta_boxes($wp_meta_boxes)
        {
            ...
            if (isset($wp_meta_boxes[$current_screen->id]['acf_after_title'])) {
                ...
                // Append metaboxes.
                foreach (
                    $locations['acf_after_title']
                    as $priority => $meta_boxes
                ) {
                    $locations['normal']['high'] = array_merge(
                        $meta_boxes,
                        $locations['normal']['high']
                    );
                }
                ...
                add_filter(
                    'get_user_option_meta-box-order_' . $current_screen->id,
                    [$this, 'modify_user_option_meta_box_order']
                );
            }
