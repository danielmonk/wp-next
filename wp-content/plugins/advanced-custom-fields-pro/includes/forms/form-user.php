...
if (!class_exists('ACF_Form_User')):
    class ACF_Form_User
    {
        ...
        function __construct()
        {
            ...
            add_filter(
                'registration_errors',
                [$this, 'filter_registration_errors'],
                10,
                3
            );
        }
        ...
        function admin_enqueue_scripts()
        {
            ...
            if (!acf_is_screen(['profile', 'user', 'user-edit'])) {
                return;
            }
...
<?php
         ...
         * @return	WP_Error
         */
        function filter_registration_errors(
            $errors,
