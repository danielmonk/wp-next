<div class="acf-field-list-wrap">
	...
	<div class="acf-field-list<?php if (!$fields) {
     echo ' -empty';
      ...
      foreach ($fields as $i => $field):
          acf_get_view('field-group-field', ['field' => $field, 'i' => $i]);
      endforeach;
  endif; ?>
	...
	<ul class="acf-hl acf-tfoot">
		<li class="acf-fr">
			<a href="#" class="button button-primary button-large add-field"><?php _e(
       '+ Add Field',
       'acf'
   ); ?></a>
		</li>
...
<?php if (!$parent):
	...
	<?php acf_get_view('field-group-field', ['field' => $clone, 'i' => 0]); ?>
	</script>
<?php
endif; ?>
