    ...
    abstract class ACF_Legacy_Location
    {
        ...
        public function __construct()
        {
            ...
            if (method_exists($this, 'rule_match')) {
                add_filter(
                    "acf/location/rule_match/{$this->name}",
                    [$this, 'rule_match'],
                    5,
                    3
                );
            ...
            if (method_exists($this, 'rule_operators')) {
                add_filter(
                    "acf/location/rule_operators/{$this->name}",
                    [$this, 'rule_operators'],
                    5,
                    2
                );
            ...
            if (method_exists($this, 'rule_values')) {
                add_filter(
                    "acf/location/rule_values/{$this->name}",
                    [$this, 'rule_values'],
                    5,
                    2
                );
        ...
        public function __call($name, $arguments)
        {
            ...
            switch ($name) {
                case 'rule_match':
                    ...
                    $arguments[3] = isset($arguments[3])
                        ? $arguments[3]
                        : false; // Add $field_group param.
                case 'rule_operators':
