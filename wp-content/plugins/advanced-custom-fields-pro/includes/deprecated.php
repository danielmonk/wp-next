...
acf_add_deprecated_filter(
    'acf/settings/export_textdomain',
    '5.3.3',
...
acf_add_deprecated_filter(
    ...
    '5.3.3',
    'acf/settings/l10n_field'
);
acf_add_deprecated_filter(
    'acf/settings/export_translate',
    '5.3.3',
    'acf/settings/l10n_field_group'
);
...
acf_add_deprecated_filter(
    'acf/get_valid_post_id',
    '5.5.6',
    'acf/validate_post_id'
);
acf_add_deprecated_filter(
    'acf/get_field_reference',
    '5.6.5',
    'acf/load_reference'
);
acf_add_deprecated_filter(
...
function acf_get_fields_by_id($parent_id = 0)
{
    ...
    // Return fields.
    return acf_get_fields(['ID' => $parent_id, 'key' => "group_$parent_id"]);
}
