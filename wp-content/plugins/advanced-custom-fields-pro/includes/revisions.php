    ...
    class acf_revisions
    {
        ...
        function __construct()
        {
            ...
            add_filter(
                ...
                [$this, 'wp_save_post_revision_check_for_changes'],
                10,
                3
            );
            add_filter(
                '_wp_post_revision_fields',
                [$this, 'wp_preview_post_fields'],
                10,
                2
            );
            add_filter(
                '_wp_post_revision_fields',
                [$this, 'wp_post_revision_fields'],
                10,
                2
            );
            add_filter(
                'acf/validate_post_id',
                [$this, 'acf_validate_post_id'],
                10,
                2
            );
        }
        ...
        function wp_save_post_revision_check_for_changes(
            $return,
            $last_revision,
            $post
        ) {
        ...
        function wp_post_revision_fields($fields, $post = null)
        {
            // validate page
            if (
                acf_is_screen('revision') ||
                acf_is_ajax('get-revision-diffs')
            ) {
            ...
            foreach ($meta as $name => $value) {
                ...
                add_filter(
                    "_wp_post_revision_field_{$name}",
                    [$this, 'wp_post_revision_field'],
                    10,
                    4
                );
            }
        ...
        function wp_post_revision_field(
            $value,
            $field_name,
            $post = null,
            $direction = false
