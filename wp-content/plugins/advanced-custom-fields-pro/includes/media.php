    ...
    class ACF_Media
    {
        ...
        function __construct()
        {
            ...
            add_action(
                ...
                [$this, 'wp_ajax_query_attachments'],
                -1
            );
        }
        ...
        function handle_upload_prefilter($file)
        {
            ...
            $errors = apply_filters(
                "acf/upload_prefilter/type={$field['type']}",
                $errors,
                $file,
                $field
            );
            $errors = apply_filters(
                "acf/upload_prefilter/name={$field['_name']}",
                $errors,
                $file,
                $field
            );
