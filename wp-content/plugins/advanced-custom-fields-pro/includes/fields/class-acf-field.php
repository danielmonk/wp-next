    ...
    class acf_field
    {
        ...
        function __construct()
        {
            ...
            $this->add_filter(
                ...
                [$this, 'input_admin_l10n'],
                10,
                1
            );
            $this->add_action(
                "acf/input/admin_footer",
                [$this, 'input_admin_footer'],
                10,
                1
            );
            ...
            $this->add_action(
                ...
                [$this, 'field_group_admin_head'],
                10,
                0
            );
            $this->add_action(
                "acf/field_group/admin_footer",
                [$this, 'field_group_admin_footer'],
                10,
                0
            );
        }
