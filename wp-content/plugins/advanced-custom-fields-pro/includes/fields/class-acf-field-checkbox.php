...
if (!class_exists('acf_field_checkbox')):
    class acf_field_checkbox extends acf_field
    {
        ...
        function render_field($field)
        {
            ...
            // append to class
            $ul['class'] .=
                ' ' . ($field['layout'] == 'horizontal' ? 'acf-hl' : 'acf-bl');
        ...
        function render_field_custom($field)
        {
            ...
            foreach ($field['value'] as $value) {
                ...
                // append
                $html .=
                    '<li><input class="acf-checkbox-custom" type="checkbox" checked="checked" />' .
            ...
            // append button
            $html .=
                '<li><a href="#" class="button acf-add-checkbox">' .
                esc_attr__('Add new choice', 'acf') .
                '</a></li>' .
                "\n";
        ...
        function update_value($value, $post_id, $field)
        {
            ...
            // select -> update_value()
            $value = acf_get_field_type('select')->update_value(
                $value,
                $post_id,
                $field
            );
        ...
        function format_value($value, $post_id, $field)
        {
            ...
            // Return.
            return acf_get_field_type('select')->format_value(
                $value,
                $post_id,
                $field
            );
