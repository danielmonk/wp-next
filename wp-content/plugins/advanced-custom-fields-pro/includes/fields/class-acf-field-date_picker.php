    ...
    class acf_field_date_picker extends acf_field
    {
        ...
        function input_admin_enqueue_scripts()
        {
            ...
            acf_localize_data([
                'datePickerL10n' => [
                    'closeText' => _x(
                        'Done',
                        'Date Picker JS closeText',
                        'acf'
                    ),
                    'currentText' => _x(
                        'Today',
                        'Date Picker JS currentText',
                        'acf'
                    ),
            ...
            wp_enqueue_style(
                'acf-datepicker',
                acf_get_url('assets/inc/datepicker/jquery-ui.min.css'),
                [],
                '1.11.4'
            );
        }
        ...
        function render_field($field)
        {
            ...
            $div = [
                ...
                'data-date_format' => acf_convert_date_to_js(
                    $field['display_format']
                ),
        ...
        function render_field_settings($field)
        {
            ...
            acf_render_field_setting($field, [
                ...
                'choices' => [
                    ...
                    'F j, Y' =>
                        '<span>' . $F_j_Y . '</span><code>F j, Y</code>',
            ...
            if (!empty($field['save_format'])) {
                ...
                acf_render_field_setting($field, [
                    ...
                    'instructions' => __(
                        'The format used when saving a value',
                        'acf'
                    ),
                    'type' => 'text',
                    'name' => 'save_format',
                ...
                acf_render_field_setting($field, [
                    ...
                    'choices' => [
                        'd/m/Y' =>
                            '<span>' . $d_m_Y . '</span><code>d/m/Y</code>',
                        'm/d/Y' =>
                            '<span>' . $m_d_Y . '</span><code>m/d/Y</code>',
                        'F j, Y' =>
                            '<span>' . $F_j_Y . '</span><code>F j, Y</code>',
