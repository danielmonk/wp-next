...
if (!class_exists('acf_field_wysiwyg')):
    class acf_field_wysiwyg extends acf_field
    {
        ...
        function add_filters()
        {
            ...
            $wp_filter_content_tags = function_exists('wp_filter_content_tags')
            ...
            if (isset($GLOBALS['wp_embed'])) {
                add_filter(
                    'acf_the_content',
                    [$GLOBALS['wp_embed'], 'run_shortcode'],
                    8
                );
                add_filter(
                    'acf_the_content',
        ...
        function render_field($field)
        {
            ...
            // mode
            $switch_class =
                $default_editor === 'html' ? 'html-active' : 'tmce-active';
            ...
            $wrap = [
                'id' => 'wp-' . $id . '-wrap',
                'class' =>
                    'acf-editor-wrap wp-core-ui wp-editor-wrap ' .
                    $switch_class,
     ...
     ?>
				...
				<?php if (user_can_richedit() && $show_tabs): ?>
					<div class="wp-editor-tabs">
						<button id="<?php echo $id; ?>-tmce" class="wp-switch-editor switch-tmce" <?php echo $button; ?> type="button"><?php echo __(
     'Visual',
     'acf'
 ); ?></button>
						<button id="<?php echo $id; ?>-html" class="wp-switch-editor switch-html" <?php echo $button; ?> type="button"><?php echo _x(
     'Text',
     ...
     'acf'
			...
			<div id="wp-<?php echo $id; ?>-editor-container" class="wp-editor-container">
				<?php if ($field['delay']): ?>
					<div class="acf-editor-toolbar"><?php _e(
        ...
        function render_field_settings($field)
        {
            ...
            acf_render_field_setting($field, [
                ...
                'instructions' => __(
                    'TinyMCE will not be initialized until field is clicked',
                    'acf'
                ),
                'name' => 'delay',
                'type' => 'true_false',
