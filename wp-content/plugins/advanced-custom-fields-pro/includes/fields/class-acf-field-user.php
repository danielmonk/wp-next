...
if (!class_exists('ACF_Field_User')):
    class ACF_Field_User extends ACF_Field
    {
        ...
        function initialize()
        {
            ...
            add_action('wp_ajax_nopriv_acf/fields/user/query', [
                $this,
                'ajax_query',
            ]);
        }
            ...
            if ($field['value']) {
                ...
                if ($users) {
                    foreach ($users as $user) {
                        $field['choices'][$user->ID] = $this->get_result(
                            $user,
                            $field
                        );
                    }
        ...
        function ajax_query()
        {
            ...
            // Add query hooks.
            add_action(
                'acf/ajax/query_users/init',
                [$this, 'ajax_query_init'],
                10,
                2
            );
            add_filter(
                'acf/ajax/query_users/args',
                [$this, 'ajax_query_args'],
                10,
                3
            );
            add_filter(
                'acf/ajax/query_users/result',
                [$this, 'ajax_query_result'],
                10,
                3
            );
            add_filter(
                'acf/ajax/query_users/search_columns',
                [$this, 'ajax_query_search_columns'],
                10,
                4
            );
         ...
         * @return	array
         */
        function ajax_query_search_columns(
            $columns,
            $search,
            $WP_User_Query,
            $query
