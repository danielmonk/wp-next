...
if (!class_exists('acf_field_oembed')):
    class acf_field_oembed extends acf_field
    {
        ...
        function initialize()
        {
            ...
            // extra
            add_action('wp_ajax_acf/fields/oembed/search', [
                $this,
                'ajax_query',
            ]);
            add_action('wp_ajax_nopriv_acf/fields/oembed/search', [
                $this,
                'ajax_query',
            ]);
        }
