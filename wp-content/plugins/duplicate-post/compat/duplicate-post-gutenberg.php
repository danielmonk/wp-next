...
add_filter(
    ...
    'duplicate_post_classic_editor_clone_link',
    10,
    4
);
 ...
 * @return string
 */
function duplicate_post_classic_editor_clone_link(
    $url,
    $post_id,
    $context,
    $draft
    ...
    if (
        isset($_GET['classic-editor']) || // phpcs:ignore WordPress.Security.NonceVerification
        ($draft &&
            function_exists('gutenberg_post_has_blocks') &&
            !gutenberg_post_has_blocks($post)) ||
