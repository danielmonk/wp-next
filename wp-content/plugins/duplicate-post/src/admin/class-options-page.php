...
class Options_Page
{
    ...
    public function __construct(
        Options $options,
        Options_Form_Generator $generator,
    ...
    {
        return $this->generator->generate_options_input(
    ...
    public function register_capabilities()
    {
        ...
        foreach (Utils::get_roles() as $name => $display_name) {
            ...
            if (
                !$role->has_cap('copy_posts') &&
                \in_array($name, $roles, true)
            ) {
    ...
    protected function settings_updated()
    {
        return isset($_GET['settings-updated']) &&
            $_GET['settings-updated'] === 'true'; // phpcs:ignore WordPress.Security.NonceVerification
    }
