...
class Copied_Post_Watcher
{
    ...
    {
        if (
            $this->permissions_helper->has_trashed_rewrite_and_republish_copy(
                $post
            )
        ) {
            return \__(
        ...
        $scheduled_copy = $this->permissions_helper->has_scheduled_rewrite_and_republish_copy(
            $post
        );
        if (!$scheduled_copy) {
            return \__(
    ...
    public function add_block_editor_notice()
    {
        ...
        if ($this->permissions_helper->has_rewrite_and_republish_copy($post)) {
            ...
            \wp_add_inline_script(
                ...
                "duplicatePostNotices.has_rewrite_and_republish_notice = '" .
