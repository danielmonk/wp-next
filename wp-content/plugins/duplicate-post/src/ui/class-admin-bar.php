...
class Admin_Bar
{
    ...
    public function register_hooks()
    {
        if (
            \intval(
                Utils::get_option('duplicate_post_show_link_in', 'adminbar')
            ) === 1
        ) {
    ...
    public function admin_bar_render()
    {
        ...
        if ($show_new_draft && $show_rewrite_and_republish) {
            $wp_admin_bar->add_menu([
                'id' => 'duplicate-post',
                'title' =>
                    '<span class="ab-icon"></span><span class="ab-label">' .
            ...
            $wp_admin_bar->add_menu([
                ...
                'href' => $this->link_builder->build_rewrite_and_republish_link(
                    $post
                ),
            ]);
        } else {
    ...
    public function get_current_post()
    {
        ...
        if (
            ...
            !$this->permissions_helper->post_type_has_admin_bar(
                $post->post_type
            )
        ) {
            return false;
