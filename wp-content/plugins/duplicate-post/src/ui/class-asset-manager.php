...
class Asset_Manager
{
    ...
    public function register_styles()
    {
        \wp_register_style(
            'duplicate-post',
            \plugins_url('/css/duplicate-post.css', DUPLICATE_POST_FILE),
            [],
        ...
        \wp_register_style(
            ...
            \plugins_url(
                '/css/duplicate-post-options.css',
                DUPLICATE_POST_FILE
            ),
            [],
            DUPLICATE_POST_CURRENT_VERSION
    ...
    {
        $flattened_version = Utils::flatten_version(
            DUPLICATE_POST_CURRENT_VERSION
        );
        ...
        \wp_register_script(
            ...
            \plugins_url(
                \sprintf(
                    'js/dist/duplicate-post-edit-%s.js',
                    $flattened_version
                ),
                DUPLICATE_POST_FILE
            ),
        ...
        \wp_register_script(
            ...
            \plugins_url(
                \sprintf(
                    'js/dist/duplicate-post-strings-%s.js',
                    $flattened_version
                ),
                DUPLICATE_POST_FILE
            ),
        ...
        \wp_register_script(
            ...
            \plugins_url(
                \sprintf(
                    'js/dist/duplicate-post-quick-edit-%s.js',
                    $flattened_version
                ),
                DUPLICATE_POST_FILE
            ),
    ...
    public function enqueue_edit_script($object = [])
    {
        ...
        \wp_localize_script($handle, 'duplicatePost', $object);
    }
    ...
    public function enqueue_strings_script($object = [])
    {
        ...
        \wp_enqueue_script($handle);
        \wp_localize_script($handle, 'duplicatePostStrings', $object);
    }
    ...
    public function enqueue_elementor_script($object = [])
    {
        ...
        \wp_register_script(
            ...
            \plugins_url(
                \sprintf(
                    'js/dist/duplicate-post-elementor-%s.js',
                    $flattened_version
                ),
                DUPLICATE_POST_FILE
            ),
