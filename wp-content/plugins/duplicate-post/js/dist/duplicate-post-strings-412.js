!(function (e) {
  ...
  function (e, t, o) {
    ...
    var i = o(0),
      r = function (e) {
        var t = (0, i.select)("core/editor").getCurrentPostAttribute("status"),
          o = (0, i.select)("core/editor").getEditedPostAttribute("status");
    ...
    t.redirectOnSaveCompletion = function (e, t) {
      var o = (0, i.select)("core/editor").isSavingPost(),
        n = (0, i.select)("core/editor").isAutosavingPost(),
        s = (0, i.select)("core/edit-post").hasMetaBoxes(),
        a = (0, i.select)("core/edit-post").isSavingMetaBoxes();
      return (
        s && !a && t.wasSavingMetaboxes && r(e),
        s || o || !t.wasSavingPost || t.wasAutoSavingPost || r(e),
        { isSavingPost: o, isSavingMetaBoxes: a, isAutosavingPost: n }
      );
    };
  },
  ,
  ...
  function (e, t, o) {
    ...
    var u,
      ...
      c,
      p = function () {
        (0, s.dispatch)("core/editor").savePost();
        var e = !1,
          t = !1,
          o = !1;
        (0, s.subscribe)(function () {
          var i = (0,
          a.redirectOnSaveCompletion)(duplicatePostStrings.checkLink, {
            wasSavingPost: e,
            wasSavingMetaboxes: t,
            wasAutoSavingPost: o,
          });
          (e = i.isSavingPost),
            (t = i.isSavingMetaBoxes),
            (o = i.isAutosavingPost);
        });
      },
      d = {
        Publish: (0, n.__)("Republish", "duplicate-post"),
        "Publish:": (0, n.__)("Republish:", "duplicate-post"),
        "Publish on:": (0, n.__)("Republish on:", "duplicate-post"),
        "Are you ready to publish?": (0, n.__)(
          "Are you ready to republish your post?",
          "duplicate-post"
        ),
        "Double-check your settings before publishing.": (0,
        i.createInterpolateElement)(
          (0, n.__)(
          ...
          {
            button: wp.element.createElement(r.Button, {
              isSecondary: !0,
              onClick: p,
            }),
        ...
        Schedule: (0, n.__)("Schedule republish", "duplicate-post"),
        "Schedule…": (0, n.__)("Schedule republish…", "duplicate-post"),
        "post action/button labelSchedule": (0, n.__)(
          "Schedule republish",
          "duplicate-post"
        ),
        "Are you ready to schedule?": (0, n.__)(
          "Are you ready to schedule the republishing of your post?",
          "duplicate-post"
        ),
        "Your work will be published at the specified date and time.": (0,
        i.createInterpolateElement)(
          (0, n.__)(
        ...
        "is now scheduled. It will go live on": (0, n.__)(
