    ...
    function mycred_init_wpecom_construct_gateway()
    {
        ...
        $mycred_wpecom_settings = shortcode_atts(
            [
                ...
                'rate' => 1,
                'visitor' => __(
                    'You must be logged in to use this gateway',
                    'mycred'
                ),
        ...
        $nzshpcrt_gateways[] = [
            ...
            'requirements' => ['php_version' => '5.2.4'],
        ...
        class myCRED_WP_E_Commerce_Gateway
        {
            ...
            function __construct()
            {
                ...
                add_filter('wpsc_gateway_checkout_form_mycred', [
                    $this,
                    'checkout_form',
                ]);
                add_filter(
                    'mycred_parse_log_entry_wpecom_payment',
                    [$this, 'parse_template_tags'],
                    10,
                    2
                );
            }
            ...
            function process_gateway($gateway, $purchase_log)
            {
                ...
                // Load Gateway
                $merchant_instance = new wpsc_merchant_mycred(
                    $log_id,
                    false,
                    $this->prefs,
                    $this->core,
                ...
                // Charge
                do_action_ref_array('wpsc_pre_submit_gateway', [
                    &$merchant_instance,
                ]);
            ...
            function checkout_form()
            {
                ...
                $output .=
                    '<tr><td><table width="100%"><thead><th class="cart-item">' .
                    __('Item', 'mycred') .
                    '</th><th class="cart-item-qt"></th><th class="cart-item-cost">' .
                    $this->core->plural() .
                    '</th></thead><tbody>';
                ...
                $output .=
                    ...
                    '</td><td class="cart-item-cost">' .
                    $this->core->format_creds($total) .
                    '</td></tr>';
                ...
                $output .=
                    '<tr><td class="cart-item" colspan="2">' .
                    __('Your current balance', 'mycred') .
                    '</td><td class="cart-item-cost"' .
                    $highlight .
                    '>' .
                    $this->core->format_creds($balance) .
                    '</td></tr></tdody></table></tr>';
        ...
        class wpsc_merchant_mycred extends wpsc_merchant
        {
            ...
            function validate($purchase_log)
            {
                ...
                if (!is_user_logged_in()) {
                    $error = $this->core->template_tags_general(
                        $this->prefs['visitor']
                    );
                }
                ...
                $this->transaction_id =
                    strtoupper(MYCRED_SLUG) . $user_id . time();
            }
            ...
            function submit()
            {
                ...
                if (
                    ...
                    do_action_ref_array('mycred_wpecom_charg', [&$this]);
                    ...
                    if ($this->prefs['share'] > 0) {
                        ...
                        foreach ((array) $this->cart_items as $item) {
                            ...
                            if (
                                $product === null ||
                                $product->post_author == $this->user_id
                            ) {
                                continue;
                            }
                    ...
                    do_action_ref_array('mycred_wpecom_charged', [&$this]);

                    // Empty Cart, Redirect & Exit
                    wpsc_empty_cart();

                    $this->go_to_transaction_results(
                        $this->cart_data['session_id']
                    );
...
<tr>
	<td width="150">' .
            __('Log Template for Payments', 'mycred') .
            '</td>
	<td><input type="text" name="mycred_gateway[log]" value="' .
            esc_attr($mycred_wpecom_settings['log']) .
            '" style="width:50%;" /><br /><span class="description">' .
            $mycred->available_template_tags(['general'], '%order_id%') .
            '</span></td>
</tr>';
...
<tr>
	<td width="150">' .
                __('Point Type', 'mycred') .
                '</td>
	<td>' .
                mycred_types_select_from_dropdown(
                    'mycred_gateway[type]',
                    'mycred-point-type',
                    $type,
                    true
...
<tr>
	<td width="150">' .
            __('Exchange Rate', 'mycred') .
            '</td>
	<td><input type="text" name="mycred_gateway[rate]" value="' .
            esc_attr($mycred_wpecom_settings['rate']) .
            '" style="width:50px;" /><br /><span class="description">' .
            sprintf(
                __('How much is 1 %s worth in %s', 'mycred'),
                $selected_currency,
                $mycred->plural()
            ) .
            '</span></td>
...
<tr>
	<td width="150">' .
            __('Payout', 'mycred') .
            '</td>
	<td><input type="text" name="mycred_gateway[share]" value="' .
            esc_attr($mycred_wpecom_settings['share']) .
            '" style="width:50px;" /> %<br /><span class="description">' .
            __(
...
<tr>
	<td width="150">' .
            __('Log Template', 'mycred') .
            '</td>
	<td><input type="text" name="mycred_gateway[share_log]" value="' .
            esc_attr($mycred_wpecom_settings['share_log']) .
            '" style="width:50%;" /><br /><span class="description">' .
            $mycred->available_template_tags(['general', 'post']) .
            '</span></td>
</tr>
<tr>
	<td colspan="2"><strong>' .
...
<tr>
	<td width="150">' .
            __('Instructions', 'mycred') .
            '</td>
	<td><input type="text" name="mycred_gateway[message]" value="' .
            esc_attr($mycred_wpecom_settings['message']) .
            '" style="width:50%;" /><br /><span class="description">' .
            __(
                'Optional instructions to show users when selecting this gateway. Leave empty to hide.',
                'mycred'
            ) .
            '</span></td>
</tr>
<tr>
	<td width="150">' .
            __('Visitors', 'mycred') .
            '</td>
	<td><input type="text" name="mycred_gateway[visitor]" value="' .
            esc_attr($mycred_wpecom_settings['visitor']) .
            '" style="width:50%;" /><br /><span class="description">' .
            __('Message to show visitors who are not logged in.', 'mycred') .
            '</span></td>
</tr>
<tr>
	<td width="150">' .
            ...
            '</td>
	<td><input type="text" name="mycred_gateway[low_funds]" value="' .
            esc_attr($mycred_wpecom_settings['low_funds']) .
            '" style="width:50%;" /><br /><span class="description">' .
            $mycred->template_tags_general(
                __(
                    'Message to show when users does not have enough %plural% to pay using this gateway.',
                    'mycred'
                )
            ) .
            '</span></td>
...
if (!function_exists('mycred_wpecom_gateway_settings_save')):
    function mycred_wpecom_gateway_settings_save()
    {
        if (isset($_POST['mycred_gateway'])) {
            $new_settings = apply_filters('mycred_wpecom_save_settings', [
                ...
                'share_log' => sanitize_text_field(
                    $_POST['mycred_gateway']['share_log']
                ),
                'rate' => sanitize_text_field($_POST['mycred_gateway']['rate']),
                'visitor' => sanitize_text_field(
                    $_POST['mycred_gateway']['visitor']
                ),
                'low_funds' => sanitize_text_field(
                    $_POST['mycred_gateway']['low_funds']
                ),
                'message' => sanitize_text_field(
                    $_POST['mycred_gateway']['message']
                ),
            ]);
