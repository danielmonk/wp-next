...
class PublicKey extends Key
{
    ...
    public function generate(PrivateKey $privateKey = null)
    {
        ...
        if (is_null($this->privateKey)) {
            throw new \Exception(
                'Please `setPrivateKey` before you generate a public key'
            );
        }
        ...
        if (!$this->privateKey->isValid()) {
            throw new \Exception(
                'Private Key is invalid and cannot be used to generate a public key'
            );
        }
    ...
    public function isValid()
    {
        return !empty($this->hex) &&
            ...
            (!empty($this->dec) && ctype_digit($this->dec));
    }
