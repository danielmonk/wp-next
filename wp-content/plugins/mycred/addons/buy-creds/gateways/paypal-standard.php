...
if (!class_exists('myCRED_PayPal_Standard')):
    class myCRED_PayPal_Standard extends myCRED_Payment_Gateway
    {
        ...
        public function IPN_is_valid_call()
        {
            ...
            // Call PayPal
            $curl_attempts = apply_filters(
                'mycred_paypal_standard_max_attempts',
                3
            );
            $attempt = 1;
            $result = '';
            ...
            do {
                ...
                curl_setopt(
                    $call,
                    CURLOPT_CAINFO,
                    MYCRED_PURCHASE_DIR . '/cacert.pem'
                );
            ...
            if (
                ...
                if ($pending_payment !== false) {
                    ...
                    if ($this->IPN_is_valid_call()) {
                        ...
                        // Check currency
                        if (
                            $_POST['mc_currency'] != $pending_payment->currency
                        ) {
                            $new_call[] = sprintf(
                                __(
        ...
        public function prep_sale($new_transaction = false)
        {
            ...
            $this->redirect_to = $this->sandbox_mode
...
<div class="row">
    ...
    'mycred'
       ...
       'currency',
       'mycred-gateway-paypal-standard-currency'
   ); ?>
