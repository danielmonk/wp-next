...
if (!class_exists('myCRED_Bank_Transfer')):
    class myCRED_Bank_Transfer extends myCRED_Payment_Gateway
    {
        ...
        public function ajax_buy()
        {
            ...
            $content .=
                '</div><div id="buycred-checkout-step2" style="display: none;">';
...
<div class="row">
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		...
		<div class="form-group">
			<label for="<?php echo $this->field_id('title'); ?>"><?php _e(
    'Title',
    'mycred'
); ?></label>
...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="form-group">
			<label for="buycredbanktransferaccount"><?php _e(
       'Bank Account Information',
       'mycred'
   ); ?></label>
			<?php wp_editor($prefs['account'], 'buycredbanktransferaccount', [
       'textarea_name' => $this->field_name('account'),
       'textarea_rows' => 10,
   ]); ?>
		</div>
	</div>
