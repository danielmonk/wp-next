...
if (!class_exists('myCRED_Statistics_Widget')):
    abstract class myCRED_Statistics_Widget
    {
         ...
         * Construct
         */
        function __construct($widget_id = null, $args = [], $default = null)
        {
            if ($widget_id === null) {
                return false;
            }

            $this->id = str_replace(['_', '-', ' '], '', $widget_id);
        ...
        {
            wp_die(
                'function myCRED_Statistics_Widget::widget() must be over-ridden in a sub-class.'
            );
        }
        ...
        function action_buttons()
        {
            ...
            if (!empty($buttons)) {
                $output =
                    '<p class="circulation-buttons mycred-action-buttons">' .
                    implode(' ', $buttons) .
                    '</p>';
            }
