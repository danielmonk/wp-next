...
if (!class_exists('myCRED_Stats_Widget_Daily_Loses')):
    class myCRED_Stats_Widget_Daily_Loses extends myCRED_Statistics_Widget
    {
        ...
        function widget()
        {
            ...
            if ($this->args['ctypes'] != 'all') {
                $lose_label = $this->core->template_tags_general(
                    __(
...
<?php
    ...
    echo '</ol></div><div class="last-ten-days-chart"><canvas id="daily-loses-' .
        $this->id .
        '-chart"></canvas><div id="' .
        $this->id .
