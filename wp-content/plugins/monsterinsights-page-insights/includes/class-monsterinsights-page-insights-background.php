...
class MonsterInsights_Page_Insights_Background
{
    ...
    {
        add_action('wp_ajax_monsterinsights_pageinsights_fetch_data', [
            $this,
            'fetch_all_data',
        ]);
    }
    ...
    public function fetch_all_data()
    {
        ...
        $api = new MonsterInsights_API_Request(
            'analytics/reports/pageinsights',
            $api_options,
            'GET'
        );
        ...
        if (is_wp_error($report_data)) {
            ...
            if (
                !empty($report_data['data']['pageinsights']) &&
                is_array($report_data['data']['pageinsights'])
            ) {
            ...
            wp_remote_post(admin_url('admin-ajax.php'), [
                ...
                'body' => [
                    ...
                    'nonce' => wp_create_nonce(
                        'monsterinsights_pageinsights_fetch'
                    ),
                    'page' => $page,
                ],
                'cookies' => $_COOKIE,
