    ...
    <Step isActive={isStepActive} isComplete={isStepComplete}>
      ...
      >
        ...
        <ul className="list-disc list-inside mt-2">
          <li>
            <b>{__("CSS", "genesis-blocks")}</b> -{" "}
            {__("CSS classes and HTML markup have changed.", "genesis-blocks")}
            &nbsp;
            <a href={cssDetailsUrl} target="_blank" rel="noopener noreferrer">
              {__("Check if you need to make CSS changes.", "genesis-blocks")}
            </a>
          </li>
          <li>
            <b>{__("PHP", "genesis-blocks")}</b> -{" "}
            {__(
              "Filter, function and block names have changed.",
              "genesis-blocks"
            )}
            &nbsp;
            <a href={phpDetailsUrl} target="_blank" rel="noopener noreferrer">
