...
final class Module implements ModuleInterface
{
    ...
    public function is_enabled(): bool
    {
        ...
        $has_completed_migration =
            get_option('genesis_blocks_migrated_from_atomic_blocks') ||
            get_option('genesis_blocks_pro_migrated_from_genesis_blocks_pro');
    ...
    {
        if (empty($_GET['genesis-blocks-migrate'])) {
