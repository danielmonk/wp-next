...
class Api
{
    ...
    public function init(): void
    {
        ...
        add_action('rest_api_init', [
            $this,
            'register_route_migrate_user_meta',
        ]);
        add_action('rest_api_init', [
            $this,
            'register_route_migration_cleanup',
        ]);
    }
    ...
    {
        register_rest_route('genesis-blocks', 'migrate-settings', [
            'methods' => 'POST',
        ...
        register_rest_route('genesis-blocks', 'migrate-pro-settings', [
            'methods' => 'POST',
    ...
    public function get_migrate_setting_response()
    {
        ...
        return new WP_Error(
            'migration_failed',
            __('Settings migration failed', 'genesis-blocks')
        );
    }
    ...
    public function get_migrate_pro_setting_response()
    {
        ...
        return new WP_Error(
            'migration_failed',
            __('Pro settings migration failed', 'genesis-blocks')
        );
    }
    ...
    {
        register_rest_route('genesis-blocks', 'migrate-content', [
            'methods' => 'POST',
    ...
    public function get_migrate_content_response()
    {
        ...
        return new WP_Error(
            'migration_failed',
            __('Content migration failed', 'genesis-blocks')
        );
    }
    ...
    {
        register_rest_route('genesis-blocks', 'migrate-user-meta', [
            'methods' => 'POST',
    ...
    {
        register_rest_route('genesis-blocks', 'migrate-cleanup', [
            'methods' => 'POST',
    ...
    public function get_migration_cleanup_response()
    {
        ...
        if (genesis_blocks_is_pro()) {
            \update_option(
                'genesis_blocks_pro_migrated_from_genesis_blocks_pro',
                true
            );
        } else {
