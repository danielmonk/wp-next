...
final class SettingTest extends TestCase
{
    ...
    public function test_migrate_success(): void
    {
        ...
        Functions\expect('update_option')
            ->once()
            ->with(Setting::NEW_NAME, $option_value)
            ->andReturn(true);
    ...
    public function test_migrating_pro_settings_data_gives_expected_result(): void
    {
        ...
        $expected_settings = include __DIR__ .
            '/fixtures/settings/expected-pro-block-settings-permissions.php';
        $this->assertSame(
            $expected_settings,
            $this->instance->migrate_permissions_data($old_settings)
        );
    }
}
