...
final class ApiTest extends TestCase
{
    ...
    public function test_init(): void
    {
        Functions\expect('add_action')
            ...
            ->with('rest_api_init', [
                $this->instance,
                'register_route_migrate_setting',
            ]);
    ...
    {
        $old_settings = include __DIR__ .
            '/fixtures/settings/pro-block-settings-permissions.php';
    ...
    public function test_get_migrate_user_response_on_success(): void
    {
        ...
        Functions\expect('rest_ensure_response')->once();
    ...
    public function test_get_migrate_setting_response_on_failure(): void
    {
        ...
        $this->assertEquals(
            'WP_Error',
            get_class($this->instance->get_migrate_setting_response())
        );
    }
    ...
    public function test_get_migrate_user_meta_response_on_failure(): void
    {
        ...
        $this->assertEquals(
            'WP_Error',
            get_class($this->instance->get_migrate_user_meta_response())
        );
    }
    ...
    public function test_get_migration_cleanup_response(): void
    {
        ...
        Functions\expect('genesis_blocks_is_pro')->once();
