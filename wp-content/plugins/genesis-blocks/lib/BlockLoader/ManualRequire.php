...
final class ManualRequire
{
    ...
    private function require_files(): void
    {
        ...
        if (!class_exists('\DrewM\MailChimp\MailChimp')) {
            require_once $this->context['path'] .
                'lib/drewm/mailchimp-api/MailChimp.php';
        }

        require_once $blocks_path .
            'block-newsletter/includes/exceptions/class-api-error-exception.php';
        require_once $blocks_path .
            'block-newsletter/includes/exceptions/class-mailchimp-api-error-exception.php';
        require_once $blocks_path .
            'block-newsletter/includes/interfaces/newsletter-provider-interface.php';
        require_once $blocks_path .
            'block-newsletter/includes/classes/class-mailchimp.php';
        require_once $blocks_path .
            'block-newsletter/includes/newsletter-functions.php';
