            ...
            {(tab) => {
              ...
              if (tab.name) {
                if ("gb-layout-tab-sections" === tab.name) {
                  return [
                    <LayoutLibrary
                      key={"layout-library-sections-" + props.clientId}
                ...
                if ("gb-layout-tab-layouts" === tab.name) {
                  return [
                    <LayoutLibrary
                      key={"layout-library-layouts-" + props.clientId}
                      clientId={props.clientId}
                      currentTab={currentTab}
                ...
                if ("gb-layout-tab-collections" === tab.name) {
                  return [
                    <LayoutLibrary
                      key={"layout-library-collections-" + props.clientId}
                      clientId={props.clientId}
                      currentTab={currentTab}
                ...
                if ("gb-layout-tab-favorites" === tab.name) {
                  return [
                    <LayoutLibrary
                      key={"layout-library-favorites-" + props.clientId}
                      clientId={props.clientId}
                      currentTab={currentTab}
                ...
                if ("gb-layout-tab-reusable-blocks" === tab.name) {
                  return [
                    <LayoutLibrary
                      key={"layout-library-reusable-blocks-" + props.clientId}
                      clientId={props.clientId}
                      currentTab={currentTab}
