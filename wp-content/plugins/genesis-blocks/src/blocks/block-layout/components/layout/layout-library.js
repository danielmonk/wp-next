          ...
          <Fragment>
            <div className="gb-layout-modal-header">
              <SelectControl
                ...
                label={__("Layout Categories", "genesis-blocks")}
              ...
              <TextControl
                ...
                placeholder={__("Search Layouts", "genesis-blocks")}
          ...
          <Fragment>
            ...
            <div className="gb-layout-modal-header gb-layout-modal-header-reusable">
              ...
              <div className="gb-layout-modal-header-reusable-actions">
                ...
                >
                  {__("Manage All Reusable Blocks", "genesis-blocks")}
                </a>
              </div>
            </div>
          </Fragment>
          ...
          {(context) => (
            <ButtonGroup
              ...
              className={classnames(
                ...
                "full" === this.state.activeView ? "gb-layout-view-full" : null
              )}
