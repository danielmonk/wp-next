      ...
      <InspectorControls key="inspector">
        ...
        <RenderSettingControl id="gb_cta_backgroundOptions">
          <PanelBody
            ...
            initialOpen={false}
          >
            <p>{__("Select a background image:", "genesis-blocks")}</p>
            <MediaUpload
              ...
              render={({ open }) => (
                <div>
                  <Button
                    ...
                    label={__("Edit image", "genesis-blocks")}
                    onClick={open}
                  >
                  ...
                  {imgURL && !!imgURL.length && (
                    <Button
                      className="gb-cta-inspector-media"
                      label={__("Remove Image", "genesis-blocks")}
              ...
              colorSettings={[
                {
                  ...
                  label: __("Overlay Color", "genesis-blocks"),
                },
              ]}
            ></PanelColorSettings>
          </PanelBody>
