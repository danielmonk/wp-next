      ...
      <CallToAction key={"gb-cta-" + this.props.clientId} {...this.props}>
        {imgURL && !!imgURL.length && (
          <div className="gb-cta-image-wrap">
            <img
              className={classnames("gb-cta-image", dimRatioToClass(dimRatio), {
        ...
        <div className="gb-cta-content">
          ...
          <RichText
            tagName="div"
            multiline="p"
            placeholder={__("Call To Action Text", "genesis-blocks")}
            keepPlaceholderOnFocus
            value={ctaText}
            className={classnames(
              "gb-cta-text",
        ...
        <div className="gb-cta-button">
          <RichText
            ...
            value={buttonText}
            allowedFormats={[]}
            className={classnames("gb-button", buttonShape, buttonSize)}
            style={{
          ...
          {isSelected && (
            ...
            >
              ...
              />
              <Button label={__("Apply", "genesis-blocks")} type="submit">
