...
function genesis_blocks_register_sharing()
{
    ...
    register_block_type('genesis-blocks/gb-sharing', [
...
function genesis_blocks_render_sharing($attributes)
{
    ...
    $reddit_url =
        'https://www.reddit.com/submit?url=' . get_the_permalink() . '';

    $share_url = '';

    if (isset($attributes['twitter']) && $attributes['twitter']) {
        $href_format = sprintf(
            'href="javascript:void(0)" onClick="javascript:genesisBlocksShare(\'%1$s\', \'%2$s\', \'600\', \'600\')"',
            esc_url($twitter_url),
    ...
    $block_content = sprintf(
        ...
        $share_url,
        isset($attributes['shareButtonStyle'])
            ? $attributes['shareButtonStyle']
            : null,
        isset($attributes['shareButtonShape'])
            ? $attributes['shareButtonShape']
            : null,
        isset($attributes['shareButtonSize'])
            ? $attributes['shareButtonSize']
            : null,
        isset($attributes['shareButtonColor'])
            ? $attributes['shareButtonColor']
            : null,
        isset($attributes['shareAlignment'])
            ? 'gb-align-' . $attributes['shareAlignment']
            : null
    );
