        ...
        >
          ...
          <RenderSettingControl id="gb_newsletter_containerMargin">
            <Margin
              ...
              marginTopLabel={__("Block Margin Top", "genesis-blocks")}
              ...
              marginBottomLabel={__("Block Margin Bottom", "genesis-blocks")}
            ...
            colorSettings={[
              {
                ...
                label: __("Block Background Color", "genesis-blocks"),
              },
              {
              ...
              },
              {
                ...
                label: __("Button Background Color", "genesis-blocks"),
              },
              {
                value: buttonTextColor.color,
                onChange: setButtonTextColor,
                label: __("Button Text Color", "genesis-blocks"),
              },
            ]}
          >
