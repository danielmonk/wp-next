...
function genesis_blocks_render_block_core_latest_posts($attributes)
{
    ...
    $categories = isset($attributes['categories'])
        ? $attributes['categories']
        : '';

    /* Get the selected pages */
    $page_selection = isset($attributes['selectedPages'])
        ? array_column($attributes['selectedPages'], 'value')
        : null;
    ...
    if (isset($attributes['postType']) && 'page' === $attributes['postType']) {
        ...
        $args = [
            ...
            'post__not_in' => isset($post->ID) ? [$post->ID] : [],
        ];
    }
    ...
    if ($grid_query->have_posts()) {
        while ($grid_query->have_posts()) {
            ...
            if (
                ...
                $attributes['displayPostImage'] === false
            ) {
            ...
            if (
                isset($attributes['displayPostTitle']) &&
            ...
            if (
                isset($attributes['displayPostExcerpt']) &&
            ...
            if (
                isset($attributes['displayPostLink']) &&
        ...
        if (
            isset($attributes['displaySectionTitle']) &&
            $attributes['displaySectionTitle'] &&
            !empty($attributes['sectionTitle'])
        ) {
            ...
            $section_title =
                '<' .
                esc_attr($section_title_tag) .
                ' class="gb-post-grid-section-title">' .
...
function genesis_blocks_register_block_core_latest_posts()
{
    ...
    /* Block attributes */
    register_block_type('genesis-blocks/gb-post-grid', [
        'attributes' => [
            'categories' => [
                'type' => 'string',
            ],
...
function genesis_blocks_register_rest_fields()
{
    ...
    register_rest_field(['post', 'page'], 'featured_image_src_square', [
