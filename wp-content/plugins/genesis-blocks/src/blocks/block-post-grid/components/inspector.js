...
export default class Inspector extends Component {
  ...
  componentDidMount() {
    ...
    if (
      this.props.attributes.postType === "page" &&
      this.props.attributes.selectedPages.length !==
        this.props.attributes.selectedPages.postsToShow
    ) {
      ...
      <InspectorControls>
            ...
            <RenderSettingControl id="gb_postgrid_selectedPages">
              <div className="components-base-control select2-page">
                <div className="components-base-control__field">
                  ...
                  >
                    {__("Pages To Show", "genesis-blocks")}
                  </label>
                  <Select
                    options={pageOptions}
        ...
        >
          <RenderSettingControl id="gb_postgrid_displaySectionTitle">
            <ToggleControl
              label={__("Display Section Title", "genesis-blocks")}
          ...
          <RenderSettingControl id="gb_postgrid_displayPostImage">
            <ToggleControl
              label={__("Display Featured Image", "genesis-blocks")}
          ...
          <RenderSettingControl id="gb_postgrid_displayPostLink">
            <ToggleControl
              label={__("Display Continue Reading Link", "genesis-blocks")}
          ...
          {attributes.displayPostLink && (
            <RenderSettingControl id="gb_postgrid_readMoreText">
              <TextControl
                label={__("Customize Continue Reading Text", "genesis-blocks")}
                type="text"
        ...
        >
          <RenderSettingControl id="gb_postgrid_sectionTag">
            <SelectControl
              label={__("Post Grid Section Tag", "genesis-blocks")}
              options={sectionTags}
          ...
          {attributes.sectionTitle && (
            <RenderSettingControl id="gb_postgrid_sectionTitleTag">
              <SelectControl
                label={__("Section Title Heading Tag", "genesis-blocks")}
          ...
          {attributes.displayPostTitle && (
            <RenderSettingControl id="gb_postgrid_postTitleTag">
              <SelectControl
                label={__("Post Title Heading Tag", "genesis-blocks")}
                options={sectionTitleTags}
