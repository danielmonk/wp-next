          ...
          >
            ...
            {(2 === attributes.columns ||
              ...
              <Fragment>
                <RenderSettingControl id="gb_column_columnLayouts">
                  <p>{__("Column Layout", "genesis-blocks")}</p>
                  <ButtonGroup
                    aria-label={__("Column Layout", "genesis-blocks")}
                  >
                    {map(
            ...
            {0 < attributes.columnMaxWidth && (
              <RenderSettingControl id="gb_column_centerColumns">
                <ToggleControl
                  label={__("Center Columns In Container", "genesis-blocks")}
                  help={__(
            ...
            <RenderSettingControl id="gb_column_responsiveToggle">
              <ToggleControl
                label={__("Responsive Columns", "genesis-blocks")}
                help={__(
          ...
          >
            ...
            {!attributes.marginSync ? (
              ...
              <Margin
                ...
                marginVerticalLabel={__("Margin Top/Bottom", "genesis-blocks")}
