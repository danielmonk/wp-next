	...
	function monsterinsights_forms_record_impression( event ) {
		...
		for (monsterinsights_forms_i = 0; monsterinsights_forms_i < monsterinsights_forms.length; monsterinsights_forms_i++ ) {
			...
			if ( monsterinsights_form_id && monsterinsights_form_id !== 'commentform' && monsterinsights_form_id !== 'adminbar-search' ) {
				...
				var custom_conversion_mi_forms = <?php echo apply_filters(
        "monsterinsights_forms_custom_conversion",
        "false"
    ); ?>;
...
function monsterinsights_forms_custom_wpforms_save(
    $fields,
    $entry,
    $form_id,
    $form_data
...
add_action(
    ...
    'monsterinsights_forms_custom_wpforms_save',
    10,
    4
);
...
add_action(
    ...
    'monsterinsights_forms_custom_ninja_forms_save'
);
...
add_action(
    ...
    'monsterinsights_forms_custom_gravity_forms_save',
    10,
    2
);
...
add_action(
    ...
    'monsterinsights_forms_custom_formidable_forms_save',
    30,
    2
);
...
function monsterinsights_add_elementor_form_id($instance, $form)
{
    ...
    if (
        method_exists($form, 'add_render_attribute') &&
        method_exists($form, 'get_id')
    ) {
...
add_action(
    'elementor-pro/forms/pre_render',
    'monsterinsights_add_elementor_form_id',
    15,
    2
);
...
function monsterinsights_enfold_add_unique_id($form_args, $post_id)
{
    ...
    $form_id = !empty($form_args['heading'])
        ? sanitize_title(strip_tags($form_args['heading']))
        : '';
...
add_filter(
    'avia_contact_form_args',
    'monsterinsights_enfold_add_unique_id',
    10,
    2
);
