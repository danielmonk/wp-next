<div id="akismet-plugin-container">
	<div class="akismet-masthead">
        ...
        plugins_url('../_inc/img/logo-full-2x.png', __FILE__)
    ); ?>" alt="Akismet" />
			</div>
		</div>
	</div>
      ...
      (int) $stat_totals['all']->spam > 0
			...
			<div class="akismet-card">
				...
				<div class="akismet-new-snapshot">
					<iframe allowtransparency="true" scrolling="no" frameborder="0" style="width: 100%; height: 220px; overflow: hidden;" src="<?php printf(
         ...
         Akismet_Admin::get_page_url()
						...
						<table cellspacing="0" class="akismet-settings">
							<tbody>
								...
								<tr>
									<th class="akismet-api-key" width="10%" align="left" scope="row"><?php esc_html_e(
             'API Key',
             'akismet'
         ); ?></th>
									<td width="5%"/>
    ...
    'regular-text code ' . $akismet_user->status
								...
								<?php if (isset($_GET['ssl_status'])) { ?>
									<tr>
										...
										<td align="left">
											<p>
												<?php if (!wp_http_supports(['ssl'])) { ?><b><?php esc_html_e(
    'Disabled.',
    'akismet'
); ?></b> <?php esc_html_e(
    'Your Web server cannot make SSL requests; contact your Web host and ask them to add support for SSL requests.',
    'akismet'
);} else {$ssl_disabled = get_option('akismet_ssl_disabled');

                if ($ssl_disabled) { ?><b><?php esc_html_e(
    ...
    'akismet'
								...
								<tr>
									...
									<td align="left">
										<p>
											<label for="akismet_show_user_comments_approved" title="<?php esc_attr_e(
             ...
             checked(
                ...
                'akismet'
								...
								<tr>
									<th class="strictness" align="left" scope="row"><?php esc_html_e(
             'Strictness',
             'akismet'
         ); ?></th>
									<td></td>
									<td align="left">
										<fieldset><legend class="screen-reader-text"><span><?php esc_html_e(
              'Akismet anti-spam strictness',
              'akismet'
          ); ?></span></legend>
										<p><label for="akismet_strictness_1"><input type="radio" name="akismet_strictness" id="akismet_strictness_1" value="1" <?php checked(
              '1',
     ...
     'akismet'
										...
										<p><label for="akismet_strictness_0"><input type="radio" name="akismet_strictness" id="akismet_strictness_0" value="0" <?php checked(
              '0',
              get_option('akismet_strictness')
          ); ?> /> <?php esc_html_e(
     ...
     'akismet'
										...
										<span class="akismet-note"><strong><?php esc_html_e(
              'Note:',
              'akismet'
          ); ?></strong>
										<?php
          $delete_interval = max(
              1,
              intval(apply_filters('akismet_delete_comment_interval', 15))
          );
          ...
          ?>
								...
								<tr>
									<th class="comment-form-privacy-notice" align="left" scope="row"><?php esc_html_e(
             'Privacy',
             'akismet'
         ); ?></th>
									<td></td>
              ...
              'akismet'
										...
										<p><label for="akismet_comment_form_privacy_notice_display"><input type="radio" name="akismet_comment_form_privacy_notice" id="akismet_comment_form_privacy_notice_display" value="display" <?php checked(
              'display',
     ...
     'akismet'
										...
										<span class="akismet-note"><?php esc_html_e(
				...
				<div class="akismet-card">
					...
					<div class="inside">
						<table cellspacing="0" border="0" class="akismet-settings">
							<tbody>
								<tr>
									<th scope="row" align="left"><?php esc_html_e(
             'Subscription Type',
             'akismet'
         ); ?></th>
									<td width="5%"/>
								...
								<tr>
									...
									<td width="5%"/>
									<td align="left">
										<p><?php if ('cancelled' == $akismet_user->status):
